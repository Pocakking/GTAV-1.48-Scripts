...
int func_59(int iParam0)//Position - 0x4585
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x4620
{
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5B5D
{
	int iVar0;
	int iVar1;
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x62A8
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x62EF
{
...
bool func_70(int iParam0)//Position - 0x634A
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x635A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x63C4
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x66E5
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x66F0
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6700
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x67A2
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6DA4
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6E02
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6EB0
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x6F45
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x6F89
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x710D
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x711B
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7BE2
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7C64
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7CC2
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7CCB
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7ED6
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x7EE6
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7F03
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7F13
{
	switch (iParam0)
	{
		case -1:
...
void func_182(int iParam0)//Position - 0xC62E
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_184()//Position - 0xC739
{
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_96, "SET_COLOUR");
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_96, "SET_DISTANCE");
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_98) > 1250)
	{
		AUDIO::PLAY_SOUND_FROM_COORD(iLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = MISC::GET_GAME_TIMER();
	}
}

int func_185(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xC82B
{
	var uVar0;
...
void func_186(int iParam0)//Position - 0xC94D
{
	Global_16877 = iParam0;
}

int func_187(char* sParam0)//Position - 0xC95A
{
	struct<6> Var0;
...
struct<6> func_188()//Position - 0xC97A
{
	struct<6> Var0;
...
void func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC99E
{
...
void func_190(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC9D9
{
...
void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCA2F
{
...
float func_192(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCACA
{
	vector3 vVar0;
...
void func_193(int iParam0, int iParam1, vector3 vParam2)//Position - 0xCB04
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_194(int iParam0, bool bParam1)//Position - 0xCBF5
{
	if (iParam0 == -1)
	{
		return;
...
int func_195(int iParam0)//Position - 0xCC31
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_196(int iParam0, int iParam1)//Position - 0xCC6A
{
	bool bVar0;
	int iVar1;
...
bool func_197()//Position - 0xCD08
{
	return Global_91021;
}

void func_198(int iParam0)//Position - 0xCD14
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_199(iParam0);
...
void func_199(int iParam0)//Position - 0xCD2B
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_200(int iParam0)//Position - 0xCE13
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_201(int iParam0, bool bParam1)//Position - 0xCE3B
{
	struct<27> Var0;
...
void func_202(int iParam0, var uParam1, int iParam2)//Position - 0xD0AE
{
	int iVar0;
	int iVar1;
...
int func_203(int iParam0)//Position - 0xD406
{
...
int func_204(var uParam0)//Position - 0xD426
{
...
int func_205(var uParam0)//Position - 0xD43E
{
...
void func_206(var uParam0)//Position - 0xD463
{
	int iVar0;
	int iVar1;
...
void func_207(int iParam0)//Position - 0xD767
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_208(var uParam0)//Position - 0xD792
{
	int iVar0;
...
int func_209(var uParam0, bool bParam1, bool bParam2)//Position - 0xD812
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_210(int iParam0, int iParam1)//Position - 0xD9D0
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, int iParam2)//Position - 0xDA00
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0xDCBC
{
...
int func_213(int iParam0, float fParam1)//Position - 0xDCF0
{
	float fVar0;
...
bool func_214(int iParam0, float fParam1)//Position - 0xDD66
{
	return func_215(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDD7E
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_216(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDE3F
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_217(int iParam0, int iParam1)//Position - 0xDF6B
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE07A
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_220(vector3 vParam0, vector3 vParam3)//Position - 0xE10B
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_221(vector3 vParam0)//Position - 0xE12C
{
	float fVar0;
	float fVar1;
...
void func_222(var uParam0)//Position - 0xE16B
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_223(int iParam0, int iParam1)//Position - 0xE186
{
	int iVar0;
...
int func_224(int iParam0)//Position - 0xE1C5
{
...
int func_225(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE1ED
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_226(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE2E8
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_227(int iParam0, float fParam1)//Position - 0xE3F4
{
	var uVar0;
	vector3 vVar1;
...
int func_228(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE489
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_229(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE517
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_230(int iParam0)//Position - 0xE55F
{
...
void func_231(int iParam0)//Position - 0xE5A9
{
	int iVar0;
...
int func_232(int iParam0)//Position - 0xE646
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_233(int iParam0)//Position - 0xE6DE
{
...
int func_236(int iParam0)//Position - 0xE760
{
...
int func_238(int iParam0)//Position - 0xE7D2
{
	if (func_107(0))
	{
...
void func_239()//Position - 0xE7FA
{
	iLocal_98 = MISC::GET_GAME_TIMER();
}

void func_240()//Position - 0xE808
{
...
int func_241(int iParam0)//Position - 0xE870
{
	switch (*iParam0)
	{
		case 44:
...
int func_242(var uParam0)//Position - 0xE8B7
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
void func_243(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xEA85
{
	func_244(iParam0);
...
void func_244(int iParam0)//Position - 0xEAC7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_245(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xEB63
{
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xEBBF
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0xEC4D
{
	int iVar0;
...
int func_248(var uParam0)//Position - 0xEC93
{
	if (func_205(uParam0))
	{
...
int func_249(int iParam0)//Position - 0xECBD
{
	int iVar0;
...
void func_250(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xECEE
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_251(var uParam0)//Position - 0xED2A
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
int func_252(int iParam0)//Position - 0xEFAC
{
	struct<27> Var0;
	int iVar32;
...
int func_253(int iParam0)//Position - 0xF000
{
	char* sVar0;
...
int func_254(int iParam0)//Position - 0xF0B9
{
	var uVar0;
...
int func_255(int iParam0)//Position - 0xF17A
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_256(int iParam0, char* sParam1)//Position - 0xF1FF
{
...
bool func_257(int iParam0)//Position - 0xF2E1
{
...
bool func_258(int iParam0)//Position - 0xF30F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_259(int iParam0)//Position - 0xF33D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_260(int iParam0)//Position - 0xF36B
{
	if (func_233(iParam0))
	{
		return 0;
...
void func_261()//Position - 0xF3A0
{
	func_282("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_262(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF3BA
{
	int iVar0;
...
int func_263(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xF41F
{
	int iVar0;
	struct<7> Var1;
...
int func_264(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xF49D
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_265(int iParam0, bool bParam1)//Position - 0xF518
{
	char* sVar0;
...
void func_266(char* sParam0)//Position - 0xF5E8
{
...
void func_267()//Position - 0xF607
{
	Global_14732 = 0;
	func_268();
}

void func_268()//Position - 0xF617
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_269(var uParam0)//Position - 0xF638
{
	if (func_205(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_270(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF66E
{
...
void func_271(var uParam0, bool bParam1)//Position - 0xF68E
{
	func_272(&(uParam0->f_41), bParam1);
}

void func_272(var uParam0, bool bParam1)//Position - 0xF6A0
{
	int iVar0;
...
void func_273(int iParam0, bool bParam1)//Position - 0xF6DE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_274(var uParam0, bool bParam1)//Position - 0xF719
{
	func_275(&(uParam0->f_35), bParam1);
}

void func_275(var uParam0, bool bParam1)//Position - 0xF72B
{
	int iVar0;
...
void func_276(int iParam0)//Position - 0xF768
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_277(var uParam0, int iParam1)//Position - 0xF7A0
{
	func_278(&(uParam0->f_28), iParam1);
}

void func_278(var uParam0, int iParam1)//Position - 0xF7B2
{
	int iVar0;
...
void func_279(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF7F3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_280(int iParam0)//Position - 0xF843
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_281(var uParam0)//Position - 0xF884
{
	if (*uParam0 == -1)
	{
		return;
...
void func_282(int iParam0)//Position - 0xF8C1
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_283(var uParam0)//Position - 0xF8D3
{
	*uParam0 = -1;
...
void func_284()//Position - 0xF906
{
	func_282("Running start routines.");
	Global_106283++;
}

int func_285(int iParam0)//Position - 0xF920
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
