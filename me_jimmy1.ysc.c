...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_99 = 49;
	iLocal_100 = 64;
	iLocal_105 = HUD::_0x4A9923385BDB9DAD();
	iLocal_106 = HUD::_GET_BLIP_INFO_ID_ITERATOR();
...
void func_3()//Position - 0x39F
{
	...
	else if (func_36(iLocal_392) && func_36(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_392, PLAYER::PLAYER_PED_ID(), 1))
		{
			if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_392, 0, 2) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(iLocal_392))
			{
				...
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_392, iVar0);
		...
		else
		{
			...
			if (((PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && func_34(PLAYER::PLAYER_PED_ID(), iLocal_392, 50f, 1)) && func_33(iLocal_392, 1126825984)) && func_24(PLAYER::PLAYER_PED_ID(), iLocal_392, 90f, 1, 250, 7))
			{
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_392, -1519143300) != 1)
				{
					BRAIN::TASK_HANDS_UP(iLocal_392, -1, 0, -1, 0);
				}
			}
			else if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_392, -1519143300) == 1)
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_392);
			}
		}
	}
}
...
int func_25(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF45
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
int func_28(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x1180
{
	...
	{
		vVar3 = { func_30(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_29(vector3 vParam0, vector3 vParam3)//Position - 0x1211
{
...
void func_40(bool bParam0, bool bParam1)//Position - 0x14C8
{
	...
	{
		if (func_36(iLocal_392) && PED::IS_PED_IN_GROUP(iLocal_392))
		{
			PED::REMOVE_PED_FROM_GROUP(iLocal_392);
		}
		if (bParam1)
		...
		else if (func_36(iLocal_392) && ENTITY::IS_ENTITY_AT_COORD(iLocal_392, vLocal_380, 50f, 50f, 50f, false, true, 0))
		{
			func_44(iLocal_392);
		}
		else
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			func_47(&(iLocal_394[iVar0]), 1, 0, 1);
			iVar0++;
		}
	}
	func_61(&iLocal_391);
...
void func_62()//Position - 0x27CF
{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
	{
		...
		switch (iLocal_389)
		{
			case 0:
				...
				BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_392, -1, 2050, 4);
				if (func_43(iVar0))
				{
				...
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_392, 0);
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_296, 1f, 20000, 1048576000, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar1);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_392, iVar1);
				...
				if ((((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) || (PED::IS_PED_IN_ANY_VEHICLE(iLocal_392, 1) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_392))) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(iLocal_392))
				{
					...
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_392, iVar2);
			...
			case 1:
				...
				if (!func_21())
				{
					if (((func_43(iLocal_403) && func_36(iLocal_392)) && PED::IS_PED_IN_VEHICLE(iLocal_392, iLocal_403, 0)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_403, 0, 0))
					{
			...
			case 2:
				if (func_43(iVar0))
				{
					...
					if (VEHICLE::IS_VEHICLE_STOPPED(iVar0))
					{
						...
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_392, iVar3);
			...
			case 3:
				...
				if (((!func_21() && func_76(iLocal_392, vLocal_296, 4f)) || bLocal_300) || MISC::GET_GAME_TIMER() > iLocal_299)
				{
					if (bLocal_300)
					{
						if (func_21())
...
void func_67(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2E21
{
	if (bParam0)
	{
...
bool func_68()//Position - 0x2F5A
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_69(int iParam0, int iParam1)//Position - 0x2F77
{
	bool bVar0;
...
int func_70(int iParam0, bool bParam1)//Position - 0x2FC2
{
	int iVar0;
	int iVar1;
...
int func_71()//Position - 0x3003
{
	return Global_1312745;
}

int func_72(int iParam0)//Position - 0x300F
{
...
bool func_73()//Position - 0x3051
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_74(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x3062
{
	int iVar0;
...
void func_75(int iParam0)//Position - 0x3095
{
	if (iParam0 == 1)
	{
...
bool func_76(int iParam0, vector3 vParam1, float fParam4)//Position - 0x30B8
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_77(int iParam0)//Position - 0x30ED
{
...
void func_79(int iParam0, bool bParam1)//Position - 0x3169
{
...
void func_80(int iParam0, bool bParam1)//Position - 0x31A5
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
int func_81(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x31D7
{
...
void func_82(int iParam0)//Position - 0x3366
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_83(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x3392
{
	int iVar0;
...
Vector3 func_84(int iParam0)//Position - 0x3550
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3563
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x3D79
{
	int iVar0;
...
int func_87(int iParam0)//Position - 0x3E05
{
	switch (iParam0)
	{
...
void func_88(int iParam0, int iParam1, int iParam2)//Position - 0x3E40
{
	int iVar0;
	int iVar1;
...
int func_89(int iParam0, int iParam1, int iParam2)//Position - 0x3ECA
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_90(int iParam0, int iParam1, int iParam2)//Position - 0x3FA8
{
	Global_71402[1 /*14*/] = { func_135(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_91(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x3FD3
{
	var uVar0;
	int iVar10;
...
int func_92(int iParam0, int iParam1, int iParam2)//Position - 0x45D8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4671
{
	int iVar0;
...
int func_94(int iParam0, int iParam1, int iParam2)//Position - 0x4707
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0)//Position - 0x47A8
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4858
{
	int iVar0;
...
int func_97(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4B5F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x5712
{
	int iVar0;
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x59F6
{
	int iVar0;
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5CBD
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5CF4
{
	int iVar0;
...
int func_102(int iParam0, int iParam1, int iParam2)//Position - 0x5D1D
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5FE7
{
	int iVar0;
...
int func_104(int iParam0, int iParam1, int iParam2)//Position - 0x6271
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x63C8
{
	int iVar0;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6460
{
	switch (iParam0)
	{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x652E
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_95(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_108(int iParam0, int iParam1)//Position - 0x668A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_109(int iParam0)//Position - 0x6A31
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6A92
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_111(int iParam0, int iParam1)//Position - 0x6B8E
{
	int iVar0;
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6CCC
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_95(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_113(int iParam0)//Position - 0x6DAC
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_114(int iParam0, int iParam1)//Position - 0x6E32
{
	int iVar0;
	struct<10> Var1;
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7761
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_116(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x788B
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_117(int iParam0, int iParam1)//Position - 0x78D3
{
	int iVar0;
	struct<17> Var1;
...
void func_118(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x971E
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_119(int iParam0)//Position - 0x9908
{
	switch (iParam0)
	{
		case 0:
...
void func_120(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x99B8
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9A29
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9CA6
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA0CB
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_124(int iParam0, int iParam1)//Position - 0xA3BE
{
	int iVar0;
	int iVar1;
...
int func_125(int iParam0, int iParam1)//Position - 0xA404
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_126(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA464
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_127(int iParam0)//Position - 0xA4E8
{
...
void func_128(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xA5A0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA5EA
{
	int iVar0;
...
int func_130(var uParam0)//Position - 0xA61A
{
	int iVar0;
	int iVar1;
...
int func_131(int iParam0, int iParam1, int iParam2)//Position - 0xA64E
{
	int iVar0;
	var uVar1;
...
bool func_132(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xA680
{
	int iVar0;
...
int func_133(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC608
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_134(int iParam0)//Position - 0xD526
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_135(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD577
{
	func_198();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_136(int iParam0, int iParam1)//Position - 0xD5C9
{
	switch (iParam0)
	{
		case 0:
...
void func_137(int iParam0)//Position - 0xD6B9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE930
{
	int iVar0;
	int iVar1;
...
bool func_139(int iParam0, int iParam1, var uParam2)//Position - 0xECC1
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_140(int iParam0, int iParam1)//Position - 0xF0C6
{
	switch (iParam1)
	{
		case 0:
...
int func_141(int iParam0, int iParam1)//Position - 0xF4C1
{
	switch (iParam1)
	{
		case 0:
...
int func_142(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF8BC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_143(int iParam0)//Position - 0xF8FE
{
	switch (iParam0)
	{
		case -1:
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF9D2
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_138(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_138(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_95(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_145(int iParam0)//Position - 0xFCAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0xFE02
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x10311
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x10386
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x103FA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x104E1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x10844
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x10A55
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x10C85
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x10D95
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x11734
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x122A7
{
	if (iParam0 < 136)
	{
		func_158(iParam0);
...
void func_157(int iParam0)//Position - 0x122DC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x12EE0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x13DEE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x13F1B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0, int iParam1)//Position - 0x1401A
{
	switch (iParam0)
	{
		case 0:
...
void func_162(int iParam0)//Position - 0x1410A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x155FB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1574C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x15C57
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x162C5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x16339
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x16409
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x16939
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x16AD0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x172CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x173DE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1830A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x18FC7
{
	if (iParam0 < 107)
	{
		func_177(iParam0);
...
void func_175(int iParam0)//Position - 0x1900D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x19AB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1A8A1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x1B4EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x1B763
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0, int iParam1)//Position - 0x1B8A9
{
	switch (iParam0)
	{
		case 0:
...
void func_181(int iParam0)//Position - 0x1B999
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x1C724
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1C89E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x1CE15
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x1D33F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x1D3B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x1D483
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x1D95B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x1DBC4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x1DE9A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x1E063
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x1EBB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x1F801
{
	if (iParam0 < 60)
	{
		func_195(iParam0);
...
void func_194(int iParam0)//Position - 0x1F836
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x205D7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x20C63
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x20D4A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198()//Position - 0x20E48
{
...
int func_199(int iParam0, int iParam1, int iParam2)//Position - 0x20EC1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_200(bool bParam0)//Position - 0x2111C
{
	int iVar0;
...
void func_201()//Position - 0x2115A
{
	Global_14732 = 0;
	func_202();
}

void func_202()//Position - 0x2116A
{
...
void func_203()//Position - 0x211A1
{
	Global_14732 = 0;
	func_204();
}

void func_204()//Position - 0x211B1
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_205()//Position - 0x211D5
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		switch (iLocal_389)
		{
			case 0:
				...
				else
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2f, 20000, 1048576000, 0, 1193033728);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_293, 1f, 20000, 1048576000, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar1);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_392, iVar1);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar1);
				}
			...
			case 1:
				...
				if (!func_21())
				{
					if (func_34(PLAYER::PLAYER_PED_ID(), iLocal_392, 5f, 1))
					{
						if (((func_43(iLocal_403) && func_36(iLocal_392)) && PED::IS_PED_IN_VEHICLE(iLocal_392, iLocal_403, 0)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_403, 0, 0))
						{
							if (func_39(&uLocal_107, "MEJ1AUD", "MEJ1_HOME2", 7, 0, 0, 0) || func_38(&iLocal_457, 5000))
			...
			case 3:
				...
				if (((!func_21() && (func_76(iLocal_392, vLocal_287, 2f) || func_76(iLocal_392, vLocal_290, 2f))) || bLocal_300) || MISC::GET_GAME_TIMER() > iLocal_299)
				{
					if (bLocal_300)
					{
						if (func_21())
...
void func_206(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x215A1
{
	func_207(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_207(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x215CB
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_208(vector3 vParam0)//Position - 0x219BF
{
...
int func_209(int iParam0, int iParam1, bool bParam2)//Position - 0x219E9
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_210(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x21A5A
{
...
int func_211(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x21B32
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_212(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x21E28
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_213(int iParam0)//Position - 0x21EDC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
Vector3 func_214()//Position - 0x21F41
{
	return 2.55f, 5.665f, 2.55f;
}

void func_215()//Position - 0x21F58
{
	func_235();
	...
	switch (iLocal_389)
	{
		case 0:
			...
			func_228(&uLocal_459);
			if (func_36(iLocal_392) && !PED::IS_PED_GROUP_MEMBER(iLocal_392, func_227()))
			{
				PED::SET_PED_AS_GROUP_MEMBER(iLocal_392, func_227());
		...
		case 1:
			if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
			{
				...
				if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_392) > 15f)
				{
					func_22();
					iLocal_389 = 0;
					iLocal_388 = 4;
...
void func_216()//Position - 0x2205B
{
	if (func_36(iLocal_392) && func_43(iLocal_403))
	{
		switch (iLocal_274)
		{
			...
			case 2:
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "enter_back", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_322 = 0;
				iLocal_323 = -1;
				iLocal_274 = 12;
				break;
			...
			case 4:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "enter_left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 5;
				break;
			...
			case 5:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_273) >= 0.9f)
					{
						...
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 6;
					}
				}
				break;
			...
			case 7:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "exit_left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				if (iLocal_277 || (func_43(iLocal_403) && !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_403, 7)))
				{
					iLocal_274 = 13;
				}
				else
			...
			case 8:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "enter_right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 9;
				break;
			...
			case 9:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_273) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 10;
					}
				}
				break;
			...
			case 11:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "exit_right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				if (iLocal_277 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_403, 7))
				{
					iLocal_274 = 13;
				}
			...
			case 12:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_273) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "back", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 3;
					}
				}
				break;
			...
			case 14:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "exit_back", 4f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 15;
				break;
			...
			case 15:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_273) >= 0.95f)
					{
						...
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "enter_backseat", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 16;
					}
				}
				else
			...
			case 17:
				if (PED::IS_PED_IN_VEHICLE(iLocal_392, iLocal_403, 0) && iLocal_277)
				{
					...
					{
						BRAIN::TASK_LEAVE_ANY_VEHICLE(iLocal_392, 0, 65536);
...
void func_217(int iParam0, int iParam1, int iParam2)//Position - 0x227B7
{
	if (func_36(iParam0))
	{
		if (func_35(iParam1))
...
int func_218()//Position - 0x227F9
{
	vector3 vVar0;
	
	if (func_43(iLocal_403) && func_34(iLocal_403, PLAYER::PLAYER_PED_ID(), 10f, 1))
	{
...
float func_219(int iParam0, int iParam1)//Position - 0x22866
{
	return func_220(iParam0, iParam1, 1);
}

float func_220(int iParam0, int iParam1, bool bParam2)//Position - 0x22877
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_221()//Position - 0x228D5
{
	int iVar0;
	...
	if (func_36(iLocal_392))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_392, 0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				{
					BRAIN::TASK_LEAVE_ANY_VEHICLE(iLocal_392, 0, 4416);
				}
			}
		}
	}
...
void func_222()//Position - 0x22926
{
	if ((iLocal_349 < 3 && MISC::GET_GAME_TIMER() > iLocal_343) && (func_225() || func_224()))
	{
...
int func_225()//Position - 0x22A04
{
	...
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		if (func_43(iVar0) && PED::IS_PED_IN_VEHICLE(iLocal_392, iVar0, 0))
		{
			return 1;
		}
	}
...
void func_226()//Position - 0x22A40
{
	int iVar0;
	bool bVar1;
	
	if ((iLocal_332 < 6 && MISC::GET_GAME_TIMER() > iLocal_324) && func_225())
	{
...
int func_227()//Position - 0x22AF5
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_228(var uParam0)//Position - 0x22B05
{
...
void func_229(char* sParam0, int iParam1, int iParam2)//Position - 0x22B2F
{
	iParam2 = iParam2;
...
void func_230(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x22B48
{
	switch (*uParam0)
	{
		case 0:
...
bool func_231(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x22C59
{
	func_20(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_232()//Position - 0x22CAD
{
	Global_14732 = 0;
	func_19();
}

struct<6> func_233()//Position - 0x22CBD
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
struct<6> func_234()//Position - 0x22D69
{
	struct<6> Var0;
...
void func_235()//Position - 0x22D8D
{
	int iVar0;
	int iVar1;
...
void func_236()//Position - 0x22DFA
{
	func_235();
	func_230(&uLocal_459, &uLocal_107, "MEJ1AUD", &sLocal_460, &cLocal_466);
	switch (iLocal_389)
	{
		...
		case 1:
			...
			if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
			{
				if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_392) < 5f)
				{
...
void func_237()//Position - 0x22EB9
{
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
	{
		if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_392) > fLocal_386)
		{
...
int func_238(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x22F09
{
	int iVar0;
	bool bVar1;
...
void func_239()//Position - 0x22F5B
{
	func_235();
	func_230(&uLocal_459, &uLocal_107, "MEJ1AUD", &sLocal_460, &cLocal_466);
	switch (iLocal_389)
	{
		case 0:
			...
			if (func_331() == 1)
			{
				iLocal_391 = func_330(vLocal_383, 5, 1);
			...
			{
				iLocal_391 = func_330(vLocal_380, 5, 1);
			}
...
void func_240()//Position - 0x2313B
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
void func_241()//Position - 0x231F0
{
	int iVar0;
	
	if (func_36(PLAYER::PLAYER_PED_ID()) && MISC::GET_GAME_TIMER() > iLocal_374)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
void func_242()//Position - 0x2324F
{
...
void func_243()//Position - 0x2329D
{
	if ((iLocal_372 < 12 && MISC::GET_GAME_TIMER() > iLocal_358) && func_36(iLocal_394[0]))
	{
		if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 30f)
		{
			if (!func_21() && func_223())
			{
...
void func_244()//Position - 0x2331F
{
	bool bVar0;
	
	if ((iLocal_342 < 3 && MISC::GET_GAME_TIMER() > iLocal_333) && (func_225() || func_224()))
	{
...
void func_245()//Position - 0x23408
{
	if (iLocal_278 == 0)
	{
	...
	{
		if (((!func_21() && func_223()) && func_225()) && MISC::GET_GAME_TIMER() > iLocal_319)
		{
...
void func_246()//Position - 0x234CC
{
	if (((((iLocal_375 && ENTITY::DOES_ENTITY_EXIST(iLocal_394[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_394[1])) && ENTITY::DOES_ENTITY_EXIST(iLocal_394[2])) && func_36(iLocal_392)) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
...
void func_247(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2353D
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_320(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
...
void func_248(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x236B2
{
	func_249(&Global_100114, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_249(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x236CE
{
	int iVar0;
	int iVar1;
...
int func_250(var uParam0)//Position - 0x24558
{
...
void func_251(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2457A
{
	int iVar0;
...
int func_252(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x24602
{
...
int func_253(int iParam0)//Position - 0x24642
{
	int iVar0;
...
void func_254(var uParam0, int iParam1, int iParam2)//Position - 0x24670
{
...
int func_255(int iParam0)//Position - 0x2474C
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0x2478E
{
	int iVar0;
...
int func_257(int iParam0, int iParam1, int iParam2)//Position - 0x247F1
{
	int iVar0;
...
int func_258(int iParam0, int iParam1)//Position - 0x2487F
{
	struct<82> Var0;
...
void func_259(int iParam0, var uParam1, int iParam2)//Position - 0x248C1
{
	int iVar0;
...
void func_260(int iParam0, var uParam1)//Position - 0x24B1D
{
	int iVar0;
...
int func_261(int iParam0)//Position - 0x24DC8
{
	switch (iParam0)
	{
		case 1:
...
int func_262(int iParam0, var uParam1, var uParam2)//Position - 0x24E78
{
	int iVar0;
	int iVar1;
...
int func_263(int iParam0)//Position - 0x2506B
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_264(var uParam0)//Position - 0x2508B
{
	int iVar0;
...
int func_265(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2513B
{
	char* sVar0;
...
void func_266(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2526A
{
	int iVar0;
	int iVar1;
...
int func_267(int iParam0, int iParam1)//Position - 0x2540A
{
	var uVar0;
	var uVar1;
...
void func_268(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x25436
{
	int iVar0;
...
void func_269(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2597E
{
	int iVar0;
...
int func_270()//Position - 0x25BBF
{
	func_12();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_271(int iParam0, bool bParam1)//Position - 0x25BD8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_272(int iParam0, var uParam1)//Position - 0x25CCB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_274(Var11.f_1)) && iVar72 < 51)
			{
...
int func_273(int iParam0)//Position - 0x25F53
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_274(int iParam0)//Position - 0x25FEE
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_275(int iParam0, int iParam1)//Position - 0x26174
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_276(int iParam0, var uParam1)//Position - 0x26CE5
{
	int iVar0;
	int iVar1;
...
int func_277(int iParam0)//Position - 0x26D20
{
	int iVar0;
...
void func_278(int iParam0)//Position - 0x26F94
{
	int iVar0;
...
void func_279(var uParam0, int iParam1)//Position - 0x26FD0
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_280(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x2752B
{
	int iVar0;
	int iVar1;
...
bool func_281(int iParam0, var uParam1, var uParam2)//Position - 0x2756F
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_282(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x27C76
{
	if (bParam6)
	{
...
int func_283(var uParam0)//Position - 0x27CBD
{
...
bool func_284(int iParam0)//Position - 0x27D18
{
	return func_285(iParam0, 0, 1);
}

int func_285(int iParam0, int iParam1, bool bParam2)//Position - 0x27D28
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_286(int iParam0)//Position - 0x27D92
{
	switch (iParam0)
	{
		case 0:
...
int func_287()//Position - 0x280B4
{
	return Global_25765;
}

int func_288(int iParam0)//Position - 0x280BF
{
	return func_285(iParam0, 5, 1);
}

int func_289(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x280CF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_290(int iParam0, bool bParam1)//Position - 0x28171
{
	switch (iParam0)
	{
		case -1:
...
int func_291(int iParam0)//Position - 0x28773
{
	if (iParam0 != func_300())
	{
...
Vector3 func_292(int iParam0, int iParam1)//Position - 0x287D1
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_293(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2887F
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_294(vector3 vParam0, float fParam3)//Position - 0x28914
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_295(int iParam0)//Position - 0x28958
{
	struct<6> Var0;
...
struct<6> func_296(int iParam0)//Position - 0x28ADC
{
	return func_297(iParam0);
}

struct<6> func_297(int iParam0)//Position - 0x28AEA
{
	struct<6> Var0;
...
int func_298(int iParam0, var uParam1)//Position - 0x295B1
{
	switch (iParam0)
	{
		case 0:
...
int func_299(int iParam0)//Position - 0x29633
{
	if (iParam0 != func_300())
	{
...
int func_300()//Position - 0x29691
{
	return -1;
}

Vector3 func_301(int iParam0)//Position - 0x2969A
{
	switch (iParam0)
	{
		case 1:
...
int func_302()//Position - 0x298A5
{
	return func_303(PLAYER::PLAYER_ID());
}

int func_303(int iParam0)//Position - 0x298B5
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_304(int iParam0)//Position - 0x298D2
{
	return func_285(iParam0, 0, 0);
}

int func_305(int iParam0)//Position - 0x298E2
{
	switch (iParam0)
	{
		case -1:
...
bool func_306()//Position - 0x29BA3
{
	return Global_93734.f_339 > 0;
}

var func_307()//Position - 0x29BB4
{
	var uVar0;
...
void func_308(var uParam0, int iParam1)//Position - 0x29BFA
{
	if (iParam1 <= 0)
	{
		return;
...
void func_309(var uParam0, int iParam1)//Position - 0x29C80
{
...
void func_310(var uParam0, int iParam1)//Position - 0x29CB3
{
	int iVar0;
	int iVar1;
...
int func_311(int iParam0, int iParam1)//Position - 0x29D04
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_312(int iParam0)//Position - 0x29DA6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_313(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_313(bool bParam0, int iParam1, int iParam2)//Position - 0x29DCB
{
	if (bParam0)
	{
		return iParam1;
...
int func_314(var uParam0)//Position - 0x29DE2
{
	return uParam0 & 15;
}

void func_315(var uParam0, int iParam1)//Position - 0x29DEF
{
...
void func_316(var uParam0, int iParam1)//Position - 0x29E29
{
...
void func_317(var uParam0, int iParam1)//Position - 0x29E64
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_318(char* sParam0)//Position - 0x29EA0
{
...
struct<2> func_319(int iParam0)//Position - 0x29EF6
{
	struct<2> Var0;
...
int func_320(char* sParam0, int iParam1)//Position - 0x2A342
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_321(int iParam0, var uParam1)//Position - 0x2A38B
{
	switch (iParam0)
	{
		case 0:
...
int func_323(int iParam0)//Position - 0x2B5D1
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_324(int iParam0)//Position - 0x2B917
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_325(int iParam0)//Position - 0x2B94E
{
	switch (iParam0)
	{
		case 69:
...
int func_326(int iParam0)//Position - 0x2BA0A
{
	switch (iParam0)
	{
		case 1:
...
int func_327(char* sParam0, bool bParam1)//Position - 0x2BA5E
{
	int iVar0;
	int iVar1;
...
int func_328(int iParam0, bool bParam1)//Position - 0x2BA88
{
	int iVar0;
...
void func_329(bool bParam0)//Position - 0x2BABE
{
	int iVar0;
	int iVar1;
...
int func_330(vector3 vParam0, int iParam3, bool bParam4)//Position - 0x2BD40
{
	int iVar0;
...
int func_332(int iParam0)//Position - 0x2BDEC
{
...
int func_333(int iParam0)//Position - 0x2BE19
{
...
void func_334()//Position - 0x2BE45
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_389)
	{
		case 0:
			func_22();
			func_61(&iLocal_391);
			if ((((func_43(iLocal_403) && func_36(iLocal_394[0])) && func_36(iLocal_394[1])) && func_36(iLocal_394[2])) && func_36(iLocal_392))
			{
				...
				BRAIN::TASK_VEHICLE_DRIVE_WANDER(iLocal_394[0], iLocal_403, 12f, 786468);
		...
		case 1:
			...
			if (func_43(iLocal_403) && ENTITY::DOES_ENTITY_EXIST(iLocal_394[0]))
			{
				...
				if ((((((((((ENTITY::GET_ENTITY_HEALTH(iLocal_403) < 850 || func_347()) || func_345()) || func_344(iLocal_403, &uLocal_454, &uLocal_456, &uLocal_453, &fLocal_455, 6, 1082130432)) || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_403) < 50f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(iLocal_403) < 50f) || (func_36(iLocal_394[0]) && !PED::IS_PED_IN_VEHICLE(iLocal_394[0], iLocal_403, 0))) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 2, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 1, 5000))
				{
					if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
					{
						func_201();
					}
					if (func_36(iLocal_394[0]))
					{
						BRAIN::TASK_VEHICLE_TEMP_ACTION(iLocal_394[0], iLocal_403, 20, 1000);
					}
				...
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_403))
				{
					...
					while (iVar2 < 3)
					{
						if (func_36(iLocal_394[iVar2]))
						{
							...
							BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iVar3);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_394[iVar2], iVar3);
							BRAIN::CLEAR_SEQUENCE_TASK(&iVar3);
							if (iVar2 == 0 && !func_345())
							{
								func_22();
							...
							else if (((iVar2 == 1 && !func_36(iLocal_394[0])) || ((iVar2 == 2 && !func_36(iLocal_394[0])) && !func_36(iLocal_394[1]))) && !func_345())
							{
								func_343(&uLocal_107, 6, iLocal_394[iVar2], "MEJimmyKidnapper2", 1, 1);
								func_22();
								func_4(&uLocal_107, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_2", 7, 0, 0);
							}
							else if ((iVar2 == 1 && func_36(iLocal_394[0])) || (iVar2 == 2 && (func_36(iLocal_394[0]) || func_36(iLocal_394[1]))))
							{
								func_340(iLocal_394[iVar2], 1);
							}
						}
						iVar2++;
					}
					...
					iLocal_372 = 0;
					iLocal_358 = MISC::GET_GAME_TIMER() + 9000;
					if (func_36(iLocal_392) && (((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 2, 5000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 1, 5000)))
					{
						if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_392) > (5f + 1f))
						{
							iLocal_391 = func_238(iLocal_392, 1, 1, 5);
		...
		case 3:
			func_243();
			func_335();
			if ((func_43(iLocal_403) && func_36(PLAYER::PLAYER_PED_ID())) && func_36(iLocal_392))
			{
				if (iLocal_438 && func_219(PLAYER::PLAYER_PED_ID(), iLocal_392) > fLocal_387)
				{
				...
				if (bLocal_437)
				{
					if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_392) < 5f)
					{
						BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_392);
						func_336();
					}
				}
				else if (func_220(PLAYER::PLAYER_PED_ID(), iLocal_403, 1) < (5f - 1f))
				{
					iLocal_277 = 1;
					func_336();
				}
...
void func_335()//Position - 0x2C60E
{
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
	{
...
void func_336()//Position - 0x2C667
{
	if (!func_21())
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
...
void func_337()//Position - 0x2C6AF
{
	iLocal_358 = MISC::GET_GAME_TIMER() + 9000;
	iLocal_389 = 0;
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
...
void func_338(var uParam0, int iParam1, int iParam2)//Position - 0x2C6DC
{
	char* sVar0;
...
int func_339(char* sParam0)//Position - 0x2C7B9
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_340(int iParam0, bool bParam1)//Position - 0x2C7CC
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_341(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2C83D
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_342(iParam3), 0);
}

int func_342(int iParam0)//Position - 0x2C856
{
	int iVar0;
...
void func_343(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2CA4B
{
...
int func_344(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)//Position - 0x2CAE6
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
int func_345()//Position - 0x2CB97
{
	int iVar0;
	int iVar1;
	
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_43(iLocal_403))
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		if (func_43(iVar0))
		{
			...
			{
				if (VEHICLE::IS_VEHICLE_SIREN_ON(iVar0) && func_34(iVar0, iLocal_403, 15f, 1))
				{
					return 1;
				}
			}
...
int func_346(int iParam0)//Position - 0x2CC36
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_348(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2CD0E
{
	func_349(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_349(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x2CD28
{
	uParam0->f_6 = 0;
	func_350(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_350(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2CD4A
{
	int iVar0;
	int iVar1;
	...
	if (func_373(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_365(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_351(var uParam0)//Position - 0x2D0B7
{
...
int func_352(var uParam0)//Position - 0x2D120
{
	int iVar0;
...
int func_353(bool bParam0)//Position - 0x2D14B
{
	switch (Global_36425)
	{
		case 0:
...
int func_354(char* sParam0)//Position - 0x2D1F5
{
	if (!func_355(1, 1, 0))
	{
...
int func_355(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2D28E
{
	int iVar0;
	int iVar1;
...
int func_356(int iParam0)//Position - 0x2D4E7
{
	if (iParam0 != func_300())
	{
...
int func_357(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D54D
{
	int iVar0;
...
int func_358(int iParam0, int iParam1)//Position - 0x2D597
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_359(int iParam0, int iParam1)//Position - 0x2D5F9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_360()//Position - 0x2D67E
{
	return Global_2448756.f_16;
}

bool func_361(int iParam0)//Position - 0x2D68C
{
	return iParam0 == 51;
}

var func_362()//Position - 0x2D699
{
	return Global_2448756.f_15;
}

bool func_363()//Position - 0x2D6A7
{
	return MISC::GET_GAME_TIMER() <= Global_17411.f_5878 + 100;
}

int func_364(int iParam0)//Position - 0x2D6BC
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
void func_365(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x2D716
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_366()//Position - 0x2D826
{
	return func_367(PLAYER::PLAYER_ID());
}

int func_367(int iParam0)//Position - 0x2D836
{
...
int func_368(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2D855
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_369(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DBC1
{
...
int func_370(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DC13
{
	if (!func_355(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_371(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DC5C
{
	if (!func_355(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_372(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DCBB
{
	if (!func_355(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_373(int iParam0)//Position - 0x2DD11
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_374()//Position - 0x2DD6C
{
	MISC::SET_BIT(&Global_2424, 4);
}

void func_375(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x2DD7C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_376()//Position - 0x2DED5
{
	if (iLocal_312 > 0 && MISC::GET_GAME_TIMER() > iLocal_312)
	{
		if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
		{
			if ((func_219(PLAYER::PLAYER_PED_ID(), iLocal_392) < 50f && !func_21()) && !func_377("MEJ1_02", 0, 0))
			{
				if (iLocal_315)
				{
...
bool func_377(char* sParam0, int iParam1, int iParam2)//Position - 0x2DF80
{
...
void func_378()//Position - 0x2DF9E
{
	bool bVar0;
	
	if ((func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_394[0])) && func_43(iLocal_403))
	{
		if (iLocal_310 == -1 && iLocal_311 == -1)
		{
			...
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_403, PLAYER::PLAYER_PED_ID(), 1) || bLocal_313)
			{
				...
				if (func_4(&uLocal_107, "MEJ1AUD", "MEJ1_RAM", "MEJ1_RAM_3", 7, 0, 0))
				{
					...
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_394[0], iLocal_403, PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 100f, 1f, 1);
					RECORDING::_0x293220DA1B46CEBC(3f, 0f, 3);
					iLocal_274 = 2;
					fLocal_386 = 200f;
					fLocal_387 = 500f;
			...
			else if (func_219(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_403))
			{
		...
		else if (((iLocal_310 < 8 && func_219(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f) && !func_21()) && !func_377("MEJ1_02", 0, 0))
		{
...
bool func_379(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x2E1E9
{
...
void func_380()//Position - 0x2E237
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
void func_381(int iParam0, int iParam1, int iParam2)//Position - 0x2E2AB
{
	char* sVar0;
	char* sVar1;
	char* sVar2;
...
int func_382(int iParam0, int iParam1)//Position - 0x2E3B1
{
...
bool func_383(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2E423
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_384(var uParam0, var uParam1, var uParam2, float fParam3)//Position - 0x2E440
{
	*uParam0 = 0;
	*uParam1 = 0;
	*uParam2 = 0;
...
void func_385(char* sParam0, int iParam1)//Position - 0x2E458
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_386(int iParam0, bool bParam1, int iParam2)//Position - 0x2E46F
{
	int iVar0;
...
void func_387()//Position - 0x2E4A4
{
	func_230(&uLocal_459, &uLocal_107, "MEJ1AUD", &sLocal_460, &cLocal_466);
	switch (iLocal_389)
	{
		case 0:
			func_61(&iLocal_391);
			iLocal_391 = func_330(vLocal_377, 5, 0);
		...
		case 2:
			...
			{
				if (func_383(PLAYER::PLAYER_PED_ID(), vLocal_377, 150f) || func_379(&uLocal_107, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_389 = 3;
				}
			}
...
int func_388()//Position - 0x2E64B
{
	if (((func_43(iLocal_403) && func_36(PLAYER::PLAYER_PED_ID())) && func_36(iLocal_394[0])) && func_36(iLocal_392))
	{
...
void func_389()//Position - 0x2E737
{
	int iVar0;
	...
	if (func_43(iLocal_403))
	{
		...
		if (!func_36(iLocal_392))
		{
			if (STREAMING::HAS_MODEL_LOADED(func_46(14)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_272))
			{
				...
				BRAIN::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_392, 1);
				BRAIN::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_392, 1);
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, false);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "base", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 0;
			}
		}
	}
...
int func_390(int iParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x2EA1A
{
	int iVar0;
...
void func_392()//Position - 0x2EAB2
{
	func_393(iLocal_402);
	func_393(func_46(14));
	func_393(iLocal_404);
...
bool func_393(int iParam0)//Position - 0x2EAD5
{
	if (iParam0 == 0)
	{
		return 1;
...
void func_394(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2EAF3
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_395()//Position - 0x2EB1C
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		if (func_36(PLAYER::PLAYER_PED_ID()))
		{
			func_343(&uLocal_107, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
		}
		...
		if (func_60(0) && func_36(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_430(&iVar0, vVar1, fVar4, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
		}
		if (func_391())
		{
			iVar5 = func_429();
...
void func_396(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2EE9A
{
	int iVar0;
	int iVar1;
...
void func_397()//Position - 0x2EF0A
{
	Global_17272.f_6 = 1;
}

void func_398(int iParam0)//Position - 0x2EF18
{
	if (func_401())
	{
		return;
...
void func_399(int iParam0)//Position - 0x2EF4B
{
	if (func_401())
	{
		return;
...
void func_400(bool bParam0, bool bParam1)//Position - 0x2EFC5
{
	if (bParam0)
	{
		if (func_364(0))
...
bool func_401()//Position - 0x2F039
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

void func_402(int iParam0, int iParam1, int iParam2)//Position - 0x2F04B
{
...
void func_403(bool bParam0)//Position - 0x2F07F
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
	{
		...
		if (bParam0)
		{
			if ((func_43(iLocal_403) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_403, -1, 0)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_403, 0, 0))
			{
		...
		else
		{
			...
			func_430(&iVar1, vVar2, fVar5, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
			if ((func_43(iVar1) && VEHICLE::IS_VEHICLE_SEAT_FREE(iVar1, 0, 0)) && func_36(iLocal_392))
			{
...
void func_404(var uParam0, var uParam1)//Position - 0x2F1FF
{
	vector3 vVar0[5];
	float fVar16[5];
	int iVar22;
...
Vector3 func_405()//Position - 0x2F303
{
	return Global_100114.f_2884;
}

void func_406()//Position - 0x2F314
{
	int iVar0;
...
int func_407(int iParam0)//Position - 0x2F352
{
	if (*iParam0 < 0)
	{
...
int func_408(int iParam0)//Position - 0x2F3D1
{
	if (*iParam0 < 0)
	{
		*iParam0 = MISC::GET_GAME_TIMER() + 1000;
...
void func_409(bool bParam0, bool bParam1)//Position - 0x2F42C
{
	if (bParam0)
	{
		func_410(0, 1, 1);
...
void func_410(bool bParam0, int iParam1, int iParam2)//Position - 0x2F45F
{
	bool bVar0;
...
void func_411()//Position - 0x2F4BE
{
	int iVar0;
...
void func_412()//Position - 0x2F5BE
{
	int iVar0;
	int iVar1;
...
void func_413(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x2F5F5
{
	vector3 vVar0;
	float fVar3;
	...
	if (func_428() && func_414(iParam1, iParam2, iParam3, 1))
	{
		vVar0 = { 0f, 0f, 0f };
		fVar3 = 0f;
		func_430(iParam0, vVar0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
int func_414(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2F686
{
...
bool func_416()//Position - 0x2F789
{
	return func_417(&(Global_100114.f_2890));
}

int func_417(var uParam0)//Position - 0x2F79C
{
...
int func_418(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x2F7FB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_419(int iParam0, bool bParam1)//Position - 0x2F876
{
	int iVar0;
	struct<2> Var1;
...
int func_420(int iParam0)//Position - 0x2F9F6
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_422(int iParam0)//Position - 0x2FAD9
{
	int iVar0;
	int iVar1;
...
int func_423()//Position - 0x31B47
{
	return 0;
}

int func_424()//Position - 0x31B50
{
	return 1;
}

int func_425()//Position - 0x31B59
{
	return 1;
}

int func_426()//Position - 0x31B62
{
...
var func_428()//Position - 0x31C36
{
	return Global_97130.f_2890.f_8;
}

int func_429()//Position - 0x31C47
{
	if (!Global_93682 == 10 && !Global_93682 == 9)
	{
		return 0;
...
void func_430(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x31C71
{
	int iVar0;
	...
	else if (iParam9 == 1)
	{
		...
		{
			func_478(iParam12, 0);
			while (!func_431(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_431(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x31E05
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_432(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x32C49
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_433(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x3385D
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_434(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x338D0
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_435(int iParam0)//Position - 0x34DC3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_436(int iParam0, bool bParam1, var uParam2)//Position - 0x34E73
{
	int iVar0;
	bool bVar1;
...
int func_437(int iParam0)//Position - 0x34FE1
{
	int iVar0;
...
int func_438(int iParam0)//Position - 0x3501C
{
	if (iParam0 != func_300())
	{
		if (func_357(iParam0, 1, 1))
...
int func_439(int iParam0)//Position - 0x35063
{
	switch (iParam0)
	{
		case 0:
...
int func_440(int iParam0)//Position - 0x353F3
{
...
int func_441(int iParam0)//Position - 0x35435
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_442(int iParam0)//Position - 0x354C8
{
	if (iParam0 != func_300())
	{
		if (func_357(iParam0, 1, 1))
...
int func_443(int iParam0)//Position - 0x3550F
{
	if (iParam0 != func_300())
	{
		if (func_357(iParam0, 1, 1))
...
int func_444(int iParam0)//Position - 0x35555
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_445(int iParam0)//Position - 0x3558A
{
...
int func_446(int iParam0)//Position - 0x355B9
{
...
int func_447(int iParam0)//Position - 0x35676
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_448(int iParam0)//Position - 0x356AC
{
	switch (iParam0)
	{
		case 562680400:
...
int func_449(int iParam0, bool bParam1)//Position - 0x35705
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_450(int iParam0)//Position - 0x35760
{
	int iVar0;
...
int func_451(int iParam0, int iParam1)//Position - 0x3579A
{
	if (iParam1 == 0)
	{
...
bool func_452()//Position - 0x35B0E
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_453()//Position - 0x35B1F
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_454()//Position - 0x35B30
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_455()//Position - 0x35B41
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_456()//Position - 0x35B52
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_457()//Position - 0x35B63
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_458(int iParam0, int iParam1)//Position - 0x35B74
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_459(int iParam0)//Position - 0x35EEA
{
	if (iParam0 != func_300())
	{
		if (func_357(iParam0, 1, 1))
...
int func_460(int iParam0)//Position - 0x35F49
{
	if (iParam0 != func_300())
	{
		if (func_357(iParam0, 1, 1))
...
int func_461(int iParam0)//Position - 0x35FA9
{
	if (iParam0 != func_300())
	{
		if (func_357(iParam0, 1, 1))
...
int func_462(int iParam0, bool bParam1, var uParam2)//Position - 0x35FF0
{
	bool bVar0;
...
int func_463(int iParam0)//Position - 0x36415
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_464(int iParam0, int iParam1)//Position - 0x3643E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_465(int iParam0)//Position - 0x36640
{
...
int func_466(int iParam0)//Position - 0x3671D
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_467(int iParam0)//Position - 0x368CE
{
	int iVar0;
	char* sVar1;
...
int func_468(int iParam0)//Position - 0x36914
{
	int iVar0;
...
int func_469(int iParam0)//Position - 0x36990
{
	int iVar0;
...
void func_470(int iParam0, int iParam1)//Position - 0x36A78
{
	int iVar0;
...
void func_471(int iParam0)//Position - 0x36AFA
{
	if (!func_472(*iParam0))
	{
...
bool func_472(int iParam0)//Position - 0x36B25
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_473(int iParam0, var uParam1, var uParam2)//Position - 0x36B34
{
	int iVar0;
	int iVar1;
...
int func_474(int iParam0)//Position - 0x36CF7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_475(var uParam0)//Position - 0x36DD3
{
...
int func_476(int iParam0, int iParam1)//Position - 0x36E13
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_477(var uParam0, int iParam1)//Position - 0x36EF8
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_478(int iParam0, int iParam1)//Position - 0x36F39
{
	int iVar0;
...
void func_479(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x36FD7
{
	int iVar0;
...
void func_480(int iParam0)//Position - 0x37027
{
	bool bVar0;
...
void func_481(int iParam0, bool bParam1)//Position - 0x37199
{
	if (iParam0 == -1)
	{
		return;
...
void func_482(int iParam0, int iParam1, bool bParam2)//Position - 0x371F6
{
	if (iParam0 == -1)
	{
		return;
...
void func_483(var uParam0, var uParam1)//Position - 0x37231
{
...
int func_484(int iParam0, int iParam1)//Position - 0x372FD
{
	int iVar0;
...
int func_485(var uParam0)//Position - 0x3736F
{
	return *uParam0;
}

bool func_486(int iParam0, int iParam1)//Position - 0x3737A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_487(var uParam0, int iParam1)//Position - 0x3739D
{
	int iVar0;
	int iVar1;
...
int func_488(vector3 vParam0, float fParam3)//Position - 0x38A95
{
	return func_489(&(Global_100114.f_2890), vParam0, fParam3, 0);
}

int func_489(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x38AAF
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_490(int iParam0)//Position - 0x38D61
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_491(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x38E24
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_492(iParam0, uVar1[iVar6], 1) && func_418(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_282(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_492(int iParam0, int iParam1, bool bParam2)//Position - 0x3902C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_493(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x3908D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_494(int iParam0, int iParam1)//Position - 0x395DD
{
	int iVar0;
	int iVar1;
...
bool func_495()//Position - 0x39655
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_496(int iParam0)//Position - 0x39666
{
	int iVar0;
...
int func_497(int iParam0)//Position - 0x396B1
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_498(int iParam0)//Position - 0x39738
{
...
int func_499(int iParam0)//Position - 0x39767
{
...
int func_500(int iParam0)//Position - 0x39784
{
...
int func_501(int iParam0, int iParam1)//Position - 0x397A7
{
...
int func_502(int iParam0)//Position - 0x397E2
{
	if (func_501(iParam0, 0))
	{
...
int func_503(int iParam0, int iParam1)//Position - 0x39805
{
	int iVar0;
...
int func_504(var uParam0)//Position - 0x39852
{
	if (func_417(uParam0))
	{
...
bool func_505()//Position - 0x39887
{
	return func_504(&(Global_100114.f_2890));
}

void func_506()//Position - 0x3989A
{
	func_507(&(Global_100114.f_2890));
}

void func_507(var uParam0)//Position - 0x398AD
{
	if (func_417(uParam0))
	{
...
void func_508(bool bParam0)//Position - 0x398CB
{
	if (bParam0)
	{
...
void func_509(bool bParam0)//Position - 0x398F7
{
	func_40(0, bParam0);
...
void func_510()//Position - 0x3995E
{
	int iVar0;
