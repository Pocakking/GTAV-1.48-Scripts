...
void func_22(char* sParam0)//Position - 0x17B1
{
	struct<16> Var0;
...
void func_23(char* sParam0)//Position - 0x17D7
{
	int iVar0;
...
void func_24(char* sParam0)//Position - 0x1815
{
	int iVar0;
...
void func_25(int iParam0, char* sParam1)//Position - 0x1859
{
	switch (iParam0)
	{
		case 0:
...
void func_26(char* sParam0)//Position - 0x1A22
{
	char cVar0[64];
...
void func_27(char* sParam0)//Position - 0x1A56
{
	struct<4> Var0;
...
void func_28(char* sParam0)//Position - 0x1A81
{
...
void func_29()//Position - 0x1AA2
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_30(char* sParam0)//Position - 0x1AB3
{
	int iVar0;
...
bool func_32(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B1F
{
...
int func_33(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B6D
{
	Global_15867 = 0;
...
bool func_40(int iParam0, int iParam1)//Position - 0x20B6
{
	switch (iParam0)
	{
		case 5:
...
void func_41(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x20F1
{
...
void func_42(char[4] cParam0)//Position - 0x2147
{
	int iVar0;
...
void func_43(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2182
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_44(char* sParam0)//Position - 0x221D
{
	int iVar0;
...
void func_45(var uParam0)//Position - 0x2255
{
}

void func_46(var uParam0, int iParam1, float fParam2)//Position - 0x225D
{
}

void func_47()//Position - 0x2265
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_48()//Position - 0x2274
{
	char* sVar0;
	struct<16> Var8;
...
void func_49(var uParam0)//Position - 0x22EA
{
}

void func_50(char* sParam0)//Position - 0x22F2
{
...
void func_51(int iParam0, char* sParam1, char* sParam2)//Position - 0x2305
{
...
bool func_53()//Position - 0x246F
{
	return Global_93734.f_339 > 0;
}

bool func_54()//Position - 0x2480
{
	bool bVar0;
...
void func_58(char* sParam0)//Position - 0x2503
{
	struct<8> Var0;
...
void func_59(char* sParam0)//Position - 0x2543
{
	func_25(iLocal_297, sParam0);
}

void func_60(char* sParam0)//Position - 0x2554
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_106510[iLocal_251] + 1, 16);
}

void func_61(int iParam0, bool bParam1)//Position - 0x2572
{
	int iVar0;
...
void func_62(int iParam0, bool bParam1)//Position - 0x2593
{
	int iVar0;
...
void func_63(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2604
{
	func_64(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_64(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2624
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x2916
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0)//Position - 0x2A5F
{
	if (func_71(iParam0))
	{
...
int func_70(int iParam0)//Position - 0x2A86
{
	int iVar0;
...
int func_71(int iParam0)//Position - 0x2AB9
{
...
int func_72(int iParam0)//Position - 0x2AE3
{
	switch (iParam0)
	{
...
void func_73(int iParam0)//Position - 0x2BA1
{
	if (iLocal_447 == 1)
	{
...
void func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x2BC0
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_75(int iParam0, bool bParam1, int iParam2)//Position - 0x2C13
{
	int iVar0;
...
int func_76(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C65
{
	int iVar0;
...
float func_77(bool bParam0, float fParam1, float fParam2)//Position - 0x2D09
{
	if (bParam0)
	{
		return fParam1;
...
float func_78(int iParam0, int iParam1, bool bParam2)//Position - 0x2D20
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_79(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2D7E
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_80(vector3 vParam0, vector3 vParam3)//Position - 0x2E0F
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_81(vector3 vParam0)//Position - 0x2E30
{
	float fVar0;
	float fVar1;
...
void func_85()//Position - 0x2EC3
{
	Global_14732 = 0;
	func_86();
}

void func_86()//Position - 0x2ED3
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_87()//Position - 0x2EF4
{
	return 0;
}

void func_88()//Position - 0x2EFD
{
}
...
float func_90(int iParam0, int iParam1)//Position - 0x2F0E
{
	return func_78(iParam0, iParam1, 1);
}

void func_91(int iParam0)//Position - 0x2F1F
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x2F50
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0, bool bParam1)//Position - 0x2F81
{
	if (!func_71(iParam0))
	{
		if (!bParam1)
...
void func_94(var uParam0, var uParam1)//Position - 0x3034
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_95(int iParam0, bool bParam1)//Position - 0x3045
{
	if (iParam0 == 1)
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_96(int iParam0)//Position - 0x30B7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_97()//Position - 0x30D8
{
	func_98();
}

void func_98()//Position - 0x30E4
{
}

void func_99()//Position - 0x30EC
{
...
int func_103()//Position - 0x3215
{
	return 1;
}

bool func_104(var uParam0)//Position - 0x321E
{
	return func_105(Global_106565.f_20111, uParam0);
}

bool func_105(var uParam0, var uParam1)//Position - 0x3233
{
	return (uParam0 && uParam1) != 0;
}

int func_106(int iParam0)//Position - 0x3242
{
...
void func_107(int iParam0)//Position - 0x3369
{
	var uVar0;
...
void func_108(int iParam0)//Position - 0x3438
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_109()//Position - 0x3458
{
	struct<6> Var0;
...
void func_110()//Position - 0x347C
{
	func_111();
}

void func_111()//Position - 0x3488
{
}

void func_112()//Position - 0x3490
{
	if (iLocal_245 == -1)
	{
