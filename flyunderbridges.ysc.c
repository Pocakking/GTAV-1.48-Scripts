...
int func_27(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x26D7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_47(int iParam0, int iParam1)//Position - 0x3CB6
{
	int iVar0;
...
int func_49(int iParam0)//Position - 0x3D8B
{
	switch (iParam0)
	{
		case 33:
...
bool func_51(bool bParam0)//Position - 0x3E83
{
...
bool func_52(int iParam0)//Position - 0x3EAE
{
