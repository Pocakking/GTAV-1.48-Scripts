...
void func_1()//Position - 0x37F
{
	...
	else if (func_526(iLocal_408) && func_526(PLAYER::PLAYER_PED_ID()))
	{
...
void func_4(bool bParam0, bool bParam1)//Position - 0x4E7
{
	...
	{
		if (func_526(iLocal_408) && PED::IS_PED_IN_GROUP(iLocal_408))
		{
		...
		else if (func_526(iLocal_408) && ENTITY::IS_ENTITY_AT_COORD(iLocal_408, vLocal_390, 50f, 50f, 50f, false, true, 0))
		{
			func_11(iLocal_408);
		}
		else
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_416))
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_416))
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_416);
				BRAIN::TASK_WANDER_STANDARD(iLocal_416, 1193033728, 0);
			}
		}
		if (bParam0)
		{
...
void func_35()//Position - 0x1A5B
{
	...
	if (func_526(PLAYER::PLAYER_PED_ID()) && func_526(iLocal_408))
	{
		...
		switch (iLocal_405)
		{
			case 0:
				...
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_408, 0);
					BRAIN::OPEN_SEQUENCE_TASK(&iVar2);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2f, 20000, 1048576000, 0, 1193033728);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_294, 1f, 20000, 1048576000, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar2);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_408, iVar2);
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_408, 0) && func_8(iVar0))
				{
					if (!func_51(iLocal_408, -828834893))
					{
						if (VEHICLE::IS_VEHICLE_STOPPED(iVar0))
						{
							...
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_408, iVar3);
...
void func_40(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x1F61
{
	if (bParam0)
	{
...
bool func_41()//Position - 0x209A
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_42(int iParam0, int iParam1)//Position - 0x20B7
{
	bool bVar0;
...
int func_43(int iParam0, bool bParam1)//Position - 0x2102
{
	int iVar0;
	int iVar1;
...
int func_44()//Position - 0x2143
{
	return Global_1312745;
}

int func_45(int iParam0)//Position - 0x214F
{
...
bool func_46()//Position - 0x2191
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_47(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x21A2
{
	int iVar0;
...
void func_49(int iParam0)//Position - 0x21FC
{
	if (iParam0 == 1)
	{
...
bool func_50(int iParam0, vector3 vParam1, float fParam4)//Position - 0x221F
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_51(int iParam0, int iParam1)//Position - 0x2254
{
	if (func_526(iParam0))
	{
...
int func_52(int iParam0, int iParam1)//Position - 0x2287
{
	if (*iParam0 < 0)
	{
...
bool func_53(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x22B2
{
...
int func_54(char* sParam0, int iParam1, bool bParam2)//Position - 0x2300
{
	Global_15867 = 0;
...
bool func_60(int iParam0, int iParam1)//Position - 0x2826
{
	switch (iParam0)
	{
		case 5:
...
void func_62(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28B8
{
...
void func_63(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x290E
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_64(int iParam0)//Position - 0x29A9
{
	switch (iParam0)
	{
		case joaat("police"):
...
int func_65(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2A02
{
...
void func_66(int iParam0)//Position - 0x2B91
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_67(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2BBD
{
	int iVar0;
...
void func_68(int iParam0, bool bParam1)//Position - 0x2D7B
{
...
Vector3 func_69(int iParam0)//Position - 0x2DB7
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2DCA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_71(int iParam0, int iParam1, int iParam2)//Position - 0x35E0
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x366C
{
	switch (iParam0)
	{
...
void func_73(int iParam0, int iParam1, int iParam2)//Position - 0x36A7
{
	int iVar0;
	int iVar1;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x3731
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_75(int iParam0, int iParam1, int iParam2)//Position - 0x380F
{
	Global_71402[1 /*14*/] = { func_120(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_76(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x383A
{
	var uVar0;
	int iVar10;
...
int func_77(int iParam0, int iParam1, int iParam2)//Position - 0x3E3E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3ED7
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2)//Position - 0x3F6D
{
	int iVar0;
	int iVar1;
...
int func_80(int iParam0)//Position - 0x400F
{
	switch (iParam0)
	{
		case 0:
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x40BF
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x43C6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4F79
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x525D
{
	int iVar0;
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5524
{
	int iVar0;
	int iVar1;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x555B
{
	int iVar0;
...
int func_87(int iParam0, int iParam1, int iParam2)//Position - 0x5584
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x584E
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2)//Position - 0x5AD8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C2F
{
	int iVar0;
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5CC7
{
	switch (iParam0)
	{
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5D95
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_93(int iParam0, int iParam1)//Position - 0x5EF1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_94(int iParam0)//Position - 0x6298
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x62F9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_96(int iParam0, int iParam1)//Position - 0x63F5
{
	int iVar0;
...
int func_97(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6533
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_98(int iParam0)//Position - 0x6613
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_99(int iParam0, int iParam1)//Position - 0x6699
{
	int iVar0;
	struct<10> Var1;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6FC8
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x70F2
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_102(int iParam0, int iParam1)//Position - 0x713A
{
	int iVar0;
	struct<17> Var1;
...
void func_103(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8F83
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_104(int iParam0)//Position - 0x916D
{
	switch (iParam0)
	{
		case 0:
...
void func_105(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x921D
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x928E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x950B
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9930
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_109(int iParam0, int iParam1)//Position - 0x9C23
{
	int iVar0;
	int iVar1;
...
int func_110(int iParam0, int iParam1)//Position - 0x9C69
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9CC9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_112(int iParam0)//Position - 0x9D4D
{
...
void func_113(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x9E05
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_114(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x9E4F
{
	int iVar0;
...
int func_115(var uParam0)//Position - 0x9E7F
{
	int iVar0;
	int iVar1;
...
int func_116(int iParam0, int iParam1, int iParam2)//Position - 0x9EB3
{
	int iVar0;
	var uVar1;
...
bool func_117(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x9EE5
{
	int iVar0;
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBCB6
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_119(int iParam0)//Position - 0xCBD4
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCC25
{
	func_183();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_121(int iParam0, int iParam1)//Position - 0xCC77
{
	switch (iParam0)
	{
		case 0:
...
void func_122(int iParam0)//Position - 0xCD67
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xDFDE
{
	int iVar0;
	int iVar1;
...
bool func_124(int iParam0, int iParam1, var uParam2)//Position - 0xE36F
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_125(int iParam0, int iParam1)//Position - 0xE774
{
	switch (iParam1)
	{
		case 0:
...
int func_126(int iParam0, int iParam1)//Position - 0xEB6F
{
	switch (iParam1)
	{
		case 0:
...
int func_127(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xEF6A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_128(int iParam0)//Position - 0xEFAC
{
	switch (iParam0)
	{
		case -1:
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF080
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_123(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_123(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_80(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_130(int iParam0)//Position - 0xF359
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0xF4B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0xF9BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0xFA33
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0xFAA7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0xFB8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0xFEF1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x10104
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x10334
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x10444
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x10DE3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x11956
{
	if (iParam0 < 136)
	{
		func_143(iParam0);
...
void func_142(int iParam0)//Position - 0x1198B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x1258F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1349D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x135CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0, int iParam1)//Position - 0x136C8
{
	switch (iParam0)
	{
		case 0:
...
void func_147(int iParam0)//Position - 0x137B8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x14CAC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x14DFD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x15308
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x15976
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x159EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x15ABA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x15FEA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x16181
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1697F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x16A8F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x179BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1867A
{
	if (iParam0 < 107)
	{
		func_162(iParam0);
...
void func_160(int iParam0)//Position - 0x186C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x19165
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x19F54
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1AB9D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1AE16
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0, int iParam1)//Position - 0x1AF5C
{
	switch (iParam0)
	{
		case 0:
...
void func_166(int iParam0)//Position - 0x1B04C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1BDD6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1BF50
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1C54F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1CA79
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1CAED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1CBBD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1D095
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1D2FE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1D5D4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1D79D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1E2F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x1EF3B
{
	if (iParam0 < 60)
	{
		func_180(iParam0);
...
void func_179(int iParam0)//Position - 0x1EF70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x1FD10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x2039D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x20484
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183()//Position - 0x20582
{
...
int func_184(int iParam0, int iParam1, int iParam2)//Position - 0x205FB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_185(bool bParam0)//Position - 0x20856
{
	int iVar0;
...
void func_186()//Position - 0x20894
{
	Global_14732 = 0;
	func_187();
}

void func_187()//Position - 0x208A4
{
...
void func_188()//Position - 0x208DB
{
	Global_14732 = 0;
	func_189();
}

void func_189()//Position - 0x208EB
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_190()//Position - 0x2090F
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		switch (iLocal_405)
		{
			case 0:
				...
				else
				{
					...
					BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_408);
					func_192(iLocal_408, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) + Vector(0f, 2f, 2f));
					ENTITY::SET_ENTITY_HEADING(iLocal_408, -155.84f);
					ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), -43.04f);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_408, 0);
					BRAIN::OPEN_SEQUENCE_TASK(&iVar3);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_291, 1f, 20000, 1048576000, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar3);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_408, iVar3);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar3);
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_408, 0) && func_8(iVar0))
				{
					if (!func_51(iLocal_408, 242628503))
					{
						if (VEHICLE::IS_VEHICLE_STOPPED(iVar0))
						{
							...
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_408, iVar4);
...
Vector3 func_192(int iParam0, vector3 vParam1)//Position - 0x20DF2
{
	var uVar0;
...
bool func_193(int iParam0)//Position - 0x20E38
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_194(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x20E56
{
	func_195(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_195(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x20E80
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_196(vector3 vParam0)//Position - 0x21274
{
...
int func_197(int iParam0, int iParam1, bool bParam2)//Position - 0x2129E
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_198(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2130F
{
...
int func_199(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x213E8
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_200(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x216DE
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_201(vector3 vParam0)//Position - 0x21792
{
	float fVar0;
	float fVar1;
...
void func_202(int iParam0)//Position - 0x217D1
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
Vector3 func_203()//Position - 0x21836
{
	return 2.55f, 5.665f, 2.55f;
}

void func_204()//Position - 0x2184D
{
	func_226();
	...
	switch (iLocal_405)
	{
		case 0:
			...
			if (func_526(iLocal_408))
			{
				if (PED::IS_PED_GROUP_MEMBER(iLocal_408, func_220()))
				{
		...
		case 1:
			if (func_526(PLAYER::PLAYER_PED_ID()) && func_526(iLocal_408))
			{
				...
				if (PED::IS_PED_GROUP_MEMBER(iLocal_408, func_220()))
				{
					if (func_212(PLAYER::PLAYER_PED_ID(), iLocal_408) < 5f)
					{
						func_211();
					}
				}
				...
				func_209();
				if (func_212(PLAYER::PLAYER_PED_ID(), iLocal_408) > 200f)
				{
					func_2(4);
				}
			}
...
void func_205()//Position - 0x219BD
{
	int iVar0;
	
	if (MISC::GET_GAME_TIMER() > iLocal_370)
	{
		if ((((func_526(PLAYER::PLAYER_PED_ID()) && func_526(iLocal_408)) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_408, 0)) && !func_208()) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_408) < 10f)
		{
...
void func_206(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x21A9B
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_207(iParam3), 0);
}

int func_207(int iParam0)//Position - 0x21AB4
{
	int iVar0;
...
void func_209()//Position - 0x21CCB
{
	if (((func_9(iLocal_410) && func_526(iLocal_408)) && PED::IS_PED_IN_VEHICLE(iLocal_408, iLocal_410, 0)) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_408) < 10f)
	{
...
bool func_210(char* sParam0, int iParam1, int iParam2)//Position - 0x21D9F
{
...
void func_211()//Position - 0x21DBD
{
...
float func_212(int iParam0, int iParam1)//Position - 0x21DF0
{
	return func_213(iParam0, iParam1, 1);
}

float func_213(int iParam0, int iParam1, bool bParam2)//Position - 0x21E01
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_214()//Position - 0x21E5F
{
	if (iLocal_443)
	{
		if (PED::IS_PED_GROUP_MEMBER(iLocal_408, func_220()))
...
void func_215()//Position - 0x21E86
{
	PED::SET_PED_AS_GROUP_MEMBER(iLocal_408, func_220());
...
int func_216(int iParam0, bool bParam1, int iParam2)//Position - 0x21EC6
{
	int iVar0;
...
void func_217(var uParam0)//Position - 0x21EFB
{
...
void func_218(char* sParam0, int iParam1, int iParam2)//Position - 0x21F25
{
	iParam2 = iParam2;
...
int func_219(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x21F3E
{
	int iVar0;
	bool bVar1;
...
int func_220()//Position - 0x21F90
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_221(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x21FA0
{
	switch (*uParam0)
	{
		case 0:
...
bool func_222(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x220B3
{
...
void func_223()//Position - 0x22107
{
	Global_14732 = 0;
	func_61();
}

struct<6> func_224()//Position - 0x22117
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
struct<6> func_225()//Position - 0x221C3
{
	struct<6> Var0;
...
void func_226()//Position - 0x221E7
{
	int iVar0;
	int iVar1;
...
void func_227()//Position - 0x22254
{
	func_226();
	func_221(&uLocal_474, &uLocal_95, "MEA1AUD", &sLocal_475, &cLocal_481);
	if (func_526(iLocal_408))
	...
	switch (iLocal_405)
	{
		case 0:
			...
			if (func_251())
			{
				...
				if (func_248() == 1)
				{
					iLocal_407 = func_247(vLocal_393, 5, 1);
				}
				else
				{
					iLocal_407 = func_247(vLocal_390, 5, 1);
				}
				iLocal_405 = 1;
			}
			break;
		...
		case 2:
			if (func_526(PLAYER::PLAYER_PED_ID()) && func_526(iLocal_408))
			{
				...
				if (func_212(PLAYER::PLAYER_PED_ID(), iLocal_408) > 15f)
				{
					func_231();
					iLocal_405 = 0;
					iLocal_404 = 5;
...
void func_228()//Position - 0x22493
{
	if (func_526(iLocal_422) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_422) > 100f)
	{
		func_16(&iLocal_422, 0, 0, 1);
	}
	if (func_526(iLocal_416) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_416) > 100f)
	{
		func_16(&iLocal_416, 1, 0, 1);
	}
}

void func_229()//Position - 0x224EF
{
	int iVar0;
	
	if (((iLocal_462 && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && func_526(PLAYER::PLAYER_PED_ID())) && func_526(iLocal_408))
	{
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			if ((func_8(iVar0) && !PED::IS_PED_IN_VEHICLE(iLocal_408, iVar0, 1)) && !func_230(iVar0))
			{
...
int func_230(int iParam0)//Position - 0x22572
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_231()//Position - 0x225C2
{
	Global_14732 = 0;
	func_232();
}

void func_232()//Position - 0x225D2
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_233()//Position - 0x225F3
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
void func_234()//Position - 0x226A8
{
	if ((iLocal_430 < 3 && func_8(iLocal_428)) && func_236())
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_428, 0) && PED::IS_PED_IN_VEHICLE(iLocal_408, iLocal_428, 0))
		{
			if (((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_428, 2, 5000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_428, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_428, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_428, 1, 5000))
			{
				...
				else if (MISC::GET_GAME_TIMER() > iLocal_436 && !func_208())
				{
					func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
...
bool func_235(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x22792
{
	func_62(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_237()//Position - 0x22809
{
	int iVar0;
	
	if (func_526(PLAYER::PLAYER_PED_ID()) && MISC::GET_GAME_TIMER() > iLocal_429)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
void func_238()//Position - 0x22878
{
	if ((((iLocal_369 < 3 && !func_208()) && func_236()) && func_239()) && PED::IS_PED_GROUP_MEMBER(iLocal_408, func_220()))
	{
...
void func_240()//Position - 0x22938
{
	int iVar0;
	int iVar1;
	
	if ((((iLocal_337 < 3 && MISC::GET_GAME_TIMER() > iLocal_332) && func_236()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_239())
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
void func_241()//Position - 0x22A49
{
	if (((iLocal_330 < 3 && MISC::GET_GAME_TIMER() > iLocal_324) && func_236()) && func_239())
	{
...
void func_242()//Position - 0x22B11
{
	int iVar0;
	
	if (((iLocal_323 < 4 && MISC::GET_GAME_TIMER() > iLocal_317) && func_236()) && func_239())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_8(iVar0))
			{
				if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
				{
					if (!func_208())
					{
						if (((((iLocal_323 == 0 && func_8(iLocal_410)) && PED::IS_PED_IN_VEHICLE(iLocal_408, iLocal_410, 0)) && func_243(iLocal_408, 0) == 2) || (((iLocal_323 == 1 || iLocal_323 == 2) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_408, 0)) && (func_243(iLocal_408, 0) == 2 || func_243(iLocal_408, 0) == 1))) || (iLocal_323 == 3 && PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID())))
						{
							func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
...
int func_243(int iParam0, int iParam1)//Position - 0x22C55
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_244()//Position - 0x22CDA
{
	if ((((iLocal_302 < 4 && !func_208()) && func_236()) && (func_239() || func_245())) && PED::IS_PED_GROUP_MEMBER(iLocal_408, func_220()))
	{
...
void func_246()//Position - 0x22D9E
{
	if (iLocal_445)
	{
		if (func_208())
...
int func_247(vector3 vParam0, int iParam3, bool bParam4)//Position - 0x22DD2
{
	int iVar0;
...
int func_249(int iParam0)//Position - 0x22E7E
{
...
int func_250(int iParam0)//Position - 0x22EAB
{
		...
		else if (!func_208())
		{
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_410, 0) && PED::IS_PED_IN_VEHICLE(iLocal_408, iLocal_410, 0))
			{
				if (func_252(&uLocal_95, "MEA1AUD", "MEA1_LOSTCOP", "MEA1_LOSTCOP_1", "MEA1_LOSTCOP", "MEA1_LOSTCOP_2", "MEA1_LOSTCOP", "MEA1_LOSTCOP_3", "MEA1_LOSTCOP", "MEA1_LOSTCOP_4", 7, 1, 0) || func_52(&iLocal_457, 5000))
				{
					...
					BRAIN::TASK_LOOK_AT_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_410, 2f, 2f, 0f), 2000, 2050, 4);
					...
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_408, iVar0);
...
int func_252(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x23049
{
	var uVar0;
	var uVar11;
...
int func_253(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x230A6
{
	int iVar0;
...
void func_254(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)//Position - 0x23410
{
...
int func_255(int iParam0)//Position - 0x23498
{
	int iVar0;
	int iVar1;
...
void func_256()//Position - 0x23504
{
	func_226();
	func_221(&uLocal_474, &uLocal_95, "MEA1AUD", &sLocal_475, &cLocal_481);
	if (func_526(iLocal_408))
	...
	switch (iLocal_405)
	{
		...
		case 1:
			...
			if (func_526(PLAYER::PLAYER_PED_ID()) && func_526(iLocal_408))
			{
				...
				if (PED::IS_PED_GROUP_MEMBER(iLocal_408, func_220()))
				{
					if (func_212(PLAYER::PLAYER_PED_ID(), iLocal_408) > (15f * 2f))
					{
						func_231();
						iLocal_405 = 0;
						iLocal_404 = 5;
				...
				else if (((func_8(iLocal_410) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_408, iLocal_410)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_410, 0)) && !func_255(iLocal_410))
				{
					func_231();
					iLocal_405 = 0;
					iLocal_404 = 5;
...
void func_257()//Position - 0x236C8
{
	if (func_526(iLocal_408) && !PED::IS_PED_GROUP_MEMBER(iLocal_408, func_220()))
	{
		if (func_8(iLocal_410))
		{
...
void func_258()//Position - 0x2374B
{
	if (((((func_526(PLAYER::PLAYER_PED_ID()) && func_526(iLocal_416)) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_416)) && !BRAIN::IS_PED_GETTING_UP(iLocal_416)) && !PED::IS_PED_PRONE(iLocal_416)) && !PED::IS_PED_RAGDOLL(iLocal_416))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_403)
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_416);
				BRAIN::TASK_ARREST_PED(iLocal_416, PLAYER::PLAYER_PED_ID());
...
void func_259()//Position - 0x23816
{
	if (((((iLocal_351 < 9 && !func_208()) && func_236()) && func_239()) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) && !func_261(PLAYER::PLAYER_PED_ID()))
	{
...
bool func_260(var uParam0, char* sParam1, char* sParam2, var uParam3, char* sParam4, var uParam5, int iParam6, int iParam7, int iParam8)//Position - 0x238DF
{
	var uVar0;
	var uVar11;
...
int func_261(int iParam0)//Position - 0x23938
{
	float fVar0;
...
void func_262()//Position - 0x2396F
{
	if (func_526(iLocal_422) && !func_51(iLocal_422, 1805844857))
	{
		if ((func_264(iLocal_422, 1090519040, 1097859072) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) || (func_526(iLocal_416) && PED::IS_PED_SHOOTING(iLocal_416)))
		{
...
void func_263(bool bParam0)//Position - 0x23A19
{
	if (((((func_526(iLocal_416) && func_526(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_416)) && !BRAIN::IS_PED_GETTING_UP(iLocal_416)) && !PED::IS_PED_PRONE(iLocal_416)) && !PED::IS_PED_RAGDOLL(iLocal_416))
	{
		if (!func_5(iLocal_416) == joaat("weapon_pistol"))
		{
			PED::SET_PED_CAN_SWITCH_WEAPON(iLocal_416, true);
	...
	if ((func_526(iLocal_422) && !PED::IS_PED_FLEEING(iLocal_422)) && !PED::IS_PED_IN_COMBAT(iLocal_422, 0))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_422, sLocal_379, sLocal_273, 2) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_422, sLocal_379, sLocal_277, 2))
		{
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_422, -8f, 1);
...
int func_264(int iParam0, float fParam1, float fParam2)//Position - 0x23B64
{
	if (func_9(iParam0))
	{
...
int func_265(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x23B9C
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_266(int iParam0, float fParam1)//Position - 0x23CA8
{
	var uVar0;
	vector3 vVar1;
...
int func_267(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x23D3D
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = { func_201(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_268(vector3 vParam0, vector3 vParam3)//Position - 0x23DCB
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

void func_269()//Position - 0x23DEC
{
	if ((iLocal_441 && MISC::GET_GAME_TIMER() > iLocal_437) && func_239())
	{
		func_6(&uLocal_95, 4);
...
void func_270()//Position - 0x23E2B
{
	int iVar0;
	...
	switch (iLocal_405)
	{
		...
		case 1:
			...
			func_296();
			func_292();
			if (((func_526(PLAYER::PLAYER_PED_ID()) && func_8(iLocal_410)) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_410, PLAYER::PLAYER_PED_ID(), 1)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
			{
...
void func_271()//Position - 0x24013
{
	struct<6> Var0;
	char* sVar6;
	
	if (func_274(PLAYER::PLAYER_PED_ID(), vLocal_262, 100f))
	{
		if (iLocal_444)
		{
			func_273(0);
...
var func_272(var uParam0)//Position - 0x24076
{
	return uParam0;
}

void func_273(int iParam0)//Position - 0x24080
{
	Global_16877 = iParam0;
}

bool func_274(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2408D
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_275()//Position - 0x240AA
{
	int iVar0;
	float fVar1;
	
	iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
	if (((((PED::IS_PED_INJURED(iLocal_416) || PED::IS_PED_INJURED(iLocal_422)) || func_277(iLocal_416, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || func_277(iLocal_422, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || ((func_8(iVar0) && func_8(iLocal_410)) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(iVar0, iLocal_410))) || (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_387, true) < 30f))
	{
		if (!PED::IS_PED_IN_VEHICLE(iLocal_408, iLocal_410, 0))
		{
			if (!PED::IS_PED_GROUP_MEMBER(iLocal_408, func_220()))
			{
				...
				if ((func_8(iVar0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, 0)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iVar0, 0, 0))
				{
					...
					{
						BRAIN::TASK_ENTER_VEHICLE(iLocal_408, iVar0, 20000, 0, 3f, 1, 0);
					}
				}
				else if (func_212(iLocal_408, PLAYER::PLAYER_PED_ID()) > 10f)
				{
					if (!func_51(iLocal_408, 1227113341))
					{
						BRAIN::TASK_GO_TO_ENTITY(iLocal_408, PLAYER::PLAYER_PED_ID(), 20000, 7f, 2f, 1073741824, 0);
					}
				}
				else
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_408);
				}
				func_215();
				func_34(&iLocal_407);
				iLocal_443 = 1;
...
void func_276(int iParam0, int iParam1, int iParam2)//Position - 0x242D6
{
	if (func_526(iParam0))
	{
		if (func_9(iParam1))
...
int func_277(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x24318
{
	vector3 vVar0;
...
int func_278(int iParam0, float fParam1)//Position - 0x243D3
{
	float fVar0;
...
bool func_279(int iParam0, float fParam1)//Position - 0x24449
{
	return func_280(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_280(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x24461
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_281(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x24522
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_282(int iParam0, int iParam1)//Position - 0x2464E
{
	int iVar0;
...
int func_284(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2475D
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_285(var uParam0)//Position - 0x247EE
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_286(int iParam0, int iParam1)//Position - 0x24809
{
	int iVar0;
...
int func_287(int iParam0)//Position - 0x24848
{
...
bool func_288(int iParam0, int iParam1, float fParam2)//Position - 0x24870
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_289(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x248B7
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_290(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x249B2
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_291()//Position - 0x249FA
{
	int iVar0;
	...
	if (func_526(PLAYER::PLAYER_PED_ID()))
	{
		...
		else
		{
			...
			if (func_526(iLocal_408))
			{
				BRAIN::TASK_CLEAR_LOOK_AT(iLocal_408);
			}
			PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(vLocal_450, vLocal_453, fLocal_456, 1);
			iLocal_446 = 1;
			iLocal_441 = 1;
			iLocal_457 = -1;
			if ((((func_526(iLocal_416) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_416)) && !BRAIN::IS_PED_GETTING_UP(iLocal_416)) && !PED::IS_PED_PRONE(iLocal_416)) && !PED::IS_PED_RAGDOLL(iLocal_416))
			{
				if (!func_51(iLocal_416, 1392476864))
				{
					...
					BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_416, iVar0);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
				}
			}
			if (func_526(iLocal_422) && !PED::IS_PED_FLEEING(iLocal_422))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_422, sLocal_379, sLocal_273, 2) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_422, sLocal_379, sLocal_277, 2))
				{
					ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_422, -8f, 1);
...
void func_292()//Position - 0x24BF7
{
	struct<6> Var0;
	char* sVar6;
	float fVar7;
	...
	if (((func_8(iLocal_410) && func_526(PLAYER::PLAYER_PED_ID())) && func_526(iLocal_416)) && func_526(iLocal_422))
	{
		switch (iLocal_316)
		{
			case 0:
				if (func_208())
				{
					...
					{
						Local_310 = { func_295() };
						if ((((((((func_294(PLAYER::PLAYER_PED_ID(), iLocal_410, 5f, 1) || func_294(PLAYER::PLAYER_PED_ID(), iLocal_416, 5f, 1)) && !MISC::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_1")) && !MISC::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_2")) && !MISC::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_3")) && !MISC::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_4")) && !MISC::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_5")) && !MISC::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_6")) && func_279(iLocal_416, 1126825984))
						{
			...
			case 1:
				fVar7 = func_213(PLAYER::PLAYER_PED_ID(), iLocal_416, 1);
				fVar8 = func_213(PLAYER::PLAYER_PED_ID(), iLocal_410, 1);
				bVar9 = false;
				func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
				if (fVar7 < fVar8)
				{
				...
				if (bVar9)
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_416, PLAYER::PLAYER_PED_ID(), 2000, 2048, 4);
					iLocal_316 = 2;
				}
				break;
...
void func_296()//Position - 0x24E8A
{
	bool bVar0;
	
	if (func_526(PLAYER::PLAYER_PED_ID()) && iLocal_261 != 5)
	{
		bVar0 = false;
		if ((func_526(iLocal_416) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_416)) || (((func_526(iLocal_422) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_422)) && !((func_277(iLocal_416, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_277(iLocal_422, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0))
		{
		...
		if (((((((((((ENTITY::DOES_ENTITY_EXIST(iLocal_416) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_416, PLAYER::PLAYER_PED_ID(), 1)) || (ENTITY::DOES_ENTITY_EXIST(iLocal_416) && PED::IS_PED_INJURED(iLocal_416))) || func_289(iLocal_416, 1, 0, 0, 0)) || func_278(iLocal_416, 1126825984)) || func_278(iLocal_422, 1126825984)) || (ENTITY::DOES_ENTITY_EXIST(iLocal_422) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), 1))) || (ENTITY::DOES_ENTITY_EXIST(iLocal_422) && PED::IS_PED_INJURED(iLocal_422))) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) || bVar0) || func_264(iLocal_422, 1090519040, 1097859072)) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
		{
			PATHFIND::DISABLE_NAVMESH_IN_AREA(vLocal_381, vLocal_384, 0);
			PATHFIND::SET_PED_PATHS_IN_AREA(vLocal_381, vLocal_384, true, 0);
			if (bVar0)
			...
			if ((((func_526(iLocal_416) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_416)) && !BRAIN::IS_PED_GETTING_UP(iLocal_416)) && !PED::IS_PED_PRONE(iLocal_416)) && !PED::IS_PED_RAGDOLL(iLocal_416))
			{
				...
				if (!PED::IS_PED_IN_COMBAT(iLocal_416, 0) && !func_51(iLocal_416, 1392476864))
				{
					func_231();
					PED::SET_PED_CAN_SWITCH_WEAPON(iLocal_416, true);
					WEAPON::GIVE_WEAPON_TO_PED(iLocal_416, joaat("weapon_pistol"), -1, false, true);
...
void func_297()//Position - 0x2523F
{
	if ((func_526(PLAYER::PLAYER_PED_ID()) && func_8(iLocal_410)) && func_526(iLocal_408))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_410, 0) || func_255(iLocal_410))
		{
			func_231();
			func_34(&iLocal_407);
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_410, false);
		...
		else if (func_294(PLAYER::PLAYER_PED_ID(), iLocal_410, 6.5f, 1))
		{
			if (iLocal_442)
			{
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_410, false);
...
void func_298()//Position - 0x252EB
{
	if ((((func_526(iLocal_416) && func_526(iLocal_422)) && func_526(iLocal_408)) && func_8(iLocal_410)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_379))
	{
		switch (iLocal_261)
		{
			case 0:
				...
				iLocal_449 = 1;
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_416, iLocal_260, sLocal_379, sLocal_268, 1000f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_422, iLocal_260, sLocal_379, sLocal_269, 1000f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_408, iLocal_260, sLocal_379, sLocal_270, 1000f, -4f, 1, 16, 1148846080, 0);
			...
			case 1:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_260, false);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_416, iLocal_260, sLocal_379, sLocal_272, 1000f, -4f, 4, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_422, iLocal_260, sLocal_379, sLocal_273, 1000f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_408, iLocal_260, sLocal_379, sLocal_274, 1000f, -4f, 4, 16, 1148846080, 0);
			...
			case 3:
				...
				if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_260))
				{
					iLocal_260 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_262, vLocal_265, 2);
					PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_260, true);
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_416, iLocal_260, sLocal_379, sLocal_276, 1000f, -4f, 1, 16, 1148846080, 0);
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_422, iLocal_260, sLocal_379, sLocal_277, 1000f, -4f, 1, 16, 1148846080, 0);
					if (VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_410, 2, 0))
					{
						...
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_408, PLAYER::PLAYER_PED_ID(), -1, 2050, 4);
					}
			...
			case 4:
				...
				if (func_526(iLocal_416))
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_416, PLAYER::PLAYER_PED_ID(), -1);
				}
				iLocal_261 = 5;
				break;
			}
...
void func_299()//Position - 0x256E2
{
	switch (iLocal_278)
	{
		case 0:
		...
		case 1:
			if (!func_208())
			{
				...
				{
					if (func_274(PLAYER::PLAYER_PED_ID(), vLocal_262, 90f))
					{
						func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
				...
				else if (func_274(PLAYER::PLAYER_PED_ID(), vLocal_262, (90f * 2f)))
				{
					func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
		...
		case 2:
			if (!func_208())
			{
				if ((func_274(PLAYER::PLAYER_PED_ID(), vLocal_262, 90f) && !func_210("MEA1_02", 0, 0)) && !func_210("MEA1_03", 0, 0))
				{
					func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
		...
		case 4:
			if (func_208())
			{
				if (!func_274(PLAYER::PLAYER_PED_ID(), vLocal_262, 91f))
				{
					Local_279 = { func_224() };
					if (MISC::ARE_STRINGS_EQUAL(&Local_279, "") || MISC::ARE_STRINGS_EQUAL(&Local_279, "NULL"))
					{
...
void func_300()//Position - 0x25941
{
	int iVar0;
...
void func_301(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17)//Position - 0x25A87
{
	int iVar0;
	int iVar1;
...
void func_302(int iParam0, int iParam1)//Position - 0x25BE4
{
	MISC::SET_BIT(&(Global_1373453.f_6184[iParam0]), iParam1);
}

bool func_303(int iParam0, int iParam1)//Position - 0x25BFD
{
	return MISC::IS_BIT_SET(Global_1373453.f_6184[iParam0], iParam1);
}

void func_304()//Position - 0x25C16
{
	if (func_526(iLocal_416) && func_8(iLocal_410))
	{
		if (PED::IS_PED_IN_VEHICLE(iLocal_416, iLocal_410, 0))
		{
			...
			{
				BRAIN::TASK_VEHICLE_DRIVE_WANDER(iLocal_416, iLocal_410, 30f, 786469);
...
void func_305()//Position - 0x25C88
{
	int iVar0;
	...
	if (iLocal_440)
	{
		PATHFIND::DISABLE_NAVMESH_IN_AREA(vLocal_381, vLocal_384, 0);
		PATHFIND::SET_PED_PATHS_IN_AREA(vLocal_381, vLocal_384, true, 0);
		if ((func_526(iLocal_416) && func_8(iLocal_410)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_410, -1, 0))
		{
			func_231();
			func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
			...
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
				BRAIN::TASK_ENTER_VEHICLE(0, iLocal_410, 20000, -1, 1f, 1, 0);
				BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_410, 50f, 786597);
				BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_416, iVar0);
				BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_410, false);
...
int func_306()//Position - 0x25D54
{
	return MISC::GET_GAME_TIMER();
}

void func_307(int iParam0, bool bParam1, bool bParam2)//Position - 0x25D60
{
	int iVar0;
	bool bVar1;
...
void func_308(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x25E69
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
		{
			if (func_358(24) != PLAYER::GET_PLAYERS_LAST_VEHICLE())
			{
				if (iParam4 == 1)
				{
					if (func_355(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_309(PLAYER::GET_PLAYERS_LAST_VEHICLE(), vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_309(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x25EDA
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_341(iParam5, &Var0, vParam1, fParam4, func_347(iParam0));
		func_310(iParam5, iParam0, 0);
	}
}

void func_310(int iParam0, int iParam1, int iParam2)//Position - 0x26003
{
	int iVar0;
...
void func_311(int iParam0, int iParam1)//Position - 0x26120
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_312(int iParam0)//Position - 0x26322
{
...
int func_313(int iParam0)//Position - 0x263FF
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_314(int iParam0, bool bParam1)//Position - 0x265B0
{
	int iVar0;
	struct<2> Var1;
...
int func_315(int iParam0)//Position - 0x26730
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_317(int iParam0)//Position - 0x26813
{
	int iVar0;
	int iVar1;
...
int func_318()//Position - 0x28881
{
	return 0;
}

int func_319()//Position - 0x2888A
{
	return 1;
}

int func_320()//Position - 0x28893
{
	return 1;
}

int func_321()//Position - 0x2889C
{
...
int func_323(int iParam0)//Position - 0x28970
{
	int iVar0;
	char* sVar1;
...
int func_324(int iParam0)//Position - 0x289B6
{
	int iVar0;
...
int func_325(int iParam0)//Position - 0x289F1
{
	int iVar0;
...
int func_326(int iParam0)//Position - 0x28A6D
{
	int iVar0;
...
void func_328(var uParam0, int iParam1)//Position - 0x28B9B
{
	if (iParam1 <= 0)
	{
		return;
...
void func_329(var uParam0, int iParam1)//Position - 0x28C21
{
...
void func_330(var uParam0, int iParam1)//Position - 0x28C54
{
	int iVar0;
	int iVar1;
...
int func_331(int iParam0, int iParam1)//Position - 0x28CA5
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_332(int iParam0)//Position - 0x28D47
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_333(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_333(bool bParam0, int iParam1, int iParam2)//Position - 0x28D6C
{
	if (bParam0)
	{
		return iParam1;
...
int func_334(var uParam0)//Position - 0x28D83
{
	return uParam0 & 15;
}

void func_335(var uParam0, int iParam1)//Position - 0x28D90
{
...
void func_336(var uParam0, int iParam1)//Position - 0x28DCA
{
...
void func_337(var uParam0, int iParam1)//Position - 0x28E05
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_338(var uParam0, int iParam1)//Position - 0x28E41
{
	int iVar0;
	int iVar1;
...
int func_339(int iParam0, int iParam1)//Position - 0x2A539
{
	struct<82> Var0;
...
void func_340(int iParam0, var uParam1, int iParam2)//Position - 0x2A57B
{
	int iVar0;
...
void func_341(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x2A7D7
{
	if (func_338(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_342(int iParam0, bool bParam1)//Position - 0x2A8D6
{
	if (iParam0 == -1)
	{
		return;
...
void func_343(int iParam0, int iParam1, bool bParam2)//Position - 0x2A933
{
	if (iParam0 == -1)
	{
		return;
...
bool func_344(int iParam0, int iParam1)//Position - 0x2A96E
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_345(var uParam0, var uParam1)//Position - 0x2A991
{
...
void func_346(int iParam0)//Position - 0x2AA5D
{
	if (iParam0 == -1)
	{
		return;
...
int func_347(int iParam0)//Position - 0x2AAD7
{
	int iVar0;
...
bool func_348(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2AB3A
{
	if (bParam6)
	{
...
void func_349(int iParam0, var uParam1)//Position - 0x2AB81
{
	int iVar0;
...
int func_350(int iParam0)//Position - 0x2AE2C
{
	switch (iParam0)
	{
		case 1:
...
int func_351(int iParam0, var uParam1, var uParam2)//Position - 0x2AEDC
{
	int iVar0;
	int iVar1;
...
int func_352(int iParam0)//Position - 0x2B0CF
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_353(var uParam0)//Position - 0x2B0EF
{
	int iVar0;
...
void func_354(int iParam0)//Position - 0x2B1A0
{
...
int func_355(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x2B1C7
{
	int iVar0;
...
int func_356(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2B2DD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_357(int iParam0)//Position - 0x2B36C
{
	return MISC::IS_BIT_SET(Global_106565.f_7223[iParam0], 0);
}

int func_358(int iParam0)//Position - 0x2B384
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_359()//Position - 0x2B3A0
{
	float fVar0;
	float fVar1;
	
	fVar0 = (SYSTEM::TO_FLOAT(iLocal_397) - SYSTEM::TO_FLOAT(func_306()));
...
void func_360(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2B3E6
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_413(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
...
void func_361(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2B55C
{
	func_362(&Global_100114, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_362(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2B578
{
	int iVar0;
	int iVar1;
...
int func_363(var uParam0)//Position - 0x2C402
{
...
void func_364(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2C424
{
	int iVar0;
...
int func_365(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2C4AC
{
...
int func_366(int iParam0)//Position - 0x2C4EC
{
	int iVar0;
...
void func_367(var uParam0, int iParam1, int iParam2)//Position - 0x2C51A
{
...
int func_368(int iParam0)//Position - 0x2C5F6
{
	int iVar0;
...
int func_369(int iParam0, int iParam1, int iParam2)//Position - 0x2C638
{
	int iVar0;
...
int func_370(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2C6C6
{
	char* sVar0;
...
void func_371(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2C7F5
{
	int iVar0;
	int iVar1;
...
int func_372(int iParam0, int iParam1)//Position - 0x2C995
{
	var uVar0;
	var uVar1;
...
void func_373(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2C9C1
{
	int iVar0;
...
void func_374(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2CF09
{
	int iVar0;
...
int func_375()//Position - 0x2D14A
{
	func_29();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_376(int iParam0, bool bParam1)//Position - 0x2D163
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_377(int iParam0, var uParam1)//Position - 0x2D256
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_379(Var11.f_1)) && iVar72 < 51)
			{
...
int func_378(int iParam0)//Position - 0x2D4DE
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_379(int iParam0)//Position - 0x2D579
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_380(int iParam0, int iParam1)//Position - 0x2D6FF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_381(int iParam0, var uParam1)//Position - 0x2E270
{
	int iVar0;
	int iVar1;
...
int func_382(int iParam0)//Position - 0x2E2AB
{
	int iVar0;
...
void func_383(int iParam0)//Position - 0x2E51F
{
	int iVar0;
...
void func_384(var uParam0, int iParam1)//Position - 0x2E55B
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_385(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x2EAB6
{
	int iVar0;
	int iVar1;
...
bool func_386(int iParam0, var uParam1, var uParam2)//Position - 0x2EAFA
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_387(var uParam0)//Position - 0x2F201
{
...
bool func_388(int iParam0)//Position - 0x2F25C
{
	return func_389(iParam0, 0, 1);
}

int func_389(int iParam0, int iParam1, bool bParam2)//Position - 0x2F26C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_390(int iParam0)//Position - 0x2F2D6
{
	switch (iParam0)
	{
		case 0:
...
int func_391()//Position - 0x2F5F7
{
	return Global_25765;
}

int func_392(int iParam0)//Position - 0x2F602
{
	return func_389(iParam0, 5, 1);
}

int func_393(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2F612
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_394(int iParam0, bool bParam1)//Position - 0x2F6B4
{
	switch (iParam0)
	{
		case -1:
...
int func_395(int iParam0)//Position - 0x2FCB6
{
	if (iParam0 != func_404())
	{
...
Vector3 func_396(int iParam0, int iParam1)//Position - 0x2FD14
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_397(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2FDC2
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_398(vector3 vParam0, float fParam3)//Position - 0x2FE57
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_399(int iParam0)//Position - 0x2FE9B
{
	struct<6> Var0;
...
struct<6> func_400(int iParam0)//Position - 0x30020
{
	return func_401(iParam0);
}

struct<6> func_401(int iParam0)//Position - 0x3002E
{
	struct<6> Var0;
...
int func_402(int iParam0, var uParam1)//Position - 0x30AF5
{
	switch (iParam0)
	{
		case 0:
...
int func_403(int iParam0)//Position - 0x30B77
{
	if (iParam0 != func_404())
	{
...
int func_404()//Position - 0x30BD5
{
	return -1;
}

Vector3 func_405(int iParam0)//Position - 0x30BDE
{
	switch (iParam0)
	{
		case 1:
...
int func_406()//Position - 0x30DE9
{
	return func_407(PLAYER::PLAYER_ID());
}

int func_407(int iParam0)//Position - 0x30DF9
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_408(int iParam0)//Position - 0x30E16
{
	return func_389(iParam0, 0, 0);
}

int func_409(int iParam0)//Position - 0x30E26
{
	switch (iParam0)
	{
		case -1:
...
bool func_410()//Position - 0x310E7
{
	return Global_93734.f_339 > 0;
}

int func_411(char* sParam0)//Position - 0x310F8
{
...
struct<2> func_412(int iParam0)//Position - 0x3114E
{
	struct<2> Var0;
...
int func_413(char* sParam0, int iParam1)//Position - 0x3159B
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_414(int iParam0, var uParam1)//Position - 0x315E4
{
	switch (iParam0)
	{
		case 0:
...
int func_416(int iParam0)//Position - 0x328BC
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_417(int iParam0)//Position - 0x32C02
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_418(int iParam0)//Position - 0x32C3A
{
	switch (iParam0)
	{
		case 69:
...
int func_419(int iParam0)//Position - 0x32CF6
{
	switch (iParam0)
	{
		case 1:
...
int func_420(char* sParam0, bool bParam1)//Position - 0x32D4A
{
	int iVar0;
	int iVar1;
...
int func_421(int iParam0, bool bParam1)//Position - 0x32D74
{
	int iVar0;
...
void func_422(bool bParam0)//Position - 0x32DAA
{
	int iVar0;
	int iVar1;
...
void func_423()//Position - 0x3302C
{
	func_221(&uLocal_474, &uLocal_95, "MEA1AUD", &sLocal_475, &cLocal_481);
	switch (iLocal_405)
	{
		case 0:
			func_34(&iLocal_407);
			iLocal_407 = func_247(vLocal_412, 7, 0);
		...
		case 2:
			func_425();
			if ((((func_526(PLAYER::PLAYER_PED_ID()) && func_526(iLocal_408)) && ENTITY::DOES_ENTITY_EXIST(iLocal_422)) && ENTITY::DOES_ENTITY_EXIST(iLocal_416)) && func_8(iLocal_410))
			{
...
void func_424()//Position - 0x331B6
{
	if ((((iLocal_305 < 1 && func_526(PLAYER::PLAYER_PED_ID())) && !func_208()) && !func_210("MEA1_01", 0, 0)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_387, true) > (30f * 3f))
	{
...
void func_425()//Position - 0x33252
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_408))
	{
		if (func_8(iLocal_410) && STREAMING::HAS_MODEL_LOADED(func_15(17)))
		{
...
int func_426(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x33510
{
	int iVar0;
...
int func_427(var uParam0, int iParam1)//Position - 0x33590
{
	int iVar0;
...
void func_428()//Position - 0x335D6
{
...
bool func_429(int iParam0)//Position - 0x3360C
{
	if (iParam0 == 0)
	{
		return 1;
...
void func_430(int iParam0, vector3 vParam1, float fParam4)//Position - 0x3362A
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_431()//Position - 0x33653
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		if (func_526(PLAYER::PLAYER_PED_ID()))
		{
			func_63(&uLocal_95, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
		...
		if (func_33(0) && func_526(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_456(&iVar0, vVar1, fVar4, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
...
void func_432(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x339DD
{
	int iVar0;
	int iVar1;
...
void func_433()//Position - 0x33A4D
{
	Global_17272.f_6 = 1;
}

void func_434(int iParam0)//Position - 0x33A5B
{
	if (func_438())
	{
		return;
...
void func_435(int iParam0)//Position - 0x33A8E
{
	if (func_438())
	{
		return;
...
void func_436(bool bParam0, bool bParam1)//Position - 0x33B08
{
	if (bParam0)
	{
		if (func_437(0))
...
int func_437(int iParam0)//Position - 0x33B7C
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_438()//Position - 0x33BD6
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

void func_439(int iParam0, int iParam1, int iParam2)//Position - 0x33BE8
{
...
void func_440()//Position - 0x33C1C
{
	int iVar0;
	int iVar1;
...
void func_441()//Position - 0x33D1D
{
	int iVar0;
...
int func_442(int iParam0)//Position - 0x33D5B
{
	if (*iParam0 < 0)
	{
...
int func_443(int iParam0)//Position - 0x33DC2
{
	if (*iParam0 < 0)
	{
		*iParam0 = MISC::GET_GAME_TIMER() + 2000;
...
void func_444(bool bParam0, bool bParam1)//Position - 0x33E2C
{
	if (bParam0)
	{
		func_445(0, 1, 1);
...
void func_445(bool bParam0, int iParam1, int iParam2)//Position - 0x33E5F
{
	bool bVar0;
...
void func_446()//Position - 0x33EBE
{
	int iVar0;
	int iVar1;
...
void func_447(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x33EF5
{
	vector3 vVar0;
	float fVar3;
	...
	if (func_453() && func_448(iParam1, iParam2, iParam3, 1))
	{
		vVar0 = { 0f, 0f, 0f };
		fVar3 = 0f;
		func_456(iParam0, vVar0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
int func_448(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x33F86
{
...
bool func_450()//Position - 0x3408B
{
	return func_451(&(Global_100114.f_2890));
}

int func_451(var uParam0)//Position - 0x3409E
{
...
int func_452(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x340FD
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
var func_453()//Position - 0x34178
{
	return Global_97130.f_2890.f_8;
}

int func_454()//Position - 0x34189
{
...
void func_456(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x341D7
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_503(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_348(vParam1, 0f, 0f, 0f, 0))
		...
		{
			func_498(iParam12, 0);
			while (!func_457(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_457(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x3436B
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_458(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x351AF
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_459(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x35DC3
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_460(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x35E36
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_461(int iParam0)//Position - 0x37328
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_462(int iParam0, bool bParam1, var uParam2)//Position - 0x373D8
{
	int iVar0;
	bool bVar1;
...
int func_463(int iParam0)//Position - 0x37546
{
	if (iParam0 != func_404())
	{
...
int func_464(int iParam0)//Position - 0x3758D
{
	switch (iParam0)
	{
		case 0:
...
int func_465(int iParam0, bool bParam1, bool bParam2)//Position - 0x3791D
{
	int iVar0;
...
int func_466(int iParam0)//Position - 0x37967
{
...
int func_467(int iParam0)//Position - 0x379A9
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_468(int iParam0)//Position - 0x37A3C
{
	if (iParam0 != func_404())
	{
		if (func_465(iParam0, 1, 1))
...
int func_469(int iParam0)//Position - 0x37A83
{
	if (iParam0 != func_404())
	{
		if (func_465(iParam0, 1, 1))
...
int func_470(int iParam0)//Position - 0x37AC9
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_471(int iParam0)//Position - 0x37AFE
{
...
int func_472(int iParam0)//Position - 0x37B2D
{
...
int func_473(int iParam0)//Position - 0x37BEA
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_474(int iParam0)//Position - 0x37C20
{
	switch (iParam0)
	{
		case 562680400:
...
int func_475(int iParam0, bool bParam1)//Position - 0x37C79
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_476(int iParam0)//Position - 0x37CD4
{
	int iVar0;
...
int func_477(int iParam0, int iParam1)//Position - 0x37D0E
{
	if (iParam1 == 0)
	{
...
bool func_478()//Position - 0x38082
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_479()//Position - 0x38093
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_480()//Position - 0x380A4
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_481()//Position - 0x380B5
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_482()//Position - 0x380C6
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_483()//Position - 0x380D7
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_484(int iParam0, int iParam1)//Position - 0x380E8
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_485(int iParam0)//Position - 0x3845E
{
	if (iParam0 != func_404())
	{
		if (func_465(iParam0, 1, 1))
...
int func_486(int iParam0)//Position - 0x384BD
{
	if (iParam0 != func_404())
	{
		if (func_465(iParam0, 1, 1))
...
int func_487(int iParam0)//Position - 0x3851D
{
	if (iParam0 != func_404())
	{
		if (func_465(iParam0, 1, 1))
...
int func_488(int iParam0, bool bParam1, var uParam2)//Position - 0x38564
{
	bool bVar0;
...
int func_489(int iParam0)//Position - 0x38989
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_490(int iParam0, int iParam1)//Position - 0x389B2
{
	int iVar0;
...
void func_491(int iParam0)//Position - 0x38A34
{
	if (!func_492(*iParam0))
	{
...
bool func_492(int iParam0)//Position - 0x38A5F
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_493(int iParam0, var uParam1, var uParam2)//Position - 0x38A6E
{
	int iVar0;
	int iVar1;
...
int func_494(int iParam0)//Position - 0x38C31
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_495(var uParam0)//Position - 0x38D0D
{
...
int func_496(int iParam0, int iParam1)//Position - 0x38D4D
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_497(var uParam0, int iParam1)//Position - 0x38E32
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_498(int iParam0, int iParam1)//Position - 0x38E73
{
	int iVar0;
...
void func_499(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x38F11
{
	int iVar0;
...
void func_500(int iParam0)//Position - 0x38F61
{
	bool bVar0;
...
int func_501(int iParam0, int iParam1)//Position - 0x390D3
{
	int iVar0;
...
int func_502(var uParam0)//Position - 0x39145
{
	return *uParam0;
}

int func_503(vector3 vParam0, float fParam3)//Position - 0x39150
{
	return func_504(&(Global_100114.f_2890), vParam0, fParam3, 0);
}

int func_504(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x3916A
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_505(int iParam0)//Position - 0x3941C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_506(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x394DF
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_507(iParam0, uVar1[iVar6], 1) && func_452(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_348(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_507(int iParam0, int iParam1, bool bParam2)//Position - 0x396E7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_508(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x39748
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_509(int iParam0, int iParam1)//Position - 0x39C98
{
	int iVar0;
	int iVar1;
...
bool func_510()//Position - 0x39D10
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_511(int iParam0)//Position - 0x39D21
{
	int iVar0;
...
int func_512(int iParam0)//Position - 0x39D6C
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_513(int iParam0)//Position - 0x39DF3
{
...
int func_514(int iParam0)//Position - 0x39E22
{
...
int func_515(int iParam0)//Position - 0x39E3F
{
...
int func_516(int iParam0, int iParam1)//Position - 0x39E62
{
...
int func_517(int iParam0)//Position - 0x39E9D
{
	if (func_516(iParam0, 0))
	{
...
int func_518(int iParam0, int iParam1)//Position - 0x39EC0
{
	int iVar0;
...
int func_519(var uParam0)//Position - 0x39F0D
{
	if (func_451(uParam0))
	{
...
bool func_520()//Position - 0x39F42
{
	return func_519(&(Global_100114.f_2890));
}

void func_521()//Position - 0x39F55
{
	func_522(&(Global_100114.f_2890));
}

void func_522(var uParam0)//Position - 0x39F68
{
	if (func_451(uParam0))
	{
...
void func_523()//Position - 0x39F86
{
	float fVar0;
	
	fVar0 = func_524(PLAYER::PLAYER_PED_ID(), vLocal_387, 1);
...
float func_524(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x39FC3
{
	vector3 vVar0;
...
void func_525()//Position - 0x39FFD
{
	if (func_526(iLocal_408))
	{
		if (iLocal_449)
...
int func_526(int iParam0)//Position - 0x3A04F
{
	if (func_9(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_527(bool bParam0)//Position - 0x3A06F
{
	func_4(0, bParam0);
	PLAYER::RESET_WANTED_LEVEL_DIFFICULTY(PLAYER::PLAYER_ID());
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(vLocal_450, vLocal_453, fLocal_456, 1);
...
void func_528()//Position - 0x3A0B3
{
	int iVar0;
