		...
		switch (iLocal_293)
		{
			case 0:
				...
				else
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_239, 1f, 20000, 1048576000, 0, 1193033728);
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_123(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_123(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		...
		switch (iLocal_293)
		{
			case 0:
				...
				else
				{
					...
					BRAIN::OPEN_SEQUENCE_TASK(&iVar3);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_238, 1f, 20000, 1048576000, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar3);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_296, iVar3);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar3);
...
void func_258()
{
	if (((((func_526(PLAYER::PLAYER_PED_ID()) && func_526(iLocal_302)) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_302)) && !BRAIN::IS_PED_GETTING_UP(iLocal_302)) && !PED::IS_PED_PRONE(iLocal_302)) && !PED::IS_PED_RAGDOLL(iLocal_302))
	{
...
{
	if (((((func_526(iLocal_302) && func_526(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_302)) && !BRAIN::IS_PED_GETTING_UP(iLocal_302)) && !PED::IS_PED_PRONE(iLocal_302)) && !PED::IS_PED_RAGDOLL(iLocal_302))
	{
		if (!func_5(iLocal_302) == joaat("weapon_pistol"))
		{
			PED::SET_PED_CAN_SWITCH_WEAPON(iLocal_302, true);
...
void func_291()
{
	...
	if (func_526(PLAYER::PLAYER_PED_ID()))
	{
		...
		else
		{
			...
			iLocal_320 = 1;
			iLocal_332 = -1;
			if ((((func_526(iLocal_302) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_302)) && !BRAIN::IS_PED_GETTING_UP(iLocal_302)) && !PED::IS_PED_PRONE(iLocal_302)) && !PED::IS_PED_RAGDOLL(iLocal_302))
			{
