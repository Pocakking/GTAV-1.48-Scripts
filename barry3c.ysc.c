...
void __EntryFunction__()//Position - 0x0
{
	...
	func_455(&iLocal_172, &(Local_81.f_41[0]));
	func_446();
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_410(iVar0))
		{
			...
			if ((((iVar1 == joaat("towtruck") || iVar1 == joaat("towtruck2")) || iVar1 == joaat("cargobob")) || iVar1 == joaat("cargobob2")) || iVar1 == joaat("cargobob3"))
			{
				...
				while (iLocal_250 <= 7)
				{
					if (func_410(Local_191[iLocal_250 /*7*/].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250 /*7*/].f_4, 0))
					{
						bVar2 = true;
	...
	else
	{
		...
		else
		{
			...
			switch (iLocal_424)
			{
				...
				case 2:
					BRAIN::OPEN_SEQUENCE_TASK(&uLocal_430);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f, 1500, 9, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(uLocal_430);
					BRAIN::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_430);
					BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_430);
				...
				case 7:
					if (MISC::GET_GAME_TIMER() > iLocal_421 && !BRAIN::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2))
					{
						BRAIN::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
						BRAIN::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_159.f_4, 0);
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
					}
					break;
				}
...
void func_45()//Position - 0x1871
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			{
				if (!func_242(PLAYER::PLAYER_PED_ID(), Local_159.f_4, 150f, 1) && !func_15())
				{
					iLocal_157 = 2;
				}
...
int func_54()//Position - 0x26D5
{
	return Global_1312745;
}

void func_55()//Position - 0x26E1
{
	func_72();
	func_64();
	func_60();
...
void func_56(int iParam0)//Position - 0x273A
{
	if (iParam0 == 1)
	{
...
void func_58()//Position - 0x2781
{
	StringCopy(&Global_71822, "", 16);
	StringCopy(&Global_71826, "", 16);
}

void func_59()//Position - 0x279B
{
	int iVar0;
...
void func_63(int iParam0)//Position - 0x286D
{
	if (iParam0 == 1)
	{
		Global_36974 = 1;
...
void func_64()//Position - 0x2886
{
	func_65(&Global_100114);
}

void func_65(var uParam0)//Position - 0x2896
{
	int iVar0;
	int iVar1;
...
void func_66(var uParam0)//Position - 0x2E26
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_67(var uParam0)//Position - 0x2E41
{
...
void func_68(var uParam0)//Position - 0x2E70
{
	int iVar0;
...
void func_69(var uParam0)//Position - 0x2F20
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_70(var uParam0)//Position - 0x2F3E
{
	int iVar0;
...
void func_71(var uParam0)//Position - 0x301E
{
	*uParam0 = -15;
}

void func_72()//Position - 0x302C
{
	StringCopy(&Global_97122, "", 32);
	func_65(&Global_97130);
}

void func_73()//Position - 0x3045
{
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0x3183
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_76(int iParam0, int iParam1, int iParam2)//Position - 0x3342
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x33CE
{
	switch (iParam0)
	{
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3409
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_79(int iParam0, int iParam1, int iParam2)//Position - 0x3C1F
{
	int iVar0;
	int iVar1;
...
int func_80(int iParam0, int iParam1, int iParam2)//Position - 0x3CA9
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_81(int iParam0, int iParam1, int iParam2)//Position - 0x3D87
{
	Global_71402[1 /*14*/] = { func_126(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_82(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x3DB2
{
	var uVar0;
	int iVar10;
...
int func_83(int iParam0, int iParam1, int iParam2)//Position - 0x43B7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_84(int iParam0, int iParam1, int iParam2)//Position - 0x4450
{
	int iVar0;
	int iVar1;
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x44F1
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x47F8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x53AB
{
	int iVar0;
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x568F
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5956
{
	int iVar0;
	int iVar1;
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x598D
{
	int iVar0;
...
int func_91(int iParam0, int iParam1, int iParam2)//Position - 0x59B6
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C80
{
	int iVar0;
...
int func_93(int iParam0, int iParam1, int iParam2)//Position - 0x5F0A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6061
{
	int iVar0;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x60F9
{
	switch (iParam0)
	{
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x61C7
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_97(int iParam0, int iParam1)//Position - 0x6323
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_98(int iParam0)//Position - 0x66CA
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x672B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_100(int iParam0, int iParam1)//Position - 0x6827
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6965
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_102(int iParam0)//Position - 0x6A45
{
	switch (iParam0)
	{
		case 0:
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6ACB
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6D48
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x716D
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_106(int iParam0, int iParam1)//Position - 0x7460
{
	int iVar0;
	int iVar1;
...
int func_107(int iParam0, int iParam1)//Position - 0x74A6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7506
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109(int iParam0)//Position - 0x758A
{
...
void func_110(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x7642
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x768C
{
	int iVar0;
...
int func_112(var uParam0)//Position - 0x76BC
{
	int iVar0;
	int iVar1;
...
int func_113(int iParam0, int iParam1, int iParam2)//Position - 0x76F0
{
	int iVar0;
	var uVar1;
...
bool func_114(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x7722
{
	int iVar0;
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x94F4
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_116(int iParam0)//Position - 0xA412
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA463
{
	int iVar0;
...
int func_118(int iParam0)//Position - 0xA4F9
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_119(int iParam0, int iParam1)//Position - 0xA5A9
{
	int iVar0;
	struct<10> Var1;
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAED8
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xB002
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_122(int iParam0, int iParam1)//Position - 0xB04A
{
	int iVar0;
	struct<17> Var1;
...
void func_135(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF67E
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_129(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_129(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_197(int iParam0, int iParam1, int iParam2)//Position - 0x215F5
{
	...
	if (iParam0 != -1)
	{
		...
		func_198(&sVar32, Var0.f_3, Global_93719, iParam1, iParam2);
	}
}
...
void func_203()//Position - 0x22C16
{
	...
	{
		func_29();
		GRAPHICS::_0xBF59707B3E5ED531(func_204(Global_106565.f_2357.f_539.f_4321));
	}
	else
	{
...
void func_241(bool bParam0)//Position - 0x281A6
{
	if (bParam0)
	{
		...
		VEHICLE::_0x2B6747FAA9DB9D6B(Local_159.f_4, 1);
	}
	else
	{
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_159.f_4, 1, 0);
		VEHICLE::_0x2B6747FAA9DB9D6B(Local_159.f_4, 0);
	}
}
...
void func_270(int iParam0, var uParam1)//Position - 0x2AA66
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_272(Var11.f_1)) && iVar72 < 51)
			{
...
int func_271(int iParam0)//Position - 0x2ACEE
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_272(int iParam0)//Position - 0x2AD89
{
...
int func_273(int iParam0, int iParam1)//Position - 0x2AF0F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_274(int iParam0, var uParam1)//Position - 0x2BA80
{
	int iVar0;
	int iVar1;
...
int func_275(int iParam0)//Position - 0x2BABB
{
	int iVar0;
...
void func_276(int iParam0)//Position - 0x2BD2F
{
	int iVar0;
...
void func_277(var uParam0, int iParam1)//Position - 0x2BD6B
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_278(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x2C2C7
{
	int iVar0;
	int iVar1;
...
bool func_279(int iParam0, var uParam1, var uParam2)//Position - 0x2C30B
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_280(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2CA12
{
	if (bParam6)
	{
...
int func_281(var uParam0)//Position - 0x2CA59
{
...
bool func_282(int iParam0)//Position - 0x2CAB4
{
	return func_283(iParam0, 0, 1);
}

int func_283(int iParam0, int iParam1, bool bParam2)//Position - 0x2CAC4
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_284(int iParam0)//Position - 0x2CB2E
{
	switch (iParam0)
	{
		case 0:
...
int func_285(int iParam0)//Position - 0x2CE4F
{
	return func_283(iParam0, 5, 1);
}

int func_286(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2CE5F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_287(int iParam0, bool bParam1)//Position - 0x2CF01
{
	switch (iParam0)
	{
		case -1:
...
int func_288(int iParam0)//Position - 0x2D503
{
	if (iParam0 != func_297())
	{
...
Vector3 func_289(int iParam0, int iParam1)//Position - 0x2D561
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_290(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2D60F
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_291(vector3 vParam0, float fParam3)//Position - 0x2D6A4
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_292(int iParam0)//Position - 0x2D6E8
{
	struct<6> Var0;
...
struct<6> func_293(int iParam0)//Position - 0x2D86C
{
	return func_294(iParam0);
}

struct<6> func_294(int iParam0)//Position - 0x2D87A
{
	struct<6> Var0;
...
int func_295(int iParam0, var uParam1)//Position - 0x2E341
{
	switch (iParam0)
	{
		case 0:
...
int func_296(int iParam0)//Position - 0x2E3C3
{
	if (iParam0 != func_297())
	{
...
int func_297()//Position - 0x2E421
{
	return -1;
}

Vector3 func_298(int iParam0)//Position - 0x2E42A
{
	switch (iParam0)
	{
		case 1:
...
int func_299()//Position - 0x2E635
{
	return func_300(PLAYER::PLAYER_ID());
}

var func_300(int iParam0)//Position - 0x2E645
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_301(int iParam0)//Position - 0x2E662
{
	return func_283(iParam0, 0, 0);
}

int func_302(int iParam0)//Position - 0x2E672
{
	switch (iParam0)
	{
		case -1:
...
bool func_303()//Position - 0x2E933
{
	return Global_93734.f_339 > 0;
}

var func_304()//Position - 0x2E944
{
	var uVar0;
...
void func_305(var uParam0, int iParam1)//Position - 0x2E98A
{
	if (iParam1 <= 0)
	{
		return;
...
void func_306(var uParam0, int iParam1)//Position - 0x2EA10
{
...
void func_307(var uParam0, int iParam1)//Position - 0x2EA43
{
	int iVar0;
	int iVar1;
...
int func_308(int iParam0, int iParam1)//Position - 0x2EA94
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_309(int iParam0)//Position - 0x2EB36
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_310(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_310(bool bParam0, int iParam1, int iParam2)//Position - 0x2EB5B
{
	if (bParam0)
	{
		return iParam1;
...
int func_311(var uParam0)//Position - 0x2EB72
{
	return uParam0 & 15;
}

void func_312(var uParam0, int iParam1)//Position - 0x2EB7F
{
...
void func_313(var uParam0, int iParam1)//Position - 0x2EBB9
{
...
void func_314(var uParam0, int iParam1)//Position - 0x2EBF4
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_315(char* sParam0)//Position - 0x2EC30
{
...
int func_316(int iParam0)//Position - 0x2EC86
{
	switch (iParam0)
	{
		case 69:
...
int func_317(int iParam0)//Position - 0x2ED42
{
	switch (iParam0)
	{
		case 1:
...
int func_318(char* sParam0, bool bParam1)//Position - 0x2ED96
{
	int iVar0;
	int iVar1;
...
int func_319(int iParam0, bool bParam1)//Position - 0x2EDC0
{
	int iVar0;
...
void func_320(bool bParam0)//Position - 0x2EDF6
{
	int iVar0;
	int iVar1;
...
bool func_321(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2F078
{
...
void func_322()//Position - 0x2F0D7
{
	func_17();
	switch (iLocal_157)
	{
...
void func_323(int iParam0)//Position - 0x2F282
{
	bool bVar0;
	int iVar1;
...
void func_324(bool bParam0, int iParam1)//Position - 0x2F2F3
{
	int iVar0;
...
void func_325(char* sParam0, int iParam1)//Position - 0x2F38D
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_326()//Position - 0x2F3A4
{
	vector3 vVar0;
	...
	switch (iLocal_157)
	{
		case 0:
			func_41(&iLocal_158);
			iLocal_158 = func_327(vLocal_182, 5, 1);
...
int func_327(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2F5E0
{
	int iVar0;
...
void func_328()//Position - 0x2F60E
{
	func_17();
	switch (iLocal_157)
	{
...
void func_329(int iParam0, bool bParam1)//Position - 0x2F7C9
{
	int iVar0;
...
void func_330(int iParam0)//Position - 0x2F813
{
...
void func_331()//Position - 0x2F839
{
	switch (iLocal_157)
	{
		case 0:
...
bool func_332(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x2FA38
{
...
void func_334()//Position - 0x2FB07
{
	if (!iLocal_249)
	{
...
void func_335(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2FB23
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_362(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_359(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_336(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x2FB9E
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_355(iParam5, &Var0, vParam1, fParam4, func_253(iParam0));
		func_337(iParam5, iParam0, 0);
	}
}

void func_337(int iParam0, int iParam1, int iParam2)//Position - 0x2FCC7
{
	int iVar0;
...
void func_338(int iParam0, int iParam1)//Position - 0x2FDE4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_339(int iParam0)//Position - 0x2FFE6
{
...
int func_340(int iParam0)//Position - 0x300C4
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_341(int iParam0, bool bParam1)//Position - 0x30275
{
	int iVar0;
	struct<2> Var1;
...
int func_342(int iParam0)//Position - 0x303F5
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_344(int iParam0)//Position - 0x304D8
{
	int iVar0;
	int iVar1;
...
int func_345()//Position - 0x32545
{
	return 0;
}

int func_346()//Position - 0x3254E
{
	return 1;
}

int func_347()//Position - 0x32557
{
	return 1;
}

int func_348()//Position - 0x32560
{
...
int func_350(int iParam0)//Position - 0x32634
{
	int iVar0;
	char* sVar1;
...
int func_351(int iParam0)//Position - 0x3267A
{
	int iVar0;
...
int func_352(int iParam0)//Position - 0x326B5
{
	int iVar0;
...
int func_353(int iParam0)//Position - 0x32731
{
	int iVar0;
...
int func_354(var uParam0, int iParam1)//Position - 0x32819
{
	int iVar0;
	int iVar1;
...
void func_355(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x33F10
{
	if (func_354(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_356(var uParam0, var uParam1)//Position - 0x34012
{
...
void func_357(int iParam0)//Position - 0x340DE
{
	if (iParam0 == -1)
	{
		return;
...
void func_358(int iParam0)//Position - 0x34158
{
...
int func_359(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x3417F
{
	int iVar0;
...
int func_360(vector3 vParam0, int iParam3, int iParam4)//Position - 0x34295
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_361(int iParam0)//Position - 0x34324
{
	return MISC::IS_BIT_SET(Global_106565.f_7223[iParam0], 0);
}

int func_362(int iParam0)//Position - 0x3433C
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_363()//Position - 0x34358
{
	switch (iLocal_157)
	{
		case 0:
...
void func_364()//Position - 0x34443
{
	switch (iLocal_157)
	{
		case 0:
			...
			if (func_4())
			{
				...
				func_330(3);
				func_330(4);
				VEHICLE::_0x51BB2D88D31A914B(Local_159.f_4, 0);
				VEHICLE::_0x192547247864DFDD(Local_159.f_4, 0);
				if (func_2())
				{
					iLocal_157 = 0;
					iLocal_156 = 5;
				...
				case 2:
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_159.f_4, -1, 0) == PLAYER::PLAYER_PED_ID() && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_159.f_4))
					{
						if (iLocal_425 == 3)
						{
							BRAIN::OPEN_SEQUENCE_TASK(&uLocal_430);
							BRAIN::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f, 8000, 9, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(uLocal_430);
							BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_430);
							BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_430);
						...
						else if (iLocal_425 == 2)
						{
							if (func_21(&uLocal_251, "BAR3CAU", "BAR3C_C1", 7, 0, 0, 0))
							{
								BRAIN::OPEN_SEQUENCE_TASK(&uLocal_430);
								BRAIN::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
								BRAIN::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f, (1200 + iLocal_425 * 250), 9, 0, 0, 0, 0);
								BRAIN::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
								BRAIN::CLOSE_SEQUENCE_TASK(uLocal_430);
								BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_430);
								BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_430);
				...
				case 4:
					if (MISC::GET_GAME_TIMER() > iLocal_421)
					{
						...
						else
						{
							...
							if (iLocal_425 == 4)
							{
								BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_429, "franklinfailingtostartcar_slamwheel", 1000f, -8f, 3300, 0, 0, 0, 0, 0);
...
void func_365(int iParam0, bool bParam1)//Position - 0x34950
{
...
void func_366()//Position - 0x3498C
{
	switch (iLocal_157)
	{
		case 0:
...
void func_367(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x34A9D
{
	switch (*uParam0)
	{
		case 0:
...
bool func_368(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x34BAE
{
...
void func_369()//Position - 0x34C02
{
	Global_14732 = 0;
	func_36();
}

struct<6> func_370()//Position - 0x34C12
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
struct<6> func_371()//Position - 0x34CBE
{
	struct<6> Var0;
...
void func_372()//Position - 0x34CE2
{
}

int func_373()//Position - 0x34CEA
{
	if (!func_410(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
...
void func_374()//Position - 0x34E17
{
	switch (iLocal_157)
	{
		case 0:
		...
		case 1:
			if (func_390())
			{
				if ((func_410(Local_159.f_4) && func_410(iLocal_188)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_159.f_4, iLocal_188))
				{
...
void func_375()//Position - 0x34EAD
{
...
void func_376(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x34EF0
{
...
void func_377(var uParam0, bool bParam1)//Position - 0x34F10
{
	func_378(&(uParam0->f_41), bParam1);
}

void func_378(var uParam0, bool bParam1)//Position - 0x34F22
{
	int iVar0;
...
void func_379(int iParam0, bool bParam1)//Position - 0x34F60
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_380(var uParam0, bool bParam1)//Position - 0x34F9B
{
	func_381(&(uParam0->f_35), bParam1);
}

void func_381(var uParam0, bool bParam1)//Position - 0x34FAD
{
	int iVar0;
...
void func_382(var uParam0, int iParam1)//Position - 0x34FEA
{
	func_383(&(uParam0->f_28), iParam1);
}

void func_383(var uParam0, int iParam1)//Position - 0x34FFC
{
	int iVar0;
...
void func_384(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3503D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_385(int iParam0)//Position - 0x3508D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_386(bool bParam0)//Position - 0x350CE
{
	func_387(39, bParam0);
	func_387(40, bParam0);
	func_387(41, bParam0);
...
void func_387(int iParam0, bool bParam1)//Position - 0x35106
{
	if (bParam1)
	{
...
void func_388(int iParam0, int iParam1, bool bParam2)//Position - 0x3513D
{
	int iVar0;
...
void func_389(int iParam0, int iParam1, bool bParam2)//Position - 0x351AF
{
	int iVar0;
...
void func_391(char* sParam0, bool bParam1)//Position - 0x3524E
{
	func_392(sParam0);
	func_460(bParam1);
}

void func_392(char* sParam0)//Position - 0x35262
{
...
void func_393(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x352A1
{
	float fVar0;
	int iVar1;
	int iVar2;
...
float func_394(char* sParam0)//Position - 0x35586
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_395(int iParam0, int iParam1, int iParam2)//Position - 0x35599
{
	struct<2> Var0;
	int iVar2;
...
char* func_396(int iParam0)//Position - 0x3566F
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_397(int iParam0)//Position - 0x357C2
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_398(int iParam0)//Position - 0x357F5
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_399(int iParam0)//Position - 0x35828
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_400(int iParam0)//Position - 0x3585B
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_401(int iParam0)//Position - 0x3588E
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_402(int iParam0)//Position - 0x358CB
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_403(int iParam0)//Position - 0x358FE
{
	struct<2> Var0;
...
int func_404(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x35967
{
...
bool func_405(bool bParam0)//Position - 0x35A7F
{
	if (bParam0)
	{
...
int func_406(int iParam0)//Position - 0x35AA8
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
int func_407(int iParam0)//Position - 0x35B02
{
	if (Global_36425 == 15)
	{
		return 0;
...
bool func_408(int iParam0)//Position - 0x35B24
{
	return func_409(iParam0, Global_36425);
}

int func_409(int iParam0, int iParam1)//Position - 0x35B35
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_410(int iParam0)//Position - 0x35D16
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
bool func_411(bool bParam0)//Position - 0x35D37
{
...
void func_412(bool bParam0)//Position - 0x35D62
{
	if (bParam0)
	{
		if (func_428())
...
void func_413(int iParam0, int iParam1, int iParam2)//Position - 0x35F33
{
...
bool func_414()//Position - 0x35FF7
{
	return MISC::IS_BIT_SET(Global_93682.f_20, 13);
}

void func_415(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x3600B
{
	if (func_410(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam4)
	...
	if (bParam4)
	{
		func_416(PLAYER::PLAYER_PED_ID(), iLocal_188, -1);
	}
	VEHICLE::_0x51BB2D88D31A914B(iLocal_188, 0);
	VEHICLE::_0x192547247864DFDD(iLocal_188, 0);
...
void func_416(int iParam0, int iParam1, int iParam2)//Position - 0x360CC
{
	if (func_417(iParam0))
	{
		if (func_410(iParam1))
...
int func_417(int iParam0)//Position - 0x3610E
{
	if (func_410(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_418(vector3 vParam0, float fParam3)//Position - 0x3612E
{
...
void func_419()//Position - 0x36222
{
	if (func_410(PLAYER::PLAYER_PED_ID()))
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
...
void func_420()//Position - 0x36254
{
	HUD::CLEAR_PRINTS();
	HUD::CLEAR_HELP(1);
	if (func_15())
...
void func_421(int iParam0)//Position - 0x36275
{
	if (func_423())
	{
		return;
...
void func_422(bool bParam0, bool bParam1)//Position - 0x362EF
{
	if (bParam0)
	{
		if (func_406(0))
...
bool func_423()//Position - 0x36363
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

void func_424()//Position - 0x36375
{
	Global_14732 = 0;
	func_425();
}

void func_425()//Position - 0x36385
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_426(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x363A6
{
	if (func_445())
	{
...
int func_427()//Position - 0x3643B
{
	return Global_100114.f_2890.f_12.f_66;
}

bool func_428()//Position - 0x3644E
{
	return func_429(&(Global_100114.f_2890));
}

int func_429(var uParam0)//Position - 0x36461
{
...
int func_430(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x364C0
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_431(bool bParam0)//Position - 0x3653B
{
	if (bParam0)
	{
		if (func_428())
...
void func_432(bool bParam0)//Position - 0x36782
{
	if (bParam0)
	{
		if (func_428())
	...
	if (bParam0)
	{
		...
		{
			VEHICLE::_SET_TOW_TRUCK_CRANE_HEIGHT(iLocal_188, 0f);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
...
void func_433(int iParam0, int iParam1, int iParam2)//Position - 0x369FD
{
...
void func_434(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x36A31
{
	int iVar0;
...
void func_435(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x36ADA
{
	if (bParam0)
	{
...
bool func_436()//Position - 0x36C13
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_437(int iParam0, int iParam1)//Position - 0x36C30
{
	bool bVar0;
...
int func_438(int iParam0, bool bParam1)//Position - 0x36C7B
{
	int iVar0;
	int iVar1;
...
int func_439(int iParam0)//Position - 0x36CBC
{
...
bool func_440()//Position - 0x36CFE
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_441(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x36D0F
{
	int iVar0;
...
void func_442(int iParam0)//Position - 0x36D42
{
	if (iParam0 == 1)
	{
...
void func_443(bool bParam0)//Position - 0x36D65
{
	if (bParam0)
	{
		func_426(Local_159, Local_159.f_3, 1, 0);
...
void func_446()//Position - 0x36EF0
{
	...
	if (func_410(PLAYER::PLAYER_PED_ID()))
	{
		func_452(&uLocal_251, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
...
void func_447(int iParam0, int iParam1, bool bParam2)//Position - 0x371DD
{
	Global_3109 = iParam0;
...
void func_448()//Position - 0x37387
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
void func_449()//Position - 0x37406
{
...
void func_450()//Position - 0x37436
{
...
Vector3 func_451(char* sParam0, int iParam1)//Position - 0x374D8
{
	vector3 vVar0;
...
void func_452(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x374F3
{
...
struct<7> func_453(vector3 vParam0, float fParam3)//Position - 0x3758E
{
	struct<7> Var0;
...
int func_454()//Position - 0x375B6
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-564f, -1758.1f, 16.5f, -419.31f, -1649f, 23f, 0, 1, 1, 1);
}

void func_455(var uParam0, var uParam1)//Position - 0x375E4
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_456(var uParam0, int iParam1)//Position - 0x375F6
{
	Global_93682.f_22[iParam1] = uParam0;
}

void func_457(int iParam0, var uParam1)//Position - 0x3760A
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_458()//Position - 0x3761C
{
	if (func_459())
	{
	}
...
void func_460(bool bParam0)//Position - 0x3770C
{
	int iVar0;
...
void func_461(char* sParam0, int iParam1)//Position - 0x377DC
{
	if (Global_93682 != 12)
	{
...
int func_462(char* sParam0, int iParam1, int iParam2)//Position - 0x37804
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
void func_466(bool bParam0)//Position - 0x37A76
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_467(int iParam0)//Position - 0x37A8A
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_468(int iParam0)//Position - 0x37AC7
{
	if (iParam0 == 1)
	{
...
void func_469()//Position - 0x37B04
{
	Global_17272.f_5 = 1;
}

void func_470()//Position - 0x37B12
{
	Global_17272.f_5 = 0;
}

void func_471(bool bParam0)//Position - 0x37B20
{
	if (bParam0)
	{
		func_472();
...
void func_472()//Position - 0x37B83
{
...
void func_473()//Position - 0x37BAC
{
	Global_87888 = 0;
	Global_87889 = 0;
}

int func_474()//Position - 0x37BBE
{
...
void func_475()//Position - 0x37BFC
{
	Global_93717 = 1;
...
void func_476(int iParam0)//Position - 0x37CE9
{
...
void func_477()//Position - 0x37CFB
{
	int iVar0;
...
void func_478(var uParam0)//Position - 0x37D1B
{
...
void func_479(var uParam0)//Position - 0x37D3B
{
	int iVar0;
...
int func_480(int iParam0)//Position - 0x37D75
{
	if (!func_30(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
