	...
	switch (iLocal_50)
	{
		...
		case 2:
			...
			if ((func_16(iLocal_126, iLocal_124, &Local_128, &uLocal_135, 0, 1, 0, 1, 1) || func_16(iLocal_127, iLocal_125, &Local_128, &uLocal_135, 0, 1, 0, 1, 1)) || (func_15(vVar0, 4, 20, 0) && !PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID())))
			{
				...
				{
					BRAIN::TASK_COMBAT_PED(iLocal_126, PLAYER::PLAYER_PED_ID(), 0, 16);
				}
		...
		case 3:
			if (func_14(&iLocal_136))
			{
				if (func_8(&iLocal_136) > 15f)
				{
					...
					func_26(&iLocal_127);
					BRAIN::TASK_COMBAT_PED(iLocal_127, PLAYER::PLAYER_PED_ID(), 0, 16);
					iLocal_50++;
				}
	...
	if (bLocal_574)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_569, 0))
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_570, 0))
			{
				...
				BRAIN::TASK_VEHICLE_AIM_AT_COORD(iLocal_570, vVar0);
			}
			if (bLocal_572)
			{
				if (!func_28())
...
void func_29()//Position - 0x2110
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(Local_629.f_27[iVar0]))
		{
			if (!Local_629.f_18[iVar0])
			{
				...
				{
					BRAIN::TASK_COMBAT_PED(Local_629.f_27[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					Local_629.f_18[iVar0] = 1;
				}
			}
			if (!Local_629.f_18[iVar0])
			{
				if (!BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_629.f_27[iVar0]))
				{
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(Local_629.f_27[iVar0], Local_629.f_14[iVar0], 0, 0, -1);
				}
			}
		}
	...
	if (!Local_629.f_22[0])
	{
		if (!PED::IS_PED_INJURED(Local_629.f_31[0]))
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(Local_629.f_31[0]);
				BRAIN::TASK_COMBAT_PED(Local_629.f_31[0], PLAYER::PLAYER_PED_ID(), 0, 16);
				Local_629.f_22[0] = 1;
			}
		}
	}
	if (!Local_629.f_22[1])
	{
		if (!PED::IS_PED_INJURED(Local_629.f_31[1]))
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(Local_629.f_31[1]);
				BRAIN::TASK_COMBAT_PED(Local_629.f_31[1], PLAYER::PLAYER_PED_ID(), 0, 16);
				Local_629.f_22[1] = 1;
			}
		}
	}
	if (!Local_629.f_22[2])
	{
		if (!PED::IS_PED_INJURED(Local_629.f_31[2]))
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(Local_629.f_31[2]);
				BRAIN::TASK_COMBAT_PED(Local_629.f_31[2], PLAYER::PLAYER_PED_ID(), 0, 16);
				Local_629.f_22[2] = 1;
			}
		}
	}
	if (!Local_629.f_22[3])
	{
		if (!PED::IS_PED_INJURED(Local_629.f_31[3]))
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(Local_629.f_31[3]);
				BRAIN::TASK_COMBAT_PED(Local_629.f_31[3], PLAYER::PLAYER_PED_ID(), 0, 16);
				Local_629.f_22[3] = 1;
			}
		}
	}
	...
	{
		if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_629.f_27[1]))
		{
			if (!Local_629.f_22[0])
			{
				if (!PED::IS_PED_INJURED(Local_629.f_31[0]))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_629.f_31[0], Local_629.f_27[1], -2f, 0f, 0f, 1f, -1, 1036831949, 1);
				}
			}
			if (!Local_629.f_22[1])
			{
				if (!PED::IS_PED_INJURED(Local_629.f_31[1]))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_629.f_31[1], Local_629.f_27[1], -1f, 0f, 0f, 1f, -1, 1036831949, 1);
				}
			}
		}
	}
	...
	{
		if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_629.f_27[2]))
		{
			if (!Local_629.f_22[2])
			{
				if (!PED::IS_PED_INJURED(Local_629.f_31[2]))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_629.f_31[2], Local_629.f_27[2], 1f, 0f, 0f, 1f, -1, 1036831949, 1);
				}
			}
			if (!Local_629.f_22[3])
			{
				if (!PED::IS_PED_INJURED(Local_629.f_31[3]))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_629.f_31[3], Local_629.f_27[2], -1f, 0f, 0f, 1f, -1, 1036831949, 1);
				}
			}
		}
	}
...
void func_30()//Position - 0x257A
{
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_318.f_64[iVar0]) && !PED::IS_PED_INJURED(Local_318.f_64[iVar0]))
		{
			...
			{
				if (!BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_318.f_64[iVar0]))
				{
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(Local_318.f_64[iVar0], Local_318.f_42[iVar0], 0, 0, -1);
	...
	while (iVar0 < 3)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(iLocal_408[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_408[iVar0], 0)) && ENTITY::DOES_ENTITY_EXIST(iLocal_404[iVar0])) && !ENTITY::IS_ENTITY_DEAD(iLocal_404[iVar0], 0))
		{
			...
			BRAIN::TASK_VEHICLE_AIM_AT_COORD(iLocal_408[iVar0], vVar1);
...
void func_31(int iParam0)//Position - 0x2955
{
	...
	{
		BRAIN::TASK_SHOOT_AT_ENTITY(Local_318.f_64[iParam0], PLAYER::PLAYER_PED_ID(), -1, 0);
...
void func_65()//Position - 0x398A
{
	...
	BRAIN::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[0 /*13*/][0 /*3*/], 1879.944f, 2461.988f, 53.5496f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[0 /*13*/][1 /*3*/], 1831.631f, 2522.218f, 54.1376f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[0 /*13*/][2 /*3*/], 1789.07f, 2490.558f, 54.1381f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[0 /*13*/][3 /*3*/], 1789.8f, 2426.876f, 44.7729f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	...
	BRAIN::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[1 /*13*/][0 /*3*/], 1879.944f, 2461.988f, 53.5496f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[1 /*13*/][1 /*3*/], 1831.631f, 2522.218f, 54.1376f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[1 /*13*/][2 /*3*/], 1789.07f, 2490.558f, 54.1381f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[1 /*13*/][3 /*3*/], 1789.8f, 2426.876f, 44.7729f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_LINK(0, 1);
	BRAIN::ADD_PATROL_ROUTE_LINK(1, 2);
	BRAIN::ADD_PATROL_ROUTE_LINK(2, 3);
	BRAIN::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	BRAIN::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[2 /*13*/][0 /*3*/], 1655.908f, 2349.021f, 55.1775f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[2 /*13*/][1 /*3*/], 1733.875f, 2385.521f, 44.9049f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[2 /*13*/][2 /*3*/], 1662.234f, 2446.357f, 44.5652f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[2 /*13*/][3 /*3*/], 1524.631f, 2426.997f, 44.6212f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_LINK(0, 1);
	BRAIN::ADD_PATROL_ROUTE_LINK(1, 2);
	BRAIN::ADD_PATROL_ROUTE_LINK(2, 3);
	BRAIN::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	BRAIN::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[3 /*13*/][0 /*3*/], 1455.081f, 2432.642f, 51.3366f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[3 /*13*/][1 /*3*/], 1576.174f, 2407.076f, 44.8143f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[3 /*13*/][2 /*3*/], 1578.1f, 2486.227f, 44.5655f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[3 /*13*/][3 /*3*/], 1512.837f, 2560.419f, 44.8417f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_LINK(0, 1);
	BRAIN::ADD_PATROL_ROUTE_LINK(1, 2);
	BRAIN::ADD_PATROL_ROUTE_LINK(2, 3);
	BRAIN::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	BRAIN::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[4 /*13*/][0 /*3*/], 1484.2f, 2584.409f, 51.9283f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[4 /*13*/][1 /*3*/], 1535.154f, 2538.926f, 44.496f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[4 /*13*/][2 /*3*/], 1570.661f, 2587.814f, 44.5655f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[4 /*13*/][3 /*3*/], 1538.227f, 2655.531f, 44.9156f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_LINK(0, 1);
	BRAIN::ADD_PATROL_ROUTE_LINK(1, 2);
	BRAIN::ADD_PATROL_ROUTE_LINK(2, 3);
	BRAIN::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	BRAIN::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[5 /*13*/][0 /*3*/], 1505.538f, 2727.242f, 37.6965f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[5 /*13*/][1 /*3*/], 1545.95f, 2632.524f, 44.7178f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[5 /*13*/][2 /*3*/], 1599.355f, 2658.319f, 44.5652f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[5 /*13*/][3 /*3*/], 1599.041f, 2713.393f, 44.4309f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_LINK(0, 1);
	BRAIN::ADD_PATROL_ROUTE_LINK(1, 2);
	BRAIN::ADD_PATROL_ROUTE_LINK(2, 3);
	BRAIN::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	BRAIN::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[6 /*13*/][0 /*3*/], 1606.661f, 2815.673f, 37.9512f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[6 /*13*/][1 /*3*/], 1602.887f, 2721.398f, 44.651f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[6 /*13*/][2 /*3*/], 1599.355f, 2658.319f, 44.5652f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[6 /*13*/][3 /*3*/], 1719.225f, 2766.111f, 44.6846f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_LINK(0, 1);
	BRAIN::ADD_PATROL_ROUTE_LINK(1, 2);
	BRAIN::ADD_PATROL_ROUTE_LINK(2, 3);
	BRAIN::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	BRAIN::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[7 /*13*/][0 /*3*/], 1783.204f, 2811.375f, 44.4414f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[7 /*13*/][1 /*3*/], 1709.275f, 2764.432f, 44.5747f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[7 /*13*/][2 /*3*/], 1599.355f, 2658.319f, 44.5652f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[7 /*13*/][3 /*3*/], 1822.456f, 2749.189f, 44.9326f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_LINK(0, 1);
	BRAIN::ADD_PATROL_ROUTE_LINK(1, 2);
	BRAIN::ADD_PATROL_ROUTE_LINK(2, 3);
	BRAIN::ADD_PATROL_ROUTE_LINK(3, 0);
	...
	BRAIN::ADD_PATROL_ROUTE_NODE(0, "WORLD_HUMAN_GUARD_STAND", Local_420[9 /*13*/][0 /*3*/], 1606.661f, 2815.673f, 37.9512f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(1, "WORLD_HUMAN_GUARD_STAND", Local_420[9 /*13*/][1 /*3*/], 1602.887f, 2721.398f, 44.651f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(2, "WORLD_HUMAN_GUARD_STAND", Local_420[9 /*13*/][2 /*3*/], 1599.355f, 2658.319f, 44.5652f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_NODE(3, "WORLD_HUMAN_GUARD_STAND", Local_420[9 /*13*/][3 /*3*/], 1719.225f, 2766.111f, 44.6846f, MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
	BRAIN::ADD_PATROL_ROUTE_LINK(0, 1);
	BRAIN::ADD_PATROL_ROUTE_LINK(1, 2);
	BRAIN::ADD_PATROL_ROUTE_LINK(2, 3);
	BRAIN::ADD_PATROL_ROUTE_LINK(3, 0);
...
void func_66()//Position - 0x44D7
{
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_318.f_64[iVar0]) && !ENTITY::IS_ENTITY_DEAD(Local_318.f_64[iVar0], 0))
		{
			...
			BRAIN::SET_PED_DESIRED_MOVE_BLEND_RATIO(Local_318.f_64[iVar0], 0f);
			...
			if (!PED::IS_PED_INJURED(Local_318.f_64[iVar0]))
			{
				if (iVar0 == 0)
				{
					BRAIN::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_01", 1, 0, 1);
				}
				else if (iVar0 == 1)
				{
					BRAIN::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_02", 1, 0, 1);
				}
				else if (iVar0 == 2)
				{
					BRAIN::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_03", 1, 0, 1);
				}
				else if (iVar0 == 3)
				{
					BRAIN::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_04", 1, 0, 1);
				}
				else if (iVar0 == 4)
				{
					BRAIN::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_05", 1, 0, 1);
				}
				else if (iVar0 == 5)
				{
					BRAIN::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_06", 1, 0, 1);
				}
				else if (iVar0 == 6)
				{
					BRAIN::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_07", 1, 0, 1);
				}
				else if (iVar0 == 7)
				{
					BRAIN::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_08", 1, 0, 1);
				}
				else if (iVar0 == 9)
				{
					BRAIN::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_10", 1, 0, 1);
				}
				else
				{
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(Local_318.f_64[iVar0], Local_318.f_42[iVar0], 0, 0, -1);
...
int func_70()//Position - 0x4C0A
{
	...
	while (iVar0 < 3)
	{
		while (!BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(Local_629.f_14[iVar0]))
		{
			SYSTEM::WAIT(0);
		}
		iVar0++;
...
int func_72()//Position - 0x4C5E
{
	...
	while (iVar0 < 10)
	{
		if (!BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(Local_318.f_42[iVar0]))
		{
			return 0;
		}
		iVar0++;
...
void func_75()//Position - 0x4D1D
{
	...
	while (iVar0 < 3)
	{
		BRAIN::REQUEST_WAYPOINT_RECORDING(Local_629.f_14[iVar0]);
		iVar0++;
	}
}
...
void func_77()//Position - 0x4DD8
{
	...
	while (iVar0 < 10)
	{
		BRAIN::REQUEST_WAYPOINT_RECORDING(Local_318.f_42[iVar0]);
		iVar0++;
	}
