...
void func_1()//Position - 0x78
{
	...
	if (((func_13() && Local_22.f_65.f_2 == 1) && Local_22.f_65.f_13) && !Local_22.f_65.f_12)
	{
		...
		{
			iVar1 = 0;
			if (!NETSHOP::_NETWORK_SHOP_GET_TRANSACTIONS_ENABLED_FOR_CHARACTER(func_11()) || NETSHOP::_NETWORK_SHOP_GET_TRANSACTIONS_DISABLED())
			{
				iVar1 = 1;
			}
			...
			else if (Local_22.f_65.f_5 != 1 && !NETSHOP::_NETWORK_SHOP_BEGIN_SERVICE(&(Local_22.f_65), Local_22.f_65.f_6, Local_22.f_65.f_4, Local_22.f_65.f_7, Local_22.f_65.f_1, Local_22.f_65.f_10))
			{
				iVar1 = 3;
			}
			else if (!NETSHOP::_NETWORK_SHOP_CHECKOUT_START(Local_22.f_65))
			{
				iVar1 = 4;
			}
			else
...
void func_17(int iParam0)//Position - 0x62B
{
	...
	if (iVar7 || SCRIPT::GET_EVENT_DATA(1, iParam0, &Var0, 7))
	{
		...
		if (iVar9 != -1)
		{
			...
			{
				Global_4263509[iVar9 /*84*/].f_65.f_18 = MISC::GET_FRAME_COUNT();
			}
		}
		bVar94 = true;
		if (iVar9 != -1)
			...
			case 0:
				if (iVar9 != -1)
				{
					...
					else if (func_13())
					{
						if (bVar94)
						{
							NETSHOP::_NETWORK_SHOP_BASKET_APPLY_SERVER_DATA(Global_4263509[iVar9 /*84*/].f_65, &uVar95);
						}
					}
				}
				break;
...
int func_20(int iParam0)//Position - 0xBEE
{
	...
	if ((bVar0 || iVar1) || NETSHOP::_NETWORK_SHOP_CHECKOUT_START(Global_4263509[*iParam0 /*84*/].f_65))
	{
		if (iVar1 && !bVar0)
		{
		}
...
void func_25(struct<66> Param0, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, int iParam84)//Position - 0x1368
{
	vector3 vVar0;
	int iVar35;
...
void func_26()//Position - 0x13FA
{
	SCRIPT::REQUEST_SCRIPT("AM_ARENA_SHP");
}

var func_27(int iParam0)//Position - 0x1409
{
	var uVar0;
...
int func_28(int iParam0)//Position - 0x141B
{
	if (iParam0 >= 0 && iParam0 < 5)
	{
...
int func_29(int iParam0, int iParam1, int iParam2)//Position - 0x1441
{
...
int func_31(int iParam0)//Position - 0x18CE
{
...
void func_32(int iParam0, bool bParam1)//Position - 0x18FB
{
	int iVar0;
	bool bVar1;
	var uVar2;
	...
	NETSHOP::_NETWORK_SHOP_SET_TELEMETRY_NONCE_SEED(func_28(iParam0));
	...
	{
		case 631654431:
			NETCASH::_0xE7DF4E0545DFB56E(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case -180141073:
			NETCASH::NETWORK_SPENT_BUY_WANTEDLEVEL(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13), bVar1, iVar0);
			break;
		
		case 68030260:
			NETCASH::NETWORK_SPENT_PAY_VEHICLE_INSURANCE_PREMIUM(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], &(Global_4263509[iParam0 /*84*/].f_13), bVar1, iVar0);
			break;
		
		case -982394051:
			NETCASH::NETWORK_SPENT_CINEMA(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/].f_1, bVar1, iVar0);
			break;
		
		case 454359403:
			NETCASH::NETWORK_SPENT_IN_STRIPCLUB(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, Global_4263509[iParam0 /*84*/].f_2, iVar0);
			break;
		...
		case 650665123:
			NETCASH::NETWORK_SPENT_TELESCOPE(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case 1654961868:
			NETCASH::NETWORK_SPENT_CALL_PLAYER(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13), bVar1, iVar0);
			break;
		
		case 1182673174:
			NETCASH::NETWORK_SPENT_CARWASH(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], Global_4263509[iParam0 /*84*/].f_1, bVar1, iVar0);
			break;
		
		case 563463121:
			NETCASH::NETWORK_EARN_FROM_CRATE_DROP(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case 1940862352:
			NETCASH::NETWORK_PAY_MATCH_ENTRY_FEE(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13.f_26), bVar1, iVar0);
			break;
		...
		case -516219046:
			NETCASH::NETWORK_BUY_HEALTHCARE(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case -1398318418:
			NETCASH::NETWORK_EARN_FROM_BETTING(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13.f_34));
			break;
		
		case 2043854386:
			NETCASH::NETWORK_SPENT_CASH_DROP(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case 277665518:
			NETCASH::NETWORK_SPENT_ARREST_BAIL(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case -1077156170:
			NETCASH::NETWORK_EARN_FROM_DAILY_OBJECTIVES(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13.f_34), -1);
			break;
		
		case -96593501:
			NETCASH::NETWORK_SPENT_BOUNTY(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case 742499889:
			NETCASH::_0xD99DB210089617FE(Global_4263509[iParam0 /*84*/].f_6, Global_4263509[iParam0 /*84*/].f_7, Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case 2050093329:
			NETCASH::_0xDBC966A01C02BCA7(Global_4263509[iParam0 /*84*/].f_6, Global_4263509[iParam0 /*84*/].f_7, Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case -1752488069:
			NETCASH::_0x08A1B82B91900682(Global_4263509[iParam0 /*84*/].f_6, Global_4263509[iParam0 /*84*/].f_7, Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case 634375935:
			NETCASH::_0xFC4EE00A7B3BFB76(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case -1027218631:
			NETCASH::NETWORK_EARN_FROM_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13.f_26));
			break;
		
		case -47546905:
			NETCASH::_0xC8407624CEF2354B(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13.f_26));
			break;
		
		case 291576838:
			NETCASH::NETWORK_BUY_ITEM(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], 14, 1, bVar1, &(Global_4263509[iParam0 /*84*/].f_13.f_26), 0, 0, 0, iVar0);
			break;
		
		case 1612072658:
			NETCASH::NETWORK_SPENT_BUY_PASSIVE_MODE(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case -990286235:
			NETCASH::NETWORK_EARN_FROM_BOUNTY(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13), &(Global_4263509[iParam0 /*84*/].f_13.f_13), 1);
			break;
		
		case 1349151477:
			NETCASH::NETWORK_EARN_FROM_GANGATTACK_PICKUP(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		...
		case -1186079845:
			NETCASH::_NETWORK_EARN_FROM_ARMOUR_TRUCK(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case 1734805203:
			NETCASH::NETWORK_EARN_FROM_HOLDUPS(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case -1645229221:
			NETCASH::NETWORK_PAY_EMPLOYEE_WAGE(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case -585718395:
			NETCASH::NETWORK_PAY_UTILITY_BILL(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case 763367758:
			NETCASH::_0x5182A339A3474510(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		...
		case -2129781826:
			NETCASH::_0xB49ECA122467D05F(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], bVar1, iVar0);
			break;
		
		case 1941570214:
			NETCASH::_0x0FE8E1FCD2B86B33(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], bVar1, iVar0);
			break;
		
		case 1869490922:
			NETCASH::_0xD7CCCBA28C4ECAF0(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], Global_4263509[iParam0 /*84*/].f_1, bVar1, iVar0);
			break;
		...
		case -664597565:
		case -1100963799:
			NETCASH::NETWORK_REFUND_CASH(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13.f_40), &(Global_4263509[iParam0 /*84*/].f_13.f_44), bVar1);
			break;
		
		case 312105838:
			NETCASH::NETWORK_EARN_FROM_ROCKSTAR(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case -1922554349:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_DESTROY_VEH", &uVar2);
			break;
		
		case -2043695058:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_DISTRACT_COPS", &uVar2);
			break;
		
		case 1780666425:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_PLANE_TAKEDOWN", &uVar2);
			break;
		
		case 1643659499:
			NETCASH::NETWORK_BUY_FAIRGROUND_RIDE(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/].f_1, bVar1, iVar0);
			break;
		
		case 1839532116:
			NETCASH::NETWORK_SPENT_ROBBED_BY_MUGGER(Global_4263509[iParam0 /*84*/].f_65.f_1, 0, 0);
			break;
		
		case 941287179:
			NETCASH::NETWORK_EARN_FROM_IMPORT_EXPORT(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/].f_3);
			break;
		
		case -352356931:
			NETCASH::NETWORK_EARN_FROM_AI_TARGET_KILL(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/]);
			break;
		
		case 1948102096:
			NETCASH::NETWORK_SPENT_REQUEST_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case -1834046564:
			NETCASH::NETWORK_SPENT_TAXI(Global_4263509[iParam0 /*84*/].f_65.f_1, bVar1, iVar0);
			break;
		
		case 393059668:
			NETCASH::NETWORK_EARN_FROM_BEND_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13.f_26));
			break;
		
		case -57868256:
			NETCASH::NETWORK_EARN_FROM_CHALLENGE_WIN(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13.f_34), Global_4263509[iParam0 /*84*/].f_4);
			break;
		
		case -1127021384:
			NETCASH::NETWORK_EARN_FROM_NOT_BADSPORT(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case 1564537328:
			NETCASH::NETWORK_PAY_MATCH_ENTRY_FEE(Global_4263509[iParam0 /*84*/].f_65.f_1, "RaceToPoint", false, 0);
			break;
		
		case -1359375127:
			NETCASH::NETWORK_SPENT_PROSTITUTES(Global_4263509[iParam0 /*84*/].f_65.f_1, 0, 0);
			break;
		
		case 283351220:
			NETCASH::NETWORK_BUY_ITEM(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], Global_4263509[iParam0 /*84*/].f_5, 1, bVar1, &(Global_4263509[iParam0 /*84*/].f_13.f_40), 0, 0, 0, iVar0);
			break;
		...
		case 1704445500:
			NETCASH::NETWORK_SPENT_BETTING(Global_4263509[iParam0 /*84*/].f_65.f_1, 0, &(Global_4263509[iParam0 /*84*/].f_13.f_34), 0, 0);
			break;
		
		case 1620609399:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_HOT_TARGET_DELIVER", &uVar2);
			break;
		
		case 1961641934:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_HOT_TARGET_KILL", &uVar2);
			break;
		
		case 210955503:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_KILL_LIST", &uVar2);
			break;
		
		case -59668082:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_CP_COLLECTION", &uVar2);
			break;
		
		case 1736933716:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_TIME_TRIAL", &uVar2);
			break;
		
		case -1468524125:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_CHALLENGES", &uVar2);
			break;
		
		case 111573502:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_HOT_TARGET_HELI", &uVar2);
			break;
		
		case 1525644423:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_DEAD_DROP", &uVar2);
			break;
		
		case 968073639:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_PENNED_IN", &uVar2);
			break;
		
		case 1577781788:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_PASS_THE_PARCEL", &uVar2);
			break;
		
		case -934465332:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_CRIMINAL_DAMAGE", &uVar2);
			break;
		
		case -1194253122:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_HOT_PROPERTY", &uVar2);
			break;
		
		case -212607085:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_KING_OF_THE_HILL", &uVar2);
			break;
		
		case -815546555:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "AM_HUNT_THE_BEAST", &uVar2);
			break;
		
		case 1048226110:
			NETCASH::_0x08B0CA7A6AB3AC32(Global_4263509[iParam0 /*84*/].f_6, Global_4263509[iParam0 /*84*/].f_7, Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case 569170531:
			NETCASH::_0xCDA1C62BE2777802(Global_4263509[iParam0 /*84*/].f_6, Global_4263509[iParam0 /*84*/].f_7, Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case -856006867:
			NETCASH::_0x0CB1BE0633C024A8(Global_4263509[iParam0 /*84*/].f_6, Global_4263509[iParam0 /*84*/].f_7, Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/].f_8);
			break;
		
		case 208223429:
			NETCASH::_0xECA658CE2A4E5A72(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/].f_9);
			break;
		
		case 848090538:
			NETCASH::_0x84C0116D012E8FC2(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case 665109499:
			NETCASH::_0xE8B0B270B6E7C76E(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], 0, 1);
			break;
		
		case -1330755006:
			NETCASH::_0x05F04155A226FBBF(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], 0, 1);
			break;
		
		case 1976384368:
			NETCASH::_0x5BCDE0F640C773D2(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], 0, 0);
			break;
		
		case 268924934:
			NETCASH::_0x0035BB914316F1E3(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/], Global_4263509[iParam0 /*84*/].f_1, Global_4263509[iParam0 /*84*/].f_9);
			break;
		
		case -293060240:
			NETCASH::_0xEDEAD9A91EC768B3(Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/].f_6, Global_4263509[iParam0 /*84*/].f_7);
			break;
		
		case 437291904:
			NETCASH::_0xA75CCF58A60A5FD1(Global_4263509[iParam0 /*84*/].f_65.f_1, 0, 1, Global_4263509[iParam0 /*84*/].f_6, Global_4263509[iParam0 /*84*/].f_7, Global_4263509[iParam0 /*84*/].f_1, Global_4263509[iParam0 /*84*/], Global_4263509[iParam0 /*84*/].f_10, Global_4263509[iParam0 /*84*/].f_11, Global_4263509[iParam0 /*84*/].f_12);
			break;
		
		case -135813048:
			NETCASH::_0xC1952F3773BA18FE(Global_4263509[iParam0 /*84*/].f_65.f_1, 0, 1);
			break;
		
		case 463142405:
			NETCASH::_0xDEE612F2D71B0308(Global_4263509[iParam0 /*84*/].f_6, Global_4263509[iParam0 /*84*/].f_7, Global_4263509[iParam0 /*84*/].f_65.f_1, Global_4263509[iParam0 /*84*/].f_8);
			break;
		
		case 1550217370:
			NETCASH::_0x005ACA7100BD101D(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case -101307780:
			NETCASH::_0x35F8DA0E8A31EF1B(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case 599804707:
			NETCASH::NETWORK_EARN_FROM_AMBIENT_JOB(Global_4263509[iParam0 /*84*/].f_65.f_1, "GB_SALVAGE", &uVar2);
			break;
		
		case 1347433368:
			NETCASH::NETWORK_EARN_FROM_PICKUP(Global_4263509[iParam0 /*84*/].f_65.f_1);
			break;
		
		case 1052472386:
			NETCASH::NETWORK_EARN_FROM_JOB_BONUS(Global_4263509[iParam0 /*84*/].f_65.f_1, &(Global_4263509[iParam0 /*84*/].f_13.f_26), &(Global_4263509[iParam0 /*84*/].f_13.f_34));
			break;
	...
	if (func_13())
	{
		if (bParam1)
		{
			NETSHOP::_NETWORK_SHOP_BASKET_APPLY_SERVER_DATA(Global_4263509[iParam0 /*84*/].f_65, &uVar6);
		}
	}
	func_7(iParam0);
}

int func_33(int iParam0, bool bParam1, bool bParam2)//Position - 0x2F48
{
	int iVar0;
...
int func_34(int iParam0, var uParam1)//Position - 0x2F92
{
	int iVar0;
...
void func_35(int iParam0)//Position - 0x2FD4
{
	int iVar0;
	var uVar1;
	char* sVar2;
...
int func_36(var uParam0)//Position - 0x3100
{
	*uParam0 = SYSTEM::SHIFT_LEFT(1, 2);
	return 5410420;
}

var func_37()//Position - 0x3115
{
	return SYSTEM::SHIFT_LEFT(1, 25);
}

int func_38()//Position - 0x3124
{
	var uVar0;
...
int func_41()//Position - 0x3205
{
	return Global_25765;
}

bool func_42()//Position - 0x3210
{
	return Global_2448756.f_586;
}

int func_43(int iParam0)//Position - 0x321F
{
...
bool func_44()//Position - 0x3236
{
	return Global_2458613;
}

bool func_45()//Position - 0x3242
{
	return Global_2448756.f_581;
}

void func_46(var uParam0)//Position - 0x3251
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_47(int iParam0)//Position - 0x32C4
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
int func_48(int iParam0, var uParam1)//Position - 0x3345
{
...
void func_49()//Position - 0x33A4
{
	SYSTEM::WAIT(0);
}

void func_50()//Position - 0x33B1
{
	func_51();
}

void func_51()//Position - 0x33BD
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_52(struct<33> Param0)//Position - 0x33C9
{
	if (Global_262145.f_23434)
	{
		func_50();
...
int func_53(struct<18> Param0, var uParam18, int iParam19)//Position - 0x344D
{
