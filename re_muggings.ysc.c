...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		func_222(iLocal_65, &uLocal_392);
		if (TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_149)
		{
			switch (iLocal_46)
			{
				case 0:
				...
				case 1:
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						if (iLocal_141 == 0)
						{
							iLocal_141 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(99, vLocal_122, 0f);
						}
						PLAYER::SET_ALL_RANDOM_PEDS_FLEE_THIS_FRAME(PLAYER::PLAYER_ID());
						switch (iLocal_48)
						{
							...
							case 2:
								...
								switch (iLocal_49)
								{
									case 0:
										...
										if (PED::IS_PED_INJURED(iLocal_63) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), 0))
										{
											...
											if (bVar0 == 0 && iLocal_90 == 1)
											{
												...
												BRAIN::TASK_SMART_FLEE_PED(iLocal_62, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
									...
									case 4:
										...
										if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_62, 242628503) == 7)
										{
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
											BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_63, 5000, 0, 2);
											BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 5000);
											BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
											BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
											BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
										}
										break;
									...
									case 5:
										...
										if (!ENTITY::IS_ENTITY_DEAD(iLocal_62, 0))
										{
											...
											{
												BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
												BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_63, 0);
												BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
												BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
												BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
												BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
												BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
					...
					if (iLocal_150)
					{
						if (!iLocal_163)
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_63, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_62, 0))
							{
								...
								{
									BRAIN::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
									iLocal_163 = 1;
								}
							}
						}
					...
					if (bLocal_149 && !iLocal_150)
					{
						if (!PED::IS_PED_INJURED(iLocal_63))
						{
							if (iLocal_90 == 3)
							{
								if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_63, 1805844857) != 1)
								{
									BRAIN::CLEAR_PED_SECONDARY_TASK(iLocal_63);
									BRAIN::TASK_SMART_FLEE_PED(iLocal_63, iLocal_62, 200f, -1, 0, 0);
									PED::FORCE_PED_MOTION_STATE(iLocal_63, -530524, true, 0, 0);
									iLocal_150 = 1;
								}
							}
							else if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_63, 1805844857) != 1)
							{
								BRAIN::CLEAR_PED_SECONDARY_TASK(iLocal_63);
								BRAIN::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
								PED::FORCE_PED_MOTION_STATE(iLocal_63, -530524, true, 0, 0);
...
void func_41()//Position - 0x1F2B
{
	if (!PED::IS_PED_INJURED(iLocal_62))
	{
		...
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "flee_backward_outro_shopkeeper", 8f, -4f, -1, 8, 0, 0, 0, 0);
		...
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_outro_shopkeeper", 8f, -4f, -1, 8, 0, 0, 0, 0);
			BRAIN::TASK_WANDER_STANDARD(0, 1193033728, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
...
bool func_49(int iParam0)//Position - 0x2549
{
	return Global_36425 == iParam0;
}

void func_50()//Position - 0x2557
{
	int iVar0;
...
bool func_51(int iParam0, int iParam1)//Position - 0x25AD
{
	switch (iParam0)
	{
		case 5:
...
void func_53(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x263F
{
...
void func_54()//Position - 0x2695
{
	if (!PED::IS_PED_INJURED(iLocal_62))
	{
		BRAIN::CLEAR_PED_TASKS(iLocal_62);
		BRAIN::TASK_SMART_FLEE_PED(iLocal_62, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_62, true);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_64))
		{
...
void func_55()//Position - 0x274E
{
	...
	if (iLocal_143 == 1)
	{
		if (!iLocal_51)
		{
			if (!PED::IS_PED_INJURED(iLocal_63))
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_63);
				BRAIN::TASK_COMBAT_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 0, 16);
			...
			if (!PED::IS_PED_INJURED(iLocal_62))
			{
				if (OBJECT::DOES_PICKUP_EXIST(iLocal_191))
				{
					if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_191))
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_62);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(iLocal_191), 1f, 20000, 0.25f, 0, 1193033728);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
					}
	...
	if (iLocal_143 == 3)
	{
		if (!iLocal_51)
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_63);
				BRAIN::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
				PED::SET_PED_KEEP_TASK(iLocal_63, true);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_63, false, 1);
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_63);
			}
			...
			if (iLocal_51)
			{
				if (OBJECT::DOES_PICKUP_EXIST(iLocal_191))
				{
					if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_191))
					{
						...
						else if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_62, 242628503) == 7)
						{
							BRAIN::CLEAR_PED_TASKS(iLocal_62);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
							BRAIN::TASK_PLAY_ANIM(0, cLocal_360, "pickup_low", 8f, -8f, -1, 0, 0, 0, 0, 0);
	...
	if (!PED::IS_PED_INJURED(iLocal_62))
	{
		if (!bLocal_152)
		{
			if (iLocal_153)
			{
						...
						if (func_118(1, 0, 1))
						{
							if (!func_117())
							{
								if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
								{
									...
									if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
									{
										while (!func_107(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fLocal_77, 1, 1056964608, 0, 1, 0) || func_161())
										{
				...
				{
					func_103(ENTITY::GET_ENTITY_COORDS(iLocal_62, true), &uLocal_76, &fLocal_77);
				}
			}
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 15f, 15f, 15f, 0, 1, 0))
			{
				...
				if (iLocal_47 == 2)
				{
					BRAIN::TASK_PLAY_ANIM(0, cLocal_377, "RETURNING_FRONT_A", 8f, -1000f, -1, 0, 0, 0, 0, 0);
				}
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
			...
			switch (iLocal_151)
			{
				case 0:
					...
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_62))
						{
							func_100(iLocal_62, &vLocal_125, &vLocal_128, cLocal_361, sLocal_363);
							if (iLocal_90 == 1)
							{
							...
							if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
							{
								...
								if (ENTITY::IS_ENTITY_AT_COORD(iVar0, vLocal_125, (Var7.f_1 + 1.5f), (Var7.f_1 + 1.5f), 3f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, vLocal_125, vLocal_128, 0, 2), (Var7.f_1 + 1f), (Var7.f_1 + 1f), 3f, false, true, 0))
								{
									...
									else
									{
										...
										vLocal_80 = { func_98(vLocal_125, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, vLocal_125, vLocal_128, 0, 2)) };
									}
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
									{
						...
						BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_131, cLocal_361, sLocal_362, 1000f, -8f, 0, 0, 1148846080, 0);
						if (!PED::IS_PED_INJURED(iLocal_62))
						{
							BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_62);
							BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_62, iLocal_131, cLocal_361, sLocal_363, 1000f, -8f, 0, 0, 1148846080, 0);
						}
				...
				case 1:
					if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_131) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_131) > 0.9f) || func_96(1000))
					{
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
						...
						if (!PED::IS_PED_INJURED(iLocal_62))
						{
							...
							if (iLocal_90 == 4)
							{
								if (func_94(vVar1.z, 0f, 90f))
								{
									...
									BRAIN::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(iLocal_62), 1);
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
									BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
								}
...
void func_59(int iParam0, int iParam1)//Position - 0x363E
{
	int iVar0;
...
int func_60(int iParam0, int iParam1, int iParam2)//Position - 0x3661
{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x36AA
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_62(bool bParam0)//Position - 0x3CA9
{
	int iVar0;
	int iVar1;
...
void func_63(int iParam0)//Position - 0x3F2B
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x3F85
{
	bool bVar0;
	char cVar1[64];
...
char* func_65(int iParam0)//Position - 0x4117
{
	switch (iParam0)
	{
		case 0:
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x421F
{
	int iVar0;
...
int func_68(var uParam0)//Position - 0x424F
{
	int iVar0;
	int iVar1;
...
int func_69()//Position - 0x4283
{
	return Global_1312745;
}

int func_70(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x428F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_71(int iParam0)//Position - 0x4845
{
	func_92(93, iParam0);
	func_92(29, iParam0);
	func_92(30, iParam0);
...
bool func_72(int iParam0)//Position - 0x4865
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_73(int iParam0, int iParam1, int iParam2)//Position - 0x4A15
{
	int iVar0;
	var uVar1;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x4A47
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_75(int iParam0)//Position - 0x4A84
{
	int iVar0;
...
int func_76(int iParam0, int iParam1)//Position - 0x4DC8
{
	int iVar0;
...
int func_77(bool bParam0)//Position - 0x50EB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_78(int iParam0, int iParam1)//Position - 0x51A2
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_79(int iParam0, int iParam1)//Position - 0x51BD
{
...
int func_80(var uParam0, int iParam1)//Position - 0x525A
{
	int iVar0;
	var uVar1[78];
...
int func_81(var uParam0, int iParam1)//Position - 0x530B
{
	int iVar0;
...
bool func_82(var uParam0, int iParam1)//Position - 0x5386
{
	return (*uParam0)[iParam1] == 78;
}

void func_83(var uParam0)//Position - 0x5397
{
	int iVar0;
...
void func_84(var uParam0, int iParam1)//Position - 0x53CB
{
	(*uParam0)[iParam1] = 78;
}

void func_85(var uParam0, float fParam1)//Position - 0x53DB
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_86(var uParam0)//Position - 0x53F8
{
	return uParam0->f_80;
}

bool func_87(var uParam0, int iParam1)//Position - 0x5404
{
	return func_88(uParam0, iParam1) != -1;
}

int func_88(var uParam0, int iParam1)//Position - 0x5416
{
	int iVar0;
...
bool func_89(var uParam0)//Position - 0x5443
{
	return uParam0->f_79 == 1;
}

int func_90(int iParam0)//Position - 0x5451
{
	switch (iParam0)
	{
		case 60:
...
int func_91(int iParam0, int iParam1)//Position - 0x54A1
{
	int iVar0;
...
void func_92(int iParam0, int iParam1)//Position - 0x54F2
{
	int iVar0;
...
int func_94(float fParam0, float fParam1, float fParam2)//Position - 0x55C4
{
	float fVar0;
	float fVar1;
...
int func_96(int iParam0)//Position - 0x5677
{
...
Vector3 func_98(vector3 vParam0, vector3 vParam3)//Position - 0x56F3
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
Vector3 func_99(vector3 vParam0, float fParam3, struct<2> Param4, var uParam6)//Position - 0x5CF4
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void func_100(int iParam0, var uParam1, var uParam2, char* sParam3, char* sParam4)//Position - 0x5D41
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_101(struct<2> Param0, float fParam2, struct<2> Param3, var uParam5, int iParam6)//Position - 0x5EF9
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_102(int iParam0, int iParam1, int iParam2)//Position - 0x5F5E
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_103(vector3 vParam0, var uParam3, float fParam4)//Position - 0x5F8A
{
	bool bVar0;
	vector3 vVar1;
	float fVar4;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_104(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fVar4, 15f))
		{
			bVar0 = true;
		}
...
int func_104(int iParam0, float fParam1, float fParam2)//Position - 0x608B
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_105()//Position - 0x6112
{
	Global_14732 = 0;
	func_106();
}

void func_106()//Position - 0x6122
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_107(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x6143
{
...
void func_108(int iParam0)//Position - 0x62D2
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_109(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x62FE
{
	if (bParam0)
	{
...
bool func_110()//Position - 0x6437
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_111(int iParam0, int iParam1)//Position - 0x6454
{
	bool bVar0;
...
int func_112(int iParam0, bool bParam1)//Position - 0x649F
{
	int iVar0;
	int iVar1;
...
int func_113(int iParam0)//Position - 0x64E0
{
...
bool func_114()//Position - 0x6522
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_115(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x6533
{
	int iVar0;
...
void func_116(int iParam0)//Position - 0x6566
{
	if (iParam0 == 1)
	{
...
int func_118(bool bParam0, bool bParam1, bool bParam2)//Position - 0x65AA
{
	int iVar0;
...
bool func_119(int iParam0)//Position - 0x668F
{
	return func_36(func_120(iParam0));
}

char* func_120(int iParam0)//Position - 0x66A1
{
	char* sVar0;
...
int func_121(int iParam0)//Position - 0x66E3
{
	var uVar0;
...
int func_122()//Position - 0x673B
{
	func_123();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_123()//Position - 0x6754
{
	int iVar0;
...
bool func_124(int iParam0)//Position - 0x6851
{
	return iParam0 < 3;
}

int func_125(int iParam0)//Position - 0x685D
{
	int iVar0;
	int iVar1;
...
int func_126(int iParam0)//Position - 0x689A
{
	if (func_124(iParam0))
	{
...
void func_127()//Position - 0x68C4
{
	if (!PED::IS_PED_INJURED(iLocal_62))
	{
		BRAIN::TASK_SMART_FLEE_PED(iLocal_62, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_62, true);
		SYSTEM::WAIT(0);
	}
}

int func_128()//Position - 0x68F4
{
	vector3 vVar0;
	vector3 vVar3;
	...
	else
	{
		...
		if (GRAPHICS::_0x2F09F7976C512404(PED::GET_PED_BONE_COORDS(iLocal_62, 31086, 0f, 0f, 0f), 3f))
		{
			return 1;
		}
	}
...
void func_130()//Position - 0x6A28
{
	if (!PED::IS_PED_INJURED(iLocal_62))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, Global_19, 0, 1, 0))
		{
			BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 3000, 0, 2);
			BRAIN::TASK_LOOK_AT_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
		}
	}
}

void func_131()//Position - 0x6A6D
{
	float fVar0;
	...
	if (iLocal_90 == 1 || iLocal_90 == 4)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_166, vLocal_169, fVar0, 0, true, 0))
		{
			if (!iLocal_157)
			{
				if (!PED::IS_PED_INJURED(iLocal_62))
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 0);
					iLocal_157 = 1;
					iLocal_158 = 0;
				}
			}
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 25f, 25f, 5f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 17))
			{
				if (func_42(&uLocal_194, cLocal_103, sLocal_108, 4, 0, 0, 0) || func_58())
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_62, cLocal_359, "flee_forward_outro_shopkeeper", 3))
					{
						...
						if (iLocal_47 == 2)
						{
							BRAIN::TASK_PLAY_ANIM(0, cLocal_377, "RETURNING_FRONT_A", 8f, -4f, -1, 0, 0, 0, 0, 0);
						}
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
...
void func_132(int iParam0, var uParam1)//Position - 0x6BEF
{
	float fVar0;
	...
	switch (*uParam1)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iParam0))
			{
				...
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
				BRAIN::TASK_PERFORM_SEQUENCE(iParam0, iLocal_121);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
				SYSTEM::SETTIMERA(0);
				*uParam1++;
			}
...
void func_134(int iParam0)//Position - 0x6D3F
{
	switch (iParam0)
	{
		case 0:
...
void func_135(var uParam0)//Position - 0x6E20
{
	*uParam0 = -99;
}

void func_136()//Position - 0x6E2E
{
	iLocal_67 = 0;
	if (!HUD::DOES_BLIP_EXIST(iLocal_65))
	{
...
int func_137(int iParam0, bool bParam1, int iParam2)//Position - 0x6E58
{
	iParam2 = iParam2;
	return func_138(iParam0, bParam1, 145);
}

int func_138(int iParam0, bool bParam1, int iParam2)//Position - 0x6E6E
{
	int iVar0;
...
int func_139(int iParam0, bool bParam1, bool bParam2)//Position - 0x6EC0
{
	int iVar0;
...
float func_140(bool bParam0, float fParam1, float fParam2)//Position - 0x6F64
{
	if (bParam0)
	{
		return fParam1;
...
void func_141(bool bParam0)//Position - 0x6F7B
{
	if (!PED::IS_PED_INJURED(iLocal_62) && iLocal_90 == 4)
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_62, cLocal_359, "flee_forward_loop_shopkeeper", 3))
		{
			...
			if (bParam0)
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
			}
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
			BRAIN::CLEAR_PED_TASKS(iLocal_62);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
...
void func_143(int iParam0, var uParam1)//Position - 0x70BF
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
bool func_144(int iParam0)//Position - 0x711D
{
	return MISC::IS_BIT_SET(Global_106561, iParam0);
}

void func_145()//Position - 0x712F
{
	if (!PED::IS_PED_INJURED(iLocal_62))
	{
...
void func_148()//Position - 0x7246
{
	...
	if (!PED::IS_PED_INJURED(iLocal_63))
	{
		...
		BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
		BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63, iLocal_121);
		BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
		PED::SET_PED_KEEP_TASK(iLocal_63, true);
		SYSTEM::WAIT(0);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_63, false, 1);
...
int func_150(int iParam0)//Position - 0x7300
{
	return func_151(iParam0);
}

int func_151(int iParam0)//Position - 0x730E
{
	int iVar0;
...
int func_153()//Position - 0x74EA
{
	if (!PED::IS_PED_INJURED(iLocal_63))
	{
		if (PED::_CAN_PED_SEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 20f, 20f, 20f, 0, 1, 0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
...
void func_157(int iParam0, char* sParam1, int iParam2)//Position - 0x7773
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_158(iParam2), 1);
}

int func_158(int iParam0)//Position - 0x778A
{
	int iVar0;
	...
	if (!PED::IS_PED_INJURED(iLocal_62))
	{
		...
		if (bLocal_53)
		{
			if (!iLocal_136)
			{
				...
				{
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_62, 242628503) == 1)
					{
						if (BRAIN::GET_SEQUENCE_PROGRESS(iLocal_62) == iLocal_164)
						{
							BRAIN::TASK_LOOK_AT_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 9000, 0, 2);
			...
			if (!PED::IS_PED_INJURED(iLocal_62) && !PED::IS_PED_INJURED(iLocal_63))
			{
				...
				if (func_167())
				{
					...
					if (iLocal_90 == 3)
					{
						...
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
							BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_63, 16000, 0, 2);
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_87, 1f, 20000, fVar0, 4, 1193033728);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
							iLocal_57 = 1;
						...
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
						BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_62, -1, 0, 2);
						BRAIN::TASK_PLAY_ANIM(0, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@EXIT", "exit_forward", 1000f, -1000f, -1, 512, 0, 0, 0, 0);
						BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_87, iLocal_62, 1f, false, 1.5f, 4f, true, 0, 0, -957453492, 20000);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, iLocal_62, -1, 1);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63, iLocal_121);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
						SYSTEM::SETTIMERA(0);
		...
		if (!iLocal_135)
		{
			if (SYSTEM::TIMERA() > 1000)
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 60f, 60f, 50f, 0, 1, 0))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_62, 0))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_62, iLocal_63, 0);
					}
					iLocal_135 = 1;
				}
				else
		...
		if (iLocal_135 && !bLocal_133)
		{
			if (!PED::IS_PED_INJURED(iLocal_62) && !PED::IS_PED_INJURED(iLocal_63))
			{
				if (func_42(&uLocal_194, cLocal_103, sLocal_104, 4, 0, 0, 0) || func_58())
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_62);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
					BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "handsup_standing_enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "handsup_standing_base", 8f, -4f, 7000, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "handsup_standing_exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
					func_166();
				...
				switch (iLocal_667)
				{
					case 0:
						...
						if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_191))
						{
							BRAIN::CLEAR_PED_TASKS(iLocal_63);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
							BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_670, iLocal_62, 2f, false, 0.1f, 4f, true, 0, 0, -957453492, 20000);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63, iLocal_121);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
					...
					case 1:
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_63, 242628503) == 7)
						{
							vLocal_670 = { OBJECT::GET_PICKUP_COORDS(iLocal_191) - Vector(0f, 0f, 0.75f) };
							if (OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_191))
							{
								...
								else
								{
									BRAIN::CLEAR_PED_TASKS(iLocal_63);
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
									BRAIN::TASK_PLAY_ANIM(0, cLocal_360, "pickup_low", 8f, -4f, -1, 8224, 0, 0, 0, 0);
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
									BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63, iLocal_121);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
									iLocal_667 = 2;
					...
					case 4:
						...
						BRAIN::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
...
void func_165()//Position - 0x819E
{
	...
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_63, cLocal_359, sLocal_367, 1000f, -1000f, -1, 8, 0, 0, 0, 0);
		if (iLocal_47 == 2)
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, sLocal_368, 8f, -8f, -1, 0, 0, 0, 0, 0);
		...
		else if (iLocal_90 == 4)
		{
			...
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "flee_backward_intro_shopkeeper", 8f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "flee_backward_loop_shopkeeper", 8f, -4f, -1, 9, 0, 0, 0, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
		}
		...
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, sLocal_368, 8f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
	...
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_63, cLocal_359, sLocal_369, 1000f, -1000f, -1, 8, 0, 0, 0, 0);
		if (iLocal_47 == 2)
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, sLocal_370, 8f, -8f, -1, 8, 0.1f, 0, 0, 0);
		...
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_intro_shopkeeper", 8f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_loop_shopkeeper", 8f, -4f, -1, 9, 0, 0, 0, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
		}
		...
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, sLocal_370, 8f, -4f, -1, 8, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
...
int func_168(int iParam0)//Position - 0x871C
{
	if (func_170())
	{
		Global_106555 = 1;
...
int func_169(int iParam0)//Position - 0x876F
{
	switch (iParam0)
	{
		case 29:
...
int func_171(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x87D4
{
	int iVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0x890B
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0x895A
{
	return func_174(iParam0, Global_36425);
}

int func_174(int iParam0, int iParam1)//Position - 0x896B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_175(int iParam0)//Position - 0x8B4C
{
	if (Global_36425 == 15)
	{
		return 0;
...
int func_178(float fParam0, bool bParam1)//Position - 0x8C86
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_179(int iParam0, var uParam1)//Position - 0x8D3D
{
	switch (iParam0)
	{
		case 0:
...
int func_181(int iParam0)//Position - 0x9F43
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_182(int iParam0)//Position - 0xA289
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_183(int iParam0)//Position - 0xA2BF
{
	struct<2> Var0;
...
bool func_187()//Position - 0xA79F
{
	return Global_106283 > 0;
}

int func_188()//Position - 0xA7AD
{
	if (Global_90634 != -1)
	{
		return 1;
...
int func_192(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0xA830
{
...
void func_194()//Position - 0xAA3B
{
	func_195();
}

int func_195()//Position - 0xAA48
{
	if (func_196(0))
	{
		return 0;
...
bool func_196(bool bParam0)//Position - 0xAA93
{
...
int func_197()//Position - 0xAABE
{
	return 1;
}

void func_198(int iParam0)//Position - 0xAAC7
{
	Global_106551 = iParam0;
}

void func_199()//Position - 0xAAD5
{
	switch (iLocal_140)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_63))
			{
				BRAIN::TASK_PLAY_ANIM(iLocal_63, cLocal_359, "IG_1_guy_stickup_loop", 8f, -4f, -1, 1, 0, 0, 0, 0);
			}
			if (!PED::IS_PED_INJURED(iLocal_62))
			{
				BRAIN::TASK_PLAY_ANIM(iLocal_62, cLocal_361, "ortega_stand_loop_ort", 8f, -4f, -1, 1, 0, 0, 0, 0);
			}
			iLocal_140++;
			break;
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_63))
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_COORD(iLocal_62, vLocal_145, 250f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_62, true);
					SYSTEM::WAIT(0);
					func_205();
				}
		...
		case 2:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_63))
			{
				if (!PED::IS_PED_INJURED(iLocal_63))
				{
					...
					{
						if (PED::_CAN_PED_SEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 3f, 3f, 15f, 0, 1, 0))
						{
							if (PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_63, 65f))
							{
								iLocal_189 = MISC::GET_GAME_TIMER();
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), 7000, 0, 2);
								func_42(&uLocal_194, cLocal_103, sLocal_112, 4, 0, 0, 0);
								SYSTEM::SETTIMERB(0);
								iLocal_140++;
							}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_62))
			{
				if (!PED::IS_PED_INJURED(iLocal_62))
				{
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 1))
					{
						...
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
							BRAIN::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_63, false), 150f, -1, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
							PED::SET_PED_KEEP_TASK(iLocal_62, true);
		...
		case 9:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_63))
			{
				...
				{
					PED::SET_PED_RESET_FLAG(iLocal_63, 156, true);
					BRAIN::TASK_COMBAT_HATED_TARGETS_AROUND_PED(iLocal_63, 50f, 0);
					if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
					{
						func_105();
					}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_62))
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_62);
					BRAIN::TASK_COWER(iLocal_62, 2000);
					iLocal_148 = 1;
				}
			}
			break;
	...
	if (iLocal_190 && !bLocal_137)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_63) && ENTITY::DOES_ENTITY_EXIST(iLocal_63))
		{
			if (!PED::IS_PED_INJURED(iLocal_62) && !PED::IS_PED_INJURED(iLocal_63))
			{
				if ((((iLocal_188 - iLocal_187) > 12000 && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 3f, 3f, 35f, 0, 1, 0)) && ENTITY::IS_ENTITY_ON_SCREEN(iLocal_63)) && !func_161())
				{
					if ((func_42(&uLocal_194, cLocal_103, "REMG2_FKIT", 4, 0, 0, 0) || func_58()) || func_58())
					{
						...
						BRAIN::TASK_SMART_FLEE_COORD(iLocal_63, vLocal_145, 250f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_63, true);
						func_274();
					}
				}
...
void func_200()//Position - 0xB2C8
{
	Global_14732 = 0;
	func_52();
}

int func_201()//Position - 0xB2D8
{
	if (!PED::IS_PED_INJURED(iLocal_62) && !PED::IS_PED_INJURED(iLocal_63))
	{
...
void func_205()//Position - 0xB4AF
{
	if (!PED::IS_PED_INJURED(iLocal_62))
	{
		if (!PED::IS_PED_RAGDOLL(iLocal_62))
		{
			if (func_190())
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_62, 242628503) == 7 || BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_62, 474215631) == 7)
				{
					if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
					{
						func_105();
					...
					if (!PED::IS_PED_INJURED(iLocal_63))
					{
						...
						{
							BRAIN::TASK_SMART_FLEE_PED(iLocal_62, iLocal_63, 150f, -1, 0, 0);
						}
					}
					else if (iLocal_47 == 3)
					{
						if (!PED::IS_PED_FLEEING(iLocal_62))
						{
							BRAIN::TASK_SMART_FLEE_COORD(iLocal_62, vLocal_122, 150f, -1, 0, 0);
						}
					}
					PED::SET_PED_KEEP_TASK(iLocal_62, true);
					SYSTEM::WAIT(0);
...
void func_206(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xB5BD
{
	int iVar0;
	int iVar1;
...
void func_209()//Position - 0xB7B7
{
	...
	AUDIO::STOP_PED_SPEAKING(iLocal_62, true);
	PED::_0x570389D1C3DE3C6B(iLocal_62);
	...
	{
		case 0:
			func_211(&uLocal_194, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			break;
		
		case 1:
			func_211(&uLocal_194, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			break;
		
		case 2:
			func_211(&uLocal_194, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			break;
	}
	...
	if (iLocal_90 == 3)
	{
		...
		iLocal_131 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_125, vLocal_128, 2);
		BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_63, iLocal_131, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@BASE", "base", 1000f, -1000f, 0, 0, 1148846080, 0);
	}
	if (iLocal_90 == 4)
	{
...
void func_210()//Position - 0xBA78
{
	...
	BRAIN::TASK_PLAY_ANIM(iLocal_63, cLocal_359, sLocal_365, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(iLocal_62, cLocal_359, sLocal_366, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
}

void func_211(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xBB6E
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_212(var uParam0)//Position - 0xBC09
{
	int iVar0;
...
bool func_213(var uParam0)//Position - 0xBC6D
{
	return func_214(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_214(int iParam0, char* sParam1, int iParam2)//Position - 0xBC84
{
...
int func_215(int iParam0)//Position - 0xBD78
{
	int iVar0;
...
void func_216(var uParam0, int iParam1)//Position - 0xBDA4
{
	func_217(uParam0, 0, iParam1, "NULL", 0);
}

void func_217(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xBDB8
{
	int iVar0;
...
void func_218(var uParam0, char* sParam1)//Position - 0xBEA2
{
	func_217(uParam0, 1, -1, sParam1, 0);
}

void func_219()//Position - 0xBEB5
{
	func_272();
...
void func_222(int iParam0, var uParam1)//Position - 0xC62D
{
	int iVar0;
	int iVar1;
...
void func_223(var uParam0)//Position - 0xC6CC
{
	int iVar0;
...
void func_224(int iParam0)//Position - 0xC75A
{
	func_225(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_225(int iParam0, char* sParam1, int iParam2)//Position - 0xC770
{
	if (MISC::IS_BIT_SET(*iParam0, 30))
	{
		switch (func_215(*iParam0))
...
void func_226(int iParam0)//Position - 0xC84A
{
	if (iParam0 == -1)
	{
		iParam0 = func_191();
...
void func_228(int iParam0)//Position - 0xC8BD
{
	Global_106554 = iParam0;
}

int func_229(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xC8CB
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_230(int iParam0)//Position - 0xCC65
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xCC86
{
	return func_232(iParam0, 1);
}

int func_232(int iParam0, int iParam1)//Position - 0xCC95
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_233(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xCCE8
{
	func_234(func_245(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_234(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xCD06
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_235(float fParam0, float fParam1, float fParam2)//Position - 0xCF07
{
	float fVar0;
...
int func_236(int iParam0, int iParam1)//Position - 0xCF49
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_237(int iParam0)//Position - 0xCFEB
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_238(int iParam0)//Position - 0xCFFE
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_239(int iParam0)//Position - 0xD011
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_240(int iParam0)//Position - 0xD024
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_241(int iParam0)//Position - 0xD036
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_242(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_242(bool bParam0, int iParam1, int iParam2)//Position - 0xD05B
{
	if (bParam0)
	{
		return iParam1;
...
int func_243(int iParam0)//Position - 0xD072
{
	return iParam0 & 15;
}

int func_244(int iParam0, int iParam1)//Position - 0xD07F
{
	int iVar0;
	int iVar1;
...
void func_246(var uParam0, int iParam1)//Position - 0xD1D1
{
	if (iParam1 <= 0)
	{
		return;
...
void func_247(var uParam0, int iParam1)//Position - 0xD257
{
...
void func_248(var uParam0, int iParam1)//Position - 0xD28A
{
	int iVar0;
	int iVar1;
...
void func_249(var uParam0, int iParam1)//Position - 0xD2DB
{
...
void func_250(var uParam0, int iParam1)//Position - 0xD315
{
...
void func_251(var uParam0, int iParam1)//Position - 0xD350
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_252(int iParam0)//Position - 0xD38C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_253(int iParam0, int iParam1)//Position - 0xD468
{
...
int func_254(int iParam0)//Position - 0xD48B
{
	int iVar0;
...
var func_255()//Position - 0xDBA8
{
	return Global_93721.f_1;
}

int func_256()//Position - 0xDBB6
{
	if (Global_90634 != -1)
	{
...
bool func_259()//Position - 0xDC20
{
	return Global_93734.f_340 > 0;
}

bool func_260()//Position - 0xDC31
{
	return Global_93734.f_339 > 0;
}

var func_261()//Position - 0xDC42
{
	return Global_1312867;
}

int func_262()//Position - 0xDC4E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_264(int iParam0)//Position - 0xDC92
{
	return func_244(func_245(), iParam0);
}

int func_265(int iParam0, int iParam1, int iParam2)//Position - 0xDCA4
{
	int iVar0;
	int iVar1;
...
int func_266(int iParam0)//Position - 0xDD88
{
	if (!func_124(iParam0))
	{
		return 7;
...
bool func_267(int iParam0)//Position - 0xDDAC
{
	int iVar0;
	bool bVar1;
...
bool func_270(int iParam0)//Position - 0xDF09
{
...
bool func_271(int iParam0)//Position - 0xDF37
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
void func_273(var uParam0, int iParam1)//Position - 0xDFE4
{
	if (iParam1 > 0)
	{
...
void func_274()//Position - 0xDFFC
{
	if (iLocal_156)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_63))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				BRAIN::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
			}
			PED::SET_PED_KEEP_TASK(iLocal_63, true);
			if (!bLocal_60)
			{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_62))
		{
			if (!PED::IS_PED_INJURED(iLocal_62))
			{
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_62, -1146898486) == 7 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_62, 242628503) == 7)
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_121);
					...
					BRAIN::TASK_SMART_FLEE_COORD(0, vLocal_122, 250f, -1, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_121);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_62, iLocal_121);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_121);
					PED::SET_PED_KEEP_TASK(iLocal_62, true);
...
void func_275(var uParam0, bool bParam1)//Position - 0xE1A0
{
	int iVar0;
...
void func_276(var uParam0)//Position - 0xE1E3
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_277(var uParam0)//Position - 0xE1FC
{
	int iVar0;
...
void func_278(var uParam0)//Position - 0xE236
{
	func_279(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_279(int iParam0, char* sParam1, int iParam2)//Position - 0xE24D
{
	if (MISC::IS_BIT_SET(iParam0, 30))
	{
		switch (func_215(iParam0))
...
void func_280(int iParam0)//Position - 0xE30D
{
	char cVar0[64];
...
void func_281(var uParam0)//Position - 0xE3C2
{
	if (*uParam0 == -1)
	{
		return;
...
int func_282(int iParam0)//Position - 0xE3FF
{
	int iVar0;
...
char* func_283(int iParam0, bool bParam1)//Position - 0xE4B0
{
	switch (iParam0)
	{
		case 0:
...
void func_284(int iParam0)//Position - 0xE6F9
{
	Global_36976 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_285(int iParam0)//Position - 0xE70B
{
	func_286(iParam0, 0, func_291(iParam0));
}

void func_286(int iParam0, int iParam1, int iParam2)//Position - 0xE720
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_287(var uParam0)//Position - 0xE74F
{
	struct<16> Var0;
	int iVar16;
...
void func_288(int iParam0, var uParam1)//Position - 0xE81E
{
	Global_106565.f_24989.f_43[iParam0] = *uParam1;
}

void func_289(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE836
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_290(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE9B8
{
...
int func_291(int iParam0)//Position - 0xE9F0
{
	int iVar0;
...
void func_292(int iParam0, int iParam1)//Position - 0xEB93
{
	if (iParam0 == -1)
	{
		iParam0 = func_191();
...
void func_293(int iParam0, var uParam1, var uParam2)//Position - 0xEC97
{
	bool bVar0;
...
int func_295()//Position - 0xF240
{
	return Global_25765;
}

int func_296(int iParam0, int iParam1)//Position - 0xF24B
{
	switch (iParam0)
	{
		case 0:
...
void func_297(int iParam0)//Position - 0xF5BF
{
	int iVar0;
	int iVar1;
...
void func_298(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xF601
{
	func_299(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_299(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xF621
{
	int iVar0;
...
int func_301(int iParam0)//Position - 0xF913
{
	int iVar0;
	int iVar1;
...
void func_302(int iParam0, int iParam1)//Position - 0xF956
{
