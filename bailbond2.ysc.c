...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_514())
	{
		...
		switch (iVar0)
		{
			case 0:
				...
				{
					func_441(&iLocal_713, 225.012f, 2310.695f, 77.257f, 218.1301f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				else
				{
					func_441(&iLocal_713, 232.0044f, 2314.844f, 76.9871f, 173.0429f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
			...
			case 1:
				func_441(&iLocal_713, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
	...
	else if (func_428(0))
	{
		...
		{
			func_426(PLAYER::PLAYER_PED_ID(), vLocal_698, fLocal_458, 0, 0);
		...
		switch (iLocal_98)
		{
			case 0:
				if (iLocal_100 == 1)
				{
					if (!func_70())
					{
						func_19(PLAYER::PLAYER_PED_ID(), vLocal_701, fLocal_459, 0, 1);
			...
			case 1:
				...
				if (iLocal_100 == 1)
				{
					if (!func_70())
					{
						func_19(PLAYER::PLAYER_PED_ID(), vLocal_704, fLocal_460, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_443 == 0)
						{
			...
			case 3:
				...
				if (iLocal_100 == 1)
				{
					...
					if (!func_70())
					{
						func_426(PLAYER::PLAYER_PED_ID(), vLocal_689, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_443 == 0)
						{
...
void func_10(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7F6
{
	var uVar0;
	int iVar1;
...
void func_18(int iParam0, struct<2> Param1, float fParam3)//Position - 0xA28
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_19(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0xA87
{
	bool bVar0;
	float fVar1;
...
void func_26(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xC83
{
	if (bParam0)
	{
...
bool func_27()//Position - 0xDBC
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_28(int iParam0, int iParam1)//Position - 0xDD9
{
	bool bVar0;
...
int func_29(int iParam0, bool bParam1)//Position - 0xE24
{
	int iVar0;
	int iVar1;
...
int func_30()//Position - 0xE65
{
	return Global_1312745;
}

int func_31(int iParam0)//Position - 0xE71
{
...
bool func_32()//Position - 0xEB3
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_33(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xEC4
{
	int iVar0;
...
void func_34(int iParam0)//Position - 0xEF7
{
	if (iParam0 == 1)
	{
...
void func_37(int iParam0, bool bParam1)//Position - 0x112B
{
	if (bParam1)
	{
		func_39(iParam0);
...
void func_38(int iParam0, bool bParam1)//Position - 0x1148
{
...
void func_39(int iParam0)//Position - 0x1183
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
char* func_40()//Position - 0x11AE
{
	return "special_ped@maude@base";
}

void func_41(int iParam0, bool bParam1)//Position - 0x11B9
{
	if (bParam1)
	{
		func_43(iParam0);
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11D8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_43(int iParam0)//Position - 0x1228
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_44()//Position - 0x1269
{
	return 2057223314;
}

float func_45()//Position - 0x1276
{
	return -92.17f;
}

Vector3 func_46()//Position - 0x1283
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_47()//Position - 0x129A
{
	return -380698483;
}

void func_48()//Position - 0x12A7
{
	int iVar0;
	int iVar1;
...
char* func_49()//Position - 0x1393
{
	return "base_chair";
}

char* func_50()//Position - 0x139E
{
	return "base";
}

Vector3 func_51()//Position - 0x13A9
{
	return 0f, 0f, -92.17f;
}

Vector3 func_52()//Position - 0x13B8
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_53(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x13CF
{
...
void func_54(int iParam0, bool bParam1)//Position - 0x1451
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_55(int iParam0)//Position - 0x147C
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_56(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x14A2
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_55(iParam1))
...
int func_57(int iParam0)//Position - 0x150D
{
	switch (iParam0)
	{
		case 0:
...
bool func_58(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x1578
{
	return SYSTEM::VDIST2(vParam0, vParam3) <= (fParam6 * fParam6);
}

int func_59(int iParam0, float fParam1, int iParam2)//Position - 0x1592
{
	int iVar0;
...
int func_63(int iParam0, int iParam1)//Position - 0x16FC
{
	if (func_22(iParam0))
	{
...
int func_64(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x172F
{
...
void func_65(int iParam0)//Position - 0x18BE
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_67(char* sParam0)//Position - 0x192C
{
	func_26(1, 1, 0, 0, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x1946
{
	if (func_514() && func_70())
	{
...
void func_69(int iParam0)//Position - 0x1A0A
{
	if (iParam0 == 1)
	{
...
bool func_70()//Position - 0x1A33
{
	return MISC::IS_BIT_SET(Global_93682.f_20, 13);
}

void func_71()//Position - 0x1A47
{
	char* sVar0;
	int iVar1;
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_22(Local_385))
				{
					...
					{
						if (func_105(Local_385, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
				...
				if (iLocal_102 == 4)
				{
					...
					else if (func_22(Local_385))
					{
						if (!func_63(Local_385, 1805844857))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_385, func_102(), func_73(), 3))
								{
									func_72(&Local_385);
...
void func_72(int iParam0)//Position - 0x1CFD
{
	if (func_22(*iParam0))
	{
...
char* func_73()//Position - 0x1D66
{
	return "female_Flee_Table_Left_Maude";
}

int func_74(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D71
{
	if (iParam4 == 0)
	{
...
bool func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1DAE
{
...
int func_76(char* sParam0, int iParam1, bool bParam2)//Position - 0x1DFC
{
	Global_15867 = 0;
...
int func_81()//Position - 0x22C9
{
	func_82();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_82()//Position - 0x22E2
{
	int iVar0;
...
bool func_83(int iParam0)//Position - 0x23DF
{
	return iParam0 < 3;
}

int func_84(int iParam0)//Position - 0x23EB
{
	int iVar0;
	int iVar1;
...
int func_85(int iParam0)//Position - 0x2428
{
	if (func_83(iParam0))
	{
...
bool func_86(int iParam0)//Position - 0x2452
{
	return Global_36425 == iParam0;
}

void func_87()//Position - 0x2460
{
	int iVar0;
...
bool func_88(int iParam0, int iParam1)//Position - 0x24B7
{
	switch (iParam0)
	{
		case 5:
...
void func_89(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x24F2
{
...
void func_90(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2548
{
...
void func_91(bool bParam0)//Position - 0x25E3
{
	int iVar0;
...
void func_92(int iParam0, bool bParam1)//Position - 0x27B7
{
	if (bParam1)
	{
		func_94(iParam0);
...
void func_93(int iParam0)//Position - 0x27D3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_94(int iParam0)//Position - 0x280B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_95(int iParam0)//Position - 0x28A7
{
	if (func_427(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_96(var uParam0)//Position - 0x28D1
{
...
void func_98(char* sParam0)//Position - 0x2917
{
...
void func_99(int iParam0, bool bParam1)//Position - 0x2956
{
	if (func_22(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, 0);
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x29D1
{
	int iVar0;
...
char* func_101()//Position - 0x2B1D
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_102()//Position - 0x2B29
{
	return "special_ped@maude@exit_flee";
}

void func_103(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2B35
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_104(iParam3), 0);
}

int func_104(int iParam0)//Position - 0x2B4E
{
	int iVar0;
...
bool func_105(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2D43
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1) <= (fParam4 * fParam4);
}

void func_106(int iParam0, bool bParam1)//Position - 0x2D60
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_107(var uParam0, int iParam1)//Position - 0x2DD1
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_109(int iParam0)//Position - 0x2E12
{
	bool bVar0;
	struct<8> Var1;
...
void func_110(int iParam0)//Position - 0x2E84
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_111(int iParam0)//Position - 0x2EA4
{
	int iVar0;
...
bool func_113(int iParam0, int iParam1)//Position - 0x3072
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_114(int iParam0)//Position - 0x3084
{
	if (func_22(Local_132[iParam0 /*20*/]))
	{
		BRAIN::CLEAR_PED_SECONDARY_TASK(Local_132[iParam0 /*20*/]);
		BRAIN::CLEAR_PED_TASKS(Local_132[iParam0 /*20*/]);
		BRAIN::TASK_CLEAR_LOOK_AT(Local_132[iParam0 /*20*/]);
		...
		BRAIN::TASK_LOOK_AT_ENTITY(Local_132[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
		BRAIN::TASK_COMBAT_PED(Local_132[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 0, 16);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iParam0 /*20*/], 0);
		Local_132[iParam0 /*20*/].f_14 = 2;
	}
}

void func_115(int iParam0)//Position - 0x31DB
{
	func_23(500, 1);
...
void func_116(int iParam0, int iParam1, int iParam2)//Position - 0x3210
{
	bool bVar0;
...
int func_119()//Position - 0x3804
{
	return Global_25765;
}

int func_120(int iParam0, int iParam1)//Position - 0x380F
{
	int iVar0;
...
int func_121(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3860
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(int iParam0)//Position - 0x3E16
{
	int iVar0;
...
void func_124(int iParam0)//Position - 0x4164
{
	iLocal_98 = iParam0;
	iLocal_100 = 0;
}

void func_125(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x4173
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_177(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_174(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_126(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x41EE
{
	struct<60> Var0;
...
void func_127(int iParam0, int iParam1, int iParam2)//Position - 0x4317
{
	int iVar0;
...
void func_128(int iParam0, int iParam1)//Position - 0x4434
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0x4636
{
...
int func_130(int iParam0)//Position - 0x4713
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_131(int iParam0, bool bParam1)//Position - 0x48C4
{
	int iVar0;
	struct<2> Var1;
...
int func_132(int iParam0)//Position - 0x4A44
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_134(int iParam0)//Position - 0x4B27
{
	int iVar0;
	int iVar1;
...
int func_135()//Position - 0x6B94
{
	return 0;
}

int func_136()//Position - 0x6B9D
{
	return 1;
}

int func_137()//Position - 0x6BA6
{
	return 1;
}

int func_138()//Position - 0x6BAF
{
...
int func_140(int iParam0)//Position - 0x6C83
{
	int iVar0;
	char* sVar1;
...
int func_142(int iParam0)//Position - 0x6D04
{
	int iVar0;
...
int func_143(int iParam0)//Position - 0x6D80
{
	int iVar0;
...
int func_144(int iParam0, int iParam1, bool bParam2)//Position - 0x6E68
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_145(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x6ED9
{
...
void func_147(var uParam0, int iParam1)//Position - 0x6FF7
{
	if (iParam1 <= 0)
	{
		return;
...
void func_148(var uParam0, int iParam1)//Position - 0x707D
{
...
void func_149(var uParam0, int iParam1)//Position - 0x70B0
{
	int iVar0;
	int iVar1;
...
int func_150(int iParam0, int iParam1)//Position - 0x7101
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_151(int iParam0)//Position - 0x71A3
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_152(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_152(bool bParam0, int iParam1, int iParam2)//Position - 0x71C8
{
	if (bParam0)
	{
		return iParam1;
...
int func_153(var uParam0)//Position - 0x71DF
{
	return uParam0 & 15;
}

void func_154(var uParam0, int iParam1)//Position - 0x71EC
{
...
void func_155(var uParam0, int iParam1)//Position - 0x7226
{
...
void func_156(var uParam0, int iParam1)//Position - 0x7261
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_157(var uParam0, int iParam1)//Position - 0x729D
{
	int iVar0;
	int iVar1;
...
int func_158(int iParam0, int iParam1)//Position - 0x8995
{
	struct<82> Var0;
...
void func_159(int iParam0, var uParam1, int iParam2)//Position - 0x89D7
{
	int iVar0;
...
void func_160(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x8C33
{
	if (func_157(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_161(int iParam0, bool bParam1)//Position - 0x8D32
{
	if (iParam0 == -1)
	{
		return;
...
void func_162(int iParam0, int iParam1, bool bParam2)//Position - 0x8D8F
{
	if (iParam0 == -1)
	{
		return;
...
bool func_163(int iParam0, int iParam1)//Position - 0x8DCA
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_164(var uParam0, var uParam1)//Position - 0x8DED
{
...
void func_165(int iParam0)//Position - 0x8EB9
{
	if (iParam0 == -1)
	{
		return;
...
int func_166(int iParam0)//Position - 0x8F33
{
	int iVar0;
...
bool func_167(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x8F96
{
	if (bParam6)
	{
...
void func_168(int iParam0, var uParam1)//Position - 0x8FDD
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0x9288
{
	switch (iParam0)
	{
		case 1:
...
int func_170(int iParam0, var uParam1, var uParam2)//Position - 0x9338
{
	int iVar0;
	int iVar1;
...
int func_171(int iParam0)//Position - 0x952B
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_172(var uParam0)//Position - 0x954B
{
	int iVar0;
...
void func_173(int iParam0)//Position - 0x95FB
{
...
int func_174(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x9622
{
	int iVar0;
...
int func_175(vector3 vParam0, int iParam3, int iParam4)//Position - 0x9738
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_176(int iParam0)//Position - 0x97C7
{
	return MISC::IS_BIT_SET(Global_106565.f_7223[iParam0], 0);
}

int func_177(int iParam0)//Position - 0x97DF
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_178(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x97FB
{
	func_179(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_179(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x9824
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_180(vector3 vParam0)//Position - 0x9C18
{
...
int func_181(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x9C42
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_182(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x9F38
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_183(vector3 vParam0)//Position - 0x9FEC
{
	float fVar0;
	float fVar1;
...
void func_184(int iParam0)//Position - 0xA02B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
bool func_185(vector3 vParam0, int iParam3)//Position - 0xA090
{
	return func_186(Global_97130.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_186(int iParam0, vector3 vParam1, int iParam4)//Position - 0xA0AD
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_187()//Position - 0xA117
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_188()//Position - 0xA12E
{
	return 3.01f, 11.01f, 6.01f;
}

int func_189(var uParam0, var uParam1, var uParam2)//Position - 0xA145
{
...
void func_190(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0xA17C
{
	int iVar0;
...
Vector3 func_191(int iParam0)//Position - 0xA33A
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_192(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA34D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_193(int iParam0, int iParam1, int iParam2)//Position - 0xAB63
{
	int iVar0;
...
int func_194(int iParam0)//Position - 0xABEF
{
	switch (iParam0)
	{
...
void func_195(int iParam0, int iParam1, int iParam2)//Position - 0xAC2A
{
	int iVar0;
	int iVar1;
...
int func_196(int iParam0, int iParam1, int iParam2)//Position - 0xACB4
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_197(int iParam0, int iParam1, int iParam2)//Position - 0xAD92
{
	Global_71402[1 /*14*/] = { func_242(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_198(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xADBD
{
	var uVar0;
	int iVar10;
...
int func_199(int iParam0, int iParam1, int iParam2)//Position - 0xB3C1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB45A
{
	int iVar0;
...
int func_201(int iParam0, int iParam1, int iParam2)//Position - 0xB4F0
{
	int iVar0;
	int iVar1;
...
int func_202(int iParam0)//Position - 0xB591
{
	switch (iParam0)
	{
		case 0:
...
int func_203(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB641
{
	int iVar0;
...
int func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB948
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_205(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xC4FB
{
	int iVar0;
...
int func_206(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC7DF
{
	int iVar0;
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCAA6
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCADD
{
	int iVar0;
...
int func_209(int iParam0, int iParam1, int iParam2)//Position - 0xCB06
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCDD0
{
	int iVar0;
...
int func_211(int iParam0, int iParam1, int iParam2)//Position - 0xD05A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_212(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD1B1
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD249
{
	switch (iParam0)
	{
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD317
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_202(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_215(int iParam0, int iParam1)//Position - 0xD473
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_216(int iParam0)//Position - 0xD81A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD87B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_218(int iParam0, int iParam1)//Position - 0xD977
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDAB5
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_202(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_220(int iParam0)//Position - 0xDB95
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_221(int iParam0, int iParam1)//Position - 0xDC1B
{
	int iVar0;
	struct<10> Var1;
...
void func_222(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE54A
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_223(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xE674
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_224(int iParam0, int iParam1)//Position - 0xE6BC
{
	int iVar0;
	struct<17> Var1;
...
void func_225(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10505
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_226(int iParam0)//Position - 0x106EF
{
	switch (iParam0)
	{
		case 0:
...
void func_227(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1079F
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10810
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_229(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10A8D
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_230(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10EB2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_231(int iParam0, int iParam1)//Position - 0x111A5
{
	int iVar0;
	int iVar1;
...
int func_232(int iParam0, int iParam1)//Position - 0x111EB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_233(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1124B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_234(int iParam0)//Position - 0x112CF
{
...
void func_235(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x11387
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_236(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x113D1
{
	int iVar0;
...
int func_237(var uParam0)//Position - 0x11401
{
	int iVar0;
	int iVar1;
...
int func_238(int iParam0, int iParam1, int iParam2)//Position - 0x11435
{
	int iVar0;
	var uVar1;
...
bool func_239(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x11467
{
	int iVar0;
...
int func_240(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x13238
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_241(int iParam0)//Position - 0x14158
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_242(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x141A9
{
	func_305();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_243(int iParam0, int iParam1)//Position - 0x141FB
{
	switch (iParam0)
	{
		case 0:
...
void func_244(int iParam0)//Position - 0x142EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_245(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x15562
{
	int iVar0;
	int iVar1;
...
bool func_246(int iParam0, int iParam1, var uParam2)//Position - 0x158F3
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_247(int iParam0, int iParam1)//Position - 0x15CF8
{
	switch (iParam1)
	{
		case 0:
...
int func_248(int iParam0, int iParam1)//Position - 0x160F3
{
	switch (iParam1)
	{
		case 0:
...
int func_249(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x164EE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_250(int iParam0)//Position - 0x16530
{
	switch (iParam0)
	{
		case -1:
...
void func_251(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x16604
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_245(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_245(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_202(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_252(int iParam0)//Position - 0x168DD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_253(int iParam0)//Position - 0x16A34
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_254(int iParam0)//Position - 0x16F42
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(int iParam0)//Position - 0x16FB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_256(int iParam0)//Position - 0x1702B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_257(int iParam0)//Position - 0x17112
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_258(int iParam0)//Position - 0x17475
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_259(int iParam0)//Position - 0x17686
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0)//Position - 0x178B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_261(int iParam0)//Position - 0x179C6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x18366
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x18ED9
{
	if (iParam0 < 136)
	{
		func_265(iParam0);
...
void func_264(int iParam0)//Position - 0x18F0E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x19B12
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x1AA20
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x1AB4D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0, int iParam1)//Position - 0x1AC4B
{
	switch (iParam0)
	{
		case 0:
...
void func_269(int iParam0)//Position - 0x1AD3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x1C22D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x1C37E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1C889
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1CEF7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1CF6B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1D03B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1D56B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1D702
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1DF00
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1E010
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1EF3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1FBF8
{
	if (iParam0 < 107)
	{
		func_284(iParam0);
...
void func_282(int iParam0)//Position - 0x1FC3E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x206E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x214D4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x2211D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x22396
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0, int iParam1)//Position - 0x224DC
{
	switch (iParam0)
	{
		case 0:
...
void func_288(int iParam0)//Position - 0x225CC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x23356
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x234D0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x23A47
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x23F71
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x23FE5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x240B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x2458F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x247F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x24ACE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x24C97
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x257EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x26435
{
	if (iParam0 < 60)
	{
		func_302(iParam0);
...
void func_301(int iParam0)//Position - 0x2646A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x2720A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x27896
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x2797D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305()//Position - 0x27A7B
{
...
int func_306(int iParam0, int iParam1, int iParam2)//Position - 0x27AF4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_307(bool bParam0)//Position - 0x27D4F
{
	int iVar0;
...
void func_308()//Position - 0x27D8D
{
	bool bVar0;
	vector3 vVar1;
				...
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_113(iLocal_463, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_112.f_9, vLocal_692, 30f))
									{
...
int func_309(var uParam0)//Position - 0x2826A
{
	vector3 vVar0;
...
int func_310(var uParam0)//Position - 0x282AF
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
bool func_311(char* sParam0, int iParam1, int iParam2)//Position - 0x282E7
{
...
void func_312(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x28305
{
...
void func_313(char* sParam0, int iParam1, int iParam2)//Position - 0x283B1
{
	iParam2 = iParam2;
...
int func_314(char* sParam0, bool bParam1)//Position - 0x283CA
{
	struct<6> Var0;
...
struct<6> func_315()//Position - 0x28405
{
	struct<6> Var0;
...
void func_316(int iParam0, vector3 vParam1, int iParam4, float fParam5)//Position - 0x28429
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_317(var uParam0, int iParam1, int iParam2)//Position - 0x2850E
{
	char* sVar0;
...
int func_318(char* sParam0)//Position - 0x285EB
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_319()//Position - 0x285FE
{
	if (func_22(Local_112.f_9))
	{
...
int func_320(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x286F9
{
	int iVar0;
...
int func_321(int iParam0, vector3 vParam1, float fParam4, float fParam5)//Position - 0x2886F
{
	if (func_105(iParam0, vParam1, fParam4))
	{
...
int func_322(int iParam0, vector3 vParam1)//Position - 0x288A7
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
void func_323(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x28905
{
	func_324(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_324(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x2891F
{
	func_325(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_325(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2893C
{
	...
	uParam0->f_6 = 2;
	func_326(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_326(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x28974
{
	int iVar0;
	int iVar1;
	...
	if (func_350(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_342(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_327(var uParam0)//Position - 0x28CE1
{
...
int func_328(var uParam0)//Position - 0x28D4A
{
	int iVar0;
...
int func_329(bool bParam0)//Position - 0x28D75
{
	switch (Global_36425)
	{
		case 0:
...
void func_330(char* sParam0, int iParam1)//Position - 0x28E1F
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_331(char* sParam0)//Position - 0x28E36
{
	if (!func_332(1, 1, 0))
	{
...
int func_332(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28ECF
{
	int iVar0;
	int iVar1;
...
int func_333(int iParam0)//Position - 0x29128
{
	if (iParam0 != func_335())
	{
...
int func_334(int iParam0, bool bParam1, bool bParam2)//Position - 0x2918E
{
	int iVar0;
...
int func_335()//Position - 0x291D8
{
	return -1;
}

int func_336(int iParam0, int iParam1)//Position - 0x291E1
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_337(int iParam0, int iParam1)//Position - 0x29243
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_338()//Position - 0x292C8
{
	return Global_2448756.f_16;
}

bool func_339(int iParam0)//Position - 0x292D6
{
	return iParam0 == 51;
}

var func_340()//Position - 0x292E3
{
	return Global_2448756.f_15;
}

bool func_341()//Position - 0x292F1
{
	return MISC::GET_GAME_TIMER() <= Global_17411.f_5878 + 100;
}

void func_342(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x29306
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_343()//Position - 0x29416
{
	return func_344(PLAYER::PLAYER_ID());
}

int func_344(int iParam0)//Position - 0x29426
{
...
int func_345(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x29445
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_346(bool bParam0, bool bParam1, bool bParam2)//Position - 0x297B1
{
...
int func_347(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29803
{
	if (!func_332(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_348(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2984C
{
	if (!func_332(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_349(bool bParam0, bool bParam1, bool bParam2)//Position - 0x298AB
{
	if (!func_332(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_350(int iParam0)//Position - 0x29901
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_351()//Position - 0x2995C
{
	MISC::SET_BIT(&Global_2424, 4);
}

void func_352(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2996C
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_353(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x29A67
{
	int iVar0;
	bool bVar1;
...
void func_354(int iParam0)//Position - 0x29AB9
{
...
void func_355(var uParam0, vector3 vParam1)//Position - 0x29B08
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_356()//Position - 0x29BE5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_22(Local_112.f_9))
	{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
				...
				case 3:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
				...
				case 7:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 1000)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::_0xF1C03A5352243A30(Local_112.f_9);
				...
				case 29:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						BRAIN::TASK_COMBAT_PED(Local_112.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						BRAIN::TASK_SET_SPHERE_DEFENSIVE_AREA(Local_112.f_9, vLocal_695, 30f);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
						Local_112.f_10 = 30;
					}
					break;
				...
				case 13:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::_0xFE07FF6495D52E2A(Local_112.f_9, vLocal_692);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, 1);
						if (iVar0 != joaat("weapon_unarmed"))
						{
				...
				case 15:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], 0) && func_105(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) && func_363(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
						{
							if (PED::IS_PED_IN_VEHICLE(Local_112.f_9, Local_254[0 /*6*/], 0) && !PED::IS_PED_BEING_JACKED(Local_112.f_9))
							{
								Local_112.f_10 = 16;
							}
							else if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
								{
									PED::_0xFE07FF6495D52E2A(Local_112.f_9, vLocal_692);
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_105(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) || !func_363(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
					{
						Local_112.f_10 = 13;
					}
...
bool func_357(int iParam0, int iParam1)//Position - 0x2AD50
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_358()//Position - 0x2AD62
{
	int iVar0;
	int iVar1;
...
var func_359()//Position - 0x2ADE8
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_360()//Position - 0x2ADF8
{
	if (!iLocal_418)
	{
		return 1;
...
int func_361(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2AE65
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (func_22(iParam0))
	{
		...
		if (func_105(iParam0, vLocal_692, fParam2))
		{
...
int func_362(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2B01B
{
	int iVar0;
...
int func_363(float fParam0, float fParam1, float fParam2)//Position - 0x2B112
{
...
char* func_364()//Position - 0x2B12E
{
	return "move_m@bail_bond_not_tazered";
}

char* func_365()//Position - 0x2B13A
{
	return "move_m@bail_bond_tazered";
}

int func_366()//Position - 0x2B146
{
...
void func_367(var uParam0, bool bParam1)//Position - 0x2B17B
{
...
void func_368(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2B192
{
	if (func_427(iParam0))
	{
...
bool func_369(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2B1BE
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_370(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2B27F
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_371(int iParam0, int iParam1)//Position - 0x2B3AB
{
	int iVar0;
...
int func_373(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2B4BA
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_374(vector3 vParam0, vector3 vParam3)//Position - 0x2B54B
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

int func_375(int iParam0, int iParam1)//Position - 0x2B56C
{
	int iVar0;
...
void func_376(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2B5AB
{
	if (func_427(iParam0))
	{
...
void func_377()//Position - 0x2B5D7
{
	if (func_58(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_689, 100f))
	{
		if (!func_378())
		{
	...
	{
		if (!func_58(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_689, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
bool func_378()//Position - 0x2B661
{
	return Global_91021;
}

void func_379()//Position - 0x2B66D
{
	func_36();
	func_377();
	if (func_22(Local_112.f_9))
...
void func_380()//Position - 0x2B969
{
	int iVar0;
	int iVar1;
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_63(Local_112.f_9, -1519143300))
				{
					if (func_105(Local_112.f_9, vLocal_692, 25f))
					{
						...
						{
							if (func_113(iLocal_464, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_3();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_113(iLocal_463, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_112.f_9, vLocal_692, 20f))
							{
...
int func_381(int iParam0)//Position - 0x2BDE5
{
	int iVar0;
...
void func_382(char* sParam0, int iParam1)//Position - 0x2BE1E
{
	if (func_318(sParam0))
	{
...
void func_383(int iParam0)//Position - 0x2BE35
{
...
void func_384()//Position - 0x2BE70
{
	func_36();
	func_377();
	if (func_22(Local_112.f_9))
				...
				if (!iLocal_449)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_456))
						{
							if (iLocal_436)
							{
								iLocal_456 = func_389(vLocal_689, 5, 1);
							}
						}
						if (!iLocal_419)
						{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_105(PLAYER::PLAYER_PED_ID(), vLocal_689, 6.5f))
							{
								iLocal_100 = 2;
							}
						}
						else if (func_105(PLAYER::PLAYER_PED_ID(), vLocal_689, 2.5f))
						{
							iLocal_100 = 2;
						}
					}
...
int func_385(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2C25F
{
	int iVar0;
...
bool func_386(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2C351
{
	vector3 vVar0;
...
int func_387(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6)//Position - 0x2C37B
{
	vector3 vVar0;
	var uVar3;
	char[] cVar168[8];
...
void func_388(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2C407
{
...
int func_389(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2C442
{
	int iVar0;
...
void func_390()//Position - 0x2C470
{
	bool bVar0;
		...
		switch (iLocal_100)
		{
			...
			case 1:
				...
				if (!iLocal_448)
				{
					...
					else if ((iLocal_468 > 0 && func_105(Local_112.f_9, vLocal_692, 85f)) || ENTITY::GET_ENTITY_HEALTH(Local_112.f_9) < 200)
					{
						Local_112.f_10 = 13;
						Local_112.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						iLocal_475 = MISC::GET_GAME_TIMER();
					...
					{
						if (func_113(iLocal_463, MISC::GET_RANDOM_INT_IN_RANGE(3500, 7000)))
						{
							if (func_105(Local_112.f_9, vLocal_692, 30f))
							{
								if (MISC::GET_RANDOM_INT_IN_RANGE(0, 101) < 30)
...
void func_391(bool bParam0, var uParam1)//Position - 0x2C951
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_392(int iParam0)//Position - 0x2CA3E
{
	int iVar0;
...
void func_393(int iParam0)//Position - 0x2CA87
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_394(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x2CC11
{
	if (iParam3 == 0)
	{
...
void func_395(int iParam0)//Position - 0x2CDE8
{
	int iVar0;
...
void func_396()//Position - 0x2CE27
{
	if (func_22(Local_112.f_9))
	{
...
void func_397(bool bParam0)//Position - 0x2D306
{
...
void func_398()//Position - 0x2D32A
{
	Global_14732 = 0;
	func_399();
}

void func_399()//Position - 0x2D33A
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_400()//Position - 0x2D35E
{
	if (!iLocal_431)
	{
		if (!func_61())
...
struct<6> func_401()//Position - 0x2D483
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
int func_402(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2D52F
{
	if (iParam5 == 0)
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
...
bool func_403(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2D56C
{
...
int func_404(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2D5C0
{
	if (func_427(iParam0))
	{
		if (!func_357(iParam1, 10))
...
int func_405(var uParam0)//Position - 0x2D626
{
...
int func_406(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2D640
{
	vector3 vVar0;
	float fVar3;
...
void func_407()//Position - 0x2D66F
{
	switch (iLocal_100)
	{
		case 0:
...
void func_408(var uParam0, var uParam1)//Position - 0x2D89C
{
	if (!uParam0->f_7)
	{
...
char* func_409(int iParam0)//Position - 0x2D92D
{
	switch (iParam0)
	{
		case 0:
...
char* func_410(int iParam0)//Position - 0x2D972
{
	switch (iParam0)
	{
		case 0:
...
int func_411(int iParam0, int iParam1, int iParam2)//Position - 0x2D9B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_412(int iParam0)//Position - 0x2DA9F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_413(int iParam0)//Position - 0x2DB03
{
	switch (iParam0)
	{
		case 0:
...
void func_414()//Position - 0x2DB40
{
	if (bLocal_442)
	{
...
void func_415()//Position - 0x2DB9D
{
	if (bLocal_442)
	{
...
void func_416()//Position - 0x2DBE7
{
...
int func_417(bool bParam0)//Position - 0x2DD26
{
	if (func_22(Local_385))
	{
...
int func_418(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2DE7E
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_419(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2DF79
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_420(int iParam0, float fParam1)//Position - 0x2E085
{
	var uVar0;
	vector3 vVar1;
...
int func_421(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x2E11A
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_422(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2E1A8
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_423(int iParam0, float fParam1)//Position - 0x2E1F0
{
	float fVar0;
...
bool func_424(int iParam0, float fParam1)//Position - 0x2E266
{
	return func_369(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_425(int iParam0)//Position - 0x2E27E
{
...
void func_426(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2E2A6
{
...
int func_427(int iParam0)//Position - 0x2E2D4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
bool func_428(bool bParam0)//Position - 0x2E2F5
{
...
void func_429(int iParam0, bool bParam1)//Position - 0x2E320
{
	func_439(bParam1, 1);
	if (bParam1)
	{
...
void func_430()//Position - 0x2E3AF
{
	func_431(1, 0);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_431(bool bParam0, bool bParam1)//Position - 0x2E421
{
	HUD::CLEAR_PRINTS();
	if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
...
void func_432(bool bParam0)//Position - 0x2E53F
{
	if (bParam0)
	{
...
void func_433()//Position - 0x2E565
{
	STREAMING::REMOVE_ANIM_SET(func_364());
	STREAMING::REMOVE_ANIM_SET(func_365());
}

void func_434(bool bParam0, int iParam1, int iParam2)//Position - 0x2E57D
{
	bool bVar0;
...
void func_435(int iParam0)//Position - 0x2E5DC
{
	Global_91018 = iParam0;
}

void func_436(bool bParam0)//Position - 0x2E5EA
{
	if (bParam0)
	{
...
void func_437(bool bParam0)//Position - 0x2E6C6
{
	if (bParam0)
	{
		func_438();
...
void func_438()//Position - 0x2E729
{
...
void func_439(bool bParam0, bool bParam1)//Position - 0x2E752
{
	if (bParam0)
	{
		func_434(0, 1, 1);
...
void func_440(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2E785
{
	if (func_514())
	{
...
void func_441(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2E81A
{
	int iVar0;
...
int func_442(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x2E9AE
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_443(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2F7F2
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_444(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x30408
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_445(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x3047B
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_446(int iParam0)//Position - 0x3196D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_447(int iParam0, bool bParam1, var uParam2)//Position - 0x31A1D
{
	int iVar0;
	bool bVar1;
...
int func_448(int iParam0)//Position - 0x31B8B
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_449(int iParam0)//Position - 0x31BD2
{
	switch (iParam0)
	{
		case 0:
...
int func_450(int iParam0)//Position - 0x31F62
{
...
int func_451(int iParam0)//Position - 0x31FA4
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_452(int iParam0)//Position - 0x32037
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_453(int iParam0)//Position - 0x3207E
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_454(int iParam0)//Position - 0x320C4
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_455(int iParam0)//Position - 0x320F9
{
...
int func_456(int iParam0)//Position - 0x32128
{
...
int func_457(int iParam0)//Position - 0x321E5
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_458(int iParam0)//Position - 0x3221B
{
	switch (iParam0)
	{
		case 562680400:
...
int func_459(int iParam0, bool bParam1)//Position - 0x32274
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_460(int iParam0)//Position - 0x322CF
{
	int iVar0;
...
int func_461(int iParam0, int iParam1)//Position - 0x32309
{
	if (iParam1 == 0)
	{
...
bool func_462()//Position - 0x3267D
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_463()//Position - 0x3268E
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_464()//Position - 0x3269F
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_465()//Position - 0x326B0
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_466()//Position - 0x326C1
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_467()//Position - 0x326D2
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_468(int iParam0, int iParam1)//Position - 0x326E3
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_469(int iParam0)//Position - 0x32A59
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_470(int iParam0)//Position - 0x32AB8
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_471(int iParam0)//Position - 0x32B18
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_472(int iParam0, bool bParam1, var uParam2)//Position - 0x32B5F
{
	bool bVar0;
...
int func_473(int iParam0)//Position - 0x32F84
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_474(int iParam0, int iParam1)//Position - 0x32FAD
{
	int iVar0;
...
void func_475(int iParam0)//Position - 0x3302F
{
	if (!func_476(*iParam0))
	{
...
bool func_476(int iParam0)//Position - 0x3305A
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_477(int iParam0, var uParam1, var uParam2)//Position - 0x33069
{
	int iVar0;
	int iVar1;
...
int func_478(int iParam0)//Position - 0x3322C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_479(var uParam0)//Position - 0x33308
{
...
int func_480(int iParam0, int iParam1)//Position - 0x33348
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_481(var uParam0, int iParam1)//Position - 0x3342D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_482(int iParam0, int iParam1)//Position - 0x3346E
{
	int iVar0;
...
void func_483(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x3350C
{
	int iVar0;
...
void func_484(int iParam0)//Position - 0x3355C
{
	bool bVar0;
...
int func_485(int iParam0, int iParam1)//Position - 0x336CE
{
	int iVar0;
...
int func_486(var uParam0)//Position - 0x33740
{
	return *uParam0;
}

int func_487(vector3 vParam0, float fParam3)//Position - 0x3374B
{
	return func_488(&(Global_100114.f_2890), vParam0, fParam3, 0);
}

int func_488(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x33765
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_489(int iParam0)//Position - 0x33A17
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_490(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x33ADA
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_167(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_491(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x33CE2
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_492(int iParam0, int iParam1, bool bParam2)//Position - 0x33D5D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_493(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x33DBE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_494(int iParam0, int iParam1)//Position - 0x3430F
{
	int iVar0;
	int iVar1;
...
bool func_495()//Position - 0x34387
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_496(int iParam0)//Position - 0x34398
{
	int iVar0;
...
int func_497(int iParam0)//Position - 0x343E3
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_498(int iParam0)//Position - 0x3446A
{
...
int func_499(int iParam0)//Position - 0x34499
{
...
int func_500(int iParam0)//Position - 0x344B6
{
...
int func_501(int iParam0, int iParam1)//Position - 0x344D9
{
...
int func_502(int iParam0)//Position - 0x34514
{
	if (func_501(iParam0, 0))
	{
...
int func_503(int iParam0, int iParam1)//Position - 0x34537
{
	int iVar0;
...
int func_504(var uParam0)//Position - 0x34584
{
	if (func_505(uParam0))
	{
...
int func_505(var uParam0)//Position - 0x345B9
{
...
bool func_506()//Position - 0x34618
{
	return func_504(&(Global_100114.f_2890));
}

void func_507()//Position - 0x3462B
{
	func_508(&(Global_100114.f_2890));
}

void func_508(var uParam0)//Position - 0x3463E
{
	if (func_505(uParam0))
	{
...
int func_509(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3465C
{
...
int func_511(int iParam0)//Position - 0x3475F
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_512()//Position - 0x347B8
{
	return func_505(&(Global_100114.f_2890));
}

int func_513()//Position - 0x347CB
{
...
void func_515()//Position - 0x34819
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_516()//Position - 0x3495E
{
	int iVar0;
	...
	while (iVar0 <= 5)
	{
		if (func_22(Local_132[iVar0 /*20*/]))
		{
			...
			if (iVar0 == 0)
			{
				...
				BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_484, 1);
				BRAIN::CLOSE_SEQUENCE_TASK(uLocal_484);
				BRAIN::TASK_PERFORM_SEQUENCE(Local_132[iVar0 /*20*/], uLocal_484);
				BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_484);
				if (func_22(Local_132[iVar0 /*20*/]))
				{
...
void func_517(int iParam0, char* sParam1, int iParam2)//Position - 0x34E10
{
	char cVar0[16];
...
int func_519(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7)//Position - 0x35073
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_55(iParam6))
...
int func_520(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x350E4
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_55(iParam1))
...
Vector3 func_521(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x35183
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_522(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x351F7
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_523()//Position - 0x3526B
{
	int iVar0;
...
float func_524()//Position - 0x356B6
{
	return 75.15f;
}

Vector3 func_525()//Position - 0x356C3
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_526()//Position - 0x356DA
{
	return 71f;
}

Vector3 func_527()//Position - 0x356E7
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_528()//Position - 0x356FE
{
	return 1385417869;
}

float func_529()//Position - 0x3570B
{
	return -91.28f;
}

Vector3 func_530()//Position - 0x35718
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_531()//Position - 0x3572F
{
	return -741944541;
}

float func_532()//Position - 0x3573C
{
	return 89.19f;
}

Vector3 func_533()//Position - 0x35749
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_534(int iParam0)//Position - 0x35760
{
	if (!func_83(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
...
int func_535(bool bParam0)//Position - 0x3578B
{
...
int func_539(int iParam0)//Position - 0x358C3
{
	int iVar0;
...
var func_540()//Position - 0x35FE0
{
	return Global_93721.f_1;
}

int func_541()//Position - 0x35FEE
{
	if (Global_90634 != -1)
	{
...
bool func_542()//Position - 0x36014
{
	return Global_93734.f_340 > 0;
}

bool func_543()//Position - 0x36025
{
	return Global_93734.f_339 > 0;
}

var func_544()//Position - 0x36036
{
	return Global_1312867;
}

bool func_545(int iParam0)//Position - 0x36042
{
	return func_546(iParam0, Global_36425);
}

int func_546(int iParam0, int iParam1)//Position - 0x36053
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_547(int iParam0)//Position - 0x36234
{
	func_572();
	if (!func_571())
	{
...
void func_548(char* sParam0)//Position - 0x3627F
{
	if (Global_93682 != 12)
	{
...
int func_549(char* sParam0, int iParam1, int iParam2)//Position - 0x3629C
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_550(char* sParam0)//Position - 0x3642E
{
...
void func_551(int iParam0, var uParam1)//Position - 0x36484
{
	switch (iParam0)
	{
		case 0:
...
int func_553(int iParam0)//Position - 0x376CA
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_554(int iParam0)//Position - 0x37A10
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_555(int iParam0)//Position - 0x37A47
{
	struct<2> Var0;
...
int func_557(char* sParam0, bool bParam1)//Position - 0x37EB7
{
	int iVar0;
	int iVar1;
...
int func_558(int iParam0, bool bParam1)//Position - 0x37EE1
{
	int iVar0;
...
void func_561(int iParam0)//Position - 0x37FD3
{
	if (iParam0 == 1)
	{
		Global_36974 = 1;
...
void func_562(bool bParam0)//Position - 0x37FEC
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_563(int iParam0)//Position - 0x38000
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_564(int iParam0)//Position - 0x3803D
{
	if (iParam0 == 1)
	{
...
void func_565()//Position - 0x3807A
{
	Global_17272.f_5 = 1;
}

void func_566()//Position - 0x38088
{
	Global_17272.f_5 = 0;
}

void func_567()//Position - 0x38096
{
	Global_87888 = 0;
	Global_87889 = 0;
}

void func_568()//Position - 0x380A8
{
	Global_93682 = 13;
	Global_93682.f_1 = -1;
	Global_93682.f_2 = 0;
...
void func_572()//Position - 0x38193
{
	Global_93717 = 1;
...
void func_573()//Position - 0x38280
{
	if (iLocal_451)
	{
		func_431(0, 1);
