			...
			if (!PED::IS_PED_INJURED(iLocal_3233[iLocal_3189]))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_3233[iLocal_3189], 0))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						{
							BRAIN::CLEAR_PED_TASKS(iLocal_3233[iLocal_3189]);
						...
						{
							if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_3233[iLocal_3189], -1207174364) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_3233[iLocal_3189], -1207174364) != 0)
							{
								BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_3233[iLocal_3189], PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 2f, 1, 15f, 20f, 0, 0, -687903391);
							}
						}
						else if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_3233[iLocal_3189], 780511057) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_3233[iLocal_3189], 780511057) != 0)
						{
							BRAIN::TASK_COMBAT_PED(iLocal_3233[iLocal_3189], PLAYER::PLAYER_PED_ID(), 0, 16);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3268[0], 0))
				{
					...
					else
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_3233[6]))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3233[6], false);
								BRAIN::CLEAR_PED_TASKS(iLocal_3233[6]);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_3292);
								BRAIN::TASK_LEAVE_VEHICLE(0, iLocal_3268[0], 256);
								BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_3292);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_3233[6], iLocal_3292);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_3292);
							}
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_3233[7]))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3233[7], false);
								BRAIN::CLEAR_PED_TASKS(iLocal_3233[7]);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_3292);
								BRAIN::TASK_LEAVE_VEHICLE(0, iLocal_3268[0], 256);
								BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_3292);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_3233[7], iLocal_3292);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_3292);
							}
						}
						iLocal_3346 = 1;
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3268[1], 0))
				{
					...
					else
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_3233[8]))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3233[8], false);
								BRAIN::CLEAR_PED_TASKS(iLocal_3233[8]);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_3292);
								BRAIN::TASK_LEAVE_VEHICLE(0, iLocal_3268[1], 256);
								BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_3292);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_3233[8], iLocal_3292);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_3292);
							}
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_3233[9]))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3233[9], false);
								BRAIN::CLEAR_PED_TASKS(iLocal_3233[9]);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_3292);
								BRAIN::TASK_LEAVE_VEHICLE(0, iLocal_3268[1], 256);
								BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_3292);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_3233[9], iLocal_3292);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_3292);
							}
						}
						iLocal_3347 = 1;
			...
			if (!PED::IS_PED_INJURED(iLocal_3233[10]))
			{
				...
				else if (STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3"))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -923.2303f, -2948.004f, 12.9451f, 2f, 2f, 2f, false, true, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_3233[10]))
						{
							BRAIN::CLEAR_PED_TASKS(iLocal_3233[10]);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_3292);
							BRAIN::TASK_PLAY_ANIM(0, "misssolomon_3", "plyr_roll_left", 8f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_3292);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_3233[10], iLocal_3292);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_3292);
							iLocal_3348 = 1;
						}
					}
...
int func_61(int iParam0)//Position - 0x4904
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_62(int iParam0)//Position - 0x499F
{
...
int func_63(int iParam0, int iParam1)//Position - 0x4B25
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_64(int iParam0, var uParam1)//Position - 0x5696
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0)//Position - 0x56D1
{
	int iVar0;
...
void func_66(int iParam0)//Position - 0x5945
{
	int iVar0;
...
void func_67(var uParam0, int iParam1)//Position - 0x5981
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_68(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5EDC
{
	int iVar0;
	int iVar1;
...
bool func_69(int iParam0, var uParam1, var uParam2)//Position - 0x5F20
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_70(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6627
{
	if (bParam6)
	{
...
int func_71(var uParam0)//Position - 0x666E
{
...
bool func_72(int iParam0)//Position - 0x66C9
{
	return func_73(iParam0, 0, 1);
}

int func_73(int iParam0, int iParam1, bool bParam2)//Position - 0x66D9
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_74(int iParam0)//Position - 0x6743
{
	switch (iParam0)
	{
		case 0:
...
int func_75()//Position - 0x6A64
{
	return Global_25765;
}

int func_76(int iParam0)//Position - 0x6A6F
{
	return func_73(iParam0, 5, 1);
}

int func_77(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6A7F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_78(int iParam0, bool bParam1)//Position - 0x6B21
{
	switch (iParam0)
	{
		case -1:
...
int func_79(int iParam0)//Position - 0x7123
{
	if (iParam0 != func_88())
	{
...
Vector3 func_80(int iParam0, int iParam1)//Position - 0x7181
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_81(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x722F
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_82(vector3 vParam0, float fParam3)//Position - 0x72C4
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_83(int iParam0)//Position - 0x7308
{
	struct<6> Var0;
...
struct<6> func_84(int iParam0)//Position - 0x748C
{
	return func_85(iParam0);
}

struct<6> func_85(int iParam0)//Position - 0x749A
{
	struct<6> Var0;
...
int func_86(int iParam0, var uParam1)//Position - 0x7F61
{
	switch (iParam0)
	{
		case 0:
...
int func_87(int iParam0)//Position - 0x7FE3
{
	if (iParam0 != func_88())
	{
...
int func_88()//Position - 0x8042
{
	return -1;
}

Vector3 func_89(int iParam0)//Position - 0x804B
{
	switch (iParam0)
	{
		case 1:
...
int func_90()//Position - 0x8256
{
	return func_91(PLAYER::PLAYER_ID());
}

int func_91(int iParam0)//Position - 0x8266
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_92(int iParam0)//Position - 0x8283
{
	return func_73(iParam0, 0, 0);
}

int func_93(int iParam0)//Position - 0x8293
{
	switch (iParam0)
	{
		case -1:
...
bool func_94()//Position - 0x8554
{
	return Global_93734.f_339 > 0;
}

var func_95()//Position - 0x8565
{
	var uVar0;
...
void func_96(var uParam0, int iParam1)//Position - 0x85AB
{
	if (iParam1 <= 0)
	{
		return;
...
void func_97(var uParam0, int iParam1)//Position - 0x8631
{
...
void func_98(var uParam0, int iParam1)//Position - 0x8664
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, int iParam1)//Position - 0x86B5
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_100(int iParam0)//Position - 0x8757
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_101(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_101(bool bParam0, int iParam1, int iParam2)//Position - 0x877C
{
	if (bParam0)
	{
		return iParam1;
...
int func_102(int iParam0)//Position - 0x8793
{
	return iParam0 & 15;
}

void func_103(var uParam0, int iParam1)//Position - 0x87A0
{
...
void func_104(var uParam0, int iParam1)//Position - 0x87DA
{
...
void func_105(var uParam0, int iParam1)//Position - 0x8815
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_106()//Position - 0x8851
{
	func_57();
	return Global_106565.f_2357.f_539.f_4321;
}

int func_107(char* sParam0)//Position - 0x886A
{
...
struct<2> func_108(int iParam0)//Position - 0x88C0
{
	struct<2> Var0;
...
int func_109(char* sParam0, int iParam1)//Position - 0x8D0D
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_110(int iParam0, var uParam1)//Position - 0x8D56
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0xA02E
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_113(int iParam0)//Position - 0xA374
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_114(int iParam0)//Position - 0xA3AC
{
	switch (iParam0)
	{
		case 69:
...
int func_115(int iParam0)//Position - 0xA468
{
	switch (iParam0)
	{
		case 1:
...
int func_116(char* sParam0, bool bParam1)//Position - 0xA4BC
{
	int iVar0;
	int iVar1;
...
int func_117(int iParam0, bool bParam1)//Position - 0xA4E6
{
	int iVar0;
...
void func_118(bool bParam0)//Position - 0xA51C
{
	int iVar0;
	int iVar1;
	...
	switch (iLocal_3180)
	{
		...
		case 8:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3266))
			{
				...
				ENTITY::SET_ENTITY_PROOFS(iLocal_3266, true, true, true, true, true, false, 0, false);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("jet"));
				iLocal_3763 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_damage", iLocal_3266, -11.956f, 10.528f, -7.657f, 0f, 2f, 0f, 1f, 0, 0, 0);
				ENTITY::SET_ENTITY_LOD_DIST(iLocal_3266, 500);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3228))
			{
				...
				BRAIN::TASK_SMART_FLEE_PED(iLocal_3228, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
...
void func_122(bool bParam0)//Position - 0xB679
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xB6AE
{
	if (Global_93719 > 0)
	{
...
void func_124()//Position - 0xB6D8
{
	if (iLocal_3339 == 0)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3233[0]))
		{
			...
			BRAIN::TASK_AIM_GUN_AT_ENTITY(iLocal_3233[0], PLAYER::PLAYER_PED_ID(), -1, 1);
...
void func_125(int iParam0, int iParam1)//Position - 0xBA78
{
...
void func_126(int iParam0, bool bParam1)//Position - 0xBA9F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_127()//Position - 0xBB3A
{
	return func_128(&(Global_100114.f_2890));
}

int func_128(var uParam0)//Position - 0xBB4D
{
	if (func_129(uParam0))
	{
...
int func_129(var uParam0)//Position - 0xBB82
{
...
int func_130(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xBBE1
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_131(int iParam0, bool bParam1)//Position - 0xBC5C
{
	int iVar0;
	struct<2> Var1;
...
int func_132(int iParam0)//Position - 0xBDDC
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_134(int iParam0)//Position - 0xBEBF
{
	int iVar0;
	int iVar1;
...
int func_135()//Position - 0xDF2D
{
	return 0;
}

int func_136()//Position - 0xDF36
{
	return 1;
}

int func_137()//Position - 0xDF3F
{
	return 1;
}

int func_138()//Position - 0xDF48
{
...
void func_140()//Position - 0xE01C
{
	func_141(&(Global_100114.f_2890));
}

void func_141(var uParam0)//Position - 0xE02F
{
	if (func_129(uParam0))
	{
...
int func_142(vector3 vParam0, float fParam3)//Position - 0xE04D
{
	return func_143(&(Global_100114.f_2890), vParam0, fParam3, 0);
}

int func_143(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0xE067
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
void func_144(int iParam0, int iParam1)//Position - 0xE319
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_145(int iParam0)//Position - 0xE51B
{
...
int func_146(int iParam0)//Position - 0xE5F8
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_147(int iParam0)//Position - 0xE7A9
{
	int iVar0;
	char* sVar1;
...
int func_148(int iParam0)//Position - 0xE7EF
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xE82A
{
	int iVar0;
...
int func_150(int iParam0)//Position - 0xE8A6
{
	int iVar0;
...
void func_151(int iParam0, bool bParam1)//Position - 0xE98E
{
	if (iParam0 == -1)
	{
		return;
...
void func_152(int iParam0, int iParam1, bool bParam2)//Position - 0xE9EB
{
	if (iParam0 == -1)
	{
		return;
...
bool func_153(int iParam0, int iParam1)//Position - 0xEA26
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_154(int iParam0)//Position - 0xEA49
{
	bool bVar0;
...
void func_155(var uParam0, var uParam1)//Position - 0xEBBB
{
...
int func_156(int iParam0, int iParam1)//Position - 0xEC87
{
	int iVar0;
...
int func_157(var uParam0)//Position - 0xECF9
{
	return *uParam0;
}

int func_158(var uParam0, int iParam1)//Position - 0xED04
{
	int iVar0;
	int iVar1;
...
int func_159(int iParam0)//Position - 0x10400
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_160(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x104C3
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_161(iParam0, uVar1[iVar6], 1) && func_130(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_70(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_161(int iParam0, int iParam1, bool bParam2)//Position - 0x106CB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_162(int iParam0, int iParam1)//Position - 0x1072C
{
	int iVar0;
...
void func_163(int iParam0, int iParam1)//Position - 0x107AE
{
	int iVar0;
...
void func_164(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x1084C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_165(int iParam0, var uParam1, var uParam2)//Position - 0x10D9C
{
	int iVar0;
	int iVar1;
...
int func_166(int iParam0)//Position - 0x10F5F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_167(var uParam0)//Position - 0x1103B
{
...
int func_168(int iParam0, int iParam1)//Position - 0x1107B
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_169(int iParam0, int iParam1)//Position - 0x11160
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
void func_170(int iParam0, int iParam1)//Position - 0x114D6
{
	int iVar0;
	int iVar1;
...
bool func_171()//Position - 0x1154E
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_172(int iParam0)//Position - 0x1155F
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0x115AA
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_174(int iParam0)//Position - 0x11631
{
...
int func_175(int iParam0)//Position - 0x11660
{
...
int func_176(int iParam0)//Position - 0x1167D
{
...
int func_177(int iParam0, int iParam1)//Position - 0x116A0
{
...
int func_178(int iParam0)//Position - 0x116DB
{
	if (func_177(iParam0, 0))
	{
...
int func_179(int iParam0, int iParam1)//Position - 0x116FE
{
	int iVar0;
...
int func_180(int iParam0, bool bParam1, bool bParam2)//Position - 0x1174B
{
	int iVar0;
...
void func_181(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x11795
{
	int iVar0;
...
var func_182()//Position - 0x117E5
{
	return Global_100114.f_2890.f_12.f_66;
}

bool func_183()//Position - 0x117F8
{
	return func_129(&(Global_100114.f_2890));
}

void func_184()//Position - 0x1180B
{
	...
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_3293) || !func_185(1, "BB_Chase"))
	{
		SYSTEM::WAIT(0);
	}
...
bool func_185(int iParam0, char* sParam1)//Position - 0x119E0
{
	return VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iParam0, sParam1);
}

void func_186(int iParam0, char* sParam1)//Position - 0x119F0
{
	VEHICLE::REQUEST_VEHICLE_RECORDING(iParam0, sParam1);
}

void func_187()//Position - 0x11A00
{
	func_213();
	func_211();
	HUD::CLEAR_PRINTS();
...
void func_188(bool bParam0, bool bParam1)//Position - 0x121CC
{
...
void func_189(bool bParam0)//Position - 0x12288
{
	int iVar0;
...
void func_190(int iParam0, bool bParam1)//Position - 0x122AB
{
	if (bParam1)
	{
...
void func_191(int iParam0, int iParam1, bool bParam2)//Position - 0x122E2
{
	int iVar0;
...
void func_192(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x12354
{
	int iVar0;
...
void func_193(int iParam0, int iParam1, bool bParam2)//Position - 0x12384
{
	int iVar0;
...
void func_194()//Position - 0x123F6
{
	int iVar0;
...
void func_195()//Position - 0x12583
{
	func_198();
	func_197();
	func_196();
...
void func_196()//Position - 0x12597
{
	int iVar0;
	int iVar1;
...
void func_197()//Position - 0x1268E
{
	int iVar0;
...
void func_198()//Position - 0x1270B
{
	int iVar0;
	int iVar1;
...
void func_199()//Position - 0x1280A
{
	int iVar0;
...
void func_200(int iParam0)//Position - 0x128D7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_201(int iParam0)//Position - 0x128EE
{
	float fVar0;
	int iVar1;
...
void func_202()//Position - 0x12988
{
	int iVar0;
...
void func_203()//Position - 0x12A0C
{
	int iVar0;
...
int func_204()//Position - 0x12AFA
{
	return joaat("s_m_y_cop_01");
}

int func_205()//Position - 0x12B07
{
	return joaat("police");
}

int func_206()//Position - 0x12B14
{
	return joaat("sultan");
}

int func_207()//Position - 0x12B21
{
	if (iLocal_2913 == 0)
	{
...
void func_208()//Position - 0x12B3E
{
...
void func_209(var uParam0, int iParam1, int iParam2)//Position - 0x12B68
{
	char* sVar0;
...
int func_210(char* sParam0)//Position - 0x12C45
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_211()//Position - 0x12C58
{
	Global_14732 = 0;
	func_212();
}

void func_212()//Position - 0x12C68
{
...
void func_213()//Position - 0x12C89
{
	Global_14732 = 0;
	func_214();
}

void func_214()//Position - 0x12C99
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
...
void func_215()//Position - 0x12CF0
{
	if (HUD::DOES_BLIP_EXIST(iLocal_3285))
	{
		HUD::REMOVE_BLIP(&iLocal_3285);
...
void func_216()//Position - 0x12D3C
{
	if (iLocal_3570 == 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_3228))
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_3228))
			{
				if (!PED::IS_PED_INJURED(iLocal_3228))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_3222))
					{
						...
						{
							if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
							{
								if (BRAIN::GET_PED_WAYPOINT_PROGRESS(iLocal_3222) > 18)
								{
									if (ENTITY::DOES_ENTITY_EXIST(iLocal_3284))
									{
									...
									BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_3228, iLocal_3210, "misssolomon_3", "_action", 1000f, -1000f, 4, 0, 1148846080, 0);
									BRAIN::TASK_LOOK_AT_ENTITY(iLocal_3228, PLAYER::PLAYER_PED_ID(), 9000, 1024, 3);
									iLocal_3534 = 1;
									iLocal_3535 = 0;
								}
							}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_3228))
			{
				if (!PED::IS_PED_INJURED(iLocal_3228))
				{
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_3210))
					{
						...
						{
							iLocal_3210 = PED::CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
							BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_3228, iLocal_3210, "misssolomon_3", "_react_to_death", 1000f, -1.5f, 3, 16, 1148846080, 0);
							iLocal_3536 = 1;
						}
					}
				}
				...
				if (!PED::IS_PED_INJURED(iLocal_3228))
				{
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_3210))
					{
						if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_3228, MISC::GET_HASH_KEY("ENDS_IN_RUN")))
						{
							...
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_3292);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_3228, iLocal_3292);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_3292);
...
void func_217(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x1301C
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_15(iParam3), 0);
}

void func_218()//Position - 0x13035
{
	if (iLocal_3181 == 0)
	{
		iLocal_3183 = 0;
...
void func_219(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x13295
{
	if (bParam0)
	{
...
bool func_220()//Position - 0x133CE
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_221(int iParam0, int iParam1)//Position - 0x133EB
{
	bool bVar0;
...
int func_222(int iParam0, bool bParam1)//Position - 0x13436
{
	int iVar0;
	int iVar1;
...
int func_223(int iParam0)//Position - 0x13477
{
...
bool func_224()//Position - 0x134B9
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_225(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x134CA
{
	int iVar0;
...
void func_227(int iParam0)//Position - 0x13524
{
	if (iParam0 == 1)
	{
...
void func_228()//Position - 0x13547
{
	if (iLocal_3511 == 0)
	{
	...
	if (iLocal_3181 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_3222))
		{
			if (!PED::IS_PED_INJURED(iLocal_3222))
			{
				if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
				{
					BRAIN::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_3222, 3f, 1);
				}
			}
		}
		if (!CAM::IS_SCREEN_FADED_IN())
	...
	if (iLocal_3181 == 1)
	{
		...
		if (iLocal_3471 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_3222))
			{
				if (!PED::IS_PED_INJURED(iLocal_3222))
				{
					if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
					{
						if (BRAIN::GET_PED_WAYPOINT_PROGRESS(iLocal_3222) > 20)
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_3266))
							{
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3266, 0))
		...
		if (iLocal_3512 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_3222))
			{
				if (!PED::IS_PED_INJURED(iLocal_3222))
				{
					if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
					{
						if (BRAIN::GET_PED_WAYPOINT_PROGRESS(iLocal_3222) > 23)
						{
							BRAIN::CLEAR_PED_TASKS(iLocal_3222);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_3266))
							{
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3266, 0))
								{
									...
									BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_3222, iLocal_3209, "MISSSOLOMON_3", "molly_death", 1.5f, -8f, 4, 0, 1148846080, 0);
				...
				if (!PED::IS_PED_INJURED(iLocal_3222))
				{
					if (iLocal_3512 == 1)
					{
						...
						if (vLocal_3318.y < -2965f)
						{
							...
							PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
							BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_3222, 0);
							BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_3222, 4000, 48, 4);
							iLocal_3513 = 1;
						}
					}
				}
		...
		else if (iLocal_3514 == 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3222))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_3233[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_3233[0]))
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_3233[0]);
		...
		if (iLocal_3515 == 0)
		{
			...
			{
				iLocal_3288 = func_230(iLocal_3283);
...
void func_229()//Position - 0x13E45
{
	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_3759))
	{
		GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_3759, 0);
...
int func_230(int iParam0)//Position - 0x13E95
{
	return func_231(iParam0, 1, 0);
}

int func_231(int iParam0, bool bParam1, bool bParam2)//Position - 0x13EA5
{
	int iVar0;
...
float func_232(bool bParam0, float fParam1, float fParam2)//Position - 0x13F49
{
	if (bParam0)
	{
		return fParam1;
...
void func_233(int iParam0)//Position - 0x13F60
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
	{
		...
		vVar12 = { 180f, 0f, 0f };
		iLocal_3759 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *iParam0, vVar0, vVar12, 1f, 0, 0, 0);
		iLocal_3760 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *iParam0, vVar3, vVar12, 1f, 0, 0, 0);
		iLocal_3761 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *iParam0, vVar6, vVar12, 1f, 0, 0, 0);
		iLocal_3762 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *iParam0, vVar9, vVar12, 1f, 0, 0, 0);
	}
}

void func_234()//Position - 0x14046
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_3222))
	{
		if (!PED::IS_PED_INJURED(iLocal_3222))
		{
			if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
			{
				...
				{
					BRAIN::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_3222, 2f, 1);
				}
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -921.7f, -2946.4f, 13.4f, true) > 8f && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_3222))
				{
					...
					{
						BRAIN::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_3222, 1f, 1);
					}
				}
	...
	if (iLocal_3181 > 0)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3228))
		{
			...
			if ((STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_airworker")) && STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3")) && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_clipboard_01")))
			{
				...
				iLocal_3210 = PED::CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_3228, iLocal_3210, "misssolomon_3", "_start_loop", 1000f, -8f, 68, 0, 1148846080, 0);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_y_airworker"));
	...
	if (iLocal_3181 == 2)
	{
		...
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -932.1196f, -2934.317f, 12.9448f, 2f, 2f, 2f, false, true, 0))
		{
			if (!PED::IS_PED_INJURED(iLocal_3222))
			{
				if (!BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
				{
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_3222, "BB_MOLLY_2", 10, 4, -1);
					BRAIN::TASK_PLAY_ANIM(iLocal_3222, "move_f@film_reel_arms", "run", 8f, -8f, -1, 49, 0, 0, 0, 0);
				}
			}
			SYSTEM::SETTIMERA(0);
			iLocal_3181 = 3;
	...
	if (iLocal_3181 == 3)
	{
		if (!PED::IS_PED_INJURED(iLocal_3222))
		{
			if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
			{
				if (BRAIN::GET_PED_WAYPOINT_PROGRESS(iLocal_3222) > 18 && iLocal_3437 == 0)
				{
					iLocal_3352 = 0;
					BRAIN::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_3222, 3f, 1);
					iLocal_3181 = 0;
		...
		if (SYSTEM::TIMERA() > 50000)
		{
			if (!PED::IS_PED_INJURED(iLocal_3222))
			{
				BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_3222);
				ENTITY::SET_ENTITY_COORDS(iLocal_3222, -932.5f, -2964.1f, 13.4f, 1, false, 0, 1);
				BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_3222, "BB_MOLLY_2", 18, 4, -1);
				BRAIN::TASK_PLAY_ANIM(iLocal_3222, "move_f@film_reel_arms", "run", 8f, -8f, -1, 49, 0, 0, 0, 0);
				iLocal_3352 = 0;
				iLocal_3181 = 0;
				iLocal_3180 = 6;
...
void func_235(char* sParam0)//Position - 0x148A3
{
	if (iLocal_3437 == 0)
	{
		if (iLocal_3336)
...
void func_236(char* sParam0)//Position - 0x1492C
{
	func_244(sParam0);
	func_237(0);
}

void func_237(int iParam0)//Position - 0x1493F
{
	int iVar0;
...
int func_238(int iParam0)//Position - 0x14984
{
	int iVar0;
	int iVar1;
...
void func_239(var uParam0, int iParam1)//Position - 0x14A9B
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_240(var uParam0)//Position - 0x14C64
{
	*uParam0 = -15;
}

int func_241(int iParam0, var uParam1, float fParam2)//Position - 0x14C72
{
	switch (iParam0)
	{
		case 11:
...
void func_242(int iParam0, bool bParam1)//Position - 0x155E1
{
	if (bParam1)
	{
...
void func_243()//Position - 0x1561F
{
	Global_93717 = 1;
...
void func_244(char* sParam0)//Position - 0x1570E
{
...
void func_245()//Position - 0x1574E
{
	Global_56501 = 0;
}

void func_246()//Position - 0x1575A
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3266))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_3258))
	...
	if (HUD::DOES_BLIP_EXIST(iLocal_3285))
	{
		func_340(iLocal_3285, iLocal_3222, 300f, 0.9f, 0);
	}
	if (iLocal_3181 == 0)
	{
		if (iLocal_3182 < 2)
		...
		if (iLocal_3349 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_3258))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3258, 0))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3258))
					{
						func_304(iLocal_3289, iLocal_3271, "BB_Chase", 1);
						iLocal_3349 = 1;
					}
				}
			}
		...
		else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3258, 0))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3258))
			{
				func_303(iLocal_3289, iLocal_3271, fLocal_3323);
		...
		if (iLocal_3337 == 0)
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3258, 0))
			{
				if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3258))
				{
					if ((VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 15000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) < 125464f) && func_295(1, 0, 0))
					{
						iLocal_3352 = 1;
						if (iLocal_3437 == 0)
						{
		...
		else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3258, 0))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3258))
			{
				if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_3293) && func_185(1, "BB_Chase"))
				{
		...
		switch (iLocal_3182)
		{
			case 0:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3258, 0))
				{
					if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3258))
					{
						if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) < 30000f)
						{
							func_262(iLocal_3258, VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258));
						}
					}
				}
				if (iLocal_3440 == 0)
								...
								if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 58000f)
								{
									if (!PED::IS_PED_INJURED(iLocal_3246))
									{
										if (STREAMING::HAS_ANIM_DICT_LOADED("misstrevor4"))
										{
											...
											{
												BRAIN::TASK_PLAY_ANIM(iLocal_3246, "misstrevor4", "dive_clear_goon1", 8f, -8f, -1, 0, 0, 0, 0, 0);
											}
										}
									}
									if (!PED::IS_PED_INJURED(iLocal_3247))
									{
										if (STREAMING::HAS_ANIM_DICT_LOADED("misstrevor4"))
										{
											...
											{
												BRAIN::TASK_PLAY_ANIM(iLocal_3247, "misstrevor4", "dive_clear_goon2", 8f, -8f, -1, 0, 0, 0, 0, 0);
											}
										}
									}
									iLocal_3399 = 1;
			...
			case 1:
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_3251[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_3251[0]))
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_3251[0]);
								...
								if (STREAMING::HAS_ANIM_DICT_LOADED("misssolomon_3"))
								{
									if (!PED::IS_PED_INJURED(iLocal_3222))
									{
										...
										if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_3222, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											...
											BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_3222, iLocal_3208, "misssolomon_3", "molly_escapes_car_mol", 1000f, -1000f, 5, 0, 1148846080, 0);
					...
					if (iLocal_3466 == 1)
					{
						if (!PED::IS_PED_INJURED(iLocal_3222))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_3222, -937.6656f, -2927.864f, 12.77007f, -934.8479f, -2929.484f, 14.46523f, 1.5f, 0, true, 0))
							{
								...
								BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_3222, "BB_MOLLY_2", 1, 4, -1);
...
void func_247()//Position - 0x17C26
{
	if (iLocal_3433 == 0)
	{
	...
	else if (iLocal_3432 == 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_3248))
		{
			if (!PED::IS_PED_INJURED(iLocal_3248))
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_3248);
				...
				BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_3292);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_3248, iLocal_3292);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_3292);
				iLocal_3432 = 1;
			}
		}
...
bool func_248(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x17DB0
{
...
int func_249(char* sParam0, int iParam1, bool bParam2)//Position - 0x17E04
{
	Global_15867 = 0;
...
void func_250()//Position - 0x180D1
{
	int iVar0;
...
void func_251()//Position - 0x18103
{
...
void func_253()//Position - 0x18231
{
	if (func_58(14))
	{
...
void func_254()//Position - 0x182D3
{
	int iVar0;
...
bool func_255(int iParam0, int iParam1)//Position - 0x1832B
{
	switch (iParam0)
	{
		case 5:
...
void func_256(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x18366
{
...
bool func_258(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x183DE
{
...
void func_259()//Position - 0x1842C
{
	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_3755[0]))
	{
		GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_3755[0], 0);
...
void func_260(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7, bool bParam8)//Position - 0x1848E
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
Vector3 func_261(vector3 vParam0)//Position - 0x1850B
{
	float fVar0;
	float fVar1;
...
void func_262(int iParam0, float fParam1)//Position - 0x1854A
{
	int iVar0;
	vector3 vVar1;
	...
	if (iLocal_1956 < 15)
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iParam0))
			{
				...
				vVar1 = { VEHICLE::_0x92523B76657A517D(iVar0, (fParam1 + (SYSTEM::TO_FLOAT((iLocal_1956 - 1)) * 2000f))) };
...
void func_263()//Position - 0x186BE
{
	iLocal_89 = 1;
}

void func_264()//Position - 0x186C9
{
	if (iLocal_3333 == 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_3258))
			...
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3258))
			{
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 55000f)
				{
					...
					if ((STREAMING::HAS_MODEL_LOADED(1938952078) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_fireman_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("missheist_agency3aig_lift_waitped_a"))
					{
						...
						iLocal_3755[0] = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_trev4_trailer_fire", -1151f, -2311f, 15f, 0f, 0f, 0f, 1065353216, 0, 0, 0, 0);
						if (iLocal_3388 == 0)
						{
							AUDIO::PLAY_SOUND_FROM_COORD(iLocal_3217, "Trevor_4_747_Loud_Fire", -1151f, -2311f, 15f, 0, 0, 0, 0);
							iLocal_3388 = 1;
						}
						iLocal_3755[1] = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_trev4_trailer_fire", -1140f, -2328f, 18f, 0f, 0f, 0f, 1065353216, 0, 0, 0, 0);
						iLocal_3755[2] = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_trev4_trailer_fire", -1150f, -2327f, 19f, 0f, 0f, 0f, 1065353216, 0, 0, 0, 0);
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3223[0]))
						{
							...
							BRAIN::TASK_VEHICLE_SHOOT_AT_COORD(iLocal_3223[0], -1147.07f, -2320.65f, 18.93f, 1101004800);
						}
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3223[1]))
						{
							iLocal_3223[1] = PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), -1138.313f, -2313.277f, 12.9445f, 155.4271f, 1, true);
							BRAIN::TASK_PLAY_ANIM(iLocal_3223[1], "missheist_agency3aig_lift_waitped_a", "idle_b", 8f, -8f, -1, 9, 0, 0, 0, 0);
						...
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3223[2]))
						{
							...
							BRAIN::TASK_PLAY_ANIM(iLocal_3223[2], "missheist_agency3aig_lift_waitped_a", "idle_a", 8f, -8f, -1, 9, 0, 0, 0, 0);
						...
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3223[3]))
						{
							...
							BRAIN::TASK_PLAY_ANIM(iLocal_3223[3], "missheist_agency3aig_lift_waitped_a", "idle_c", 8f, -8f, -1, 9, 0, 0, 0, 0);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_3223[1]))
			{
				if (!PED::IS_PED_INJURED(iLocal_3223[1]))
				{
					...
					if (iLocal_3547[0] == 1)
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_3223[1], "missheist_agency3aig_lift_waitped_a", "idle_b", 3))
						{
							BRAIN::TASK_COWER(iLocal_3223[1], -1);
							PED::SET_PED_KEEP_TASK(iLocal_3223[1], true);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_3223[2]))
			{
				if (!PED::IS_PED_INJURED(iLocal_3223[2]))
				{
					...
					if (iLocal_3547[1] == 1)
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_3223[2], "missheist_agency3aig_lift_waitped_a", "idle_a", 3))
						{
							BRAIN::TASK_COWER(iLocal_3223[2], -1);
							PED::SET_PED_KEEP_TASK(iLocal_3223[2], true);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_3223[3]))
			{
				if (!PED::IS_PED_INJURED(iLocal_3223[3]))
				{
					...
					if (iLocal_3547[2] == 1)
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_3223[3], "missheist_agency3aig_lift_waitped_a", "idle_c", 3))
						{
							BRAIN::TASK_COWER(iLocal_3223[3], -1);
							PED::SET_PED_KEEP_TASK(iLocal_3223[3], true);
...
void func_265()//Position - 0x18BAA
{
	if (iLocal_3434 == 0)
	{
		STREAMING::REQUEST_MODEL(joaat("police3"));
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3272[0], 0))
				{
					...
					else if (ENTITY::DOES_ENTITY_EXIST(iLocal_3251[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_3251[0]))
						{
							...
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
								BRAIN::TASK_VEHICLE_CHASE(iLocal_3251[0], PLAYER::PLAYER_PED_ID());
								PED::SET_PED_KEEP_TASK(iLocal_3251[0], true);
							}
							else
							{
								BRAIN::TASK_COMBAT_PED(iLocal_3251[0], PLAYER::PLAYER_PED_ID(), 0, 16);
								PED::SET_PED_KEEP_TASK(iLocal_3251[0], true);
							}
				...
				if (MISC::GET_GAME_TIMER() > iLocal_3196 + 500)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_3251[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_3251[0]))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
								BRAIN::SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(iLocal_3251[0], 16, 1);
								BRAIN::SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(iLocal_3251[0], 1, 1);
								iLocal_3483[0] = 1;
							}
							else
							{
...
void func_266()//Position - 0x18E35
{
	if (!iLocal_3335)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3121[20], 0))
...
void func_267()//Position - 0x19275
{
	RECORDING::_0xEB2D525B57F42B40();
	func_268();
}

void func_268()//Position - 0x19285
{
	Global_17272.f_134 = 1;
}

void func_269()//Position - 0x19293
{
	Global_56501 = 1;
}

void func_270()//Position - 0x1929F
{
	if (iLocal_3186 > 4)
	{
		iLocal_3186 = 0;
...
void func_271(char* sParam0)//Position - 0x192D6
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_272(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4)//Position - 0x192E8
{
	if (!func_280())
	{
		func_280();
...
void func_273(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x193B6
{
	if (!func_280())
	{
		func_280();
...
void func_274(int iParam0)//Position - 0x194BD
{
	if (iParam0 < 32)
	{
...
int func_275(int iParam0)//Position - 0x194D7
{
...
void func_276(bool bParam0, int iParam1)//Position - 0x194EF
{
	if (!func_280())
	{
		func_280();
...
float func_277(bool bParam0)//Position - 0x19685
{
	if (bParam0)
	{
		return -1f;
...
int func_278(int iParam0)//Position - 0x1969E
{
...
void func_279(bool bParam0, int iParam1)//Position - 0x196D7
{
	if (!func_280())
	{
		func_280();
...
int func_281(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x19789
{
	if (uParam0->f_1)
	{
...
void func_282()//Position - 0x19AF5
{
	MISC::SET_BIT(&Global_2424, 4);
}

int func_283(bool bParam0, bool bParam1, bool bParam2)//Position - 0x19B05
{
...
int func_284(bool bParam0, bool bParam1, bool bParam2)//Position - 0x19B57
{
	if (!func_295(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_285(var uParam0)//Position - 0x19BA0
{
	int iVar0;
...
int func_286(bool bParam0, bool bParam1, bool bParam2)//Position - 0x19BCB
{
	if (!func_295(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_287(bool bParam0, bool bParam1, bool bParam2)//Position - 0x19C2A
{
	if (!func_295(bParam0, bParam1, bParam2))
	{
		return 0;
...
void func_288(bool bParam0)//Position - 0x19C80
{
	if (bParam0)
	{
		func_293();
...
void func_289(int iParam0)//Position - 0x19CE3
{
	if (func_291())
	{
		return;
...
void func_290(bool bParam0, bool bParam1)//Position - 0x19D5D
{
	if (bParam0)
	{
		if (func_292(0))
...
bool func_291()//Position - 0x19DD1
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

int func_292(int iParam0)//Position - 0x19DE3
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
void func_293()//Position - 0x19E3D
{
...
void func_294(char* sParam0, int iParam1)//Position - 0x19E66
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_295(bool bParam0, bool bParam1, bool bParam2)//Position - 0x19E7D
{
	int iVar0;
	int iVar1;
...
int func_296(int iParam0)//Position - 0x1A0D6
{
	if (iParam0 != func_88())
	{
		if (func_180(iParam0, 1, 1))
...
int func_297(int iParam0, int iParam1)//Position - 0x1A13C
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_298(int iParam0, int iParam1)//Position - 0x1A19E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_299()//Position - 0x1A223
{
	return Global_2448756.f_16;
}

bool func_300(int iParam0)//Position - 0x1A231
{
	return iParam0 == 51;
}

var func_301()//Position - 0x1A23E
{
	return Global_2448756.f_15;
}

bool func_302()//Position - 0x1A24C
{
	return MISC::GET_GAME_TIMER() <= Global_17411.f_5878 + 100;
}

void func_303(int iParam0, int iParam1, float fParam2)//Position - 0x1A261
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_304(int iParam0, int iParam1, char* sParam2, int iParam3)//Position - 0x1A2B0
{
	vector3 vVar0;
...
void func_305()//Position - 0x1A319
{
	if (iLocal_3218 != -1)
	{
		if (iLocal_3389 == 1)
...
void func_306()//Position - 0x1A3D5
{
...
void func_307()//Position - 0x1A64C
{
	if (func_338())
	{
		fLocal_3324 = 0.5f;
			...
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3258))
			{
				if (iLocal_3359 == 0)
				{
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) < 10000f)
					{
						...
						{
							func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 40f, 55f, 100f, 1.7f, 1f, fLocal_3324, 0);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
							func_308(iLocal_3258, fLocal_3323);
						}
						else
						{
							func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 0.6f, 40f, 50f, 60f, 1.7f, 1f, fLocal_3324, 0);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
							func_308(iLocal_3258, fLocal_3323);
						}
					}
				...
				{
					func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 40f, 180f, 1.7f, 1f, fLocal_3324, 0);
					VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
					func_308(iLocal_3258, fLocal_3323);
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 10000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) < 23000f)
				{
					...
					{
						func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 35f, 180f, 1.7f, 0.5f, fLocal_3324, 1);
						VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
						func_308(iLocal_3258, fLocal_3323);
					}
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 23000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) < 32000f)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_3121[7]))
					{
						...
						else if (ENTITY::DOES_ENTITY_EXIST(iLocal_3121[8]))
						{
							...
							{
								func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 40f, 100f, 1.8f, 1f, fLocal_3324, 0);
								VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
								func_308(iLocal_3258, fLocal_3323);
							}
						}
				...
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 32000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) < 39000f)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_3121[7]))
					{
						...
						{
							func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 35f, 150f, 1.8f, 0.5f, fLocal_3324, 1);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
							func_308(iLocal_3258, fLocal_3323);
						}
					}
				...
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 39000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) < 56000f)
				{
					...
					{
						func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 35f, 150f, 1.8f, 1f, fLocal_3324, 0);
						VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
						func_308(iLocal_3258, fLocal_3323);
					}
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 56000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) < 65000f)
				{
					...
					{
						func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 35f, 100f, 1.8f, 1f, fLocal_3324, 0);
						VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
						func_308(iLocal_3258, fLocal_3323);
					}
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 65000f && VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) < 90000f)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_3121[13]))
					{
						...
						{
							func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 45f, 55f, 150f, 1.8f, 1f, fLocal_3324, 0);
							VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
							func_308(iLocal_3258, fLocal_3323);
						}
					}
				...
				{
					func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 60f, 70f, 150f, 1.5f, 0.5f, fLocal_3324, 1);
					VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
					func_308(iLocal_3258, fLocal_3323);
				}
				if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_3258) > 110000f)
				{
					func_334(iLocal_3258, PLAYER::PLAYER_PED_ID(), &fLocal_3323, 1f, 100f, 120f, 150f, 1.6f, 1f, fLocal_3324, 0);
					VEHICLE::SET_PLAYBACK_SPEED(iLocal_3258, fLocal_3323);
					func_308(iLocal_3258, fLocal_3323);
				}
			}
...
void func_308(int iParam0, float fParam1)//Position - 0x1AF03
{
	float fVar0;
	vector3 vVar1;
	int iVar4;
...
int func_309(int iParam0, float fParam1)//Position - 0x1B19E
{
	if (!iLocal_90)
	{
		iLocal_75 = 1;
...
int func_310(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x1B2D0
{
	float fVar0;
...
void func_311(int iParam0, float fParam1, bool bParam2)//Position - 0x1B4B6
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				else if (iLocal_1858[iVar0] == 5)
				{
					if (!iLocal_3121[iVar0] == iLocal_3166)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3121[iVar0], 0))
						{
							...
							if (!PED::IS_PED_INJURED(iVar1))
							{
								iVar20 = BRAIN::GET_SCRIPT_TASK_STATUS(iVar1, 242628503);
								if (iVar20 == 7)
								{
									...
									BRAIN::SET_DRIVE_TASK_CRUISE_SPEED(iVar1, fVar13);
								}
							}
						}
						if (!bLocal_87 && !bLocal_100)
...
void func_312(int iParam0)//Position - 0x1C0C8
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		func_201(iParam0);
...
int func_313(int iParam0, int iParam1, bool bParam2)//Position - 0x1C0EA
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
float func_314(vector3 vParam0, vector3 vParam3)//Position - 0x1C187
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

int func_315(int iParam0, int iParam1, float fParam2)//Position - 0x1C1A8
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_316(int iParam0)//Position - 0x1C22B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_317(var uParam0, int iParam1, bool bParam2)//Position - 0x1C289
{
	int iVar0;
...
void func_318(int iParam0)//Position - 0x1C380
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_319(int iParam0)//Position - 0x1C397
{
	int iVar0;
	int iVar1;
...
void func_320(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x1C510
{
	bool bVar0;
	int iVar1;
...
int func_321(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7)//Position - 0x1C582
{
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
		if (!bLocal_88)
...
float func_322(int iParam0)//Position - 0x1C5C9
{
	float fVar0;
...
int func_323(int iParam0)//Position - 0x1C605
{
...
void func_324(int iParam0)//Position - 0x1C67F
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void func_325(int iParam0, float fParam1, int iParam2)//Position - 0x1C976
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_326(int iParam0, int iParam1)//Position - 0x1D4EA
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_327(int iParam0, float fParam1)//Position - 0x1D54E
{
	int iVar0;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_2916[iParam0], 0))
	{
		...
		if (!PED::IS_PED_INJURED(iVar0) && iVar0 != PLAYER::PLAYER_PED_ID())
		{
			...
			BRAIN::TASK_VEHICLE_MISSION(iVar0, iLocal_2916[iParam0], 0, 1, fParam1, 786603, 5f, 5f, 1);
			PED::SET_PED_FLEE_ATTRIBUTES(iVar0, 8192, true);
			if (bLocal_108)
			{
				PED::SET_PED_FLEE_ATTRIBUTES(iVar0, 65536, true);
...
void func_328(int iParam0, float fParam1, float fParam2)//Position - 0x1D6A9
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void func_329(int iParam0, float fParam1)//Position - 0x1D72C
{
	if (!bLocal_88)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_330(int iParam0, float fParam1)//Position - 0x1D77A
{
	if (!bLocal_88)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_331(int iParam0, float fParam1)//Position - 0x1D7C8
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0) && VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iParam0))
	{
		...
		if (fVar1 < (fParam1 + 25000f))
		{
			...
			if (fVar1 <= VEHICLE::GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID(iVar0))
			{
				if (iLocal_1956 == 0)
				{
					vLocal_2656 = { VEHICLE::_0x92523B76657A517D(iVar0, fLocal_1289) };
					iLocal_1956++;
				}
				else if (iLocal_1956 == 1)
				{
					vLocal_2659 = { VEHICLE::_0x92523B76657A517D(iVar0, fVar1) };
					iLocal_1956++;
				}
				else if (!bLocal_106)
				{
		...
		if (fVar2 < (fParam1 - 8000f))
		{
			...
			if (iLocal_1959 == 0)
			{
				vLocal_2662 = { VEHICLE::_0x92523B76657A517D(iVar0, fLocal_1290) };
				iLocal_1959++;
			}
			else if (iLocal_1959 == 1)
			{
				vLocal_2665 = { VEHICLE::_0x92523B76657A517D(iVar0, fVar2) };
				iLocal_1959++;
			}
...
int func_332(int iParam0, int iParam1)//Position - 0x1DA16
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_333()//Position - 0x1DAB9
{
...
void func_334(int iParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, bool bParam10)//Position - 0x1DB03
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_335(int iParam0, int iParam1)//Position - 0x1DDBA
{
	struct<2> Var0;
	vector3 vVar3;
	vector3 vVar6;
...
float func_336(int iParam0, int iParam1)//Position - 0x1DE4B
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
float func_337(int iParam0, int iParam1)//Position - 0x1DE9D
{
	struct<2> Var0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_339()//Position - 0x1E146
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_340(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x1E415
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_341()//Position - 0x1E56E
{
...
void func_342()//Position - 0x1E744
{
	if (iLocal_3181 == 0)
	{
...
void func_343()//Position - 0x1EB83
{
...
void func_344(char* sParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1F495
{
	vector3 vVar0;
...
void func_345()//Position - 0x1F5B7
{
	if (iLocal_3181 == 0)
	{
		...
		if (!HUD::DOES_BLIP_EXIST(iLocal_3287))
		{
			iLocal_3287 = func_350(vLocal_3300, 0);
		}
	...
	if (iLocal_3181 == 1)
	{
		...
		if ((iLocal_3362 == 1 && ENTITY::DOES_ENTITY_EXIST(iLocal_3258)) && ENTITY::DOES_ENTITY_EXIST(iLocal_3222))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3258, 0))
			{
				if (WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_3258, func_347(PLAYER::PLAYER_PED_ID()), 0))
				{
					func_346();
					iLocal_3181 = 0;
					iLocal_3183 = 0;
...
void func_346()//Position - 0x1FCC7
{
...
var func_347(int iParam0)//Position - 0x1FD73
{
	var uVar0;
...
void func_348(int iParam0, char* sParam1)//Position - 0x1FD87
{
	VEHICLE::REMOVE_VEHICLE_RECORDING(iParam0, sParam1);
}

int func_349()//Position - 0x1FD97
{
	if (Global_15866 == 4)
	{
		if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
...
int func_350(vector3 vParam0, bool bParam3)//Position - 0x1FDBC
{
	int iVar0;
...
void func_351()//Position - 0x1FDE8
{
	if (iLocal_3181 == 0)
	{
		iLocal_3338 = 1;
...
void func_352()//Position - 0x20379
{
	Global_56500 = 0;
}

void func_353(int iParam0)//Position - 0x20385
{
	if (Global_90634 != -1)
	{
...
void func_354(var uParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x203A9
{
	int iVar0;
...
void func_355()//Position - 0x2051C
{
	int iVar0;
...
void func_356(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x20548
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_365(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_362(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_357(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x205C3
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_359(iParam5, &Var0, vParam1, fParam4, func_34(iParam0));
		func_358(iParam5, iParam0, 0);
	}
}

void func_358(int iParam0, int iParam1, int iParam2)//Position - 0x206EC
{
	int iVar0;
...
void func_359(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x20809
{
	if (func_158(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_360(int iParam0)//Position - 0x20908
{
	if (iParam0 == -1)
	{
		return;
...
void func_361(int iParam0)//Position - 0x20982
{
...
int func_362(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x209A9
{
	int iVar0;
...
int func_363(vector3 vParam0, int iParam3, int iParam4)//Position - 0x20ABF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_364(int iParam0)//Position - 0x20B4E
{
	return MISC::IS_BIT_SET(Global_106565.f_7223[iParam0], 0);
}

int func_365(int iParam0)//Position - 0x20B66
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_366()//Position - 0x20B82
{
	Global_56500 = 1;
}

bool func_367(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x20B8E
{
	struct<2> Var0;
...
int func_368(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x20BBC
{
	int iVar0;
	float fVar1;
	int iVar2;
...
int func_369(int iParam0)//Position - 0x2136F
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
int func_371(int iParam0, int iParam1, char* sParam2, char* sParam3, var uParam4, float fParam5, int iParam6, bool bParam7, float fParam8)//Position - 0x213EB
{
	float fVar0;
	int iVar1;
	int iVar2;
...
int func_372(int iParam0)//Position - 0x21680
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

float func_373(float fParam0, float fParam1, float fParam2)//Position - 0x21692
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
int func_374(int iParam0)//Position - 0x216B9
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_375(int iParam0)//Position - 0x216CC
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_376(int iParam0)//Position - 0x216DF
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_377()//Position - 0x216F2
{
	int iVar0;
...
void func_378(float fParam0)//Position - 0x21740
{
	int iVar0;
	int iVar1;
...
void func_379(int iParam0, float fParam1)//Position - 0x217D1
{
	if (func_384(iParam0))
	{
...
void func_380(int iParam0, float fParam1)//Position - 0x217F4
{
...
float func_381(bool bParam0)//Position - 0x21822
{
	float fVar0;
	float fVar1;
	int iVar2;
...
float func_382(var uParam0)//Position - 0x2187A
{
	if (func_384(uParam0))
	{
		if (func_383(uParam0))
...
bool func_383(var uParam0)//Position - 0x218B9
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_384(var uParam0)//Position - 0x218C9
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

void func_385(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x218D9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_386(float fParam0, float fParam1, float fParam2)//Position - 0x21ADA
{
	float fVar0;
...
void func_387(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x21B1C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_388(int iParam0, int iParam1)//Position - 0x21C9E
{
	int iVar0;
	int iVar1;
...
int func_389(int iParam0)//Position - 0x21DAA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_390(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x21E86
{
...
bool func_391(int iParam0, int iParam1)//Position - 0x21EBE
{
	return func_392(CLOCK::GET_CLOCK_HOURS(), iParam0, iParam1);
}

int func_392(int iParam0, int iParam1, int iParam2)//Position - 0x21ED2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_393(int iParam0, var uParam1, var uParam2)//Position - 0x21F7B
{
	switch (iParam0)
	{
		case 65:
...
void func_394(int iParam0, var uParam1)//Position - 0x21FCD
{
	uParam1->f_17 = -1;
	switch (iParam0)
	{
...
bool func_395()//Position - 0x22EB6
{
	bool bVar0;
...
void func_396()//Position - 0x22ED9
{
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
	if (!func_23())
	{
...
void func_397()//Position - 0x232C6
{
	if (iLocal_3181 == 0)
	{
...
void func_398(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x23340
{
	if (func_23())
	{
...
void func_400()//Position - 0x233FF
{
	if (iLocal_3490[0] == 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_3121[7]))
...
void func_401()//Position - 0x238A6
{
	switch (iLocal_3180)
	{
		case 2:
			...
			if (iLocal_3181 > 0)
			{
				...
				if (iLocal_3185 == 1)
				{
					if (iLocal_3567 == 0)
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							iLocal_3257 = func_402(PLAYER::PLAYER_PED_ID(), -1533126372, 0, 0, 28);
...
int func_402(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x246BE
{
	int iVar0[16];
	int iVar17;
...
bool func_404(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x247DC
{
...
void func_405()//Position - 0x2482A
{
...
int func_406(vector3 vParam0, int iParam3, int iParam4, bool bParam5)//Position - 0x248D1
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
void func_407()//Position - 0x25625
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_408()//Position - 0x25651
{
	if (iLocal_3351 == 1)
	{
		if (iLocal_3180 == 4)
...
void func_409()//Position - 0x25B60
{
	func_417(PLAYER::PLAYER_PED_ID(), 0);
	func_413();
}

int func_410()//Position - 0x25B75
{
	if (Global_3)
	{
		return 1;
...
void func_411(char* sParam0)//Position - 0x25BA2
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, -1);
}

void func_412(bool bParam0)//Position - 0x25BB8
{
	if (bParam0)
	{
...
void func_413()//Position - 0x25BE4
{
	func_419(24, 1);
	AUDIO::SET_AUDIO_FLAG("PoliceScannerDisabled", 0);
...
void func_414()//Position - 0x2641E
{
	int iVar0;
...
void func_415()//Position - 0x26448
{
	int iVar0;
...
void func_417(int iParam0, int iParam1)//Position - 0x264F7
{
	int iVar0;
...
int func_418(int iParam0, int iParam1)//Position - 0x2655D
{
	int iVar0;
...
void func_419(int iParam0, bool bParam1)//Position - 0x26690
{
	char* sVar0;
	int iVar1;
...
int func_420(int iParam0)//Position - 0x2671B
{
	struct<2> Var0;
...
struct<2> func_421(var uParam0)//Position - 0x2674F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_422(int iParam0, bool bParam1)//Position - 0x267A1
{
	struct<2> Var0;
...
var func_423(int iParam0, int iParam1)//Position - 0x267E4
{
	struct<5> Var0;
...
struct<5> func_424(int iParam0)//Position - 0x26809
{
	struct<5> Var0;
	vector3 vVar5;
...
struct<6> func_425(int iParam0, bool bParam1)//Position - 0x28C88
{
	struct<6> Var0;
...
bool func_426(bool bParam0)//Position - 0x2983E
{
