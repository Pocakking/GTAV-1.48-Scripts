...
void func_5()//Position - 0x280
{
	...
	{
		case 0:
			func_39(&uLocal_172, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		...
		case 1:
			if (func_23(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					if (func_23(iLocal_171) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_171, 1))
					{
...
void func_56(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x1503
{
	int iVar0;
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA607
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_109(int iParam0)//Position - 0xB525
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB576
{
	func_173();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_111(int iParam0, int iParam1)//Position - 0xB5C8
{
	switch (iParam0)
	{
		case 0:
...
void func_112(int iParam0)//Position - 0xB6B8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xC8EC
{
	int iVar0;
	int iVar1;
...
bool func_114(int iParam0, int iParam1, var uParam2)//Position - 0xCC7C
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_115(int iParam0, int iParam1)//Position - 0xD081
{
	switch (iParam1)
	{
		case 0:
...
int func_116(int iParam0, int iParam1)//Position - 0xD47C
{
	switch (iParam1)
	{
		case 0:
...
int func_117(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xD877
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_118(int iParam0)//Position - 0xD8B9
{
	switch (iParam0)
	{
		case -1:
...
void func_119(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD98D
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_113(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_113(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_120(int iParam0)//Position - 0xDC65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0xDDB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0xE2BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0xE333
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0xE3A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0xE48D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0xE7CF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0xE9D7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0xEBF7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xED00
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0xF692
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x101EC
{
	if (iParam0 < 136)
	{
		func_133(iParam0);
...
void func_132(int iParam0)//Position - 0x10221
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x10E25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x11D25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x11E52
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0, int iParam1)//Position - 0x11F49
{
	switch (iParam0)
	{
		case 0:
...
void func_137(int iParam0)//Position - 0x12039
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x13506
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1364D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x13B57
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x141C2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x14235
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x14305
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x14800
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x14991
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x15180
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x15289
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x161AC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x16E59
{
	if (iParam0 < 107)
	{
		func_152(iParam0);
...
void func_150(int iParam0)//Position - 0x16E9F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x17943
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x18733
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x19372
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x195EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0, int iParam1)//Position - 0x19726
{
	switch (iParam0)
	{
		case 0:
...
void func_156(int iParam0)//Position - 0x19816
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1A574
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1A6E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1AC54
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1B17C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1B1EF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1B2BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1B76F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1B9CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1BC8A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1BE45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1CB1F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1D751
{
	if (iParam0 < 60)
	{
		func_170(iParam0);
...
void func_169(int iParam0)//Position - 0x1D786
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1E519
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1EB9B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173()//Position - 0x1ED78
{
...
int func_174(int iParam0, int iParam1, int iParam2)//Position - 0x1EDF0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_175(bool bParam0)//Position - 0x1F04B
{
	int iVar0;
...
void func_176(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x1F089
{
	if (bParam0)
	{
...
bool func_177()//Position - 0x1F1C2
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_178(int iParam0, int iParam1)//Position - 0x1F1DF
{
	bool bVar0;
...
int func_179(int iParam0, bool bParam1)//Position - 0x1F22A
{
	int iVar0;
	int iVar1;
...
int func_180(int iParam0)//Position - 0x1F26B
{
...
bool func_181()//Position - 0x1F2AD
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_182(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x1F2BE
{
	int iVar0;
...
void func_183(int iParam0)//Position - 0x1F2F1
{
	if (iParam0 == 1)
	{
...
void func_184(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x1F314
{
	func_185(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_185(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x1F33D
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_186(vector3 vParam0)//Position - 0x1F731
{
...
int func_187(int iParam0, int iParam1, bool bParam2)//Position - 0x1F75B
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_188(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x1F7CC
{
...
int func_189(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x1F8A4
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_190(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x1FB9A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_191(vector3 vParam0)//Position - 0x1FC4E
{
	float fVar0;
	float fVar1;
...
void func_192(int iParam0)//Position - 0x1FC8D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_193()//Position - 0x1FCF2
{
	int iVar0;
...
int func_194()//Position - 0x1FD12
{
	return func_195(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_195(char* sParam0, int iParam1)//Position - 0x1FD23
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_196(int iParam0, var uParam1)//Position - 0x1FD6C
{
	switch (iParam0)
	{
		case 0:
...
int func_198(int iParam0)//Position - 0x20FB4
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_199(int iParam0)//Position - 0x212FA
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_200(int iParam0)//Position - 0x21331
{
	struct<2> Var0;
...
int func_201(int iParam0, float fParam1, int iParam2)//Position - 0x2177D
{
	int iVar0;
...
bool func_202()//Position - 0x21851
{
	bool bVar0;
...
void func_203()//Position - 0x21874
{
	Global_14732 = 0;
	func_21();
}

int func_204()//Position - 0x21884
{
...
void func_205()//Position - 0x218A6
{
...
int func_206(int iParam0, int iParam1)//Position - 0x218F7
{
	if (func_207(iParam0))
	{
...
int func_207(int iParam0)//Position - 0x2192A
{
	if (func_23(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_208(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2194A
{
...
void func_209(int iParam0)//Position - 0x21AD9
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_210(char* sParam0, bool bParam1)//Position - 0x21B05
{
	func_175(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_211(int iParam0, bool bParam1)//Position - 0x21B1B
{
	if (bParam1)
	{
...
void func_212()//Position - 0x21B3D
{
	func_235();
	func_234();
	if (func_214())
	{
		if (MISC::GET_GAME_TIMER() < iLocal_146 && !func_213(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 5f, 1))
		{
...
int func_214()//Position - 0x21BFA
{
	...
	{
		if (func_216(Local_81.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_215(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1))
		{
...
int func_215(int iParam0, int iParam1, bool bParam2)//Position - 0x21CB0
{
...
int func_216(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x21CFB
{
	vector3 vVar0;
...
int func_217(int iParam0, float fParam1)//Position - 0x21DB6
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0x21E2C
{
	return func_219(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x21E44
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_220(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x21F05
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0x22031
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x22140
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_224(vector3 vParam0, vector3 vParam3)//Position - 0x221D1
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

void func_225(var uParam0)//Position - 0x221F2
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_226(int iParam0, int iParam1)//Position - 0x2220D
{
	int iVar0;
...
int func_227(int iParam0)//Position - 0x2224C
{
...
bool func_228(int iParam0, int iParam1, float fParam2)//Position - 0x22274
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x222BB
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x223B6
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_231(int iParam0, float fParam1)//Position - 0x224C2
{
	var uVar0;
	vector3 vVar1;
...
int func_232(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x22557
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x225E5
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_234()//Position - 0x2262D
{
	vector3 vVar0;
	float fVar3;
	...
	if (!iLocal_167)
	{
		if (func_23(Local_81.f_35[0]))
		{
			...
			{
				INTERIOR::_LOAD_INTERIOR(iLocal_170);
				iLocal_167 = 1;
			}
		}
	}
...
void func_235()//Position - 0x226E3
{
	func_237(0);
	func_205();
	func_236();
...
void func_236()//Position - 0x226F8
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_237(int iParam0)//Position - 0x22750
{
	if (func_241())
	{
		return;
...
void func_238(int iParam0)//Position - 0x22783
{
	if (func_241())
	{
		return;
...
void func_239(bool bParam0, bool bParam1)//Position - 0x227FD
{
	if (bParam0)
	{
		if (func_240(0))
...
int func_240(int iParam0)//Position - 0x22871
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_241()//Position - 0x228CB
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

void func_242()//Position - 0x228DD
{
	func_235();
	func_234();
	...
	if (func_214())
	{
		if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			...
			if (func_207(PLAYER::PLAYER_PED_ID()) && func_207(Local_81.f_28[0]))
			{
...
void func_243()//Position - 0x22975
{
...
void func_244(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x229DA
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_245()//Position - 0x22CBF
{
	if (Global_71844 != 6)
	{
	}
...
float func_246(char* sParam0)//Position - 0x22CF7
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_247(int iParam0, int iParam1, int iParam2)//Position - 0x22D0A
{
	struct<2> Var0;
	int iVar2;
...
char* func_248(int iParam0)//Position - 0x22DE0
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_249(int iParam0)//Position - 0x22F33
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_250(int iParam0)//Position - 0x22F66
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_251(int iParam0)//Position - 0x22F99
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_252(int iParam0)//Position - 0x22FCC
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_253(int iParam0)//Position - 0x22FFF
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_254(int iParam0)//Position - 0x2303C
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_255(int iParam0)//Position - 0x2306F
{
	struct<2> Var0;
...
int func_256(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x230D8
{
...
bool func_257(bool bParam0)//Position - 0x231F0
{
	if (bParam0)
	{
...
int func_258(int iParam0)//Position - 0x23219
{
	if (Global_36425 == 15)
	{
		return 0;
...
bool func_259(int iParam0)//Position - 0x2323B
{
	return func_260(iParam0, Global_36425);
}

int func_260(int iParam0, int iParam1)//Position - 0x2324C
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_261(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2342D
{
	int iVar0;
...
void func_262(var uParam0, bool bParam1, bool bParam2)//Position - 0x234D6
{
	int iVar0;
...
int func_263(var uParam0)//Position - 0x235CB
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
void func_264(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x23798
{
	func_32(iParam0);
...
int func_265(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0x237DA
{
	if (func_266(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_266(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x23836
{
	int iVar0;
...
int func_267(var uParam0, int iParam1)//Position - 0x238C4
{
	int iVar0;
...
int func_268(var uParam0)//Position - 0x2390A
{
	if (func_269(uParam0))
	{
...
int func_269(var uParam0)//Position - 0x23934
{
...
int func_270(int iParam0)//Position - 0x23959
{
	int iVar0;
...
void func_271(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2398A
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_273()//Position - 0x239EA
{
	int iVar0;
...
bool func_275(bool bParam0)//Position - 0x23B00
{
...
void func_276()//Position - 0x23B2B
{
	func_277(67, 1);
}

void func_277(int iParam0, bool bParam1)//Position - 0x23B3A
{
	int iVar0;
	char* sVar1;
...
void func_279(int iParam0, int iParam1, int iParam2)//Position - 0x23CBC
{
	bool bVar0;
...
void func_280()//Position - 0x23DA4
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_281()//Position - 0x24268
{
	return Global_25765;
}

int func_282(int iParam0, int iParam1)//Position - 0x24273
{
	int iVar0;
...
int func_283(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x242C4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_284()//Position - 0x2487A
{
	func_301();
	func_293();
	func_289();
...
void func_285(int iParam0)//Position - 0x248D3
{
	if (iParam0 == 1)
	{
...
void func_286()//Position - 0x248FC
{
...
void func_287()//Position - 0x2491A
{
	StringCopy(&Global_71822, "", 16);
	StringCopy(&Global_71826, "", 16);
}

void func_288()//Position - 0x24934
{
	int iVar0;
...
void func_289()//Position - 0x24959
{
	Global_93682 = 13;
	Global_93682.f_1 = -1;
	Global_93682.f_2 = 0;
...
void func_292(int iParam0)//Position - 0x24A06
{
	if (iParam0 == 1)
	{
		Global_36974 = 1;
...
void func_293()//Position - 0x24A1F
{
	func_294(&Global_100114);
}

void func_294(var uParam0)//Position - 0x24A2F
{
	int iVar0;
	int iVar1;
...
void func_295(var uParam0)//Position - 0x24FBF
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_296(var uParam0)//Position - 0x24FDA
{
...
void func_297(var uParam0)//Position - 0x25009
{
	int iVar0;
...
void func_298(var uParam0)//Position - 0x250B9
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_299(var uParam0)//Position - 0x250D7
{
	int iVar0;
...
void func_300(var uParam0)//Position - 0x251B7
{
	*uParam0 = -15;
}

void func_301()//Position - 0x251C5
{
	StringCopy(&Global_97122, "", 32);
	func_294(&Global_97130);
}

void func_302()//Position - 0x251DE
{
...
void func_303()//Position - 0x2525B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_304(int iParam0, int iParam1, int iParam2)//Position - 0x2531C
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_305(char* sParam0, int iParam1)//Position - 0x254DB
{
...
void func_307(int iParam0, int iParam1)//Position - 0x2557B
{
...
void func_308(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x255C5
{
...
void func_309(int iParam0, int iParam1, int iParam2)//Position - 0x25662
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_310(&sVar32, Var0.f_3, Global_93719, iParam1, iParam2);
	}
}

void func_310(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x256A1
{
...
void func_311(int iParam0)//Position - 0x256E5
{
	Global_36976 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_312()//Position - 0x256F7
{
	if (Global_91024)
	{
		func_14();
		GRAPHICS::_0xBF59707B3E5ED531(func_313(Global_106565.f_2357.f_539.f_4321));
	}
	else
	{
...
char* func_313(var uParam0)//Position - 0x25729
{
	uParam0 = uParam0;
	return "";
}

void func_314()//Position - 0x25738
{
	vector3 vVar0[24];
...
void func_315(int iParam0, int iParam1)//Position - 0x2577B
{
	Global_91019 = iParam0;
	Global_91020 = iParam1;
}

void func_316(var uParam0)//Position - 0x2578F
{
	if (*uParam0 == -1)
	{
		return;
...
void func_317(int iParam0, bool bParam1)//Position - 0x257CC
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_318(int iParam0)//Position - 0x25952
{
	switch (iParam0)
	{
		case 0:
...
void func_319(int iParam0)//Position - 0x25CD9
{
	func_321(iParam0, 1);
...
int func_320()//Position - 0x25D0F
{
	return (Global_106565.f_10010.f_21 + Global_106565.f_18568.f_380);
}

void func_321(var uParam0, bool bParam1)//Position - 0x25D2B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_322(int iParam0)//Position - 0x2604F
{
...
void func_323(int iParam0)//Position - 0x26082
{
	switch (iParam0)
	{
		case 30:
...
void func_324(int iParam0, bool bParam1)//Position - 0x260B7
{
	if (iParam0 == -1)
	{
		return;
...
void func_325(int iParam0, int iParam1, bool bParam2)//Position - 0x26114
{
	if (iParam0 == -1)
	{
		return;
...
bool func_326(int iParam0, int iParam1)//Position - 0x2614F
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_327(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x26172
{
	if (iParam0 != 198)
	{
		if (Global_71590)
...
void func_328(int iParam0, int iParam1)//Position - 0x261CD
{
	switch (iParam0)
	{
		case 12:
...
void func_329(int iParam0, bool bParam1)//Position - 0x262B6
{
	if (bParam1)
	{
...
bool func_330(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x262DF
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_332()//Position - 0x26C61
{
	return Global_25766;
}

int func_333(var uParam0, int iParam1)//Position - 0x26C6C
{
	int iVar0;
...
int func_334(int iParam0)//Position - 0x2A407
{
	switch (iParam0)
	{
		case 46:
...
void func_335(int iParam0, bool bParam1)//Position - 0x2A4F9
{
	switch (iParam0)
	{
		case 46:
...
void func_336(int iParam0, bool bParam1)//Position - 0x2A54A
{
	int iVar0;
...
void func_337(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2A5B0
{
	func_338(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_338(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2A5D1
{
	int iVar0;
...
void func_339()//Position - 0x2A7A4
{
	int iVar0;
...
int func_340(int iParam0)//Position - 0x2A8C4
{
	int iVar0;
	int iVar1;
...
int func_343(int iParam0)//Position - 0x2AAFE
{
...
void func_344(int iParam0, int iParam1)//Position - 0x2AB2B
{
...
int func_345(char* sParam0)//Position - 0x2AB68
{
	int iVar0;
...
void func_346(bool bParam0)//Position - 0x2ABC8
{
	int iVar0;
...
void func_347(char* sParam0, int iParam1)//Position - 0x2AC98
{
	if (Global_93682 != 12)
	{
...
int func_348(char* sParam0, int iParam1, int iParam2)//Position - 0x2ACC0
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_349(char* sParam0)//Position - 0x2AE52
{
...
int func_351(char* sParam0, bool bParam1)//Position - 0x2AECC
{
	int iVar0;
	int iVar1;
...
int func_352(int iParam0, bool bParam1)//Position - 0x2AEF6
{
	int iVar0;
...
void func_355(bool bParam0)//Position - 0x2AFE8
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_356(int iParam0)//Position - 0x2AFFC
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_357(int iParam0)//Position - 0x2B039
{
	if (iParam0 == 1)
	{
...
void func_358()//Position - 0x2B076
{
	Global_17272.f_5 = 1;
}

void func_359()//Position - 0x2B084
{
	Global_17272.f_5 = 0;
}

void func_360(bool bParam0)//Position - 0x2B092
{
	if (bParam0)
	{
		func_361();
...
void func_361()//Position - 0x2B0F5
{
...
void func_362()//Position - 0x2B11E
{
	Global_87888 = 0;
	Global_87889 = 0;
}

int func_363()//Position - 0x2B130
{
...
void func_364()//Position - 0x2B16E
{
	Global_93717 = 1;
...
void func_365(int iParam0)//Position - 0x2B25B
{
...
void func_366(var uParam0)//Position - 0x2B26D
{
...
void func_367(var uParam0)//Position - 0x2B28D
{
	int iVar0;
...
int func_368(int iParam0)//Position - 0x2B2C7
{
	if (!func_15(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
