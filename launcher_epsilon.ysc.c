		...
		else if (Var0 == 11)
		{
			if (func_384(Var0.f_28[0]))
			{
				...
				if (func_364(Var0.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					...
					{
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_267);
						BRAIN::TASK_PLAY_ANIM(0, "rcmepsilonism3", "outro", 8f, -8f, -1, 0, 0, 0, 0, 0);
						BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_267);
						BRAIN::TASK_PERFORM_SEQUENCE(Var0.f_28[0], iLocal_267);
					}
					else
					{
...
void func_58(int iParam0, var uParam1)//Position - 0x46BC
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_60(Var11.f_1)) && iVar72 < 51)
			{
...
int func_59(int iParam0)//Position - 0x4944
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x49DF
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4B65
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x56D6
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x5711
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5985
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x59C1
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5F1C
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5F60
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6667
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x66AE
{
...
bool func_70(int iParam0)//Position - 0x6709
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6719
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x6783
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6AA4
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x6AAF
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6ABF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6B61
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x7163
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x71C1
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x726F
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x7304
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x7348
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x74CC
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x74DA
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7FA1
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x8024
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x8082
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x808B
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x8296
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x82A6
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x82C3
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x82D3
{
	switch (iParam0)
	{
		case -1:
...
bool func_92()//Position - 0x8594
{
	return Global_93734.f_339 > 0;
}

var func_93()//Position - 0x85A5
{
	var uVar0;
...
void func_94(var uParam0, int iParam1)//Position - 0x85EB
{
	if (iParam1 <= 0)
	{
		return;
...
void func_95(var uParam0, int iParam1)//Position - 0x8671
{
...
void func_96(var uParam0, int iParam1)//Position - 0x86A4
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1)//Position - 0x86F5
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_98(int iParam0)//Position - 0x8797
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_99(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_99(bool bParam0, int iParam1, int iParam2)//Position - 0x87BC
{
	if (bParam0)
	{
		return iParam1;
...
int func_100(var uParam0)//Position - 0x87D3
{
	return uParam0 & 15;
}

void func_101(var uParam0, int iParam1)//Position - 0x87E0
{
...
void func_102(var uParam0, int iParam1)//Position - 0x881A
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8855
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_104()//Position - 0x8891
{
	func_55();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_105(int iParam0)//Position - 0x88AA
{
	var uVar0;
	vector3 vVar1[24];
...
void func_106(char* sParam0, int iParam1, int iParam2)//Position - 0x8903
{
...
bool func_107(bool bParam0)//Position - 0x8945
{
...
struct<2> func_108(int iParam0)//Position - 0x8970
{
	struct<2> Var0;
...
void func_109(int iParam0, var uParam1)//Position - 0x8DBD
{
	switch (iParam0)
	{
		case 0:
...
int func_111(int iParam0)//Position - 0xA095
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0xA3DB
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0xA47F
{
	struct<2> Var0;
...
void func_114(int iParam0)//Position - 0xA51A
{
	if (iParam0 < 63)
	{
		func_115();
...
void func_116(int iParam0)//Position - 0xA578
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0)//Position - 0xA5D1
{
...
int func_118(int iParam0)//Position - 0xA654
{
	int iVar0;
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA685
{
	func_120(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA69A
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA74D
{
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA768
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA7B4
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA7FD
{
	if (func_384(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_126(int iParam0)//Position - 0xA81D
{
	switch (iParam0)
	{
		case 5:
...
int func_128(int iParam0)//Position - 0xA8ED
{
	switch (iParam0)
	{
		case 5:
...
void func_129(var uParam0, bool bParam1, bool bParam2)//Position - 0xA940
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xAA35
{
	switch (iParam0)
	{
		case 5:
...
void func_131(bool bParam0)//Position - 0xAAA0
{
	int iVar0;
...
void func_132(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xAADE
{
	if (bParam0)
	{
...
bool func_133()//Position - 0xAC17
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_134(int iParam0, int iParam1)//Position - 0xAC34
{
	bool bVar0;
...
int func_135(int iParam0, bool bParam1)//Position - 0xAC7F
{
	int iVar0;
	int iVar1;
...
int func_136(int iParam0)//Position - 0xACC0
{
...
bool func_137()//Position - 0xAD02
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_138(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAD13
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0xAD6D
{
	if (iParam0 == 1)
	{
...
int func_141(int iParam0)//Position - 0xAD90
{
...
int func_144(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xAE3A
{
...
void func_145(int iParam0)//Position - 0xAFC9
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_147(int iParam0)//Position - 0xB046
{
	if (func_151())
	{
		return;
...
void func_148(int iParam0)//Position - 0xB079
{
	if (func_151())
	{
		return;
...
void func_149(bool bParam0, bool bParam1)//Position - 0xB0F3
{
	if (bParam0)
	{
		if (func_150(0))
...
int func_150(int iParam0)//Position - 0xB167
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_151()//Position - 0xB1C1
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

int func_152(int iParam0)//Position - 0xB1D3
{
...
int func_153(int iParam0)//Position - 0xB214
{
	int iVar0;
...
void func_154(int iParam0)//Position - 0xB259
{
...
int func_155(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB28B
{
	int iVar0;
...
void func_156(var uParam0, int iParam1)//Position - 0xB3C2
{
	int iVar0;
...
bool func_157(int iParam0)//Position - 0xB411
{
	return func_158(iParam0, Global_36425);
}

int func_158(int iParam0, int iParam1)//Position - 0xB422
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_159(int iParam0)//Position - 0xB603
{
	if (Global_36425 == 15)
	{
		return 0;
...
int func_160()//Position - 0xB625
{
	return func_161(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_161(char* sParam0, int iParam1)//Position - 0xB636
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_163(int iParam0, int iParam1)//Position - 0xB6A3
{
	switch (iParam0)
	{
		case 0:
...
int func_164(vector3 vParam0, bool bParam3)//Position - 0xBB2A
{
	int iVar0;
...
float func_165(bool bParam0, float fParam1, float fParam2)//Position - 0xBB56
{
	if (bParam0)
	{
		return fParam1;
...
int func_166(int iParam0)//Position - 0xBB6D
{
	switch (iParam0)
	{
		case 0:
...
void func_167(var uParam0, int iParam1)//Position - 0xBBFC
{
	if (*iParam1)
	{
		switch (*uParam0)
...
void func_168(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBC65
{
...
void func_169(char* sParam0, int iParam1, int iParam2)//Position - 0xBC88
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(iParam1);
...
int func_170(var uParam0)//Position - 0xBCA5
{
	switch (*uParam0)
	{
		case 15:
...
int func_171(int iParam0)//Position - 0xBD4A
{
	var uVar0;
...
void func_172(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xBDA2
{
	int iVar0;
	int iVar1;
...
int func_173(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xBE89
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_174(bool bParam0)//Position - 0xC488
{
	int iVar0;
	int iVar1;
...
void func_175(int iParam0)//Position - 0xC70A
{
	int iVar0;
...
void func_176(int iParam0)//Position - 0xC764
{
	bool bVar0;
	char cVar1[64];
...
char* func_177(int iParam0)//Position - 0xC8F5
{
	switch (iParam0)
	{
		case 0:
...
void func_179(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xC9FF
{
	int iVar0;
...
int func_180(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xCA2F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_181(int iParam0)//Position - 0xCFE5
{
	func_202(93, iParam0);
	func_202(29, iParam0);
	func_202(30, iParam0);
...
bool func_182(int iParam0)//Position - 0xD005
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_183(int iParam0, int iParam1, int iParam2)//Position - 0xD1B5
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_184(int iParam0)//Position - 0xD1F2
{
	int iVar0;
...
int func_185(int iParam0, int iParam1)//Position - 0xD536
{
	int iVar0;
...
int func_186(bool bParam0)//Position - 0xD859
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_187(int iParam0, int iParam1)//Position - 0xD910
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_188(int iParam0, int iParam1)//Position - 0xD92B
{
...
int func_189(var uParam0, int iParam1)//Position - 0xD9C8
{
	int iVar0;
	var uVar1[78];
...
int func_190(var uParam0, int iParam1)//Position - 0xDA79
{
	int iVar0;
...
bool func_191(var uParam0, int iParam1)//Position - 0xDAF4
{
	return (*uParam0)[iParam1] == 78;
}

void func_192(var uParam0)//Position - 0xDB05
{
	int iVar0;
...
void func_193(var uParam0, int iParam1)//Position - 0xDB39
{
	(*uParam0)[iParam1] = 78;
}

void func_194(var uParam0, float fParam1)//Position - 0xDB49
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_195(var uParam0)//Position - 0xDB66
{
	return uParam0->f_80;
}

bool func_196(var uParam0, int iParam1)//Position - 0xDB72
{
	return func_197(uParam0, iParam1) != -1;
}

int func_197(var uParam0, int iParam1)//Position - 0xDB84
{
	int iVar0;
...
bool func_198(var uParam0)//Position - 0xDBB1
{
	return uParam0->f_79 == 1;
}

int func_199(int iParam0)//Position - 0xDBBF
{
	switch (iParam0)
	{
		case 60:
...
int func_200(int iParam0, int iParam1)//Position - 0xDC0F
{
	int iVar0;
...
void func_201(int iParam0, int iParam1)//Position - 0xDC60
{
	int iVar0;
...
void func_202(int iParam0, int iParam1)//Position - 0xDC83
{
	int iVar0;
...
int func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xDD55
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_205(int iParam0, int iParam1, int iParam2)//Position - 0xE56B
{
	int iVar0;
...
int func_206(int iParam0, int iParam1, int iParam2)//Position - 0xE5F7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_207(int iParam0)//Position - 0xE852
{
	switch (iParam0)
	{
...
void func_208(int iParam0, int iParam1, int iParam2)//Position - 0xE88D
{
	int iVar0;
	int iVar1;
...
int func_209(int iParam0, int iParam1, int iParam2)//Position - 0xE917
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_210(int iParam0, int iParam1, int iParam2)//Position - 0xE9F5
{
	Global_71402[1 /*14*/] = { func_252(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_211(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xEA20
{
	var uVar0;
	int iVar10;
...
int func_212(int iParam0, int iParam1, int iParam2)//Position - 0xF024
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF0BD
{
	int iVar0;
...
int func_214(int iParam0, int iParam1, int iParam2)//Position - 0xF153
{
	int iVar0;
	int iVar1;
...
int func_215(int iParam0)//Position - 0xF1F4
{
	switch (iParam0)
	{
		case 0:
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF2A4
{
	int iVar0;
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF5AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_218(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x1015F
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10443
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1070A
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10741
{
	int iVar0;
...
int func_222(int iParam0, int iParam1, int iParam2)//Position - 0x1076A
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_223(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10A34
{
	int iVar0;
...
int func_224(int iParam0, int iParam1, int iParam2)//Position - 0x10CBE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_225(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10E15
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10EAD
{
	switch (iParam0)
	{
...
int func_227(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10F7B
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_215(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_228(int iParam0, int iParam1)//Position - 0x110D7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_229(int iParam0)//Position - 0x1147E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_230(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x114DF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_231(int iParam0, int iParam1)//Position - 0x115DB
{
	int iVar0;
...
int func_232(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11719
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_215(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_233(int iParam0)//Position - 0x117F9
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_234(int iParam0, int iParam1)//Position - 0x1187F
{
	int iVar0;
	struct<10> Var1;
...
void func_235(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x121AE
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_236(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x122D8
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_237(int iParam0, int iParam1)//Position - 0x12320
{
	int iVar0;
	struct<17> Var1;
...
void func_238(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14169
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_239(int iParam0)//Position - 0x14353
{
	switch (iParam0)
	{
		case 0:
...
void func_240(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x14403
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_241(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14474
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_242(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x146F1
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_243(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14B16
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_244(int iParam0, int iParam1)//Position - 0x14E09
{
	int iVar0;
	int iVar1;
...
int func_245(int iParam0, int iParam1)//Position - 0x14E4F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_246(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14EAF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_247(int iParam0)//Position - 0x14F33
{
...
void func_248(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x14FEB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_249(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x15035
{
	int iVar0;
...
int func_250(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x16E06
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_251(int iParam0)//Position - 0x17D24
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_252(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x17D75
{
	func_315();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_253(int iParam0, int iParam1)//Position - 0x17DC7
{
	switch (iParam0)
	{
		case 0:
...
void func_254(int iParam0)//Position - 0x17EB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1924F
{
	int iVar0;
	int iVar1;
...
bool func_256(int iParam0, int iParam1, var uParam2)//Position - 0x195E0
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_257(int iParam0, int iParam1)//Position - 0x199E5
{
	switch (iParam1)
	{
		case 0:
...
int func_258(int iParam0, int iParam1)//Position - 0x19DE0
{
	switch (iParam1)
	{
		case 0:
...
int func_259(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x1A1DB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_260(int iParam0)//Position - 0x1A21D
{
	switch (iParam0)
	{
		case -1:
...
void func_261(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1A2F1
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_255(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_255(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_215(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_262(int iParam0)//Position - 0x1A5CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x1A721
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x1AC2F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x1ACA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x1AD18
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x1ADFF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x1B162
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x1B373
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x1B5A3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x1B6B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1C054
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1CBC7
{
	if (iParam0 < 136)
	{
		func_275(iParam0);
...
void func_274(int iParam0)//Position - 0x1CBFC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1D800
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1E70E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1E83B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0, int iParam1)//Position - 0x1E939
{
	switch (iParam0)
	{
		case 0:
...
void func_279(int iParam0)//Position - 0x1EA29
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1FF1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x2006D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x20578
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x20BE6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x20C5A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x20D2A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x2125A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x213F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x21BEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x21CFF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x22C2A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x238E7
{
	if (iParam0 < 107)
	{
		func_294(iParam0);
...
void func_292(int iParam0)//Position - 0x2392D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x243D3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x251C2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x25E0B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x26084
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0, int iParam1)//Position - 0x261CA
{
	switch (iParam0)
	{
		case 0:
...
void func_298(int iParam0)//Position - 0x262BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x27044
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x271BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x27735
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x27C5F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x27CD3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x27DA3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x2827D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x284E6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_307(int iParam0)//Position - 0x287BC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_308(int iParam0)//Position - 0x28985
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x294D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x2A123
{
	if (iParam0 < 60)
	{
		func_312(iParam0);
...
void func_311(int iParam0)//Position - 0x2A158
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312(int iParam0)//Position - 0x2AEF8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_313(int iParam0)//Position - 0x2B584
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_314(int iParam0)//Position - 0x2B66B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_315()//Position - 0x2B769
{
...
int func_316(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2B7E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_317(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2BBCA
{
	Global_71402[1 /*14*/] = { func_252(iParam0, iParam1, iParam2, -1) };
	if (MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 6))
	{
...
int func_318(int iParam0)//Position - 0x2BC66
{
...
int func_319(var uParam0, int iParam1)//Position - 0x2BCCF
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_320()//Position - 0x2C4B3
{
	func_27(&(Global_97130.f_2890), &Global_97130, 0, 1, 1, 0);
}

int func_321(var uParam0)//Position - 0x2C4CE
{
	float fVar0;
...
void func_322(int iParam0, int iParam1)//Position - 0x2C55C
{
	if (iParam0 == 1)
	{
		if (!func_128(iParam1))
...
int func_323(bool bParam0)//Position - 0x2C5C0
{
	int iVar0;
...
int func_324(int iParam0)//Position - 0x2C657
{
	if (func_384(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_325(int iParam0)//Position - 0x2C681
{
	int iVar0;
...
var func_326()//Position - 0x2CD9E
{
	return Global_93721.f_1;
}

int func_327()//Position - 0x2CDAC
{
	if (Global_90634 != -1)
	{
...
bool func_330()//Position - 0x2CE16
{
	return Global_93734.f_340 > 0;
}

bool func_331(int iParam0, int iParam1)//Position - 0x2CE27
{
	switch (iParam0)
	{
		case 5:
...
var func_332()//Position - 0x2CE62
{
	return Global_1312867;
}

int func_333()//Position - 0x2CE6E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_334(var uParam0, int iParam1)//Position - 0x2CE8A
{
	if (!*iParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_335(int iParam0, int iParam1, vector3 vParam2)//Position - 0x2CEDC
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
			...
			else
			{
				switch (func_337(*iParam0))
				{
					case 1:
						...
						{
							CUTSCENE::_REQUEST_CUTSCENE_EX(iParam1, 14, 8);
						}
						else
						{
...
void func_336(int iParam0, bool bParam1)//Position - 0x2CFCD
{
	if (iParam0 == -1)
	{
		return;
...
int func_337(int iParam0)//Position - 0x2D009
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_338(int iParam0, int iParam1)//Position - 0x2D042
{
	bool bVar0;
	int iVar1;
...
float func_339(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x2D0E0
{
	vector3 vVar0;
...
bool func_340()//Position - 0x2D11A
{
	return Global_91021;
}

void func_341(int iParam0)//Position - 0x2D126
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_342(iParam0);
...
void func_342(int iParam0)//Position - 0x2D13D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_343(int iParam0)//Position - 0x2D225
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
void func_344()//Position - 0x2D24D
{
	switch (iLocal_97)
	{
		case 0:
...
bool func_345(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2D30C
{
...
int func_346(char* sParam0, int iParam1, bool bParam2)//Position - 0x2D35A
{
	Global_15867 = 0;
...
void func_347()//Position - 0x2D626
{
	int iVar0;
...
void func_348()//Position - 0x2D658
{
...
void func_350()//Position - 0x2D786
{
	if (func_56(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
...
void func_351()//Position - 0x2D828
{
	int iVar0;
...
void func_352()//Position - 0x2D880
{
...
void func_353(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2D8D7
{
...
void func_354(int iParam0)//Position - 0x2D92D
{
	if (func_384(iParam0->f_28[0]))
	{
		switch (iLocal_272)
		{
			...
			case 1:
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0->f_28[0], vLocal_274[iLocal_273 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
...
void func_355()//Position - 0x2DB8C
{
	Global_14732 = 0;
	func_352();
}

int func_356()//Position - 0x2DB9C
{
...
int func_357(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0x2DBBE
{
	var uVar0;
	...
	if (func_325(2))
	{
		if (!func_356())
		{
			if (((func_384(PLAYER::PLAYER_PED_ID()) && func_384(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_339(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
...
int func_358(char* sParam0)//Position - 0x2DC80
{
	struct<6> Var0;
...
struct<6> func_359()//Position - 0x2DCA0
{
	struct<6> Var0;
...
void func_360(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2DCC4
{
...
void func_361()//Position - 0x2DCFF
{
	switch (iLocal_97)
	{
		case 0:
		...
		case 1:
			if (func_339(PLAYER::PLAYER_PED_ID(), 1826.45f, 4699.58f, 38.15f, 1) <= 25f && iLocal_264 == 0)
			{
...
int func_362(int iParam0, int iParam1)//Position - 0x2DDAA
{
	if (func_125(iParam0))
	{
...
void func_363()//Position - 0x2DDDD
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_268, "SET_COLOUR");
	...
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(iLocal_268, "SET_DISTANCE");
	...
	{
		AUDIO::PLAY_SOUND_FROM_COORD(iLocal_271, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_270 = MISC::GET_GAME_TIMER();
	}
}

int func_364(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x2DEA3
{
	vector3 vVar0;
...
int func_365(int iParam0, float fParam1)//Position - 0x2DF5E
{
	float fVar0;
...
bool func_366(int iParam0, float fParam1)//Position - 0x2DFD4
{
	return func_367(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_367(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2DFEC
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_368(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2E0AD
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_369(int iParam0, int iParam1)//Position - 0x2E1D9
{
	int iVar0;
...
int func_371(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2E2E8
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = { func_373(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_372(vector3 vParam0, vector3 vParam3)//Position - 0x2E379
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_373(vector3 vParam0)//Position - 0x2E39A
{
	float fVar0;
	float fVar1;
...
void func_374(var uParam0)//Position - 0x2E3D9
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_375(int iParam0, int iParam1)//Position - 0x2E3F4
{
	int iVar0;
...
int func_376(int iParam0)//Position - 0x2E433
{
...
bool func_377(int iParam0, int iParam1, float fParam2)//Position - 0x2E45B
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_378(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2E4A2
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_379(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2E59D
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_380(int iParam0, float fParam1)//Position - 0x2E6A9
{
	var uVar0;
	vector3 vVar1;
...
int func_381(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x2E73E
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_382(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2E7CC
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_383(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0x2E814
{
	var uVar0;
	
	if ((((func_384(PLAYER::PLAYER_PED_ID()) && func_384(uParam0->f_28[0])) && !func_356()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_339(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_425(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_360(&uVar0, cParam4, sParam5, 7, 0, 0);
...
int func_384(int iParam0)//Position - 0x2E89C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_385()//Position - 0x2E8BD
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
...
void func_386(int iParam0, int iParam1)//Position - 0x2E93D
{
	int iVar0;
...
void func_387(int iParam0)//Position - 0x2EA36
{
...
void func_388(int iParam0)//Position - 0x2EA84
{
	struct<7> Var0;
	bool bVar7;
	bool bVar8;
...
int func_390(int iParam0)//Position - 0x2EFE6
{
	int iVar0;
...
int func_391(int iParam0)//Position - 0x2F23B
{
	int iVar0;
...
int func_392(int iParam0)//Position - 0x2F2A7
{
	return iParam0;
}

void func_393(int iParam0, var uParam1)//Position - 0x2F2B1
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_394(iParam0) && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[26 /*34*/].f_6) == 0)
			{
				Global_106565.f_7255[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_106565.f_7255[iParam0], 1, 1);
			}
...
bool func_394(int iParam0)//Position - 0x2FC4C
{
	struct<7> Var0;
	int iVar7;
...
int func_395(int iParam0)//Position - 0x2FC80
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

struct<7> func_396(int iParam0)//Position - 0x2FC93
{
	struct<7> Var0;
...
int func_398()//Position - 0x328D0
{
	return Global_25766;
}

void func_399(int iParam0, bool bParam1)//Position - 0x328DB
{
	if (iParam0 == -1)
	{
		return;
...
void func_400(int iParam0, int iParam1, bool bParam2)//Position - 0x32938
{
	if (iParam0 == -1)
	{
		return;
...
bool func_401(int iParam0, int iParam1)//Position - 0x32973
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_402()//Position - 0x32996
{
...
void func_403(int iParam0)//Position - 0x32A09
{
	int iVar0;
...
int func_404(var uParam0, bool bParam1)//Position - 0x32A89
{
	struct<27> Var0;
...
void func_405(int iParam0, var uParam1, int iParam2)//Position - 0x32CFC
{
	int iVar0;
	int iVar1;
...
int func_406(int iParam0)//Position - 0x33054
{
...
int func_407(var uParam0)//Position - 0x33074
{
...
int func_408(var uParam0)//Position - 0x3308C
{
...
void func_409(var uParam0)//Position - 0x330B1
{
	int iVar0;
	int iVar1;
...
void func_410(int iParam0)//Position - 0x333B5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_411(var uParam0, bool bParam1, bool bParam2)//Position - 0x333E0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_412(int iParam0, int iParam1)//Position - 0x3359E
{
	int iVar0;
...
int func_413(var uParam0, bool bParam1, int iParam2)//Position - 0x335CE
{
	int iVar0;
	int iVar1;
...
int func_414(int iParam0)//Position - 0x3388A
{
...
int func_415(int iParam0)//Position - 0x338BE
{
...
void func_416(int iParam0)//Position - 0x33908
{
	int iVar0;
...
int func_417(int iParam0)//Position - 0x339A5
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_418(int iParam0)//Position - 0x33A3D
{
...
int func_421(int iParam0)//Position - 0x33ABF
{
...
int func_423(int iParam0)//Position - 0x33B31
{
	if (func_107(0))
	{
...
void func_424()//Position - 0x33B59
{
...
void func_425(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x33BC6
{
...
int func_426(int iParam0)//Position - 0x33C61
{
	switch (*iParam0)
	{
		case 9:
...
void func_431(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x342B7
{
	func_432(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

void func_432(int iParam0)//Position - 0x342D8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_433(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x34319
{
	func_434(iParam0);
...
void func_434(int iParam0)//Position - 0x3435B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_435(int iParam0)//Position - 0x343F7
{
	int iVar0;
...
int func_436(var uParam0)//Position - 0x34428
{
	uParam0->f_16 = 5;
...
int func_437(var uParam0)//Position - 0x3447E
{
	int iVar0[2];
	int iVar3;
	int iVar4;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_435(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar5))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_438(var uParam0)//Position - 0x347BC
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_439(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0x3493F
{
...
int func_440(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x3499B
{
	int iVar0;
...
int func_441(var uParam0, int iParam1)//Position - 0x34A29
{
	int iVar0;
...
int func_442(var uParam0)//Position - 0x34A6F
{
	if (func_408(uParam0))
	{
...
void func_443(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x34A99
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_444(var uParam0)//Position - 0x34AD5
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
int func_445(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0x34CFB
{
	bool bVar0;
	float fVar1;
...
int func_446(var uParam0)//Position - 0x34D57
{
	int iVar0[1];
	int iVar2;
	vector3 vVar3;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_439(&(uParam0->f_28[0]), 60, vVar3, fVar6, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
...
float func_447(float fParam0)//Position - 0x34F1E
{
	return (fParam0 * 57.29578f);
}

int func_448(var uParam0)//Position - 0x34F2E
{
	switch (iLocal_91)
	{
		case 0:
...
void func_449(int iParam0, bool bParam1)//Position - 0x34FF3
{
	char* sVar0;
	int iVar1;
...
int func_450(int iParam0)//Position - 0x35099
{
	struct<2> Var0;
...
struct<2> func_451(var uParam0)//Position - 0x350CD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_452(int iParam0, bool bParam1)//Position - 0x3511F
{
	struct<2> Var0;
...
var func_453(int iParam0, int iParam1)//Position - 0x35162
{
	struct<5> Var0;
...
struct<5> func_454(int iParam0)//Position - 0x35187
{
	struct<5> Var0;
	vector3 vVar5;
...
struct<6> func_455(int iParam0, bool bParam1)//Position - 0x37627
{
	struct<6> Var0;
...
void func_456(int iParam0, int iParam1)//Position - 0x381DE
{
...
int func_457(var uParam0)//Position - 0x38223
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_458(int iParam0)//Position - 0x38389
{
	struct<27> Var0;
	int iVar32;
...
int func_459(int iParam0)//Position - 0x383DD
{
	char* sVar0;
...
int func_460(int iParam0)//Position - 0x3849B
{
	var uVar0;
...
int func_461(int iParam0)//Position - 0x3855C
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		iVar9 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Global_88750[iParam0 /*10*/].f_3, &sVar1);
...
bool func_462(int iParam0, char* sParam1)//Position - 0x385E1
{
...
bool func_463(int iParam0)//Position - 0x386CE
{
...
bool func_464(int iParam0)//Position - 0x386FC
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_465(int iParam0)//Position - 0x3872A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_466(int iParam0)//Position - 0x38758
{
	if (func_418(iParam0))
	{
		return 0;
...
void func_467()//Position - 0x3878D
{
	func_487("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_468(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x387A8
{
	int iVar0;
...
int func_469(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0x3880E
{
	int iVar0;
	struct<7> Var1;
...
int func_470(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x3888C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_471(int iParam0, bool bParam1)//Position - 0x38907
{
	char* sVar0;
...
void func_472(char* sParam0)//Position - 0x38A16
{
...
void func_473()//Position - 0x38A35
{
	Global_14732 = 0;
	func_474();
}

void func_474()//Position - 0x38A45
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_475(var uParam0)//Position - 0x38A66
{
	if (func_408(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_476(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x38A9C
{
...
void func_477(var uParam0, bool bParam1)//Position - 0x38ABC
{
	func_478(&(uParam0->f_41), bParam1);
}

void func_478(var uParam0, bool bParam1)//Position - 0x38ACE
{
	int iVar0;
...
void func_479(int iParam0, bool bParam1)//Position - 0x38B0C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_480(var uParam0, bool bParam1)//Position - 0x38B47
{
	func_481(&(uParam0->f_35), bParam1);
}

void func_481(var uParam0, bool bParam1)//Position - 0x38B59
{
	int iVar0;
...
void func_482(int iParam0)//Position - 0x38B96
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_483(var uParam0, int iParam1)//Position - 0x38BCE
{
	func_484(&(uParam0->f_28), iParam1);
}

void func_484(var uParam0, int iParam1)//Position - 0x38BE0
{
	int iVar0;
...
void func_485(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x38C21
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_486(var uParam0)//Position - 0x38C71
{
	if (*uParam0 == -1)
	{
		return;
...
void func_487(int iParam0)//Position - 0x38CAE
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_488(var uParam0)//Position - 0x38CC0
{
	*uParam0 = -1;
...
void func_489()//Position - 0x38CF3
{
	func_487("Running start routines.");
	Global_106283++;
}

int func_490(int iParam0)//Position - 0x38D0E
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
