...
int func_59(int iParam0)//Position - 0x45C3
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x465E
{
...
int func_61(int iParam0, int iParam1)//Position - 0x47E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5355
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x5390
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5604
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x5640
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5B9B
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5BDF
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x62E6
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x632D
{
...
bool func_70(int iParam0)//Position - 0x6388
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6398
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x6402
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6723
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x672E
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x673E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x67E0
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6DE2
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6E40
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6EEE
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x6F83
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x6FC7
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x714B
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x7159
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7C20
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7CA2
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7D00
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7D09
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7F14
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x7F24
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7F41
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7F51
{
	switch (iParam0)
	{
		case -1:
...
int func_186(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCB8A
{
	var uVar0;
	
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(uParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_190(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_187(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC12
{
...
void func_188(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC4D
{
...
void func_189(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCCA3
{
...
float func_190(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCD3E
{
	vector3 vVar0;
...
void func_191(int iParam0, var uParam1, char* sParam2)//Position - 0xCD78
{
	if (func_126(*uParam1) && func_126(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				...
				BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				if (MISC::GET_GAME_TIMER() > iParam0->f_166)
				{
					...
					{
						BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_99, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
				...
				{
					BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			...
			case 4:
				if (func_192(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, true, 0))
					{
						BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
				...
				if (!func_145())
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "loop_talk", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "loop_talk") > 0.99f)
						{
							...
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, true, 0))
							{
								BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_99, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
...
bool func_192(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD074
{
...
int func_193(char* sParam0, int iParam1, bool bParam2)//Position - 0xD0C2
{
	Global_15867 = 0;
...
float func_199(int iParam0, int iParam1, bool bParam2)//Position - 0xD5E8
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_200(int iParam0, int iParam1, vector3 vParam2)//Position - 0xD646
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_201(int iParam0, bool bParam1)//Position - 0xD737
{
	if (iParam0 == -1)
	{
		return;
...
int func_202(int iParam0)//Position - 0xD773
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_203(int iParam0, int iParam1)//Position - 0xD7AC
{
	bool bVar0;
	int iVar1;
...
bool func_204()//Position - 0xD84A
{
	return Global_91021;
}

void func_205(int iParam0)//Position - 0xD856
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(iParam0);
...
void func_206(int iParam0)//Position - 0xD86D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_207(int iParam0)//Position - 0xD955
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_208(int iParam0, bool bParam1)//Position - 0xD97D
{
	struct<27> Var0;
...
void func_209(int iParam0, var uParam1, int iParam2)//Position - 0xDBF0
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0)//Position - 0xDF48
{
...
int func_211(var uParam0)//Position - 0xDF68
{
...
int func_212(var uParam0)//Position - 0xDF80
{
...
void func_213(var uParam0)//Position - 0xDFA5
{
	int iVar0;
	int iVar1;
...
void func_214(int iParam0)//Position - 0xE2A3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_215(var uParam0)//Position - 0xE2CE
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, bool bParam2)//Position - 0xE34E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_217(int iParam0, int iParam1)//Position - 0xE50C
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, int iParam2)//Position - 0xE53C
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE7F8
{
...
int func_220(int iParam0, float fParam1)//Position - 0xE82C
{
	float fVar0;
...
bool func_221(int iParam0, float fParam1)//Position - 0xE8A2
{
	return func_222(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE8BA
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_223(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE97B
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_224(int iParam0, int iParam1)//Position - 0xEAA7
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEBB6
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_227(vector3 vParam0, vector3 vParam3)//Position - 0xEC47
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_228(vector3 vParam0)//Position - 0xEC68
{
	float fVar0;
	float fVar1;
...
void func_229(var uParam0)//Position - 0xECA7
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_230(int iParam0, int iParam1)//Position - 0xECC2
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xED01
{
...
int func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xED29
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_233(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEE24
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_234(int iParam0, float fParam1)//Position - 0xEF30
{
	var uVar0;
	vector3 vVar1;
...
int func_235(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xEFC5
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_236(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF053
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_237(int iParam0)//Position - 0xF09B
{
...
void func_238(int iParam0)//Position - 0xF0E5
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xF182
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_240(int iParam0)//Position - 0xF21A
{
...
int func_243(int iParam0)//Position - 0xF29C
{
...
int func_245(int iParam0)//Position - 0xF30E
{
	if (func_107(0))
	{
...
int func_246(int iParam0)//Position - 0xF336
{
	switch (*iParam0)
	{
		case 0:
...
int func_247(var uParam0)//Position - 0xF37D
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_253(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_99))
			{
				return 0;
			}
			iLocal_91 = 2;
...
void func_248(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF52F
{
	func_249(iParam0);
...
void func_249(int iParam0)//Position - 0xF571
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xF60D
{
...
int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xF669
{
	int iVar0;
...
int func_252(var uParam0, int iParam1)//Position - 0xF6F7
{
	int iVar0;
...
int func_253(int iParam0)//Position - 0xF73D
{
	int iVar0;
...
void func_254(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF76E
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_255(var uParam0)//Position - 0xF7AA
{
	int iVar0;
	bool bVar1;
...
int func_256(int iParam0)//Position - 0xF8B5
{
	struct<27> Var0;
	int iVar32;
...
int func_257(int iParam0)//Position - 0xF909
{
	char* sVar0;
...
int func_258(int iParam0)//Position - 0xF9C2
{
	var uVar0;
...
int func_259(int iParam0)//Position - 0xFA83
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_260(int iParam0, char* sParam1)//Position - 0xFB08
{
...
bool func_261(int iParam0)//Position - 0xFBEA
{
...
bool func_262(int iParam0)//Position - 0xFC18
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_263(int iParam0)//Position - 0xFC46
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_264(int iParam0)//Position - 0xFC74
{
	if (func_240(iParam0))
	{
		return 0;
...
void func_265()//Position - 0xFCA9
{
	func_287("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_266(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xFCC3
{
	int iVar0;
...
int func_267(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xFD28
{
	int iVar0;
	struct<7> Var1;
...
int func_268(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xFDA6
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_269(int iParam0, bool bParam1)//Position - 0xFE21
{
	char* sVar0;
...
void func_270(char* sParam0)//Position - 0xFEA8
{
...
void func_271()//Position - 0xFEC7
{
	Global_14732 = 0;
	func_272();
}

void func_272()//Position - 0xFED7
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_273(char* sParam0)//Position - 0xFEF8
{
	struct<6> Var0;
...
struct<6> func_274()//Position - 0xFF18
{
	struct<6> Var0;
...
void func_275(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFF3C
{
...
void func_276(var uParam0, bool bParam1)//Position - 0xFF5C
{
	func_277(&(uParam0->f_41), bParam1);
}

void func_277(var uParam0, bool bParam1)//Position - 0xFF6E
{
	int iVar0;
...
void func_278(int iParam0, bool bParam1)//Position - 0xFFAC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_279(var uParam0, bool bParam1)//Position - 0xFFE7
{
	func_280(&(uParam0->f_35), bParam1);
}

void func_280(var uParam0, bool bParam1)//Position - 0xFFF9
{
	int iVar0;
...
void func_281(int iParam0)//Position - 0x10037
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_282(var uParam0, int iParam1)//Position - 0x1006F
{
	func_283(&(uParam0->f_28), iParam1);
}

void func_283(var uParam0, int iParam1)//Position - 0x10081
{
	int iVar0;
...
void func_284(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x100C2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_285(int iParam0)//Position - 0x10112
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_286(var uParam0)//Position - 0x10153
{
	if (*uParam0 == -1)
	{
		return;
...
void func_287(int iParam0)//Position - 0x10190
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_288(var uParam0)//Position - 0x101A2
{
	*uParam0 = -1;
...
void func_289()//Position - 0x101D5
{
	func_287("Running start routines.");
	Global_106283++;
}

int func_290(int iParam0)//Position - 0x101EF
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
