...
int func_22(struct<109> Param0, var uParam109)//Position - 0xBDC
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
...
void func_23(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)//Position - 0x3F56
{
...
bool func_27(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x424E
{
	if (bParam6)
	{
