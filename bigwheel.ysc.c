...
void func_19(var uParam0, float fParam1)//Position - 0x1116
{
	...
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_1, iLocal_160, iVar0, 1000f, -8f, 0, 0, 1148846080, 0);
	...
	BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_160, func_21(iLocal_286), 1000f, -8f, -1, 1, 0, 0, 0, 0);
	PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
}
...
void func_31()//Position - 0x14FB
{
	...
	func_199(&uLocal_40, 2, 2, iLocal_160, 0);
	...
	while (iVar0 < 2)
	{
		...
		if (iVar2 != 0)
		{
			...
			if (func_30(uParam0->f_4[iVar0]))
			{
				...
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_4[iVar0], uParam0->f_1, iLocal_160, iVar3, 1000f, -8f, 0, 0, 1148846080, 0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_62(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_62(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x6868
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_63(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x6B5E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_67(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x6D13
{
	int iVar0;
...
int func_119(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFE1A
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_120(int iParam0)//Position - 0x10D3A
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10D8B
{
	func_184();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_122(int iParam0, int iParam1)//Position - 0x10DDD
{
	switch (iParam0)
	{
		case 0:
...
void func_123(int iParam0)//Position - 0x10ECD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x12144
{
	int iVar0;
	int iVar1;
...
bool func_125(int iParam0, int iParam1, var uParam2)//Position - 0x124D5
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_126(int iParam0, int iParam1)//Position - 0x128DA
{
	switch (iParam1)
	{
		case 0:
...
int func_127(int iParam0, int iParam1)//Position - 0x12CD5
{
	switch (iParam1)
	{
		case 0:
...
int func_128(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x130D0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0x13112
{
	switch (iParam0)
	{
		case -1:
...
void func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x131E6
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_124(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_124(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_131(int iParam0)//Position - 0x134BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x13616
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x13B24
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x13B99
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x13C0D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x13CF4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x14059
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x1426A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1449A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x145AA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x14F49
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x15ABC
{
	if (iParam0 < 136)
	{
		func_144(iParam0);
...
void func_143(int iParam0)//Position - 0x15AF1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x166F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x17603
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x17730
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0, int iParam1)//Position - 0x1782E
{
	switch (iParam0)
	{
		case 0:
...
void func_148(int iParam0)//Position - 0x1791E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x18E11
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x18F62
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1946D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x19ADB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x19B4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x19C1F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1A14F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1A2E6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1AAE4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1ABF4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1BB1F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1C7DE
{
	if (iParam0 < 107)
	{
		func_163(iParam0);
...
void func_161(int iParam0)//Position - 0x1C824
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1D2C9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1E0B8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1ED01
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1EF7A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0, int iParam1)//Position - 0x1F0C0
{
	switch (iParam0)
	{
		case 0:
...
void func_167(int iParam0)//Position - 0x1F1B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1FF3A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x200B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x2062C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x20B56
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x20BCA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x20C9A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x21172
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x213DB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x216B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x2187A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x223CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x23018
{
	if (iParam0 < 60)
	{
		func_181(iParam0);
...
void func_180(int iParam0)//Position - 0x2304D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x23DED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x2447C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x24563
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184()//Position - 0x24661
{
...
int func_185(int iParam0, int iParam1, int iParam2)//Position - 0x246DA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_186(bool bParam0)//Position - 0x24935
{
	int iVar0;
...
void func_187(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x24973
{
	if (bParam0)
	{
...
bool func_188()//Position - 0x24AAC
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_189(int iParam0, int iParam1)//Position - 0x24AC9
{
	bool bVar0;
...
int func_190(int iParam0, bool bParam1)//Position - 0x24B14
{
	int iVar0;
	int iVar1;
...
int func_191(int iParam0)//Position - 0x24B55
{
...
bool func_192()//Position - 0x24B97
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_193(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x24BA8
{
	int iVar0;
...
void func_195(int iParam0)//Position - 0x24C02
{
	if (iParam0 == 1)
	{
...
bool func_196(var uParam0)//Position - 0x24C25
{
	int iVar0;
	int iVar1;
...
int func_197(var uParam0, int iParam1)//Position - 0x24C99
{
...
int func_198(var uParam0, int iParam1)//Position - 0x24E9F
{
...
int func_199(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4)//Position - 0x2503C
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_200(var uParam0)//Position - 0x25114
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_201(var uParam0, int iParam1, int iParam2)//Position - 0x25139
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_202(bool bParam0)//Position - 0x25188
{
	if (bParam0)
	{
		func_207();
...
void func_203(int iParam0)//Position - 0x251EB
{
	if (func_205())
	{
		return;
...
void func_204(bool bParam0, bool bParam1)//Position - 0x25265
{
	if (bParam0)
	{
		if (func_206(0))
...
bool func_205()//Position - 0x252D9
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

int func_206(int iParam0)//Position - 0x252EB
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
void func_207()//Position - 0x25345
{
...
void func_208(bool bParam0)//Position - 0x2536E
{
	if (bParam0)
	{
		HUD::CLEAR_HELP(1);
...
void func_209(int iParam0, int iParam1, int iParam2)//Position - 0x2548F
{
	bool bVar0;
...
void func_210()//Position - 0x25577
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_212(bool bParam0)//Position - 0x25A83
{
...
int func_213(int iParam0, int iParam1)//Position - 0x25AAE
{
	int iVar0;
...
int func_214(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x25AFF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_215(var uParam0)//Position - 0x260B5
{
	int iVar0;
...
int func_216(var uParam0, int iParam1)//Position - 0x260DA
{
...
void func_217(int iParam0, int iParam1)//Position - 0x262CD
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, int iParam2)//Position - 0x2631A
{
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x26363
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_220(bool bParam0)//Position - 0x26962
{
	int iVar0;
	int iVar1;
...
void func_221(int iParam0)//Position - 0x26BE4
{
	int iVar0;
...
void func_222(int iParam0)//Position - 0x26C3E
{
	bool bVar0;
	char cVar1[64];
...
char* func_223(int iParam0)//Position - 0x26DCF
{
	switch (iParam0)
	{
		case 0:
...
void func_225(int iParam0)//Position - 0x26ED9
{
	func_245(93, iParam0);
	func_245(29, iParam0);
	func_245(30, iParam0);
...
bool func_226(int iParam0)//Position - 0x26EF9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_227(int iParam0, int iParam1, int iParam2)//Position - 0x270A9
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_228(int iParam0)//Position - 0x270E6
{
	int iVar0;
...
int func_229(int iParam0, int iParam1)//Position - 0x2742A
{
	int iVar0;
...
int func_230(bool bParam0)//Position - 0x2774D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_231(int iParam0, int iParam1)//Position - 0x27804
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_232(int iParam0, int iParam1)//Position - 0x2781F
{
...
int func_233(var uParam0, int iParam1)//Position - 0x278BC
{
	int iVar0;
	var uVar1[78];
...
int func_234(var uParam0, int iParam1)//Position - 0x2796D
{
	int iVar0;
...
bool func_235(var uParam0, int iParam1)//Position - 0x279E8
{
	return (*uParam0)[iParam1] == 78;
}

void func_236(var uParam0)//Position - 0x279F9
{
	int iVar0;
...
void func_237(var uParam0, int iParam1)//Position - 0x27A2D
{
	(*uParam0)[iParam1] = 78;
}

void func_238(var uParam0, float fParam1)//Position - 0x27A3D
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_239(var uParam0)//Position - 0x27A5A
{
	return uParam0->f_80;
}

bool func_240(var uParam0, int iParam1)//Position - 0x27A66
{
	return func_241(uParam0, iParam1) != -1;
}

int func_241(var uParam0, int iParam1)//Position - 0x27A78
{
	int iVar0;
...
bool func_242(var uParam0)//Position - 0x27AA5
{
	return uParam0->f_79 == 1;
}

int func_243(int iParam0)//Position - 0x27AB3
{
	switch (iParam0)
	{
		case 60:
...
void func_244(int iParam0, int iParam1)//Position - 0x27B03
{
	int iVar0;
...
void func_245(int iParam0, int iParam1)//Position - 0x27B26
{
	int iVar0;
...
void func_246()//Position - 0x27B83
{
	int iVar0;
...
void func_247(int iParam0, int iParam1, int iParam2, float fParam3)//Position - 0x27BF8
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_248(int iParam0, bool bParam1)//Position - 0x27C7B
{
	if (bParam1)
	{
	}
...
var func_249(int iParam0)//Position - 0x27C8C
{
	var uVar0;
...
int func_250(int iParam0)//Position - 0x27C9E
{
	if (iParam0 > -1)
	{
		if (iParam0 == PLAYER::PLAYER_ID())
...
int func_251(int iParam0)//Position - 0x27CE1
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_252(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x27D06
{
	int iVar0;
...
int func_253(int iParam0)//Position - 0x27DAF
{
	if (func_26(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_254()//Position - 0x27DCF
{
	int iVar0;
...
void func_255(int iParam0)//Position - 0x27E7A
{
	if (*iParam0 != -1)
	{
