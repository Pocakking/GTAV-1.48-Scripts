...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3875
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3A15
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x3A47
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3A7B
{
	return Global_1312745;
}

int func_51(int iParam0, int iParam1)//Position - 0x3A87
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3AB3
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3FFB
{
	int iVar0;
...
int func_54()//Position - 0x4241
{
	func_55();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_55()//Position - 0x425A
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4357
{
	return Global_36425 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4365
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4458
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x46E0
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x477B
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4901
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5472
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x54AD
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5721
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x575D
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5CB8
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5CFC
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6403
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x644A
{
...
bool func_70(int iParam0)//Position - 0x64A5
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x64B5
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x651F
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6840
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x684B
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x685B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x68FD
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6EFF
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6F5D
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x700B
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x70A0
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x70E4
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7268
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x7276
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7D3D
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7DBF
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7E1D
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7E26
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x8032
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x8042
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x805F
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x806F
{
	switch (iParam0)
	{
		case -1:
...
bool func_92()//Position - 0x8330
{
	return Global_93734.f_339 > 0;
}

var func_93()//Position - 0x8341
{
	var uVar0;
...
void func_94(var uParam0, int iParam1)//Position - 0x8387
{
	if (iParam1 <= 0)
	{
		return;
...
void func_95(var uParam0, int iParam1)//Position - 0x840D
{
...
void func_96(var uParam0, int iParam1)//Position - 0x8440
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1)//Position - 0x8491
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_98(int iParam0)//Position - 0x8533
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_99(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_99(bool bParam0, int iParam1, int iParam2)//Position - 0x8558
{
	if (bParam0)
	{
		return iParam1;
...
int func_100(var uParam0)//Position - 0x856F
{
	return uParam0 & 15;
}

void func_101(var uParam0, int iParam1)//Position - 0x857C
{
...
void func_102(var uParam0, int iParam1)//Position - 0x85B6
{
...
void func_103(var uParam0, int iParam1)//Position - 0x85F1
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_104()//Position - 0x862D
{
	func_55();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_105(int iParam0)//Position - 0x8646
{
	var uVar0;
	vector3 vVar1[24];
...
void func_106(char* sParam0, int iParam1, int iParam2)//Position - 0x869F
{
...
bool func_107(bool bParam0)//Position - 0x86E1
{
...
struct<2> func_108(int iParam0)//Position - 0x870C
{
	struct<2> Var0;
...
void func_109(int iParam0, var uParam1)//Position - 0x8B59
{
	switch (iParam0)
	{
		case 0:
...
int func_111(int iParam0)//Position - 0x9E31
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0xA177
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0xA21B
{
	struct<2> Var0;
...
void func_114(int iParam0)//Position - 0xA2B6
{
	if (iParam0 < 63)
	{
		func_115();
...
void func_116(int iParam0)//Position - 0xA314
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0)//Position - 0xA36D
{
...
int func_118(int iParam0)//Position - 0xA3F0
{
	int iVar0;
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA421
{
	func_120(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA436
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA4E9
{
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA504
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA550
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA599
{
	if (func_199(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_128(int iParam0)//Position - 0xA689
{
	switch (iParam0)
	{
		case 5:
...
void func_129(var uParam0, bool bParam1, bool bParam2)//Position - 0xA6DC
{
	int iVar0;
...
void func_131(bool bParam0)//Position - 0xA83C
{
	int iVar0;
...
void func_132(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xA87A
{
	if (bParam0)
	{
...
bool func_133()//Position - 0xA9B3
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_134(int iParam0, int iParam1)//Position - 0xA9D0
{
	bool bVar0;
...
int func_135(int iParam0, bool bParam1)//Position - 0xAA1B
{
	int iVar0;
	int iVar1;
...
int func_136(int iParam0)//Position - 0xAA5C
{
...
bool func_137()//Position - 0xAA9E
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_138(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAAAF
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0xAB09
{
	if (iParam0 == 1)
	{
...
int func_141(int iParam0)//Position - 0xAB2C
{
...
void func_142()//Position - 0xAB69
{
	Global_14732 = 0;
	func_143();
}

void func_143()//Position - 0xAB79
{
...
int func_147(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xAC5F
{
...
void func_148(int iParam0)//Position - 0xADEE
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_150(int iParam0)//Position - 0xAE6B
{
	if (func_154())
	{
		return;
...
void func_151(int iParam0)//Position - 0xAE9E
{
	if (func_154())
	{
		return;
...
void func_152(bool bParam0, bool bParam1)//Position - 0xAF18
{
	if (bParam0)
	{
		if (func_153(0))
...
int func_153(int iParam0)//Position - 0xAF8C
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_154()//Position - 0xAFE6
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

int func_155(int iParam0)//Position - 0xAFF8
{
...
int func_156(int iParam0)//Position - 0xB039
{
	int iVar0;
...
void func_157(int iParam0)//Position - 0xB07E
{
...
int func_158(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB0B0
{
	int iVar0;
...
void func_159(var uParam0, int iParam1)//Position - 0xB1E7
{
	int iVar0;
...
bool func_160(int iParam0)//Position - 0xB236
{
	return func_161(iParam0, Global_36425);
}

int func_161(int iParam0, int iParam1)//Position - 0xB247
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_162(int iParam0)//Position - 0xB428
{
	if (Global_36425 == 15)
	{
		return 0;
...
int func_163()//Position - 0xB44A
{
	return func_164(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_164(char* sParam0, int iParam1)//Position - 0xB45B
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_166(int iParam0, int iParam1)//Position - 0xB4C8
{
	switch (iParam0)
	{
		case 0:
...
int func_167(vector3 vParam0, bool bParam3)//Position - 0xB94F
{
	int iVar0;
...
float func_168(bool bParam0, float fParam1, float fParam2)//Position - 0xB97B
{
	if (bParam0)
	{
		return fParam1;
...
int func_169(int iParam0)//Position - 0xB992
{
	switch (iParam0)
	{
		case 0:
...
int func_170(var uParam0)//Position - 0xBA21
{
	if (*uParam0 == 30)
	{
...
float func_171(int iParam0, int iParam1, bool bParam2)//Position - 0xBAA0
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_172(var uParam0)//Position - 0xBAFE
{
	if (*uParam0 == 29)
	{
...
int func_173(int iParam0, int iParam1)//Position - 0xBB91
{
	if (func_125(iParam0))
	{
...
int func_174(var uParam0)//Position - 0xBBC4
{
	if (*uParam0 == 28)
	{
...
int func_175(var uParam0, int iParam1)//Position - 0xBC5B
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_176()//Position - 0xC441
{
	func_27(&(Global_97130.f_2890), &Global_97130, 0, 1, 1, 0);
}

int func_177(var uParam0)//Position - 0xC45C
{
	float fVar0;
...
void func_178(int iParam0, int iParam1)//Position - 0xC4EA
{
	if (iParam0 == 1)
	{
		if (!func_128(iParam1))
...
int func_179(bool bParam0)//Position - 0xC54E
{
	int iVar0;
...
int func_180(int iParam0)//Position - 0xC5E5
{
	if (func_199(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_181(int iParam0)//Position - 0xC60F
{
	int iVar0;
...
var func_182()//Position - 0xCD2C
{
	return Global_93721.f_1;
}

int func_183()//Position - 0xCD3A
{
	if (Global_90634 != -1)
	{
...
bool func_186()//Position - 0xCDA4
{
	return Global_93734.f_340 > 0;
}

bool func_187(int iParam0, int iParam1)//Position - 0xCDB5
{
	switch (iParam0)
	{
		case 5:
...
var func_188()//Position - 0xCDF0
{
	return Global_1312867;
}

int func_189()//Position - 0xCDFC
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_191(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCEE4
{
...
int func_192(char* sParam0, int iParam1, bool bParam2)//Position - 0xCF32
{
	Global_15867 = 0;
...
void func_198(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD458
{
...
int func_199(int iParam0)//Position - 0xD4AE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_200(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD4CF
{
	var uVar0;
	
	if ((((func_199(PLAYER::PLAYER_PED_ID()) && func_199(iParam0->f_28[0])) && !func_144()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_211(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_201(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD557
{
...
void func_202(int iParam0, int iParam1, vector3 vParam2)//Position - 0xD592
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_203(int iParam0, bool bParam1)//Position - 0xD683
{
	if (iParam0 == -1)
	{
		return;
...
int func_204(int iParam0)//Position - 0xD6BF
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_205(int iParam0, int iParam1)//Position - 0xD6F8
{
	bool bVar0;
	int iVar1;
...
bool func_206()//Position - 0xD796
{
	return Global_91021;
}

void func_207(int iParam0)//Position - 0xD7A2
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_208(iParam0);
...
void func_208(int iParam0)//Position - 0xD7B9
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_209(int iParam0)//Position - 0xD8A1
{
	if (iParam0 == -1)
	{
		iParam0 = func_163();
...
void func_210(int iParam0)//Position - 0xD8C9
{
	int iVar0;
...
float func_211(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xD949
{
	vector3 vVar0;
...
int func_212(var uParam0, bool bParam1)//Position - 0xD983
{
	struct<27> Var0;
...
void func_213(int iParam0, var uParam1, int iParam2)//Position - 0xDBF6
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xDF4E
{
...
int func_215(var uParam0)//Position - 0xDF6E
{
...
int func_216(var uParam0)//Position - 0xDF86
{
...
void func_217(var uParam0)//Position - 0xDFAB
{
	int iVar0;
	int iVar1;
...
void func_218(int iParam0)//Position - 0xE2AF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_219(var uParam0, bool bParam1, bool bParam2)//Position - 0xE2DA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_220(int iParam0, int iParam1)//Position - 0xE498
{
	int iVar0;
...
int func_221(var uParam0, bool bParam1, int iParam2)//Position - 0xE4C8
{
	int iVar0;
	int iVar1;
...
int func_222(int iParam0)//Position - 0xE784
{
...
int func_223(int iParam0, float fParam1)//Position - 0xE7B8
{
	float fVar0;
...
bool func_224(int iParam0, float fParam1)//Position - 0xE82E
{
	return func_225(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_225(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE846
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_226(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE907
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_227(int iParam0, int iParam1)//Position - 0xEA33
{
	int iVar0;
...
int func_229(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEB42
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = { func_231(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_230(vector3 vParam0, vector3 vParam3)//Position - 0xEBD3
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_231(vector3 vParam0)//Position - 0xEBF4
{
	float fVar0;
	float fVar1;
...
void func_232(var uParam0)//Position - 0xEC33
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(int iParam0, int iParam1)//Position - 0xEC4E
{
	int iVar0;
...
int func_234(int iParam0)//Position - 0xEC8D
{
...
int func_235(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xECB5
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_236(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEDB0
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_237(int iParam0, float fParam1)//Position - 0xEEBC
{
	var uVar0;
	vector3 vVar1;
...
int func_238(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xEF51
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_239(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEFDF
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_241(int iParam0)//Position - 0xF071
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0xF10E
{
	if (iParam0 == -1)
	{
		iParam0 = func_163();
...
int func_243(int iParam0)//Position - 0xF1A6
{
...
int func_246(int iParam0)//Position - 0xF228
{
...
int func_248(int iParam0)//Position - 0xF29A
{
	if (func_107(0))
	{
...
void func_249(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xF2C2
{
...
int func_250(int iParam0)//Position - 0xF35D
{
	switch (*iParam0)
	{
		case 27:
...
int func_251(var uParam0)//Position - 0xF3D2
{
	int iVar0[4];
	int iVar5;
	float fVar6;
...
void func_252(int iParam0, bool bParam1)//Position - 0xF7C7
{
	vector3 vVar0;
	float fVar3;
	...
	func_253(iParam0, iLocal_93, vVar0, fVar3);
...
void func_253(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF83B
{
	func_254(iParam0);
...
void func_254(int iParam0)//Position - 0xF87D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_255(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0xF919
{
	func_256(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

void func_256(int iParam0)//Position - 0xF93A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_257(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xF97B
{
	if (func_258(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_258(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xF9D7
{
	int iVar0;
...
int func_259(var uParam0, int iParam1)//Position - 0xFA65
{
	int iVar0;
...
int func_260(bool bParam0, bool bParam1)//Position - 0xFAAB
{
	int iVar0;
...
int func_261(bool bParam0, bool bParam1)//Position - 0xFB19
{
	int iVar0;
...
int func_262(var uParam0)//Position - 0xFBBF
{
	if (func_216(uParam0))
	{
...
int func_263(int iParam0)//Position - 0xFBE9
{
	int iVar0;
...
void func_264(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xFC1A
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_265(var uParam0)//Position - 0xFC56
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
void func_266(int iParam0)//Position - 0xFE3E
{
	func_253(iParam0, iLocal_93, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*iParam0, 4);
...
int func_267(var uParam0)//Position - 0xFE84
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_199(uParam0->f_28[0]))
			{
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
int func_268(var uParam0)//Position - 0x100A9
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
int func_269(bool bParam0, bool bParam1)//Position - 0x10216
{
	int iVar0;
...
int func_270(int iParam0)//Position - 0x10284
{
	struct<27> Var0;
	int iVar32;
...
int func_271(int iParam0)//Position - 0x102D8
{
	char* sVar0;
...
int func_272(int iParam0)//Position - 0x10391
{
	var uVar0;
...
int func_273(int iParam0)//Position - 0x10452
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_274(int iParam0, char* sParam1)//Position - 0x104D7
{
...
bool func_275(int iParam0)//Position - 0x105B9
{
...
bool func_276(int iParam0)//Position - 0x105E7
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_277(int iParam0)//Position - 0x10615
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_278(int iParam0)//Position - 0x10643
{
	if (func_243(iParam0))
	{
		return 0;
...
void func_279()//Position - 0x10678
{
	func_301("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_280(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x10692
{
	int iVar0;
...
int func_281(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0x106F7
{
	int iVar0;
	struct<7> Var1;
...
int func_282(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x10775
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_283(int iParam0, bool bParam1)//Position - 0x107F0
{
	char* sVar0;
...
void func_284(char* sParam0)//Position - 0x1089E
{
...
void func_285()//Position - 0x108BD
{
	Global_14732 = 0;
	func_286();
}

void func_286()//Position - 0x108CD
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_287(char* sParam0)//Position - 0x108EE
{
	struct<6> Var0;
...
struct<6> func_288()//Position - 0x1090E
{
	struct<6> Var0;
...
int func_289(var uParam0)//Position - 0x10932
{
	if (func_216(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_290(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10968
{
...
void func_291(var uParam0, bool bParam1)//Position - 0x10988
{
	func_292(&(uParam0->f_41), bParam1);
}

void func_292(var uParam0, bool bParam1)//Position - 0x1099A
{
	int iVar0;
...
void func_293(int iParam0, bool bParam1)//Position - 0x109D8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_294(var uParam0, bool bParam1)//Position - 0x10A13
{
	func_295(&(uParam0->f_35), bParam1);
}

void func_295(var uParam0, bool bParam1)//Position - 0x10A25
{
	int iVar0;
...
void func_296(int iParam0)//Position - 0x10A62
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_297(var uParam0, int iParam1)//Position - 0x10A9A
{
	func_298(&(uParam0->f_28), iParam1);
}

void func_298(var uParam0, int iParam1)//Position - 0x10AAC
{
	int iVar0;
...
void func_299(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10AED
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_300(var uParam0)//Position - 0x10B3D
{
	if (*uParam0 == -1)
	{
		return;
...
void func_301(int iParam0)//Position - 0x10B7A
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_302(var uParam0)//Position - 0x10B8C
{
	*uParam0 = -1;
...
void func_303()//Position - 0x10BBF
{
	func_301("Running start routines.");
	Global_106283++;
}

int func_304(int iParam0)//Position - 0x10BD9
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
