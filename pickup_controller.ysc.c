	...
	switch (Global_26006)
	{
		...
		case 1:
			switch (Global_26007)
			{
				...
				case 1:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_86[Global_26008]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_86[Global_26008]))
					{
						Global_26009 = 0;
					}
					else
				...
				case 2:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_163[Global_26008]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_163[Global_26008]))
					{
						Global_26009 = 0;
					}
					else
