...
int func_59(int iParam0)//Position - 0x45FF
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x469A
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4820
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5391
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x53CC
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5640
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x567C
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5BD7
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5C1B
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6322
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x6369
{
...
bool func_70(int iParam0)//Position - 0x63C4
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x63D4
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x643E
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x675F
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x676A
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x677A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x681C
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6E1E
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6E7C
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6F2A
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x6FBF
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x7003
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7187
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x7195
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7C5C
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7CDE
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7D3C
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7D45
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7F50
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x7F60
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7F7D
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7F8D
{
	switch (iParam0)
	{
		case -1:
...
void func_185(int iParam0)//Position - 0xCB68
{
	if (iLocal_97 == -1)
	{
...
void func_186(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xCBB8
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_187(iParam3), 0);
}

int func_187(int iParam0)//Position - 0xCBD1
{
	int iVar0;
...
int func_188(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCDC6
{
	var uVar0;
	
	if ((((func_196(PLAYER::PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && !func_144()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCE4E
{
...
void func_190(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCE89
{
...
void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCEDF
{
...
float func_192(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCF7A
{
	vector3 vVar0;
...
int func_193(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xCFB4
{
	var uVar0;
	...
	if (func_176(2))
	{
		if (!func_144())
		{
			if (((func_196(PLAYER::PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_191(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_189(&uVar0, cParam4, sParam5, 7, 0, 0);
...
int func_194(char* sParam0)//Position - 0xD076
{
	struct<6> Var0;
...
struct<6> func_195()//Position - 0xD096
{
	struct<6> Var0;
...
int func_196(int iParam0)//Position - 0xD0BA
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_197(int iParam0, int iParam1, vector3 vParam2)//Position - 0xD0DB
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_198(int iParam0, bool bParam1)//Position - 0xD1CC
{
	if (iParam0 == -1)
	{
		return;
...
int func_199(int iParam0)//Position - 0xD208
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_200(int iParam0, int iParam1)//Position - 0xD241
{
	bool bVar0;
	int iVar1;
...
bool func_201()//Position - 0xD2DF
{
	return Global_91021;
}

void func_202(int iParam0)//Position - 0xD2EB
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD302
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_204(int iParam0)//Position - 0xD3EA
{
	if (iParam0 == -1)
	{
		iParam0 = func_163();
...
int func_205(var uParam0, bool bParam1)//Position - 0xD412
{
	struct<27> Var0;
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD685
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0)//Position - 0xD9DD
{
...
int func_208(var uParam0)//Position - 0xD9FD
{
...
int func_209(var uParam0)//Position - 0xDA15
{
...
void func_210(var uParam0)//Position - 0xDA3A
{
	int iVar0;
	int iVar1;
...
void func_211(int iParam0)//Position - 0xDD3E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_212(var uParam0)//Position - 0xDD69
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDDE9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1)//Position - 0xDFA7
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xDFD7
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE293
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE2C7
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xE33D
{
	return func_219(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE355
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_220(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE416
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE542
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE651
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_224(vector3 vParam0, vector3 vParam3)//Position - 0xE6E2
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_225(vector3 vParam0)//Position - 0xE703
{
	float fVar0;
	float fVar1;
...
void func_226(var uParam0)//Position - 0xE742
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(int iParam0, int iParam1)//Position - 0xE75D
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE79C
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE7C4
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE8BF
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_231(int iParam0, float fParam1)//Position - 0xE9CB
{
	var uVar0;
	vector3 vVar1;
...
int func_232(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xEA60
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEAEE
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_234(int iParam0)//Position - 0xEB36
{
...
void func_235(int iParam0)//Position - 0xEB80
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xEC1D
{
	if (iParam0 == -1)
	{
		iParam0 = func_163();
...
int func_237(int iParam0)//Position - 0xECB5
{
...
int func_240(int iParam0)//Position - 0xED37
{
...
int func_242(int iParam0)//Position - 0xEDA9
{
	if (func_107(0))
	{
...
int func_243(int iParam0)//Position - 0xEDD1
{
	switch (*iParam0)
	{
		case 21:
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xF244
{
	if (func_247(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xF2A0
{
	int iVar0;
...
int func_248(var uParam0, int iParam1)//Position - 0xF32E
{
	int iVar0;
...
int func_249(var uParam0)//Position - 0xF374
{
	if (func_209(uParam0))
	{
...
int func_250(int iParam0)//Position - 0xF39E
{
	int iVar0;
...
void func_251(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF3CF
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_252(var uParam0)//Position - 0xF40B
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
void func_254(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF74F
{
	func_255(iParam0);
...
void func_255(int iParam0)//Position - 0xF791
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_256(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0xF82D
{
	func_257(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

void func_257(int iParam0)//Position - 0xF84E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_258(var uParam0)//Position - 0xF88F
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_260(int iParam0)//Position - 0xFA3E
{
	char* sVar0;
...
int func_261(int iParam0)//Position - 0xFAF7
{
	var uVar0;
...
int func_262(int iParam0)//Position - 0xFBB8
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_263(int iParam0, char* sParam1)//Position - 0xFC3D
{
...
bool func_264(int iParam0)//Position - 0xFD1F
{
...
bool func_265(int iParam0)//Position - 0xFD4D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_266(int iParam0)//Position - 0xFD7B
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_267(int iParam0)//Position - 0xFDA9
{
	if (func_237(iParam0))
	{
		return 0;
...
void func_268()//Position - 0xFDDE
{
	func_288("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_269(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xFDF8
{
	int iVar0;
...
int func_270(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xFE5D
{
	int iVar0;
	struct<7> Var1;
...
int func_271(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xFEDB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_272(int iParam0, bool bParam1)//Position - 0xFF56
{
	char* sVar0;
...
void func_273(char* sParam0)//Position - 0xFFFA
{
...
void func_274()//Position - 0x1001A
{
	Global_14732 = 0;
	func_275();
}

void func_275()//Position - 0x1002A
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_276(var uParam0)//Position - 0x1004B
{
	if (func_209(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_277(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10081
{
...
void func_278(var uParam0, bool bParam1)//Position - 0x100A1
{
	func_279(&(uParam0->f_41), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0x100B3
{
	int iVar0;
...
void func_280(int iParam0, bool bParam1)//Position - 0x100F1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_281(var uParam0, bool bParam1)//Position - 0x1012C
{
	func_282(&(uParam0->f_35), bParam1);
}

void func_282(var uParam0, bool bParam1)//Position - 0x1013E
{
	int iVar0;
...
void func_283(int iParam0)//Position - 0x1017B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_284(var uParam0, int iParam1)//Position - 0x101B3
{
	func_285(&(uParam0->f_28), iParam1);
}

void func_285(var uParam0, int iParam1)//Position - 0x101C5
{
	int iVar0;
...
void func_286(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10206
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_287(var uParam0)//Position - 0x10256
{
	if (*uParam0 == -1)
	{
		return;
...
void func_288(int iParam0)//Position - 0x10293
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_289(var uParam0)//Position - 0x102A5
{
	*uParam0 = -1;
...
void func_290()//Position - 0x102D8
{
	func_288("Running start routines.");
	Global_106283++;
}

int func_291(int iParam0)//Position - 0x102F2
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
