...
int func_60(int iParam0)//Position - 0x4450
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_61(int iParam0)//Position - 0x44EB
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4671
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var uParam1)//Position - 0x51E2
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x521D
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5491
{
	int iVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x54CD
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_67(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5A28
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5A6C
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6173
{
	if (bParam6)
	{
...
int func_76(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x65CB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x666D
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x6C6F
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x6CCD
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6D7B
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_81(vector3 vParam0, float fParam3)//Position - 0x6E10
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_82(int iParam0)//Position - 0x6E54
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x6FD8
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x6FE6
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7AAD
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7B2F
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7B8D
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7B96
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x7DA1
{
	return func_90(PLAYER::PLAYER_ID());
}

var func_90(int iParam0)//Position - 0x7DB1
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x7DCE
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x7DDE
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x80A1
{
	return Global_93734.f_339 > 0;
}

var func_94()//Position - 0x80B2
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x80F8
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x817E
{
...
void func_97(var uParam0, int iParam1)//Position - 0x81B1
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8202
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x82A4
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x82C9
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x82E0
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x82ED
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8327
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8362
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_106(int iParam0)//Position - 0x83C2
{
	var uVar0;
	vector3 vVar1[24];
...
void func_107(char* sParam0, var uParam1, int iParam2)//Position - 0x841B
{
...
bool func_108(bool bParam0)//Position - 0x845C
{
...
struct<2> func_109(int iParam0)//Position - 0x8487
{
	struct<2> Var0;
...
void func_110(int iParam0, var uParam1)//Position - 0x88D3
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0x9B18
{
	switch (iParam0)
	{
		case 0:
...
void func_114(int iParam0)//Position - 0x9E9F
{
	struct<2> Var0;
...
void func_115(int iParam0)//Position - 0x9F3A
{
	if (iParam0 < 63)
	{
		func_116();
...
void func_117(int iParam0)//Position - 0x9F98
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_118(int iParam0)//Position - 0x9FF1
{
...
int func_119(int iParam0)//Position - 0xA074
{
	int iVar0;
...
void func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA0A5
{
	func_121(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA0BA
{
	int iVar0;
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA16D
{
...
int func_124(int iParam0, int iParam1, int iParam2)//Position - 0xA188
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA1D4
{
	int iVar0;
...
int func_126(int iParam0)//Position - 0xA21D
{
	if (func_127(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_127(int iParam0)//Position - 0xA23D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_128(int iParam0)//Position - 0xA25E
{
	switch (iParam0)
	{
		case 5:
...
void func_130(int iParam0)//Position - 0xA32E
{
...
int func_131(int iParam0)//Position - 0xA340
{
	if (iParam0 == -1)
	{
		iParam0 = func_141();
...
int func_132(int iParam0)//Position - 0xA3D8
{
...
int func_135(int iParam0)//Position - 0xA45A
{
...
int func_136(char* sParam0, int iParam1)//Position - 0xA48E
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
bool func_138(int iParam0)//Position - 0xA515
{
	return func_139(iParam0, Global_36425);
}

int func_139(int iParam0, int iParam1)//Position - 0xA526
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_140(int iParam0)//Position - 0xA707
{
	if (func_108(0))
	{
...
int func_141()//Position - 0xA72F
{
	return func_136(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_142(int iParam0)//Position - 0xA740
{
	int iVar0;
...
void func_143(int iParam0)//Position - 0xA785
{
...
int func_144(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xA7B7
{
	int iVar0;
...
void func_145(var uParam0, int iParam1)//Position - 0xA8EE
{
	int iVar0;
...
int func_146(int iParam0)//Position - 0xA93D
{
	if (Global_36425 == 15)
	{
		return 0;
...
int func_147(int iParam0)//Position - 0xA95F
{
	int iVar0;
...
var func_148()//Position - 0xB07C
{
	return Global_93721.f_1;
}

int func_149()//Position - 0xB08A
{
	if (Global_90634 != -1)
	{
...
bool func_152()//Position - 0xB0F4
{
	return Global_93734.f_340 > 0;
}

bool func_153(int iParam0, int iParam1)//Position - 0xB105
{
	switch (iParam0)
	{
		case 5:
...
var func_154()//Position - 0xB140
{
	return Global_1312867;
}

int func_155()//Position - 0xB14C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_157(int iParam0)//Position - 0xB1E5
{
	int iVar0;
	int iVar1;
...
void func_158(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xB227
{
	func_159(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_159(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xB248
{
	int iVar0;
...
int func_161(int iParam0)//Position - 0xB53B
{
	int iVar0;
	int iVar1;
...
void func_162()//Position - 0xB57E
{
	func_163(1);
	func_2(1);
}

void func_163(bool bParam0)//Position - 0xB590
{
	func_164(51, bParam0);
	func_164(52, bParam0);
	func_164(53, bParam0);
...
void func_164(int iParam0, bool bParam1)//Position - 0xB5C8
{
	if (iParam0 == -1)
	{
		return;
...
void func_165(int iParam0, int iParam1, bool bParam2)//Position - 0xB625
{
	if (iParam0 == -1)
	{
		return;
...
bool func_166(int iParam0, int iParam1)//Position - 0xB660
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_168(int iParam0)//Position - 0xB6AA
{
...
int func_169()//Position - 0xB6D8
{
	func_56();
	return Global_106565.f_2357.f_539.f_4321;
}

int func_170(int iParam0)//Position - 0xB6F1
{
	int iVar0;
	int iVar1;
...
int func_172(int iParam0)//Position - 0xB76C
{
	int iVar0;
	int iVar1;
