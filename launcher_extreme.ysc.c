...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((((((!func_188() && func_187(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(iLocal_96)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_95 == 0 && func_187(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
...
int func_59(int iParam0)//Position - 0x4710
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x47AB
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4931
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x54A2
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x54DD
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5751
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x578D
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5CE8
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5D2C
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6433
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x647A
{
...
bool func_70(int iParam0)//Position - 0x64D5
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x64E5
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x654F
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6870
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x687B
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x688B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x692D
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6F2F
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6F8D
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x703B
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x70D0
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x7114
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7298
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x72A6
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7D6D
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7DEF
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7E4D
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7E56
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x8061
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x8071
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x808E
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x809E
{
	switch (iParam0)
	{
		case -1:
...
bool func_92()//Position - 0x835F
{
	return Global_93734.f_339 > 0;
}

var func_93()//Position - 0x8370
{
	var uVar0;
...
void func_94(var uParam0, int iParam1)//Position - 0x83B6
{
	if (iParam1 <= 0)
	{
		return;
...
void func_95(var uParam0, int iParam1)//Position - 0x843C
{
...
void func_96(var uParam0, int iParam1)//Position - 0x846F
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1)//Position - 0x84C0
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_98(int iParam0)//Position - 0x8562
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_99(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_99(bool bParam0, int iParam1, int iParam2)//Position - 0x8587
{
	if (bParam0)
	{
		return iParam1;
...
int func_100(var uParam0)//Position - 0x859E
{
	return uParam0 & 15;
}

void func_101(var uParam0, int iParam1)//Position - 0x85AB
{
...
void func_102(var uParam0, int iParam1)//Position - 0x85E5
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8620
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_104()//Position - 0x865C
{
	func_55();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_105(int iParam0)//Position - 0x8675
{
	var uVar0;
	vector3 vVar1[24];
...
void func_106(char* sParam0, int iParam1, int iParam2)//Position - 0x86CE
{
...
bool func_107(bool bParam0)//Position - 0x8710
{
...
struct<2> func_108(int iParam0)//Position - 0x873B
{
	struct<2> Var0;
...
void func_109(int iParam0, var uParam1)//Position - 0x8B88
{
	switch (iParam0)
	{
		case 0:
...
int func_111(int iParam0)//Position - 0x9E60
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0xA1A6
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0xA24A
{
	struct<2> Var0;
...
void func_114(int iParam0)//Position - 0xA2E5
{
	if (iParam0 < 63)
	{
		func_115();
...
void func_116(int iParam0)//Position - 0xA343
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0)//Position - 0xA39C
{
...
int func_118(int iParam0)//Position - 0xA41F
{
	int iVar0;
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA450
{
	func_120(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA465
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA518
{
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA533
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA57F
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA5C8
{
	if (func_187(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_126(int iParam0)//Position - 0xA5E8
{
	switch (iParam0)
	{
		case 5:
...
int func_128(int iParam0)//Position - 0xA6B8
{
	switch (iParam0)
	{
		case 5:
...
void func_129(var uParam0, bool bParam1, bool bParam2)//Position - 0xA70B
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xA800
{
	switch (iParam0)
	{
		case 5:
...
void func_131(bool bParam0)//Position - 0xA86B
{
	int iVar0;
...
void func_132(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xA8A9
{
	if (bParam0)
	{
...
bool func_133()//Position - 0xA9E2
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_134(int iParam0, int iParam1)//Position - 0xA9FF
{
	bool bVar0;
...
int func_135(int iParam0, bool bParam1)//Position - 0xAA4A
{
	int iVar0;
	int iVar1;
...
int func_136(int iParam0)//Position - 0xAA8B
{
...
bool func_137()//Position - 0xAACD
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_138(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAADE
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0xAB38
{
	if (iParam0 == 1)
	{
...
int func_141(int iParam0)//Position - 0xAB5B
{
...
void func_142()//Position - 0xAB98
{
	Global_14732 = 0;
	func_143();
}

void func_143()//Position - 0xABA8
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xAC6C
{
...
void func_147(int iParam0)//Position - 0xADFB
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAE78
{
	if (func_153())
	{
		return;
...
void func_150(int iParam0)//Position - 0xAEAB
{
	if (func_153())
	{
		return;
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAF25
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAF99
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_153()//Position - 0xAFF3
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

int func_154(int iParam0)//Position - 0xB005
{
...
int func_155(int iParam0)//Position - 0xB046
{
	int iVar0;
...
void func_156(int iParam0)//Position - 0xB08B
{
...
int func_157(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB0BD
{
	int iVar0;
...
void func_158(var uParam0, int iParam1)//Position - 0xB1F4
{
	int iVar0;
...
bool func_159(int iParam0)//Position - 0xB243
{
	return func_160(iParam0, Global_36425);
}

int func_160(int iParam0, int iParam1)//Position - 0xB254
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_161(int iParam0)//Position - 0xB435
{
	if (Global_36425 == 15)
	{
		return 0;
...
int func_162()//Position - 0xB457
{
	return func_163(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_163(char* sParam0, int iParam1)//Position - 0xB468
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_165(int iParam0, int iParam1)//Position - 0xB4D5
{
	switch (iParam0)
	{
		case 0:
...
int func_166(vector3 vParam0, bool bParam3)//Position - 0xB95C
{
	int iVar0;
...
float func_167(bool bParam0, float fParam1, float fParam2)//Position - 0xB988
{
	if (bParam0)
	{
		return fParam1;
...
int func_168(int iParam0)//Position - 0xB99F
{
	switch (iParam0)
	{
		case 0:
...
int func_169(var uParam0)//Position - 0xBA2E
{
	if (*uParam0 == 18)
	{
...
int func_170(int iParam0, int iParam1)//Position - 0xBAD5
{
	if (func_125(iParam0))
	{
...
int func_171(var uParam0, int iParam1)//Position - 0xBB08
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_172()//Position - 0xC2EB
{
	func_27(&(Global_97130.f_2890), &Global_97130, 0, 1, 1, 0);
}

int func_173(var uParam0)//Position - 0xC306
{
	float fVar0;
...
void func_174(int iParam0, int iParam1)//Position - 0xC394
{
	if (iParam0 == 1)
	{
		if (!func_128(iParam1))
...
int func_175(bool bParam0)//Position - 0xC3F8
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0xC48F
{
	if (func_187(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_177(int iParam0)//Position - 0xC4B9
{
	int iVar0;
...
var func_178()//Position - 0xCBD6
{
	return Global_93721.f_1;
}

int func_179()//Position - 0xCBE4
{
	if (Global_90634 != -1)
	{
...
bool func_182()//Position - 0xCC4E
{
	return Global_93734.f_340 > 0;
}

bool func_183(int iParam0, int iParam1)//Position - 0xCC5F
{
	switch (iParam0)
	{
		case 5:
...
var func_184()//Position - 0xCC9A
{
	return Global_1312867;
}

int func_185()//Position - 0xCCA6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_186(char* sParam0, int iParam1)//Position - 0xCCC2
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_187(int iParam0)//Position - 0xCCD9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_189(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCD1C
{
	var uVar0;
	
	if ((((func_187(PLAYER::PLAYER_PED_ID()) && func_187(iParam0->f_28[0])) && !func_188()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_193(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_190(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCDA4
{
...
void func_191(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCDDF
{
...
void func_192(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCE35
{
...
float func_193(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCED0
{
	vector3 vVar0;
...
void func_194(int iParam0)//Position - 0xCF0A
{
...
void func_195(int iParam0, int iParam1, vector3 vParam2)//Position - 0xCF37
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_196(int iParam0, bool bParam1)//Position - 0xD028
{
	if (iParam0 == -1)
	{
		return;
...
int func_197(int iParam0)//Position - 0xD064
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_198(int iParam0, int iParam1)//Position - 0xD09D
{
	bool bVar0;
	int iVar1;
...
bool func_199()//Position - 0xD13B
{
	return Global_91021;
}

void func_200(int iParam0)//Position - 0xD147
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_201(iParam0);
...
void func_201(int iParam0)//Position - 0xD15E
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_202(int iParam0)//Position - 0xD246
{
	if (iParam0 == -1)
	{
		iParam0 = func_162();
...
int func_203(var uParam0, bool bParam1)//Position - 0xD26E
{
	struct<27> Var0;
...
void func_204(int iParam0, var uParam1, int iParam2)//Position - 0xD4E1
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0)//Position - 0xD839
{
...
int func_206(var uParam0)//Position - 0xD859
{
...
int func_207(var uParam0)//Position - 0xD871
{
...
void func_208(var uParam0)//Position - 0xD896
{
	int iVar0;
	int iVar1;
...
void func_209(int iParam0)//Position - 0xDB9A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_210(var uParam0)//Position - 0xDBC5
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, bool bParam2)//Position - 0xDC45
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_212(int iParam0, int iParam1)//Position - 0xDE03
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, int iParam2)//Position - 0xDE33
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xE0EF
{
...
int func_215(int iParam0, float fParam1)//Position - 0xE123
{
	float fVar0;
...
bool func_216(int iParam0, float fParam1)//Position - 0xE199
{
	return func_217(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE1B1
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_218(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE272
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_219(int iParam0, int iParam1)//Position - 0xE39E
{
	int iVar0;
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE4AD
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_222(vector3 vParam0, vector3 vParam3)//Position - 0xE53E
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_223(vector3 vParam0)//Position - 0xE55F
{
	float fVar0;
	float fVar1;
...
void func_224(var uParam0)//Position - 0xE59E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_225(int iParam0, int iParam1)//Position - 0xE5B9
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0xE5F8
{
...
int func_227(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE620
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_228(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE71B
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_229(int iParam0, float fParam1)//Position - 0xE827
{
	var uVar0;
	vector3 vVar1;
...
int func_230(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE8BC
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_231(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE94A
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_232(int iParam0)//Position - 0xE992
{
...
void func_233(int iParam0)//Position - 0xE9DC
{
	int iVar0;
...
int func_234(int iParam0)//Position - 0xEA79
{
	if (iParam0 == -1)
	{
		iParam0 = func_162();
...
int func_235(int iParam0)//Position - 0xEB11
{
...
int func_238(int iParam0)//Position - 0xEB93
{
...
int func_240(int iParam0)//Position - 0xEC05
{
	if (func_107(0))
	{
...
int func_241(int iParam0)//Position - 0xEC2D
{
	switch (*iParam0)
	{
		case 17:
...
int func_242(var uParam0)//Position - 0xECA2
{
	int iVar0[1];
	int iVar2;
...
void func_243(int iParam0, vector3 vParam1, float fParam4)//Position - 0xEDA6
{
	func_244(iParam0, iLocal_93, vParam1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, 0);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_244(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0xEDD8
{
	func_245(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

void func_245(int iParam0)//Position - 0xEDF9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_246(var uParam0)//Position - 0xEE3A
{
	if (func_207(uParam0))
	{
...
int func_247(int iParam0)//Position - 0xEE64
{
	int iVar0;
...
void func_248(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xEE95
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_249(var uParam0)//Position - 0xEED1
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xF064
{
...
int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xF0C0
{
	int iVar0;
...
int func_252(var uParam0, int iParam1)//Position - 0xF14E
{
	int iVar0;
...
int func_253(var uParam0)//Position - 0xF194
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
void func_254(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF498
{
	func_255(iParam0);
...
void func_255(int iParam0)//Position - 0xF4DA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_256(var uParam0)//Position - 0xF576
{
	int iVar0[1];
	int iVar2;
...
int func_257(int iParam0)//Position - 0xF662
{
	struct<27> Var0;
	int iVar32;
...
int func_258(int iParam0)//Position - 0xF6B6
{
	char* sVar0;
...
int func_259(int iParam0)//Position - 0xF76F
{
	var uVar0;
...
int func_260(int iParam0)//Position - 0xF830
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_261(int iParam0, char* sParam1)//Position - 0xF8B5
{
...
bool func_262(int iParam0)//Position - 0xF997
{
...
bool func_263(int iParam0)//Position - 0xF9C5
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_264(int iParam0)//Position - 0xF9F3
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_265(int iParam0)//Position - 0xFA21
{
	if (func_235(iParam0))
	{
		return 0;
...
void func_266()//Position - 0xFA56
{
	func_283("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_267(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xFA70
{
	int iVar0;
...
int func_268(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xFAD5
{
	int iVar0;
	struct<7> Var1;
...
int func_269(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xFB53
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_270(int iParam0, bool bParam1)//Position - 0xFBCE
{
	if (*iParam0 == 18)
	{
...
int func_271(var uParam0)//Position - 0xFCAF
{
	if (func_207(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_272(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFCE5
{
...
void func_273(var uParam0, bool bParam1)//Position - 0xFD05
{
	func_274(&(uParam0->f_41), bParam1);
}

void func_274(var uParam0, bool bParam1)//Position - 0xFD17
{
	int iVar0;
...
void func_275(int iParam0, bool bParam1)//Position - 0xFD55
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_276(var uParam0, bool bParam1)//Position - 0xFD90
{
	func_277(&(uParam0->f_35), bParam1);
}

void func_277(var uParam0, bool bParam1)//Position - 0xFDA2
{
	int iVar0;
...
void func_278(int iParam0)//Position - 0xFDDF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_279(var uParam0, int iParam1)//Position - 0xFE17
{
	func_280(&(uParam0->f_28), iParam1);
}

void func_280(var uParam0, int iParam1)//Position - 0xFE29
{
	int iVar0;
...
void func_281(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFE6A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_282(var uParam0)//Position - 0xFEBA
{
	if (*uParam0 == -1)
	{
		return;
...
void func_283(int iParam0)//Position - 0xFEF7
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_284(var uParam0)//Position - 0xFF09
{
	*uParam0 = -1;
...
void func_285()//Position - 0xFF3C
{
	func_283("Running start routines.");
	Global_106283++;
}

int func_286(int iParam0)//Position - 0xFF56
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
