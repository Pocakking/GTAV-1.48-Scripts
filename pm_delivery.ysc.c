	...
	if (iLocal_36 >= 3 && iLocal_36 <= 4)
	{
		...
		while (iVar0 < iLocal_93)
		{
			...
			else if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_93[iVar0]))
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_93[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	...
	while (iVar1 < iLocal_90)
	{
		if (!PED::IS_PED_INJURED(iLocal_90[iVar1]))
		{
			if (!HUD::DOES_BLIP_EXIST(uLocal_99[iVar1]))
			{
				...
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_90[iVar1], iLocal_120);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_120);
			...
			if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_90[iVar1], PLAYER::PLAYER_PED_ID(), 100f, 100f, 100f, 0, 1, 0))
			{
				...
				BRAIN::TASK_SMART_FLEE_PED(iLocal_90[iVar1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				PED::SET_PED_KEEP_TASK(iLocal_90[iVar1], true);
...
int func_11(int iParam0, bool bParam1, bool bParam2)//Position - 0xAF7
{
	int iVar0;
...
float func_12(bool bParam0, float fParam1, float fParam2)//Position - 0xB9B
{
	if (bParam0)
	{
		return fParam1;
...
void func_13()//Position - 0xBB2
{
	func_140(1);
	func_114();
}

void func_14(int iParam0, bool bParam1, bool bParam2)//Position - 0xBC3
{
	int iVar0;
...
int func_15()//Position - 0xD74
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_16(int iParam0, var uParam1)//Position - 0xD84
{
	switch (iParam0)
	{
		case 0:
...
void func_17(int iParam0, var uParam1)//Position - 0xDCC
{
	switch (iParam0)
	{
		case 0:
...
void func_18(var uParam0)//Position - 0xE14
{
...
int func_19(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xE2F
{
...
void func_20(int iParam0)//Position - 0xFBE
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
bool func_21(int iParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)//Position - 0xFEA
{
...
int func_22(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, bool bParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, float fParam36)//Position - 0x1039
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_23(int iParam0, bool bParam1, bool bParam2)//Position - 0x1992
{
	return func_11(iParam0, !bParam1, bParam2);
}

int func_24(int iParam0)//Position - 0x19A5
{
...
int func_25(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1A03
{
	int iVar0;
...
int func_26(int iParam0)//Position - 0x1AE8
{
	float fVar0;
...
int func_27(int iParam0, int iParam1)//Position - 0x1B1F
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_28(int iParam0, int iParam1)//Position - 0x1B8A
{
	int iVar0;
...
int func_29(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x1BD2
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_30(int iParam0, int iParam1)//Position - 0x1C4D
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
int func_31(vector3 vParam0, bool bParam3)//Position - 0x1C88
{
	int iVar0;
...
void func_32(int iParam0, char* sParam1, int iParam2)//Position - 0x1CB4
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_33(iParam2), 1);
}

int func_33(int iParam0)//Position - 0x1CCB
{
	int iVar0;
...
void func_34(int iParam0, char* sParam1, bool bParam2)//Position - 0x1EBD
{
	if (!bParam2)
	{
...
void func_35(char* sParam0, int iParam1, int iParam2)//Position - 0x1EF4
{
	iParam2 = iParam2;
...
int func_36(int iParam0)//Position - 0x1F0D
{
...
int func_37(int iParam0, int iParam1)//Position - 0x1F31
{
...
int func_40(var uParam0)//Position - 0x1FC2
{
	int iVar0;
	int iVar1;
...
int func_41(var uParam0, int iParam1)//Position - 0x1FE5
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2)//Position - 0x2016
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_43(char* sParam0)//Position - 0x20AA
{
...
int func_44(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)//Position - 0x20C2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_45(int iParam0, var uParam1)//Position - 0x3132
{
	switch (iParam0)
	{
		case 0:
...
void func_46(var uParam0, char* sParam1, int iParam2, bool bParam3)//Position - 0x317A
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_47(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0x31B3
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_48(int iParam0, var uParam1)//Position - 0x31D2
{
	switch (iParam0)
	{
		case 0:
...
int func_49(int iParam0, float fParam1)//Position - 0x321B
{
	int iVar0;
...
int func_50(int iParam0, int iParam1)//Position - 0x3252
{
	int iVar0;
...
int func_51(int iParam0, int iParam1)//Position - 0x32B9
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_52(int iParam0, var uParam1)//Position - 0x32EE
{
	switch (iParam0)
	{
		case 0:
...
int func_53(int iParam0, var uParam1)//Position - 0x3336
{
	switch (iParam0)
	{
		case 0:
...
int func_54(int iParam0)//Position - 0x337F
{
	int iVar0;
	int iVar1;
...
int func_55(int iParam0, var uParam1)//Position - 0x340C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_56(var uParam0)//Position - 0x356C
{
	int iVar0;
...
int func_57(var uParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x359B
{
	int iVar0;
...
int func_58(int iParam0)//Position - 0x3679
{
	float fVar0;
...
int func_59(int iParam0, int iParam1)//Position - 0x36B1
{
	int iVar0;
...
void func_61(var uParam0)//Position - 0x374E
{
	int iVar0;
...
void func_62(var uParam0)//Position - 0x37F1
{
	int iVar0;
...
Vector3 func_64()//Position - 0x3891
{
	vector3 vVar0;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_96, 0))
	{
			...
			while (iVar0 < iLocal_90)
			{
				if (!PED::IS_PED_INJURED(iLocal_90[iVar0]))
				{
					if (!HUD::DOES_BLIP_EXIST(uLocal_99[iVar0]))
					{
						...
						BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_120);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_90[iVar0], iLocal_120);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_120);
					}
				}
		...
		else if (!iLocal_79)
		{
			if (!PED::IS_PED_INJURED(iLocal_90[0]))
			{
				...
				{
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_90[0], iLocal_96, PLAYER::PLAYER_PED_ID(), 8, 25f, 786469, -1f, -1f, 1);
					iLocal_79 = 1;
				}
			}
		}
...
void func_68(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x3B7B
{
	func_69(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_69(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x3B98
{
	func_70(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_70(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x3BB6
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
...
void func_71(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x3BEE
{
	int iVar0;
	int iVar1;
...
void func_72(var uParam0)//Position - 0x3F5B
{
...
int func_73(var uParam0)//Position - 0x3FC4
{
	int iVar0;
...
int func_74(bool bParam0)//Position - 0x3FEF
{
	switch (Global_36425)
	{
		case 0:
...
void func_75(char* sParam0, int iParam1)//Position - 0x40A2
{
...
void func_102()//Position - 0x4E38
{
	...
	else
	{
		...
		BRAIN::TASK_VEHICLE_DRIVE_WANDER(iLocal_90[0], iLocal_96, 25f, 786599);
...
int func_128()//Position - 0x8726
{
	return 0;
}

int func_129()//Position - 0x872F
{
	return 1;
}

int func_130()//Position - 0x8738
{
	return 1;
}

int func_131()//Position - 0x8741
{
...
int func_133(int iParam0)//Position - 0x8815
{
	int iVar0;
	char* sVar1;
...
int func_134(int iParam0)//Position - 0x885B
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0x8896
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0x8912
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0x89FA
{
	int iVar0;
...
int func_138(int iParam0, int iParam1, bool bParam2)//Position - 0x8A5D
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_139(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x8ACE
{
...
void func_140(int iParam0)//Position - 0x8BA6
{
