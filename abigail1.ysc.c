	...
	switch (iLocal_153)
	{
		case 0:
			...
			if (func_297(iLocal_149))
			{
				...
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_149, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
		...
		case 1:
			func_293();
			if ((func_297(iLocal_149) && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_149, "rcmabigail", "loop_2_cs", 3)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_149, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_153++;
			}
			break;
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (func_297(PLAYER::PLAYER_PED_ID()) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000, 1048576000, 0, 1193033728);
					BRAIN::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), -1602.62f, 5260.37f, 1.41f, -1, 0, 2);
				}
				if (func_297(iLocal_149) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_149);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_149, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
				}
			}
			else
			{
		...
		case 5:
			...
			if (func_218(1000) || MISC::GET_GAME_TIMER() > iLocal_152)
			{
...
int func_12()//Position - 0x12BC
{
	return Global_1312745;
}

void func_13()//Position - 0x12C8
{
	func_30();
	func_22();
	func_18();
...
void func_14(int iParam0)//Position - 0x1321
{
	if (iParam0 == 1)
	{
...
void func_16()//Position - 0x1368
{
	StringCopy(&Global_71822, "", 16);
	StringCopy(&Global_71826, "", 16);
}

void func_17()//Position - 0x1384
{
	int iVar0;
...
void func_21(int iParam0)//Position - 0x1456
{
	if (iParam0 == 1)
	{
		Global_36974 = 1;
...
void func_22()//Position - 0x146F
{
	func_23(&Global_100114);
}

void func_23(var uParam0)//Position - 0x147F
{
	int iVar0;
	int iVar1;
...
void func_24(var uParam0)//Position - 0x1A0F
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_25(var uParam0)//Position - 0x1A2A
{
...
void func_26(var uParam0)//Position - 0x1A59
{
	int iVar0;
...
void func_27(var uParam0)//Position - 0x1B0A
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_28(var uParam0)//Position - 0x1B28
{
	int iVar0;
...
void func_29(var uParam0)//Position - 0x1C09
{
	*uParam0 = -15;
}
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x1D6F
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_34(int iParam0, int iParam1, int iParam2)//Position - 0x1F2E
{
	int iVar0;
...
int func_35(int iParam0)//Position - 0x1FBA
{
	switch (iParam0)
	{
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1FF5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_37(int iParam0, int iParam1, int iParam2)//Position - 0x280B
{
	int iVar0;
	int iVar1;
...
int func_38(int iParam0, int iParam1, int iParam2)//Position - 0x2895
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_39(int iParam0, int iParam1, int iParam2)//Position - 0x2973
{
	Global_71402[1 /*14*/] = { func_84(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_40(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x299E
{
	var uVar0;
	int iVar10;
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x2FA2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_42(int iParam0, int iParam1, int iParam2)//Position - 0x303B
{
	int iVar0;
	int iVar1;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x30DC
{
	int iVar0;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x33E3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_45(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3F96
{
	int iVar0;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x427C
{
	int iVar0;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4543
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x45A3
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_50(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x486D
{
	int iVar0;
...
int func_51(int iParam0, int iParam1, int iParam2)//Position - 0x4AF7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4C4E
{
	int iVar0;
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4CE6
{
	switch (iParam0)
	{
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DB4
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_55(int iParam0, int iParam1)//Position - 0x4F10
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_56(int iParam0)//Position - 0x52B7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5318
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0, int iParam1)//Position - 0x5414
{
	int iVar0;
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5552
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_60(int iParam0)//Position - 0x5632
{
	switch (iParam0)
	{
		case 0:
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x56B8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5935
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5D5A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_64(int iParam0, int iParam1)//Position - 0x604D
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0, int iParam1)//Position - 0x6093
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x60F3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_67(int iParam0)//Position - 0x6177
{
...
void func_68(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x622F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_69(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x6279
{
	int iVar0;
...
int func_70(var uParam0)//Position - 0x62A9
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0, int iParam1, int iParam2)//Position - 0x62DD
{
	int iVar0;
	var uVar1;
...
bool func_72(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x630F
{
	int iVar0;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x80E1
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_74(int iParam0)//Position - 0x8FFF
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9050
{
	int iVar0;
...
int func_76(int iParam0)//Position - 0x90E6
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_77(int iParam0, int iParam1)//Position - 0x9196
{
	int iVar0;
	struct<10> Var1;
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9AC5
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9BEF
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_80(int iParam0, int iParam1)//Position - 0x9C37
{
	int iVar0;
	struct<17> Var1;
...
void func_81(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBA7F
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_82(int iParam0)//Position - 0xBC69
{
	switch (iParam0)
	{
		case 0:
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xBD19
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBD8A
{
	func_148();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_85(int iParam0, int iParam1)//Position - 0xBDDC
{
	switch (iParam0)
	{
		case 0:
...
void func_86(int iParam0)//Position - 0xBECC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(var uParam0, int iParam1)//Position - 0x1FABB
{
...
void func_160(int iParam0, int iParam1, int iParam2)//Position - 0x201C5
{
	...
	if (iParam0 != -1)
	{
		...
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar32, 0, Global_93719, 0);
		func_161(&uVar32, Var0.f_3, Global_93719, iParam1, iParam2);
	}
}

void func_161(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x20204
{
...
void func_179(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22274
{
	if (iParam0 != 198)
	{
		if (Global_71590)
...
void func_180(int iParam0, int iParam1)//Position - 0x222CF
{
	switch (iParam0)
	{
		case 12:
...
void func_181(int iParam0, bool bParam1)//Position - 0x223B8
{
	if (bParam1)
	{
...
bool func_182(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x223E1
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_184()//Position - 0x22D79
{
	return Global_25766;
}

int func_185(var uParam0, int iParam1)//Position - 0x22D84
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0x265C3
{
	switch (iParam0)
	{
		case 46:
...
void func_187(int iParam0, bool bParam1)//Position - 0x266B5
{
	switch (iParam0)
	{
		case 46:
...
void func_188(int iParam0, bool bParam1)//Position - 0x26706
{
	int iVar0;
...
void func_189(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2676C
{
	func_190(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_190(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2678E
{
	int iVar0;
...
void func_191()//Position - 0x26962
{
	int iVar0;
...
int func_192(int iParam0)//Position - 0x26A82
{
	int iVar0;
	int iVar1;
...
int func_195(int iParam0)//Position - 0x26CBD
{
...
void func_196(int iParam0, int iParam1)//Position - 0x26CEA
{
...
int func_197(char* sParam0)//Position - 0x26D27
{
	int iVar0;
...
int func_198()//Position - 0x26D87
{
	return func_199(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_199(char* sParam0, int iParam1)//Position - 0x26D98
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_200(int iParam0, int iParam1, bool bParam2)//Position - 0x26DE1
{
	Global_3109 = iParam0;
...
void func_201()//Position - 0x26F8B
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
void func_202()//Position - 0x2700C
{
	if (func_92(14))
	{
...
int func_203()//Position - 0x270AE
{
	func_155();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_204(int iParam0)//Position - 0x270C7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_205(var uParam0, int iParam1, bool bParam2)//Position - 0x27108
{
	int iVar0;
...
void func_206(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x271FD
{
	int iVar0;
...
int func_207(int iParam0)//Position - 0x272A6
{
	if (func_297(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_208(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x272C6
{
	if (bParam0)
	{
...
bool func_209()//Position - 0x273FF
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_210(int iParam0, int iParam1)//Position - 0x2741C
{
	bool bVar0;
...
int func_211(int iParam0, bool bParam1)//Position - 0x27467
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0x274A8
{
...
bool func_213()//Position - 0x274EA
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_214(int iParam0, var uParam1, var uParam2, int iParam3)//Position - 0x274FB
{
	int iVar0;
...
void func_216(int iParam0)//Position - 0x27555
{
	if (iParam0 == 1)
	{
...
bool func_217(char* sParam0)//Position - 0x27578
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_218(int iParam0)//Position - 0x2758B
{
...
void func_220(int iParam0)//Position - 0x27607
{
	if (iParam0 == -1)
	{
		return;
...
void func_221(int iParam0, bool bParam1)//Position - 0x2762C
{
	if (iParam0 == -1)
	{
		return;
...
void func_222(int iParam0, int iParam1, bool bParam2)//Position - 0x27689
{
	if (iParam0 == -1)
	{
		return;
...
bool func_223(int iParam0, int iParam1)//Position - 0x276C4
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_224(int iParam0, bool bParam1)//Position - 0x276E7
{
...
void func_225(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x27723
{
	int iVar0;
...
Vector3 func_226(int iParam0)//Position - 0x278E1
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

void func_227(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x278F4
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_275(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_272(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_228(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x2796F
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_262(iParam5, &Var0, vParam1, fParam4, func_265(iParam0));
		func_229(iParam5, iParam0, 0);
	}
}

void func_229(int iParam0, int iParam1, int iParam2)//Position - 0x27A98
{
	int iVar0;
...
void func_230(int iParam0, int iParam1)//Position - 0x27BB5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_231(int iParam0)//Position - 0x27DB7
{
...
int func_232(int iParam0)//Position - 0x27E94
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_233(int iParam0, bool bParam1)//Position - 0x28160
{
	int iVar0;
	struct<2> Var1;
...
int func_234(int iParam0)//Position - 0x282E0
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_236(int iParam0)//Position - 0x283C3
{
	int iVar0;
	int iVar1;
...
int func_237()//Position - 0x2A430
{
	return 0;
}

int func_238()//Position - 0x2A439
{
	return 1;
}

int func_239()//Position - 0x2A442
{
	return 1;
}

int func_240()//Position - 0x2A44B
{
...
int func_242(int iParam0)//Position - 0x2A51F
{
	int iVar0;
	char* sVar1;
...
int func_243(int iParam0)//Position - 0x2A565
{
	int iVar0;
...
int func_244(int iParam0)//Position - 0x2A5A0
{
	int iVar0;
...
int func_245(int iParam0)//Position - 0x2A61C
{
	int iVar0;
...
int func_246(int iParam0, int iParam1, bool bParam2)//Position - 0x2A704
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_247(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2A775
{
...
void func_249(var uParam0, int iParam1)//Position - 0x2A894
{
	if (iParam1 <= 0)
	{
		return;
...
void func_250(var uParam0, int iParam1)//Position - 0x2A91A
{
...
void func_251(var uParam0, int iParam1)//Position - 0x2A94D
{
	int iVar0;
	int iVar1;
...
int func_252(int iParam0, int iParam1)//Position - 0x2A99E
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_253(int iParam0)//Position - 0x2AA40
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_254(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_254(bool bParam0, int iParam1, int iParam2)//Position - 0x2AA65
{
	if (bParam0)
	{
		return iParam1;
...
int func_255(var uParam0)//Position - 0x2AA7C
{
	return uParam0 & 15;
}

void func_256(var uParam0, int iParam1)//Position - 0x2AA89
{
...
void func_257(var uParam0, int iParam1)//Position - 0x2AAC3
{
...
void func_258(var uParam0, int iParam1)//Position - 0x2AAFE
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_259(var uParam0, int iParam1)//Position - 0x2AB3A
{
	int iVar0;
	int iVar1;
...
int func_260(int iParam0, int iParam1)//Position - 0x2C234
{
	struct<82> Var0;
...
void func_261(int iParam0, var uParam1, int iParam2)//Position - 0x2C276
{
	int iVar0;
...
void func_262(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x2C4D2
{
	if (func_259(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_263(var uParam0, var uParam1)//Position - 0x2C5D1
{
...
void func_264(int iParam0)//Position - 0x2C69D
{
	if (iParam0 == -1)
	{
		return;
...
int func_265(int iParam0)//Position - 0x2C717
{
	int iVar0;
...
bool func_266(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2C77A
{
	if (bParam6)
	{
...
void func_267(int iParam0, var uParam1)//Position - 0x2C7C1
{
	int iVar0;
...
int func_268(int iParam0)//Position - 0x2CA6C
{
	switch (iParam0)
	{
		case 1:
...
int func_269(int iParam0, var uParam1, var uParam2)//Position - 0x2CB1C
{
	int iVar0;
	int iVar1;
...
int func_270(int iParam0)//Position - 0x2CD0F
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_271(int iParam0)//Position - 0x2CD2F
{
...
int func_272(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x2CD56
{
	int iVar0;
...
int func_273(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2CE6C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_274(int iParam0)//Position - 0x2CEFB
{
	return MISC::IS_BIT_SET(Global_106565.f_7223[iParam0], 0);
}

int func_275(int iParam0)//Position - 0x2CF13
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_276(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2CF2F
{
	func_277(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_277(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2CF58
{
	int iVar0;
	bool bVar1;
	bool bVar2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
			{
				if (VEHICLE::IS_VEHICLE_MODEL(iVar0, joaat("taxi")))
				{
					...
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0 + vParam3 / Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iVar0, 1), 1) < 20f)
						{
							bVar1 = true;
							bVar2 = false;
						}
			...
			if (bVar1)
			{
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					if (bVar2)
					{
						MISC::CLEAR_AREA_OF_VEHICLES(vParam7, 5f, 0, 0, 0, 0, 0, 0);
...
int func_278(vector3 vParam0)//Position - 0x2D34C
{
...
int func_279(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x2D376
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_280(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2D66C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_281(vector3 vParam0)//Position - 0x2D720
{
	float fVar0;
	float fVar1;
...
void func_282(int iParam0)//Position - 0x2D75F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_283()//Position - 0x2D7C4
{
	int iVar0;
...
int func_284(int iParam0, float fParam1, int iParam2)//Position - 0x2D7E4
{
	int iVar0;
...
bool func_285()//Position - 0x2D8B8
{
	bool bVar0;
...
void func_286()//Position - 0x2D8DB
{
	Global_14732 = 0;
	func_287();
}

void func_287()//Position - 0x2D8EB
{
...
void func_289()//Position - 0x2D964
{
...
int func_290(int iParam0, int iParam1)//Position - 0x2D9B5
{
	if (func_207(iParam0))
	{
...
int func_291(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2D9E8
{
...
void func_292(int iParam0)//Position - 0x2DB77
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_293()//Position - 0x2DBA3
{
	if (func_297(PLAYER::PLAYER_PED_ID()))
	{
		func_298();
		...
		if (iLocal_154 == 0)
		{
			if (func_297(iLocal_149))
			{
				if (func_294(PLAYER::PLAYER_PED_ID(), iLocal_149, 1) < 4f || (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 2f && func_294(PLAYER::PLAYER_PED_ID(), iLocal_149, 1) < 6f))
				{
...
float func_294(int iParam0, int iParam1, int iParam2)//Position - 0x2DC19
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_295(char* sParam0, bool bParam1)//Position - 0x2DC77
{
	func_296(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_296(bool bParam0)//Position - 0x2DC8D
{
	int iVar0;
...
int func_297(int iParam0)//Position - 0x2DCCB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_298()//Position - 0x2DCEC
{
	func_300(0);
	func_289();
	func_299();
...
void func_299()//Position - 0x2DD01
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_300(int iParam0)//Position - 0x2DD59
{
	if (func_304())
	{
		return;
...
void func_301(int iParam0)//Position - 0x2DD8C
{
	if (func_304())
	{
		return;
...
void func_302(bool bParam0, bool bParam1)//Position - 0x2DE06
{
	if (bParam0)
	{
		if (func_303(0))
...
int func_303(int iParam0)//Position - 0x2DE7A
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_304()//Position - 0x2DED4
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

void func_305(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2DEE6
{
	float fVar0;
	int iVar1;
	int iVar2;
...
float func_306(var uParam0)//Position - 0x2E1CB
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(uParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_307(int iParam0, int iParam1, int iParam2)//Position - 0x2E1DE
{
	struct<2> Var0;
	int iVar2;
...
char* func_308(int iParam0)//Position - 0x2E2B5
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_309(int iParam0)//Position - 0x2E408
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_310(int iParam0)//Position - 0x2E43C
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_311(int iParam0)//Position - 0x2E470
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_312(int iParam0)//Position - 0x2E4A4
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_313(int iParam0)//Position - 0x2E4D8
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_314(int iParam0)//Position - 0x2E516
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_315(int iParam0)//Position - 0x2E54A
{
	struct<2> Var0;
...
int func_316(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2E5B3
{
...
bool func_317(bool bParam0)//Position - 0x2E6CB
{
	if (bParam0)
	{
...
int func_318(int iParam0)//Position - 0x2E6F4
{
	if (Global_36425 == 15)
	{
		return 0;
...
bool func_319(int iParam0)//Position - 0x2E716
{
	return func_320(iParam0, Global_36425);
}

int func_320(int iParam0, int iParam1)//Position - 0x2E727
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_321(var uParam0, var uParam1)//Position - 0x2E908
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_322()//Position - 0x2E91A
{
	if (STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
	{
...
void func_323(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2E93E
{
...
void func_324(var uParam0, bool bParam1)//Position - 0x2E95E
{
	func_325(&(uParam0->f_41), bParam1);
}

void func_325(var uParam0, bool bParam1)//Position - 0x2E970
{
	int iVar0;
...
void func_326(var uParam0, bool bParam1)//Position - 0x2E9AE
{
...
void func_327(var uParam0)//Position - 0x2E9E9
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_328(var uParam0, bool bParam1)//Position - 0x2EA14
{
	func_329(&(uParam0->f_35), bParam1);
}

void func_329(var uParam0, bool bParam1)//Position - 0x2EA26
{
	int iVar0;
...
void func_330(var uParam0)//Position - 0x2EA63
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_331(var uParam0)//Position - 0x2EA9B
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_332(int iParam0)//Position - 0x2EB37
{
	if (func_297(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_333(var uParam0, int iParam1)//Position - 0x2EB61
{
	func_334(&(uParam0->f_28), iParam1);
}

void func_334(var uParam0, int iParam1)//Position - 0x2EB73
{
	int iVar0;
...
void func_335(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2EBB4
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_336(bool bParam0)//Position - 0x2EC04
{
	int iVar0;
...
void func_337(char* sParam0, int iParam1)//Position - 0x2ECD4
{
	if (Global_93682 != 12)
	{
...
int func_338(char* sParam0, int iParam1, int iParam2)//Position - 0x2ECFC
{
	var uVar0;
	struct<32> Var1;
	int iVar33;
...
int func_339(char* sParam0)//Position - 0x2EE8E
{
...
int func_341(char* sParam0, bool bParam1)//Position - 0x2EF08
{
	int iVar0;
	int iVar1;
...
int func_342(int iParam0, bool bParam1)//Position - 0x2EF32
{
	int iVar0;
...
void func_345(int iParam0)//Position - 0x2F024
{
	HUD::DISPLAY_HUD(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_346(int iParam0)//Position - 0x2F038
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_347(int iParam0)//Position - 0x2F075
{
	if (iParam0 == 1)
	{
...
void func_348()//Position - 0x2F0B2
{
	Global_17272.f_5 = 1;
}

void func_349()//Position - 0x2F0C0
{
	Global_17272.f_5 = 0;
}

void func_350(bool bParam0)//Position - 0x2F0CE
{
	if (bParam0)
	{
		func_351();
...
void func_351()//Position - 0x2F131
{
...
void func_352()//Position - 0x2F15A
{
	Global_87888 = 0;
	Global_87889 = 0;
}

int func_353()//Position - 0x2F16C
{
...
void func_354()//Position - 0x2F1AA
{
	Global_93717 = 1;
...
void func_355(int iParam0)//Position - 0x2F299
{
...
void func_356(var uParam0)//Position - 0x2F2AB
{
...
void func_357(var uParam0)//Position - 0x2F2CB
{
	int iVar0;
...
int func_358(int iParam0)//Position - 0x2F305
{
	if (!func_152(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
