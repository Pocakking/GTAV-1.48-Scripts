...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_86(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
				...
				case 3:
					...
					else
					{
						...
						if (!func_72(3) && !Global_93716)
						{
							...
							{
								if ((!func_86(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_71())) && !Global_93716)
								{
									func_79(10);
									break;
								}
...
void func_45(char* sParam0, int iParam1, int iParam2)//Position - 0x18D7
{
...
var func_51()//Position - 0x1A85
{
	return Global_68807;
}

int func_52(int iParam0)//Position - 0x1A91
{
	if (iParam0 == 1)
	{
...
bool func_53(int iParam0, int iParam1)//Position - 0x1AEB
{
	switch (iParam0)
	{
		case 5:
...
bool func_54()//Position - 0x1B26
{
	return MISC::GET_GAME_TIMER() <= Global_17411.f_5878 + 100;
}

int func_55()//Position - 0x1B3B
{
...
bool func_56(bool bParam0)//Position - 0x1B55
{
	if (bParam0)
	{
...
int func_57()//Position - 0x1B7E
{
	return 1;
}

void func_58(var uParam0, int iParam1)//Position - 0x1B87
{
	func_59(uParam0, iParam1);
}

void func_59(var uParam0, var uParam1)//Position - 0x1B97
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_60()//Position - 0x1BA8
{
	int iVar0;
	bool bVar1;
...
int func_61(int iParam0)//Position - 0x1CB2
{
	int iVar0;
...
var func_62()//Position - 0x23CF
{
	return Global_93721.f_1;
}

int func_63()//Position - 0x23DD
{
	if (Global_90634 != -1)
	{
...
bool func_65()//Position - 0x242D
{
	return Global_93734.f_340 > 0;
}

bool func_66()//Position - 0x243E
{
	return Global_93734.f_339 > 0;
}

var func_67()//Position - 0x244F
{
	return Global_1312867;
}

int func_68()//Position - 0x245B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_69()//Position - 0x2477
{
	func_47();
	return Global_106565.f_2357.f_539.f_4321;
}

int func_70()//Position - 0x2490
{
...
var func_71()//Position - 0x24AA
{
	return Global_89544;
}

int func_72(int iParam0)//Position - 0x24B6
{
	switch (iParam0)
	{
		case 0:
...
bool func_73(int iParam0)//Position - 0x2528
{
	int iVar0;
...
bool func_74(int iParam0)//Position - 0x2564
{
	return Global_36425 == iParam0;
}

void func_75(var uParam0, int iParam1)//Position - 0x2572
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_76()//Position - 0x2583
{
	if (bLocal_125)
	{
		bLocal_126 = true;
...
void func_79(int iParam0)//Position - 0x2660
{
	iLocal_95 = iParam0;
}

void func_80(int iParam0, bool bParam1, bool bParam2)//Position - 0x266C
{
	int iVar0;
	bool bVar1;
...
bool func_83(int iParam0, int iParam1)//Position - 0x27B8
{
	bool bVar0;
...
bool func_84(int iParam0)//Position - 0x2805
{
	return func_85(iParam0, Global_36425);
}

int func_85(int iParam0, int iParam1)//Position - 0x2816
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_86(var uParam0, int iParam1)//Position - 0x29F7
{
	return (uParam0 && iParam1) != 0;
}

void func_87()//Position - 0x2A06
{
...
void func_88(int iParam0)//Position - 0x2A54
{
	if (iLocal_95 < 5)
	{
		if (iParam0 != 263)
...
int func_89(int iParam0)//Position - 0x2A97
{
	switch (iParam0)
	{
		case 91:
...
void func_90(var uParam0, int iParam1)//Position - 0x2BAF
{
	func_91(uParam0, iParam1);
}

void func_91(var uParam0, var uParam1)//Position - 0x2BBF
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_92(bool bParam0)//Position - 0x2BD4
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
