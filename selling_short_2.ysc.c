...
int func_28(int iParam0, var uParam1, int iParam2)//Position - 0x2516
{
	int iVar0;
	...
	if (*uParam1 == 0)
	{
		*uParam1 = unk_0x67D02A194A2FC2BD(iParam0);
	}
...
void func_36(bool bParam0, bool bParam1)//Position - 0x28CD
{
	if (bParam0)
	{
		if (func_38(0))
...
bool func_37()//Position - 0x2941
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

int func_38(int iParam0)//Position - 0x2953
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
void func_42(int iParam0)//Position - 0x2AE5
{
...
void func_43(char* sParam0)//Position - 0x2B48
{
	STREAMING::REMOVE_ANIM_DICT(sParam0);
}

void func_44(int iParam0)//Position - 0x2B56
{
	if (iParam0 != 0)
	{
...
void func_45(var uParam0)//Position - 0x2B6A
{
	int iVar0;
	char* sVar1;
	char* sVar2;
...
char* func_46(int iParam0)//Position - 0x2BDF
{
	char* sVar0;
...
char* func_47(int iParam0)//Position - 0x2BF5
{
	char* sVar0;
...
void func_48(var uParam0)//Position - 0x2C0A
{
	int iVar0;
...
void func_49(int iParam0)//Position - 0x2C56
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_50(var uParam0)//Position - 0x2C97
{
	int iVar0;
...
void func_51(int iParam0)//Position - 0x2CC0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
