...
void func_28(char* sParam0)//Position - 0x1AAB
{
...
void func_30(char* sParam0)//Position - 0x1ADD
{
	int iVar0;
...
bool func_32(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B49
{
...
int func_33(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B97
{
	Global_15867 = 0;
...
bool func_40(int iParam0, int iParam1)//Position - 0x20E0
{
	switch (iParam0)
	{
		case 5:
...
void func_41(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x211B
{
...
void func_42(char[4] cParam0)//Position - 0x2171
{
	int iVar0;
...
void func_43(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x21AC
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_44(char* sParam0)//Position - 0x2247
{
	int iVar0;
...
void func_45(var uParam0)//Position - 0x227F
{
}

void func_46(var uParam0, int iParam1, float fParam2)//Position - 0x2287
{
}

void func_47()//Position - 0x228F
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_48()//Position - 0x229E
{
	char* sVar0;
	struct<16> Var8;
...
void func_49(var uParam0)//Position - 0x2314
{
}

void func_50(char* sParam0)//Position - 0x231C
{
...
void func_51(int iParam0, char* sParam1, char* sParam2)//Position - 0x232F
{
...
bool func_53()//Position - 0x2499
{
	return Global_93734.f_339 > 0;
}

bool func_54()//Position - 0x24AA
{
	bool bVar0;
...
void func_58(char* sParam0)//Position - 0x252D
{
	struct<8> Var0;
...
void func_59(char* sParam0)//Position - 0x256D
{
	func_19(iLocal_297, sParam0);
}

void func_60(char* sParam0)//Position - 0x257E
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_106510[iLocal_251] + 1, 16);
}

void func_61(int iParam0, bool bParam1)//Position - 0x259C
{
	int iVar0;
...
void func_62(int iParam0, bool bParam1)//Position - 0x25BD
{
	int iVar0;
...
void func_63(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x262E
{
	func_64(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_64(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x264E
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x2940
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0)//Position - 0x2A89
{
	if (func_71(iParam0))
	{
...
int func_70(int iParam0)//Position - 0x2AB0
{
	int iVar0;
...
int func_71(int iParam0)//Position - 0x2AE3
{
...
int func_72(int iParam0)//Position - 0x2B0D
{
	switch (iParam0)
	{
...
void func_73(int iParam0)//Position - 0x2BCB
{
	if (iLocal_447 == 1)
	{
...
void func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x2BEA
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_75(int iParam0, bool bParam1, int iParam2)//Position - 0x2C3D
{
	int iVar0;
...
int func_76(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C8F
{
	int iVar0;
...
float func_77(bool bParam0, float fParam1, float fParam2)//Position - 0x2D33
{
	if (bParam0)
	{
		return fParam1;
...
float func_78(int iParam0, int iParam1, bool bParam2)//Position - 0x2D4A
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_79(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2DA8
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_80(vector3 vParam0, vector3 vParam3)//Position - 0x2E39
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_81(vector3 vParam0)//Position - 0x2E5A
{
	float fVar0;
	float fVar1;
...
int func_82(int iParam0)//Position - 0x2E99
{
	var uVar0;
...
void func_85()//Position - 0x2EED
{
	Global_14732 = 0;
	func_86();
}

void func_86()//Position - 0x2EFD
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_87()//Position - 0x2F1E
{
	return 0;
}

void func_88()//Position - 0x2F27
{
}

int func_89()//Position - 0x2F2F
{
	return 1;
}

float func_90(int iParam0, int iParam1)//Position - 0x2F38
{
	return func_78(iParam0, iParam1, 1);
}

void func_91(int iParam0)//Position - 0x2F49
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x2F7A
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0, bool bParam1)//Position - 0x2FAB
{
	if (!func_71(iParam0))
	{
		if (!bParam1)
...
void func_94(var uParam0, var uParam1)//Position - 0x305E
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_95(int iParam0, bool bParam1)//Position - 0x306F
{
	if (iParam0 == 1)
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_96(int iParam0)//Position - 0x30E1
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_97()//Position - 0x3102
{
	func_98();
}

void func_98()//Position - 0x310E
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_240, 0))
	{
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(iLocal_240, "MAG_2_RAGE_PED_GROUP", 0);
	}
}

void func_99()//Position - 0x312C
{
...
int func_103()//Position - 0x3288
{
	return 1;
}

bool func_104(var uParam0)//Position - 0x3291
{
	return func_105(Global_106565.f_20111, uParam0);
}

bool func_105(var uParam0, var uParam1)//Position - 0x32A6
{
	return (uParam0 && uParam1) != 0;
}

int func_106(int iParam0)//Position - 0x32B5
{
...
void func_107(int iParam0)//Position - 0x33DC
{
	var uVar0;
...
void func_108(int iParam0)//Position - 0x34AB
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_109()//Position - 0x34CB
{
	struct<6> Var0;
...
void func_110()//Position - 0x34EF
{
	func_111();
}

void func_111()//Position - 0x34FB
{
}

void func_112()//Position - 0x3503
{
	if (iLocal_245 == -1)
	{
