...
int func_59(int iParam0)//Position - 0x4578
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x4613
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4799
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x530A
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x5345
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x55B9
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x55F5
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5B50
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5B94
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x629B
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x62E2
{
...
bool func_70(int iParam0)//Position - 0x633D
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x634D
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x63B7
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x66D8
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x66E3
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x66F3
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6795
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6D97
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6DF5
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6EA3
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x6F38
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x6F7C
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7100
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x710E
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7BD5
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7C57
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7CB5
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7CBE
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7EC9
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x7ED9
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7EF6
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7F06
{
	switch (iParam0)
	{
		case -1:
...
int func_168(int iParam0, int iParam1)//Position - 0xB514
{
	if (func_125(iParam0))
	{
...
float func_169(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xB547
{
	vector3 vVar0;
...
int func_170(int iParam0)//Position - 0xB581
{
	int iVar0;
...
var func_171()//Position - 0xBC9E
{
	return Global_93721.f_1;
}

int func_172()//Position - 0xBCAC
{
	if (Global_90634 != -1)
	{
...
bool func_175()//Position - 0xBD16
{
	return Global_93734.f_340 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xBD27
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xBD62
{
	return Global_1312867;
}

int func_178()//Position - 0xBD6E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_179(int iParam0, int iParam1)//Position - 0xBD8A
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_180()//Position - 0xC56E
{
	func_27(&(Global_97130.f_2890), &Global_97130, 0, 1, 1, 0);
}

int func_181(var uParam0)//Position - 0xC589
{
	float fVar0;
...
void func_182(int iParam0, int iParam1)//Position - 0xC617
{
	if (iParam0 == 1)
	{
		if (!func_129(iParam1))
...
int func_183(bool bParam0)//Position - 0xC67B
{
	int iVar0;
...
int func_184(int iParam0)//Position - 0xC712
{
	if (func_126(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xC73C
{
	var uVar0;
	
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_169(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_186(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC7C4
{
...
void func_187(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC7FF
{
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC855
{
...
void func_189(int iParam0, int iParam1, vector3 vParam2)//Position - 0xC8F0
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_190(int iParam0, bool bParam1)//Position - 0xC9E1
{
	if (iParam0 == -1)
	{
		return;
...
int func_191(int iParam0)//Position - 0xCA1D
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_192(int iParam0, int iParam1)//Position - 0xCA56
{
	bool bVar0;
	int iVar1;
...
void func_195(int iParam0)//Position - 0xCB17
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_196(int iParam0)//Position - 0xCBFF
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_197(var uParam0, bool bParam1)//Position - 0xCC27
{
	struct<27> Var0;
...
void func_198(int iParam0, var uParam1, int iParam2)//Position - 0xCE9A
{
	int iVar0;
	int iVar1;
...
int func_199(int iParam0)//Position - 0xD1F2
{
...
int func_200(var uParam0)//Position - 0xD212
{
...
int func_201(var uParam0)//Position - 0xD22A
{
...
void func_202(var uParam0)//Position - 0xD24F
{
	int iVar0;
	int iVar1;
...
void func_203(int iParam0)//Position - 0xD553
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_204(var uParam0)//Position - 0xD57E
{
	int iVar0;
...
int func_205(var uParam0, bool bParam1, bool bParam2)//Position - 0xD5FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_206(int iParam0, int iParam1)//Position - 0xD7BC
{
	int iVar0;
...
int func_207(var uParam0, bool bParam1, int iParam2)//Position - 0xD7EC
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0)//Position - 0xDAA8
{
...
int func_209(int iParam0, float fParam1)//Position - 0xDADC
{
	float fVar0;
...
bool func_210(int iParam0, float fParam1)//Position - 0xDB52
{
	return func_211(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_211(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDB6A
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_212(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDC2B
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_213(int iParam0, int iParam1)//Position - 0xDD57
{
	int iVar0;
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDE66
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_216(vector3 vParam0, vector3 vParam3)//Position - 0xDEF7
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_217(vector3 vParam0)//Position - 0xDF18
{
	float fVar0;
	float fVar1;
...
void func_218(var uParam0)//Position - 0xDF57
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_219(int iParam0, int iParam1)//Position - 0xDF72
{
	int iVar0;
...
int func_220(int iParam0)//Position - 0xDFB1
{
...
int func_221(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDFD9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_222(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE0D4
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_223(int iParam0, float fParam1)//Position - 0xE1E0
{
	var uVar0;
	vector3 vVar1;
...
int func_224(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE275
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_225(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE303
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_226(int iParam0)//Position - 0xE34B
{
...
int func_228(int iParam0)//Position - 0xE432
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_229(int iParam0)//Position - 0xE4CA
{
...
int func_232(int iParam0)//Position - 0xE54C
{
...
int func_234(int iParam0)//Position - 0xE5BE
{
	if (func_107(0))
	{
...
int func_237(var uParam0)//Position - 0xE633
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
void func_238(bool bParam0)//Position - 0xE84D
{
...
void func_239(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xE89F
{
	if (iParam0 != 198)
	{
		if (Global_71590)
...
void func_240(int iParam0, int iParam1)//Position - 0xE8FA
{
	switch (iParam0)
	{
		case 12:
...
void func_241(int iParam0, bool bParam1)//Position - 0xE9E3
{
	if (bParam1)
	{
...
bool func_242(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0xEA0C
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_244()//Position - 0xF3A4
{
	return Global_25766;
}

int func_245(var uParam0, int iParam1)//Position - 0xF3AF
{
	int iVar0;
...
void func_246(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x12BEF
{
	func_247(iParam0);
...
void func_247(int iParam0)//Position - 0x12C31
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0x12CCD
{
...
int func_249(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x12D29
{
	int iVar0;
...
int func_250(var uParam0, int iParam1)//Position - 0x12DB7
{
	int iVar0;
...
int func_251(var uParam0)//Position - 0x12DFD
{
	if (func_201(uParam0))
	{
...
int func_252(int iParam0)//Position - 0x12E27
{
	int iVar0;
...
void func_253(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x12E58
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_254(int iParam0)//Position - 0x12E94
{
	struct<27> Var0;
	int iVar32;
...
int func_255(int iParam0)//Position - 0x12EE8
{
	char* sVar0;
...
int func_256(int iParam0)//Position - 0x12FA1
{
	var uVar0;
...
int func_257(int iParam0)//Position - 0x13062
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_258(int iParam0, char* sParam1)//Position - 0x130E7
{
...
bool func_259(int iParam0)//Position - 0x131C9
{
...
bool func_260(int iParam0)//Position - 0x131F7
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_261(int iParam0)//Position - 0x13225
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_262(int iParam0)//Position - 0x13253
{
	if (func_229(iParam0))
	{
		return 0;
...
void func_263()//Position - 0x13288
{
	func_286("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_264(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x132A2
{
	int iVar0;
...
int func_265(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0x13307
{
	int iVar0;
	struct<7> Var1;
...
int func_266(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x13385
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_267(int iParam0, bool bParam1)//Position - 0x13400
{
	char* sVar0;
...
void func_268(char* sParam0)//Position - 0x13485
{
...
void func_269()//Position - 0x134A4
{
	Global_14732 = 0;
	func_270();
}

void func_270()//Position - 0x134B4
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_271(char* sParam0)//Position - 0x134D5
{
	struct<6> Var0;
...
struct<6> func_272()//Position - 0x134F5
{
	struct<6> Var0;
...
int func_273(var uParam0)//Position - 0x13519
{
	if (func_201(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_274(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1354F
{
...
void func_275(var uParam0, bool bParam1)//Position - 0x1356F
{
	func_276(&(uParam0->f_41), bParam1);
}

void func_276(var uParam0, bool bParam1)//Position - 0x13581
{
	int iVar0;
...
void func_277(int iParam0, bool bParam1)//Position - 0x135BF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_278(var uParam0, bool bParam1)//Position - 0x135FA
{
	func_279(&(uParam0->f_35), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0x1360C
{
	int iVar0;
...
void func_280(int iParam0)//Position - 0x13649
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_281(var uParam0, int iParam1)//Position - 0x13681
{
	func_282(&(uParam0->f_28), iParam1);
}

void func_282(var uParam0, int iParam1)//Position - 0x13693
{
	int iVar0;
...
void func_283(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x136D4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_284(int iParam0)//Position - 0x13724
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_285(var uParam0)//Position - 0x13765
{
	if (*uParam0 == -1)
	{
		return;
...
void func_286(int iParam0)//Position - 0x137A2
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_287(var uParam0)//Position - 0x137B4
{
	*uParam0 = -1;
...
void func_288()//Position - 0x137E7
{
	func_286("Running start routines.");
	Global_106283++;
}

int func_289(int iParam0)//Position - 0x13801
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
