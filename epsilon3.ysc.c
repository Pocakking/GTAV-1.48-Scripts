...
void func_22()//Position - 0xAFA
{
	switch (iLocal_146)
	{
		...
		case 1:
			...
			if (func_232(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 1.4f)
			{
				if ((!func_231() && func_230(Local_83.f_28[0])) && (MISC::GET_GAME_TIMER() - iLocal_323) > 5000)
				{
			...
			else if ((!HUD::IS_MESSAGE_BEING_DISPLAYED() && !func_231()) && (MISC::GET_GAME_TIMER() - iLocal_322) > iLocal_324)
			{
				if (func_230(Local_83.f_28[0]))
				{
					if (func_232(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 10f)
					{
						if (iLocal_325 < 5)
						{
			...
			if (func_230(Local_83.f_28[0]))
			{
				if (func_231())
				{
					if (iLocal_325 < 5)
					{
						...
						{
							BRAIN::TASK_LOOK_AT_ENTITY(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						}
					}
				}
				else if (PED::IS_PED_HEADTRACKING_PED(Local_83.f_28[0], PLAYER::PLAYER_PED_ID()))
				{
					BRAIN::TASK_CLEAR_LOOK_AT(Local_83.f_28[0]);
				}
				if (func_232(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], true), 3f))
				{
					iLocal_146 = 3;
				}
				if ((((((GRAPHICS::_0x2F09F7976C512404(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), 5f) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("weapon_grenadelauncher"), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("weapon_rpg"), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("weapon_grenade"), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("weapon_molotov"), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("weapon_flare"), 5f, 0))
				{
					AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
					BRAIN::OPEN_SEQUENCE_TASK(&uLocal_318);
					BRAIN::TASK_PLAY_ANIM(0, "rcmepsilonism3", "outro", 8f, -8f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(uLocal_318);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_83.f_28[0], uLocal_318);
					iLocal_313 = 3;
					func_302(2);
				}
...
int func_31()//Position - 0x1C29
{
	return Global_1312745;
}

void func_32()//Position - 0x1C35
{
	func_49();
	func_41();
	func_37();
...
void func_33(int iParam0)//Position - 0x1C8E
{
	if (iParam0 == 1)
	{
...
void func_35()//Position - 0x1CD5
{
	StringCopy(&Global_71822, "", 16);
	StringCopy(&Global_71826, "", 16);
}

void func_36()//Position - 0x1CEF
{
	int iVar0;
...
void func_40(int iParam0)//Position - 0x1DC1
{
	if (iParam0 == 1)
	{
		Global_36974 = 1;
...
void func_41()//Position - 0x1DDA
{
	func_42(&Global_100114);
}

void func_42(var uParam0)//Position - 0x1DEA
{
	int iVar0;
	int iVar1;
...
void func_43(var uParam0)//Position - 0x237A
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_44(var uParam0)//Position - 0x2395
{
...
void func_45(var uParam0)//Position - 0x23C4
{
	int iVar0;
...
void func_46(var uParam0)//Position - 0x2474
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_47(var uParam0)//Position - 0x2492
{
	int iVar0;
...
void func_48(var uParam0)//Position - 0x2572
{
	*uParam0 = -15;
}

void func_49()//Position - 0x2580
{
	StringCopy(&Global_97122, "", 32);
	func_42(&Global_97130);
}

void func_50()//Position - 0x2599
{
...
int func_52(int iParam0, int iParam1, int iParam2)//Position - 0x26D7
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x2896
{
	int iVar0;
...
int func_54(int iParam0)//Position - 0x2922
{
	switch (iParam0)
	{
...
int func_55(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x295D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_56(int iParam0, int iParam1, int iParam2)//Position - 0x3173
{
	int iVar0;
	int iVar1;
...
int func_57(int iParam0, int iParam1, int iParam2)//Position - 0x31FD
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_58(int iParam0, int iParam1, int iParam2)//Position - 0x32DB
{
	Global_71402[1 /*14*/] = { func_103(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_59(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x3306
{
	var uVar0;
	int iVar10;
...
int func_60(int iParam0, int iParam1, int iParam2)//Position - 0x390A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_61(int iParam0, int iParam1, int iParam2)//Position - 0x39A3
{
	int iVar0;
	int iVar1;
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3A44
{
	int iVar0;
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3D4B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4900
{
	int iVar0;
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4BE4
{
	int iVar0;
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4EAB
{
	int iVar0;
	int iVar1;
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4EE2
{
	int iVar0;
...
int func_68(int iParam0, int iParam1, int iParam2)//Position - 0x4F0B
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x51D5
{
	int iVar0;
...
int func_70(int iParam0, int iParam1, int iParam2)//Position - 0x545F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_71(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x55B6
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x564E
{
	switch (iParam0)
	{
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x571C
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_74(int iParam0, int iParam1)//Position - 0x5878
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_75(int iParam0)//Position - 0x5C1F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C80
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_77(int iParam0, int iParam1)//Position - 0x5D7C
{
	int iVar0;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5EBA
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_79(int iParam0)//Position - 0x5F9A
{
	switch (iParam0)
	{
		case 0:
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6020
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x629D
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x66C2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_83(int iParam0, int iParam1)//Position - 0x69B5
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0, int iParam1)//Position - 0x69FB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6A5B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_86(int iParam0)//Position - 0x6ADF
{
...
void func_87(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x6B97
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x6BE1
{
	int iVar0;
...
int func_89(var uParam0)//Position - 0x6C11
{
	int iVar0;
	int iVar1;
...
int func_90(int iParam0, int iParam1, int iParam2)//Position - 0x6C45
{
	int iVar0;
	var uVar1;
...
bool func_91(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x6C77
{
	int iVar0;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8BF9
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_93(int iParam0)//Position - 0x9B17
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9B68
{
	int iVar0;
...
int func_95(int iParam0)//Position - 0x9BFE
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_96(int iParam0, int iParam1)//Position - 0x9CAE
{
	int iVar0;
	struct<10> Var1;
...
void func_97(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA5DD
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA707
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_99(int iParam0, int iParam1)//Position - 0xA74F
{
	int iVar0;
	struct<17> Var1;
...
void func_100(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC599
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_101(int iParam0)//Position - 0xC783
{
	switch (iParam0)
	{
		case 0:
...
void func_102(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC833
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC8A4
{
	func_166();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_104(int iParam0, int iParam1)//Position - 0xC8F6
{
	switch (iParam0)
	{
		case 0:
...
void func_105(int iParam0)//Position - 0xC9E6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xDC5D
{
	int iVar0;
	int iVar1;
...
bool func_107(int iParam0, int iParam1, var uParam2)//Position - 0xDFEE
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_108(int iParam0, int iParam1)//Position - 0xE3F3
{
	switch (iParam1)
	{
		case 0:
...
int func_109(int iParam0, int iParam1)//Position - 0xE7EE
{
	switch (iParam1)
	{
		case 0:
...
int func_110(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xEBE9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_111(int iParam0)//Position - 0xEC2B
{
	switch (iParam0)
	{
		case -1:
...
void func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xECFF
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_113(int iParam0)//Position - 0xEFD8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0xF12F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0xF63D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0xF6B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0xF726
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0xF80D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0xFB70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0xFD81
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0xFFB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x100E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x10A88
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x115FB
{
	if (iParam0 < 136)
	{
		func_126(iParam0);
...
void func_125(int iParam0)//Position - 0x11630
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x12234
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x13142
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x1326F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0, int iParam1)//Position - 0x1336D
{
	switch (iParam0)
	{
		case 0:
...
void func_130(int iParam0)//Position - 0x1345D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x14950
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x14AA1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x14FAC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1561A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1568E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1575E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x15C8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x15E25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x16623
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x16733
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1765E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1831C
{
	if (iParam0 < 107)
	{
		func_145(iParam0);
...
void func_143(int iParam0)//Position - 0x18362
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x18E07
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x19BF6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1A83F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1AAB8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0, int iParam1)//Position - 0x1ABFE
{
	switch (iParam0)
	{
		case 0:
...
void func_149(int iParam0)//Position - 0x1ACEE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1BA78
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1BBF2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1C16B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1C695
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1C709
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1C7D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1CCB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1CF1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1D3B9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1DF0D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1EB57
{
	if (iParam0 < 60)
	{
		func_163(iParam0);
...
void func_162(int iParam0)//Position - 0x1EB8C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1F92C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1FFB8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x200C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166()//Position - 0x201BE
{
...
int func_167(int iParam0, int iParam1, int iParam2)//Position - 0x20237
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_168(char* sParam0, int iParam1)//Position - 0x20492
{
...
struct<2> func_170(int iParam0)//Position - 0x20532
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_171(int iParam0)//Position - 0x20569
{
	struct<2> Var0;
...
void func_172(int iParam0, int iParam1)//Position - 0x209B5
{
...
void func_173(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x209FF
{
...
void func_174(int iParam0, int iParam1, int iParam2)//Position - 0x20A9C
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_175(&sVar32, Var0.f_3, Global_93719, iParam1, iParam2);
	}
}

void func_175(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x20ADB
{
...
void func_176(int iParam0, var uParam1)//Position - 0x20B1F
{
	switch (iParam0)
	{
		case 0:
...
int func_178(int iParam0)//Position - 0x21D65
{
	switch (iParam0)
	{
		case 0:
...
void func_179(int iParam0)//Position - 0x220AB
{
	Global_36976 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_180()//Position - 0x220BD
{
	if (Global_91024)
	{
		func_10();
		GRAPHICS::_0xBF59707B3E5ED531(func_181(Global_106565.f_2357.f_539.f_4321));
	}
	else
	{
...
char* func_181(var uParam0)//Position - 0x220EF
{
	uParam0 = uParam0;
	return "";
}

void func_182()//Position - 0x220FE
{
	vector3 vVar0[24];
...
void func_183(int iParam0, int iParam1)//Position - 0x22141
{
	Global_91019 = iParam0;
	Global_91020 = iParam1;
}

void func_184()//Position - 0x22155
{
	if (Global_71844 != 6)
	{
	}
...
void func_185(var uParam0)//Position - 0x2218D
{
	if (*uParam0 == -1)
	{
		return;
...
void func_186(int iParam0, bool bParam1)//Position - 0x221CA
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_187(int iParam0)//Position - 0x22350
{
	switch (iParam0)
	{
		case 0:
...
void func_188(int iParam0)//Position - 0x226D7
{
	func_190(iParam0, 1);
...
int func_189()//Position - 0x2270D
{
	return (Global_106565.f_10010.f_21 + Global_106565.f_18568.f_380);
}

void func_190(var uParam0, bool bParam1)//Position - 0x22729
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_191(int iParam0)//Position - 0x22A4D
{
...
void func_192(int iParam0)//Position - 0x22A80
{
	switch (iParam0)
	{
		case 30:
...
void func_193(int iParam0, bool bParam1)//Position - 0x22AB5
{
	if (iParam0 == -1)
	{
		return;
...
void func_194(int iParam0, int iParam1, bool bParam2)//Position - 0x22B12
{
	if (iParam0 == -1)
	{
		return;
...
bool func_195(int iParam0, int iParam1)//Position - 0x22B4D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_196(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22B70
{
	if (iParam0 != 198)
	{
		if (Global_71590)
...
void func_197(int iParam0, int iParam1)//Position - 0x22BCB
{
	switch (iParam0)
	{
		case 12:
...
void func_198(int iParam0, bool bParam1)//Position - 0x22CB4
{
	if (bParam1)
	{
...
bool func_199(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x22CDD
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_201()//Position - 0x2365F
{
	return Global_25766;
}

int func_202(var uParam0, int iParam1)//Position - 0x2366A
{
	int iVar0;
...
int func_203(int iParam0)//Position - 0x26E09
{
	switch (iParam0)
	{
		case 46:
...
void func_204(int iParam0, bool bParam1)//Position - 0x26EFB
{
	switch (iParam0)
	{
		case 46:
...
void func_205(int iParam0, bool bParam1)//Position - 0x26F4C
{
	int iVar0;
...
void func_206(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x26FB2
{
	func_207(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_207(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26FD3
{
	int iVar0;
...
void func_208()//Position - 0x271A6
{
	int iVar0;
...
int func_209(int iParam0)//Position - 0x272C6
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0x27500
{
...
void func_213(int iParam0, int iParam1)//Position - 0x2752D
{
...
int func_214(char* sParam0)//Position - 0x2756A
{
	int iVar0;
...
int func_215()//Position - 0x275CA
{
	return func_216(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_216(char* sParam0, int iParam1)//Position - 0x275DB
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_217(var uParam0, int iParam1)//Position - 0x27624
{
...
int func_218(int iParam0, int iParam1)//Position - 0x27641
{
	int iVar0;
...
void func_219(int iParam0, char* sParam1, bool bParam2)//Position - 0x27692
{
	int iVar0;
...
void func_220(int iParam0)//Position - 0x277B4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_221(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x27B24
{
	int iVar0;
	bool bVar1;
	char cVar2[64];
...
void func_222(var uParam0)//Position - 0x27D0C
{
...
char* func_223(int iParam0)//Position - 0x27D3A
{
	switch (iParam0)
	{
		case 0:
...
char* func_224(int iParam0, int iParam1)//Position - 0x280A6
{
	*iParam1 = 1;
	switch (iParam0)
	{
...
struct<16> func_225(int iParam0)//Position - 0x284F9
{
	struct<16> Var0;
	struct<16> Var16;
...
int func_226(int iParam0)//Position - 0x2852A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_227(int iParam0, int iParam1, bool bParam2)//Position - 0x2858E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_228(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2878A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_229(int iParam0, bool bParam1)//Position - 0x28B5F
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_230(int iParam0)//Position - 0x28D77
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
float func_232(int iParam0, int iParam1, bool bParam2)//Position - 0x28DBA
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_233(char* sParam0, int iParam1, int iParam2)//Position - 0x28E18
{
	iParam2 = iParam2;
...
void func_234()//Position - 0x28E31
{
	switch (iLocal_146)
	{
		case 0:
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_147, 0))
			{
				if (func_230(Local_83.f_28[0]))
				{
					BRAIN::TASK_PLAY_ANIM(Local_83.f_28[0], sLocal_144, "base_loop", 1000f, -8f, -1, 262145, 0.01f, 0, 0, 0);
		...
		case 2:
			...
			if (func_230(Local_83.f_28[0]))
			{
				BRAIN::TASK_PLAY_ANIM(Local_83.f_28[0], sLocal_144, "base_loop", 1000f, -8f, -1, 262145, 0, 0, 0, 0);
				func_248(Local_83.f_28[0], 1843.82f, 4705.74f, 40.8f, 143.14f, 1, 1);
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MICHAEL", 0))
			{
...
void func_235(var uParam0, bool bParam1, bool bParam2)//Position - 0x2916C
{
	int iVar0;
...
int func_236(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x29261
{
	int iVar0;
...
void func_237(bool bParam0, int iParam1, int iParam2)//Position - 0x29294
{
	bool bVar0;
...
void func_238(int iParam0, bool bParam1)//Position - 0x292F3
{
...
void func_239(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x29325
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0x293CE
{
	if (func_230(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_241(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x293EE
{
	if (bParam0)
	{
...
bool func_242()//Position - 0x29527
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_243(int iParam0, int iParam1)//Position - 0x29544
{
	bool bVar0;
...
int func_244(int iParam0, bool bParam1)//Position - 0x2958F
{
	int iVar0;
	int iVar1;
...
int func_245(int iParam0)//Position - 0x295D0
{
...
bool func_246()//Position - 0x29612
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

void func_247(int iParam0)//Position - 0x29623
{
	if (iParam0 == 1)
	{
...
int func_248(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0x29646
{
	bool bVar0;
	float fVar1;
...
void func_249(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x296A2
{
	int iVar0;
...
Vector3 func_250(int iParam0)//Position - 0x29860
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_251(bool bParam0)//Position - 0x29873
{
	int iVar0;
...
void func_252(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x298B1
{
	func_253(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_253(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x298DA
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_254(vector3 vParam0)//Position - 0x29CCE
{
...
int func_255(int iParam0, int iParam1, bool bParam2)//Position - 0x29CF8
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_256(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x29D69
{
...
int func_257(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x29E41
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_258(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2A137
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_259(vector3 vParam0)//Position - 0x2A1EB
{
	float fVar0;
	float fVar1;
...
void func_260(int iParam0)//Position - 0x2A22A
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_261(int iParam0, bool bParam1)//Position - 0x2A28F
{
...
void func_262()//Position - 0x2A2CB
{
	int iVar0;
...
int func_263(int iParam0, float fParam1, int iParam2)//Position - 0x2A2EB
{
	int iVar0;
...
bool func_264()//Position - 0x2A3BF
{
	bool bVar0;
...
void func_265()//Position - 0x2A3E2
{
	Global_14732 = 0;
	func_17();
}

void func_266()//Position - 0x2A3F2
{
...
int func_267(int iParam0, int iParam1)//Position - 0x2A443
{
	if (func_240(iParam0))
	{
...
int func_268(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2A476
{
...
void func_269(int iParam0)//Position - 0x2A605
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_270()//Position - 0x2A631
{
	func_272(0);
	func_266();
	func_271();
...
void func_271()//Position - 0x2A646
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_272(int iParam0)//Position - 0x2A69E
{
	if (func_276())
	{
		return;
...
void func_273(int iParam0)//Position - 0x2A6D1
{
	if (func_276())
	{
		return;
...
void func_274(bool bParam0, bool bParam1)//Position - 0x2A74B
{
	if (bParam0)
	{
		if (func_275(0))
...
int func_275(int iParam0)//Position - 0x2A7BF
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_276()//Position - 0x2A819
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

void func_277(int iParam0, int iParam1, int iParam2)//Position - 0x2A82B
{
...
void func_278(int iParam0, int iParam1, int iParam2)//Position - 0x2A85F
{
...
bool func_279()//Position - 0x2A923
{
...
{
	func_270();
	if (func_230(Local_83.f_28[0]) && func_230(PLAYER::PLAYER_PED_ID()))
	{
		if (func_232(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 9f)
		{
	...
	switch (iLocal_146)
	{
		case 0:
			...
			BRAIN::OPEN_SEQUENCE_TASK(&uLocal_317);
			...
			BRAIN::CLOSE_SEQUENCE_TASK(uLocal_317);
			if (func_232(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 4f)
			{
		...
		case 1:
			if (func_230(Local_83.f_28[0]))
			{
				if (iLocal_316 == 0)
				{
					if (((func_232(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 3f && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1847.705f, 4703.014f, 36.58427f, 1844.084f, 4709.532f, 39.73755f, 5f, 0, true, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1842.977f, 4705.946f, 36.78089f, 1842.161f, 4707.852f, 40.10524f, 2.5f, 0, true, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1843.527f, 4704.969f, 36.83727f, 1844.178f, 4703.326f, 40.25331f, 2.5f, 0, true, 0))
					{
						...
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 0);
						BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 7000, 0, 2);
						iLocal_316 = 1;
					}
				}
				if (func_232(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 4f)
			...
			if (!bLocal_314)
			{
				...
				{
					BRAIN::TASK_LOOK_AT_ENTITY(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					BRAIN::TASK_PLAY_ANIM(Local_83.f_28[0], sLocal_144, "leadin", 8f, -8f, -1, 786434, 0, 0, 0, 0);
				}
			}
			else if (!func_231())
			{
...
void func_282(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2AD87
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_283(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2AE22
{
	float fVar0;
	int iVar1;
	int iVar2;
...
float func_284(char* sParam0)//Position - 0x2B107
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_285(int iParam0, int iParam1, int iParam2)//Position - 0x2B11A
{
	struct<2> Var0;
	int iVar2;
...
char* func_286(int iParam0)//Position - 0x2B1F0
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_287(int iParam0)//Position - 0x2B343
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_288(int iParam0)//Position - 0x2B376
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_289(int iParam0)//Position - 0x2B3A9
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_290(int iParam0)//Position - 0x2B3DC
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_291(int iParam0)//Position - 0x2B40F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_292(int iParam0)//Position - 0x2B44C
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_293(int iParam0)//Position - 0x2B47F
{
	struct<2> Var0;
...
int func_294(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2B4E8
{
...
bool func_295(bool bParam0)//Position - 0x2B600
{
	if (bParam0)
	{
...
int func_296(int iParam0)//Position - 0x2B629
{
	if (Global_36425 == 15)
	{
		return 0;
...
bool func_297(int iParam0)//Position - 0x2B64B
{
	return func_298(iParam0, Global_36425);
}

int func_298(int iParam0, int iParam1)//Position - 0x2B65C
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_299(int iParam0, int iParam1, bool bParam2)//Position - 0x2B83D
{
	Global_3109 = iParam0;
...
void func_300()//Position - 0x2B9E7
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
void func_301(char* sParam0, bool bParam1)//Position - 0x2BA66
{
	func_251(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_302(int iParam0)//Position - 0x2BA7C
{
	iLocal_145 = iParam0;
	iLocal_146 = 0;
}

void func_303(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2BA8B
{
	if (func_313())
	{
...
int func_304(var uParam0)//Position - 0x2BB20
{
	int iVar0[1];
	int iVar2;
	vector3 vVar3;
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			{
				if (func_305(&(uParam0->f_28[0]), 60, vVar3, fVar6, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
...
int func_305(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0x2BCE4
{
...
int func_306(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x2BD40
{
	int iVar0;
...
int func_307(var uParam0, int iParam1)//Position - 0x2BDCE
{
	int iVar0;
...
int func_308(var uParam0)//Position - 0x2BE14
{
	if (func_309(uParam0))
	{
...
int func_309(var uParam0)//Position - 0x2BE3E
{
...
int func_310(int iParam0)//Position - 0x2BE63
{
	int iVar0;
...
void func_311(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2BE94
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
float func_312(float fParam0)//Position - 0x2BED0
{
	return (fParam0 * 57.29578f);
}

int func_313()//Position - 0x2BEE0
{
...
void func_314()//Position - 0x2BF04
{
	func_262();
	if (func_230(Local_83.f_28[0]))
	{
...
void func_315(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2BF65
{
...
void func_316(var uParam0, bool bParam1)//Position - 0x2BF85
{
	func_317(&(uParam0->f_41), bParam1);
}

void func_317(var uParam0, bool bParam1)//Position - 0x2BF97
{
	int iVar0;
...
void func_318(int iParam0, bool bParam1)//Position - 0x2BFD5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_319(int iParam0)//Position - 0x2C011
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_320(var uParam0, bool bParam1)//Position - 0x2C03C
{
	func_321(&(uParam0->f_35), bParam1);
}

void func_321(var uParam0, bool bParam1)//Position - 0x2C04E
{
	int iVar0;
...
void func_322(int iParam0)//Position - 0x2C08B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_323(int iParam0)//Position - 0x2C0C3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_324(int iParam0)//Position - 0x2C15F
{
	if (func_230(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_325(var uParam0, int iParam1)//Position - 0x2C189
{
	func_326(&(uParam0->f_28), iParam1);
}

void func_326(var uParam0, int iParam1)//Position - 0x2C19B
{
	int iVar0;
...
void func_327(int iParam0)//Position - 0x2C1DC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_328(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2C21D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_330(bool bParam0)//Position - 0x2C30E
{
	int iVar0;
...
void func_331(char* sParam0, int iParam1)//Position - 0x2C3DE
{
	if (Global_93682 != 12)
	{
...
int func_332(char* sParam0, int iParam1, int iParam2)//Position - 0x2C406
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_333(char* sParam0)//Position - 0x2C598
{
...
int func_335(char* sParam0, bool bParam1)//Position - 0x2C612
{
	int iVar0;
	int iVar1;
...
int func_336(int iParam0, bool bParam1)//Position - 0x2C63C
{
	int iVar0;
...
void func_339(bool bParam0)//Position - 0x2C72E
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_340(int iParam0)//Position - 0x2C742
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_341(int iParam0)//Position - 0x2C77F
{
	if (iParam0 == 1)
	{
...
void func_342()//Position - 0x2C7BC
{
	Global_17272.f_5 = 1;
}

void func_343()//Position - 0x2C7CA
{
	Global_17272.f_5 = 0;
}

void func_344(bool bParam0)//Position - 0x2C7D8
{
	if (bParam0)
	{
		func_345();
...
void func_345()//Position - 0x2C83B
{
...
void func_346()//Position - 0x2C864
{
	Global_87888 = 0;
	Global_87889 = 0;
}

int func_347()//Position - 0x2C876
{
...
void func_348()//Position - 0x2C8B4
{
	Global_93717 = 1;
...
void func_349(int iParam0)//Position - 0x2C9A1
{
...
void func_352(var uParam0)//Position - 0x2CA01
{
	int iVar0;
...
int func_353(int iParam0)//Position - 0x2CA3B
{
	if (!func_11(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
