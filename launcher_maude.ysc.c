...
int func_59(int iParam0)//Position - 0x450D
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x45A8
{
...
int func_61(int iParam0, int iParam1)//Position - 0x472E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x529F
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x52DA
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x554E
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x558A
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5AE5
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5B29
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6230
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x6277
{
...
bool func_70(int iParam0)//Position - 0x62D2
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x62E2
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x634C
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x666D
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x6678
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6688
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x672A
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6D2C
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6D8A
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6E38
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x6ECD
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x6F11
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7095
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x70A3
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7B6A
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7BEC
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C4A
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7C53
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7E5E
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x7E6E
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7E8B
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7E9B
{
	switch (iParam0)
	{
		case -1:
...
bool func_92()//Position - 0x815E
{
	return Global_93734.f_339 > 0;
}

var func_93()//Position - 0x816F
{
	var uVar0;
...
void func_94(var uParam0, int iParam1)//Position - 0x81B5
{
	if (iParam1 <= 0)
	{
		return;
...
void func_95(var uParam0, int iParam1)//Position - 0x823B
{
...
void func_96(var uParam0, int iParam1)//Position - 0x826E
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1)//Position - 0x82BF
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_98(int iParam0)//Position - 0x8361
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_99(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_99(bool bParam0, int iParam1, int iParam2)//Position - 0x8386
{
	if (bParam0)
	{
		return iParam1;
...
int func_100(var uParam0)//Position - 0x839D
{
	return uParam0 & 15;
}

void func_101(var uParam0, int iParam1)//Position - 0x83AA
{
...
void func_102(var uParam0, int iParam1)//Position - 0x83E4
{
...
void func_103(var uParam0, int iParam1)//Position - 0x841F
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_104()//Position - 0x845B
{
	func_55();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_105(int iParam0)//Position - 0x8474
{
	var uVar0;
	vector3 vVar1[24];
...
void func_106(char* sParam0, int iParam1, int iParam2)//Position - 0x84CD
{
...
bool func_107(bool bParam0)//Position - 0x850F
{
...
struct<2> func_108(int iParam0)//Position - 0x853A
{
	struct<2> Var0;
...
void func_109(int iParam0, var uParam1)//Position - 0x8987
{
	switch (iParam0)
	{
		case 0:
...
int func_111(int iParam0)//Position - 0x9C5F
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0x9FA5
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0xA049
{
	struct<2> Var0;
...
void func_114(int iParam0)//Position - 0xA0E4
{
	if (iParam0 < 63)
	{
		func_115();
...
void func_116(int iParam0)//Position - 0xA142
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0)//Position - 0xA19B
{
...
int func_118(int iParam0)//Position - 0xA21E
{
	int iVar0;
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA24F
{
	func_120(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA264
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA317
{
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA332
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA37E
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA3C7
{
	if (func_126(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_126(int iParam0)//Position - 0xA3E7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_127(int iParam0)//Position - 0xA408
{
	switch (iParam0)
	{
		case 5:
...
int func_129(int iParam0)//Position - 0xA4D8
{
	switch (iParam0)
	{
		case 5:
...
void func_130(var uParam0, bool bParam1, bool bParam2)//Position - 0xA52B
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xA620
{
	switch (iParam0)
	{
		case 5:
...
void func_132(bool bParam0)//Position - 0xA68B
{
	int iVar0;
...
void func_133(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xA6C9
{
	if (bParam0)
	{
...
bool func_134()//Position - 0xA802
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_135(int iParam0, int iParam1)//Position - 0xA81F
{
	bool bVar0;
...
int func_136(int iParam0, bool bParam1)//Position - 0xA86A
{
	int iVar0;
	int iVar1;
...
int func_137(int iParam0)//Position - 0xA8AB
{
...
bool func_138()//Position - 0xA8ED
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_139(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA8FE
{
	int iVar0;
...
void func_141(int iParam0)//Position - 0xA958
{
	if (iParam0 == 1)
	{
...
int func_142(int iParam0)//Position - 0xA97B
{
...
void func_143()//Position - 0xA9B8
{
	Global_14732 = 0;
	func_144();
}

void func_144()//Position - 0xA9C8
{
...
int func_148(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xAAAE
{
...
void func_149(int iParam0)//Position - 0xAC3D
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_151(int iParam0)//Position - 0xACBA
{
	if (func_155())
	{
		return;
...
void func_152(int iParam0)//Position - 0xACED
{
	if (func_155())
	{
		return;
...
void func_153(bool bParam0, bool bParam1)//Position - 0xAD67
{
	if (bParam0)
	{
		if (func_154(0))
...
int func_154(int iParam0)//Position - 0xADDB
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_155()//Position - 0xAE35
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

int func_156(int iParam0)//Position - 0xAE47
{
...
int func_157(int iParam0)//Position - 0xAE88
{
	int iVar0;
...
void func_158(int iParam0)//Position - 0xAECD
{
...
int func_159(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAEFF
{
	int iVar0;
...
void func_160(var uParam0, int iParam1)//Position - 0xB036
{
	int iVar0;
...
bool func_161(int iParam0)//Position - 0xB085
{
	return func_162(iParam0, Global_36425);
}

int func_162(int iParam0, int iParam1)//Position - 0xB096
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_163(int iParam0)//Position - 0xB277
{
	if (Global_36425 == 15)
	{
		return 0;
...
int func_164()//Position - 0xB299
{
	return func_165(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_165(char* sParam0, int iParam1)//Position - 0xB2AA
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_167(var uParam0, int iParam1)//Position - 0xB317
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_168()//Position - 0xBAFA
{
	func_27(&(Global_97130.f_2890), &Global_97130, 0, 1, 1, 0);
}

int func_169(var uParam0)//Position - 0xBB15
{
	float fVar0;
...
void func_170(int iParam0, int iParam1)//Position - 0xBBA3
{
	if (iParam0 == 1)
	{
		if (!func_129(iParam1))
...
int func_171(bool bParam0)//Position - 0xBC07
{
	int iVar0;
...
int func_172(int iParam0)//Position - 0xBC9E
{
	if (func_126(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_173(int iParam0)//Position - 0xBCC8
{
	int iVar0;
...
var func_174()//Position - 0xC3E7
{
	return Global_93721.f_1;
}

int func_175()//Position - 0xC3F5
{
	if (Global_90634 != -1)
	{
...
bool func_178()//Position - 0xC45F
{
	return Global_93734.f_340 > 0;
}

bool func_179(int iParam0, int iParam1)//Position - 0xC470
{
	switch (iParam0)
	{
		case 5:
...
var func_180()//Position - 0xC4AB
{
	return Global_1312867;
}

int func_181()//Position - 0xC4B7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_182(int iParam0, int iParam1, vector3 vParam2)//Position - 0xC4D3
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_183(int iParam0, bool bParam1)//Position - 0xC5C4
{
	if (iParam0 == -1)
	{
		return;
...
int func_184(int iParam0)//Position - 0xC600
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_185(int iParam0, int iParam1)//Position - 0xC639
{
	bool bVar0;
	int iVar1;
...
float func_186(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xC6D7
{
	vector3 vVar0;
...
bool func_187()//Position - 0xC711
{
	return Global_91021;
}

void func_188(int iParam0)//Position - 0xC71D
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_189(iParam0);
...
void func_189(int iParam0)//Position - 0xC734
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_190(int iParam0)//Position - 0xC81C
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_191(var uParam0, bool bParam1)//Position - 0xC844
{
	struct<27> Var0;
...
void func_192(int iParam0, var uParam1, int iParam2)//Position - 0xCAB7
{
	int iVar0;
	int iVar1;
...
int func_193(int iParam0)//Position - 0xCE0F
{
...
int func_194(var uParam0)//Position - 0xCE2F
{
...
int func_195(var uParam0)//Position - 0xCE47
{
...
void func_196(var uParam0)//Position - 0xCE6C
{
	int iVar0;
	int iVar1;
...
void func_197(int iParam0)//Position - 0xD170
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_198(var uParam0)//Position - 0xD19B
{
	int iVar0;
...
int func_199(var uParam0, bool bParam1, bool bParam2)//Position - 0xD21B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_200(int iParam0, int iParam1)//Position - 0xD3D9
{
	int iVar0;
...
int func_201(var uParam0, bool bParam1, int iParam2)//Position - 0xD409
{
	int iVar0;
	int iVar1;
...
int func_202(int iParam0)//Position - 0xD6C5
{
...
int func_203(int iParam0, float fParam1)//Position - 0xD6F9
{
	float fVar0;
...
bool func_204(int iParam0, float fParam1)//Position - 0xD76F
{
	return func_205(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_205(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD787
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_206(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xD848
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_207(int iParam0, int iParam1)//Position - 0xD974
{
	int iVar0;
...
int func_209(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDA83
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = { func_211(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_210(vector3 vParam0, vector3 vParam3)//Position - 0xDB14
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_211(vector3 vParam0)//Position - 0xDB35
{
	float fVar0;
	float fVar1;
...
void func_212(var uParam0)//Position - 0xDB74
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_213(int iParam0, int iParam1)//Position - 0xDB8F
{
	int iVar0;
...
int func_214(int iParam0)//Position - 0xDBCE
{
...
int func_215(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDBF6
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_216(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDCF1
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_217(int iParam0, float fParam1)//Position - 0xDDFD
{
	var uVar0;
	vector3 vVar1;
...
int func_218(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xDE92
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_219(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDF20
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_220(int iParam0)//Position - 0xDF68
{
...
void func_221(int iParam0)//Position - 0xDFB2
{
	int iVar0;
...
int func_222(int iParam0)//Position - 0xE04F
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_223(int iParam0)//Position - 0xE0E7
{
...
int func_226(int iParam0)//Position - 0xE169
{
...
int func_228(int iParam0)//Position - 0xE1DB
{
	if (func_107(0))
	{
...
int func_229(int iParam0)//Position - 0xE203
{
	if (!func_230(iParam0))
	{
		return 0;
...
int func_230(var uParam0)//Position - 0xE222
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
int func_231(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xE4BA
{
...
int func_232(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xE516
{
	int iVar0;
...
int func_233(var uParam0, int iParam1)//Position - 0xE5A4
{
	int iVar0;
...
void func_234(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xE5EA
{
	func_197(iParam0);
...
int func_235(int iParam0)//Position - 0xE611
{
	int iVar0;
...
void func_236(int iParam0, bool bParam1, bool bParam2)//Position - 0xE642
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_237(int iParam0)//Position - 0xE742
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
...
int func_238(int iParam0)//Position - 0xE76D
{
	struct<27> Var0;
	int iVar32;
...
int func_239(int iParam0)//Position - 0xE7C1
{
	char* sVar0;
...
int func_240(int iParam0)//Position - 0xE87A
{
	var uVar0;
...
int func_241(int iParam0)//Position - 0xE93B
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_242(int iParam0, char* sParam1)//Position - 0xE9C0
{
...
bool func_243(int iParam0)//Position - 0xEAA2
{
...
bool func_244(int iParam0)//Position - 0xEAD0
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_245(int iParam0)//Position - 0xEAFE
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_246(int iParam0)//Position - 0xEB2C
{
	if (func_223(iParam0))
	{
		return 0;
...
void func_247()//Position - 0xEB61
{
	func_268("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xEB7B
{
	int iVar0;
...
int func_249(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xEBE0
{
	int iVar0;
	struct<7> Var1;
...
int func_250(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xEC5E
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_251(int iParam0, bool bParam1)//Position - 0xECD9
{
	if (bParam1)
	{
...
int func_252(var uParam0)//Position - 0xED3E
{
	if (func_195(uParam0))
	{
...
void func_253(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xED74
{
...
void func_254(var uParam0, bool bParam1)//Position - 0xED94
{
	func_255(&(uParam0->f_41), bParam1);
}

void func_255(var uParam0, bool bParam1)//Position - 0xEDA6
{
	int iVar0;
...
void func_256(int iParam0, bool bParam1)//Position - 0xEDE4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_257(var uParam0, bool bParam1)//Position - 0xEE1F
{
	func_258(&(uParam0->f_35), bParam1);
}

void func_258(var uParam0, bool bParam1)//Position - 0xEE31
{
	int iVar0;
...
void func_259(int iParam0)//Position - 0xEE6E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_260(int iParam0)//Position - 0xEEA6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_261(var uParam0, int iParam1)//Position - 0xEF42
{
	func_262(&(uParam0->f_28), iParam1);
}

void func_262(var uParam0, int iParam1)//Position - 0xEF54
{
	int iVar0;
...
void func_263(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xEF95
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_264(int iParam0)//Position - 0xEFE5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_265(var uParam0)//Position - 0xF026
{
...
int func_266(int iParam0, int iParam1)//Position - 0xF097
{
	if (func_125(iParam0))
	{
...
void func_267(var uParam0)//Position - 0xF0CA
{
	if (*uParam0 == -1)
	{
		return;
...
void func_268(int iParam0)//Position - 0xF107
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_269(var uParam0)//Position - 0xF119
{
	*uParam0 = -1;
