...
void func_22(char* sParam0)//Position - 0x17C1
{
	struct<16> Var0;
...
void func_23(char* sParam0)//Position - 0x17E7
{
	int iVar0;
...
void func_24(char* sParam0)//Position - 0x183A
{
	int iVar0;
...
void func_25(int iParam0, char* sParam1)//Position - 0x187E
{
	switch (iParam0)
	{
		case 0:
...
void func_26(char* sParam0)//Position - 0x1A47
{
	char cVar0[64];
...
void func_27(char* sParam0)//Position - 0x1A7B
{
	struct<4> Var0;
...
void func_28(char* sParam0)//Position - 0x1AA6
{
...
void func_29()//Position - 0x1AC7
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_30(char* sParam0)//Position - 0x1AD8
{
	int iVar0;
...
bool func_32(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B44
{
...
int func_33(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B92
{
	Global_15867 = 0;
...
bool func_40(int iParam0, int iParam1)//Position - 0x20DB
{
	switch (iParam0)
	{
		case 5:
...
void func_41(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2116
{
...
void func_42(char[4] cParam0)//Position - 0x216C
{
	int iVar0;
...
void func_43(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x21A7
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_44(char* sParam0)//Position - 0x2242
{
	int iVar0;
...
void func_45(var uParam0)//Position - 0x227A
{
}

void func_46(var uParam0, int iParam1, float fParam2)//Position - 0x2282
{
}

void func_47()//Position - 0x228A
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_48()//Position - 0x2299
{
	char* sVar0;
	struct<16> Var8;
...
void func_49(var uParam0)//Position - 0x230F
{
}

void func_50(char* sParam0)//Position - 0x2317
{
...
void func_51(int iParam0, char* sParam1, char* sParam2)//Position - 0x232A
{
...
bool func_53()//Position - 0x241D
{
	return Global_93734.f_339 > 0;
}

bool func_54()//Position - 0x242E
{
	bool bVar0;
...
void func_58(char* sParam0)//Position - 0x24B1
{
	struct<8> Var0;
...
void func_59(char* sParam0)//Position - 0x24F1
{
	func_25(iLocal_297, sParam0);
}

void func_60(char* sParam0)//Position - 0x2502
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_106510[iLocal_251] + 1, 16);
}

void func_61(int iParam0, bool bParam1)//Position - 0x2520
{
	int iVar0;
...
void func_62(int iParam0, bool bParam1)//Position - 0x2541
{
	int iVar0;
...
void func_63(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x25B2
{
	func_64(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_64(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x25D2
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x28C4
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0)//Position - 0x2A34
{
	int iVar0;
...
int func_71(int iParam0)//Position - 0x2A67
{
...
int func_72(int iParam0)//Position - 0x2A91
{
	switch (iParam0)
	{
...
void func_73(int iParam0)//Position - 0x2B4F
{
	if (iLocal_447 == 1)
	{
...
void func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x2B6E
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_75(int iParam0, bool bParam1, int iParam2)//Position - 0x2BC1
{
	int iVar0;
...
int func_76(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C13
{
	int iVar0;
...
float func_77(bool bParam0, float fParam1, float fParam2)//Position - 0x2CB7
{
	if (bParam0)
	{
		return fParam1;
...
float func_78(int iParam0, int iParam1, bool bParam2)//Position - 0x2CCE
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_79(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2D2C
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_80(vector3 vParam0, vector3 vParam3)//Position - 0x2DBD
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_81(vector3 vParam0)//Position - 0x2DDE
{
	float fVar0;
	float fVar1;
...
int func_82(int iParam0)//Position - 0x2E1D
{
	var uVar0;
...
void func_85()//Position - 0x2E71
{
	Global_14732 = 0;
	func_86();
}

void func_86()//Position - 0x2E81
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_87()//Position - 0x2EA2
{
	return 0;
}

void func_88()//Position - 0x2EAB
{
}

int func_89()//Position - 0x2EB3
{
	return 1;
}

float func_90(int iParam0, int iParam1)//Position - 0x2EBC
{
	return func_78(iParam0, iParam1, 1);
}

void func_91(int iParam0)//Position - 0x2ECD
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x2EFE
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0, bool bParam1)//Position - 0x2F2F
{
	if (!func_71(iParam0))
	{
		if (!bParam1)
...
void func_94(var uParam0, var uParam1)//Position - 0x2FE2
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_95(int iParam0, bool bParam1)//Position - 0x2FF3
{
	if (iParam0 == 1)
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_96(int iParam0)//Position - 0x3065
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_97()//Position - 0x3086
{
	func_98();
}

void func_98()//Position - 0x3092
{
}

void func_99()//Position - 0x309A
{
...
int func_100(int iParam0)//Position - 0x3172
{
...
int func_104()//Position - 0x31F7
{
	return 1;
}

bool func_105(var uParam0)//Position - 0x3200
{
	return func_106(Global_106565.f_20111, uParam0);
}

bool func_106(var uParam0, var uParam1)//Position - 0x3215
{
	return (uParam0 && uParam1) != 0;
}

int func_107(int iParam0)//Position - 0x3224
{
...
void func_108(int iParam0)//Position - 0x334B
{
	var uVar0;
...
void func_109(int iParam0)//Position - 0x341A
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_110()//Position - 0x343A
{
	struct<6> Var0;
...
void func_112()//Position - 0x346A
{
}

void func_113()//Position - 0x3472
{
	if (iLocal_245 == -1)
	{
