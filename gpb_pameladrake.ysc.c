...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 == 1)
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_240)) && fVar43 < 25f) && func_82(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_79(iLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_83())
				{
					func_85();
		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_46(Global_106510[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_78(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_298 == -1)
			{
			...
			if (func_4(iLocal_298, 1))
			{
				...
				iLocal_250 = 13;
				iVar29 = 0;
				iVar82 = func_72(MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()));
				if (func_71(iVar82))
				{
					if (!func_70(iVar82))
					{
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_240) && func_78(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_107(1);
		}
		SYSTEM::WAIT(0);
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_448) && !ENTITY::IS_ENTITY_DEAD(iLocal_448, 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_240, 0))
	{
		if (!iLocal_449)
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_240, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 15f)
			{
				...
				BRAIN::TASK_FOLLOW_POINT_ROUTE(iLocal_448, 1f, 0);
				iLocal_449 = 1;
			}
		}
		else
...
void func_22(char* sParam0)//Position - 0x18D7
{
	struct<16> Var0;
...
void func_23(char* sParam0)//Position - 0x18FD
{
	int iVar0;
...
void func_24(char* sParam0)//Position - 0x193B
{
	int iVar0;
...
void func_25(int iParam0, char* sParam1)//Position - 0x197F
{
	switch (iParam0)
	{
		case 0:
...
void func_26(char* sParam0)//Position - 0x1B48
{
	char cVar0[64];
...
void func_27(char* sParam0)//Position - 0x1B7C
{
	struct<4> Var0;
...
void func_28(char* sParam0)//Position - 0x1BA7
{
...
void func_29()//Position - 0x1BC8
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_30(char* sParam0)//Position - 0x1BD9
{
	int iVar0;
...
bool func_32(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1C45
{
...
int func_33(char* sParam0, int iParam1, bool bParam2)//Position - 0x1C93
{
	Global_15867 = 0;
...
bool func_40(int iParam0, int iParam1)//Position - 0x21DC
{
	switch (iParam0)
	{
		case 5:
...
void func_41(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2217
{
...
void func_42(char[4] cParam0)//Position - 0x226D
{
	int iVar0;
...
void func_43(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x22A8
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_44(char* sParam0)//Position - 0x2343
{
	int iVar0;
...
void func_45(var uParam0)//Position - 0x237B
{
}

void func_46(var uParam0, int iParam1, float fParam2)//Position - 0x2383
{
}

void func_47()//Position - 0x238B
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_48()//Position - 0x239A
{
	char* sVar0;
	struct<16> Var8;
...
void func_49(var uParam0)//Position - 0x2410
{
}

void func_50(char* sParam0)//Position - 0x2418
{
...
void func_51(int iParam0, char* sParam1, char* sParam2)//Position - 0x242B
{
...
bool func_53()//Position - 0x2584
{
	return Global_93734.f_339 > 0;
}

bool func_54()//Position - 0x2595
{
	bool bVar0;
...
void func_58(char* sParam0)//Position - 0x2618
{
	struct<8> Var0;
...
void func_59(char* sParam0)//Position - 0x2658
{
	func_25(iLocal_297, sParam0);
}

void func_60(char* sParam0)//Position - 0x2669
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_106510[iLocal_251] + 1, 16);
}

void func_61(int iParam0, bool bParam1)//Position - 0x2687
{
	int iVar0;
...
void func_62(int iParam0, bool bParam1)//Position - 0x26A8
{
	int iVar0;
...
void func_63(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2719
{
	func_64(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_64(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2739
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x2A2B
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0)//Position - 0x2B74
{
	if (func_71(iParam0))
	{
...
int func_70(int iParam0)//Position - 0x2B9B
{
	int iVar0;
...
int func_71(int iParam0)//Position - 0x2BCE
{
...
int func_72(int iParam0)//Position - 0x2BF8
{
	switch (iParam0)
	{
...
void func_73(int iParam0)//Position - 0x2CB6
{
	if (iLocal_447 == 1)
	{
...
void func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x2CD5
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_75(int iParam0, bool bParam1, int iParam2)//Position - 0x2D28
{
	int iVar0;
...
int func_76(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D7A
{
	int iVar0;
...
float func_77(bool bParam0, float fParam1, float fParam2)//Position - 0x2E1E
{
	if (bParam0)
	{
		return fParam1;
...
float func_78(int iParam0, int iParam1, bool bParam2)//Position - 0x2E35
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_79(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2E93
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_80(vector3 vParam0, vector3 vParam3)//Position - 0x2F24
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_81(vector3 vParam0)//Position - 0x2F45
{
	float fVar0;
	float fVar1;
...
int func_82(int iParam0)//Position - 0x2F84
{
	var uVar0;
...
void func_85()//Position - 0x2FD8
{
	Global_14732 = 0;
	func_86();
}

void func_86()//Position - 0x2FE8
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_87()//Position - 0x3009
{
	return 0;
}

void func_88()//Position - 0x3012
{
}

int func_89()//Position - 0x301A
{
	return 1;
}

float func_90(int iParam0, int iParam1)//Position - 0x3023
{
	return func_78(iParam0, iParam1, 1);
}

void func_91(int iParam0)//Position - 0x3034
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x3065
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0, bool bParam1)//Position - 0x3096
{
	if (!func_71(iParam0))
	{
		if (!bParam1)
...
void func_94(var uParam0, var uParam1)//Position - 0x3149
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_95(int iParam0, bool bParam1)//Position - 0x315A
{
	if (iParam0 == 1)
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_96(int iParam0)//Position - 0x31CC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_97()//Position - 0x31ED
{
	func_98();
}

void func_98()//Position - 0x31F9
{
...
int func_103()//Position - 0x33D4
{
	return 1;
}

bool func_104(var uParam0)//Position - 0x33DD
{
	return func_105(Global_106565.f_20111, uParam0);
}

bool func_105(var uParam0, var uParam1)//Position - 0x33F2
{
	return (uParam0 && uParam1) != 0;
}

int func_106(int iParam0)//Position - 0x3401
{
...
void func_107(int iParam0)//Position - 0x3528
{
	var uVar0;
...
void func_108(int iParam0)//Position - 0x35F7
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_109()//Position - 0x3617
{
	struct<6> Var0;
...
void func_110()//Position - 0x363B
{
	func_111();
}

void func_111()//Position - 0x3647
{
	if (!Global_3)
	{
		return;
