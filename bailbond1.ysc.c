...
void __EntryFunction__()//Position - 0x0
{
	...
	else if (func_422(0))
	{
		...
		{
			func_420(PLAYER::PLAYER_PED_ID(), vLocal_665, fLocal_405, 0, 0);
		...
		switch (iLocal_98)
		{
			case 0:
				if (iLocal_100 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_668, fLocal_406, 0, 1);
			...
			case 1:
				...
				if (iLocal_100 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_671, fLocal_407, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_393 == 0)
						{
			...
			case 3:
				...
				if (iLocal_100 == 1)
				{
					...
					if (!func_71())
					{
						func_420(PLAYER::PLAYER_PED_ID(), vLocal_625, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_393 == 0)
						{
...
void func_11(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7F0
{
	var uVar0;
	int iVar1;
...
void func_19(int iParam0, struct<2> Param1, float fParam3)//Position - 0xA22
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_20(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0xA81
{
	bool bVar0;
	float fVar1;
...
void func_27(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xC7D
{
	if (bParam0)
	{
...
bool func_28()//Position - 0xDB6
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_29(int iParam0, int iParam1)//Position - 0xDD3
{
	bool bVar0;
...
int func_30(int iParam0, bool bParam1)//Position - 0xE1E
{
	int iVar0;
	int iVar1;
...
int func_31()//Position - 0xE5F
{
	return Global_1312745;
}

int func_32(int iParam0)//Position - 0xE6B
{
...
bool func_33()//Position - 0xEAD
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_34(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xEBE
{
	int iVar0;
...
void func_35(int iParam0)//Position - 0xEF1
{
	if (iParam0 == 1)
	{
...
void func_36(int iParam0)//Position - 0xF14
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iParam0)
...
int func_37()//Position - 0xF70
{
	if (func_59(vLocal_628, Local_336.f_1, 210f))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_356))
		{
			...
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_356.f_1, 10f, func_48(), 0))
				{
					Local_356 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_356.f_1, 10f, func_48(), 1, 0, 1);
					if (func_421(Local_356))
					{
						ENTITY::SET_ENTITY_COORDS(Local_356, func_47(), 1, 0, 0, 1);
						ENTITY::SET_ENTITY_HEADING(Local_356, func_46());
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_362))
		{
			...
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_362.f_1, 10f, func_45(), 0))
				{
					Local_362 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_362.f_1, 10f, func_45(), 1, 0, 1);
				}
			}
		}
	}
...
void func_38(int iParam0, bool bParam1)//Position - 0x1125
{
	if (bParam1)
	{
		func_40(iParam0);
...
void func_39(int iParam0, bool bParam1)//Position - 0x1142
{
...
void func_40(int iParam0)//Position - 0x117D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
char* func_41()//Position - 0x11A8
{
	return "special_ped@maude@base";
}

void func_42(int iParam0, bool bParam1)//Position - 0x11B3
{
	if (bParam1)
	{
		func_44(iParam0);
...
void func_43(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11D2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_44(int iParam0)//Position - 0x1222
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_45()//Position - 0x1263
{
	return 2057223314;
}

float func_46()//Position - 0x1270
{
	return -92.17f;
}

Vector3 func_47()//Position - 0x127D
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_48()//Position - 0x1294
{
	return -380698483;
}

void func_49()//Position - 0x12A1
{
	int iVar0;
	int iVar1;
	...
	if (func_23(Local_336))
	{
		if (func_421(Local_344))
		{
			if (func_58(3))
			{
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_336, iVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_344, iVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1148846080);
				...
				BRAIN::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_336, 0);
				BRAIN::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_336, 0);
...
char* func_51()//Position - 0x1398
{
	return "base";
}

Vector3 func_52()//Position - 0x13A3
{
	return 0f, 0f, -92.17f;
}

Vector3 func_53()//Position - 0x13B2
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_54(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x13C9
{
...
void func_55(int iParam0, bool bParam1)//Position - 0x144B
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_57(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x149C
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
int func_58(int iParam0)//Position - 0x1507
{
	switch (iParam0)
	{
		case 0:
...
bool func_59(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x1594
{
	return SYSTEM::VDIST2(vParam0, vParam3) <= (fParam6 * fParam6);
}

int func_60(int iParam0, float fParam1, int iParam2)//Position - 0x15AE
{
	int iVar0;
...
int func_64(int iParam0, int iParam1)//Position - 0x1718
{
	if (func_23(iParam0))
	{
...
int func_65(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x174B
{
...
void func_66(int iParam0)//Position - 0x18DA
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_67()//Position - 0x1906
{
	if (func_421(Local_112.f_9))
	{
		if (CUTSCENE::_0xB56BBBCC2955D9CB())
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_444, Local_112.f_9, 0);
		}
	}
	if (func_421(Local_336))
	{
		if (CUTSCENE::_0xB56BBBCC2955D9CB())
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9(sLocal_443, Local_336, 0);
		}
	}
}

void func_68(char* sParam0)//Position - 0x1948
{
	func_27(1, 1, 0, 0, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_69(int iParam0, int iParam1, int iParam2)//Position - 0x1962
{
	if (func_508() && func_71())
	{
...
void func_70(int iParam0)//Position - 0x1A26
{
	if (iParam0 == 1)
	{
...
bool func_71()//Position - 0x1A4F
{
	return MISC::IS_BIT_SET(Global_93682.f_20, 13);
}

void func_72()//Position - 0x1A63
{
	char* sVar0;
	int iVar1;
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_23(Local_336))
				{
					...
					{
						if (func_105(Local_336, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
				...
				if (iLocal_102 == 4)
				{
					...
					else if (func_23(Local_336))
					{
						if (!func_64(Local_336, 1805844857))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_336, func_102(), func_74(), 3))
								{
									func_73(&Local_336);
									BRAIN::TASK_SMART_FLEE_PED(Local_336, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(Local_336, 1);
								}
							}
						}
...
void func_73(int iParam0)//Position - 0x1D07
{
	if (func_23(*iParam0))
	{
...
char* func_74()//Position - 0x1D70
{
	return "female_Flee_Table_Left_Maude";
}

int func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D7B
{
	if (iParam4 == 0)
	{
...
bool func_76(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1DB8
{
...
int func_77(char* sParam0, int iParam1, bool bParam2)//Position - 0x1E06
{
	Global_15867 = 0;
...
int func_82()//Position - 0x22D3
{
	func_83();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_83()//Position - 0x22EC
{
	int iVar0;
...
bool func_84(int iParam0)//Position - 0x23E9
{
	return iParam0 < 3;
}

int func_85(int iParam0)//Position - 0x23F5
{
	int iVar0;
	int iVar1;
...
int func_86(int iParam0)//Position - 0x2432
{
	if (func_84(iParam0))
	{
...
bool func_87(int iParam0)//Position - 0x245C
{
	return Global_36425 == iParam0;
}

void func_88()//Position - 0x246A
{
	int iVar0;
...
bool func_89(int iParam0, int iParam1)//Position - 0x24C1
{
	switch (iParam0)
	{
		case 5:
...
void func_90(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x24FC
{
...
void func_91(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2552
{
...
void func_92(bool bParam0)//Position - 0x25ED
{
	int iVar0;
...
void func_93(int iParam0, bool bParam1)//Position - 0x279F
{
	if (bParam1)
	{
		func_95(iParam0);
...
void func_94(int iParam0)//Position - 0x27BB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_95(int iParam0)//Position - 0x27F3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
void func_96(var uParam0)//Position - 0x288F
{
...
void func_98(char* sParam0)//Position - 0x28D5
{
...
void func_99(int iParam0, bool bParam1)//Position - 0x2914
{
	if (func_23(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, 0);
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x298F
{
	int iVar0;
...
char* func_101()//Position - 0x2ADB
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_102()//Position - 0x2AE6
{
	return "special_ped@maude@exit_flee";
}

void func_103(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2AF2
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_104(iParam3), 0);
}

int func_104(int iParam0)//Position - 0x2B0B
{
	int iVar0;
...
bool func_105(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2D00
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1) <= (fParam4 * fParam4);
}

void func_106(int iParam0, bool bParam1)//Position - 0x2D1D
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_107(var uParam0, int iParam1)//Position - 0x2D8E
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_109(int iParam0)//Position - 0x2DCF
{
	bool bVar0;
	struct<8> Var1;
...
void func_110(int iParam0)//Position - 0x2E41
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_111(int iParam0)//Position - 0x2E61
{
	int iVar0;
...
bool func_113(int iParam0, int iParam1)//Position - 0x2F4D
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_114(int iParam0)//Position - 0x2F5F
{
	if (func_23(Local_133[iParam0 /*19*/]))
	{
		BRAIN::CLEAR_PED_SECONDARY_TASK(Local_133[iParam0 /*19*/]);
		BRAIN::CLEAR_PED_TASKS(Local_133[iParam0 /*19*/]);
		BRAIN::TASK_CLEAR_LOOK_AT(Local_133[iParam0 /*19*/]);
		if (func_115(1, 0, 1))
		{
		...
		else if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_133[iParam0 /*19*/]) == iLocal_612)
		{
			...
			BRAIN::TASK_LOOK_AT_ENTITY(Local_133[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_133[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1);
...
int func_115(bool bParam0, bool bParam1, bool bParam2)//Position - 0x30BC
{
	int iVar0;
...
void func_116(int iParam0)//Position - 0x31B3
{
	func_24(500, 1);
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x31E8
{
	bool bVar0;
...
int func_120()//Position - 0x37DC
{
	return Global_25765;
}

int func_121(int iParam0, int iParam1)//Position - 0x37E7
{
	int iVar0;
...
int func_122(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3838
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_123(int iParam0)//Position - 0x3DEE
{
	int iVar0;
	...
	switch (iLocal_100)
	{
		...
		case 2:
			...
			else
			{
				...
				if (func_23(Local_336))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(Local_336, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					PED::SET_PED_KEEP_TASK(Local_336, 1);
				}
...
void func_125(int iParam0)//Position - 0x413E
{
	iLocal_98 = iParam0;
	iLocal_100 = 0;
}

void func_126(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x414D
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_178(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_175(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_127(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x41C8
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_161(iParam5, &Var0, vParam1, fParam4, func_167(iParam0));
		func_128(iParam5, iParam0, 0);
	}
}

void func_128(int iParam0, int iParam1, int iParam2)//Position - 0x42F1
{
	int iVar0;
...
void func_129(int iParam0, int iParam1)//Position - 0x440E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_130(int iParam0)//Position - 0x4610
{
...
int func_131(int iParam0)//Position - 0x46ED
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_132(int iParam0, bool bParam1)//Position - 0x489E
{
	int iVar0;
	struct<2> Var1;
...
int func_133(int iParam0)//Position - 0x4A1E
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_135(int iParam0)//Position - 0x4B01
{
	int iVar0;
	int iVar1;
...
int func_136()//Position - 0x6B6E
{
	return 0;
}

int func_137()//Position - 0x6B77
{
	return 1;
}

int func_138()//Position - 0x6B80
{
	return 1;
}

int func_139()//Position - 0x6B89
{
...
int func_141(int iParam0)//Position - 0x6C5D
{
	int iVar0;
	char* sVar1;
...
int func_142(int iParam0)//Position - 0x6CA3
{
	int iVar0;
...
int func_143(int iParam0)//Position - 0x6CDE
{
	int iVar0;
...
int func_144(int iParam0)//Position - 0x6D5A
{
	int iVar0;
...
int func_145(int iParam0, int iParam1, bool bParam2)//Position - 0x6E42
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_146(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x6EB3
{
...
void func_148(var uParam0, int iParam1)//Position - 0x6FD1
{
	if (iParam1 <= 0)
	{
		return;
...
void func_149(var uParam0, int iParam1)//Position - 0x7057
{
...
void func_150(var uParam0, int iParam1)//Position - 0x708A
{
	int iVar0;
	int iVar1;
...
int func_151(int iParam0, int iParam1)//Position - 0x70DB
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_152(int iParam0)//Position - 0x717D
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_153(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_153(bool bParam0, int iParam1, int iParam2)//Position - 0x71A2
{
	if (bParam0)
	{
		return iParam1;
...
int func_154(var uParam0)//Position - 0x71B9
{
	return uParam0 & 15;
}

void func_155(var uParam0, int iParam1)//Position - 0x71C6
{
...
void func_156(var uParam0, int iParam1)//Position - 0x7200
{
...
void func_157(var uParam0, int iParam1)//Position - 0x723B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_158(var uParam0, int iParam1)//Position - 0x7277
{
	int iVar0;
	int iVar1;
...
int func_159(int iParam0, int iParam1)//Position - 0x8970
{
	struct<82> Var0;
...
void func_160(int iParam0, var uParam1, int iParam2)//Position - 0x89B2
{
	int iVar0;
...
void func_161(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x8C0E
{
	if (func_158(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_162(int iParam0, bool bParam1)//Position - 0x8D0D
{
	if (iParam0 == -1)
	{
		return;
...
void func_163(int iParam0, int iParam1, bool bParam2)//Position - 0x8D6A
{
	if (iParam0 == -1)
	{
		return;
...
bool func_164(int iParam0, int iParam1)//Position - 0x8DA5
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_165(var uParam0, var uParam1)//Position - 0x8DC8
{
...
void func_166(int iParam0)//Position - 0x8E94
{
	if (iParam0 == -1)
	{
		return;
...
int func_167(int iParam0)//Position - 0x8F0E
{
	int iVar0;
...
bool func_168(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x8F71
{
	if (bParam6)
	{
...
void func_169(int iParam0, var uParam1)//Position - 0x8FB8
{
	int iVar0;
...
int func_170(int iParam0)//Position - 0x9263
{
	switch (iParam0)
	{
		case 1:
...
int func_171(int iParam0, var uParam1, var uParam2)//Position - 0x9313
{
	int iVar0;
	int iVar1;
...
int func_172(int iParam0)//Position - 0x9506
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_173(var uParam0)//Position - 0x9526
{
	int iVar0;
...
void func_174(int iParam0)//Position - 0x95D6
{
...
int func_175(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x95FD
{
	int iVar0;
...
int func_176(vector3 vParam0, int iParam3, int iParam4)//Position - 0x9713
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_177(int iParam0)//Position - 0x97A2
{
	return MISC::IS_BIT_SET(Global_106565.f_7223[iParam0], 0);
}

int func_178(int iParam0)//Position - 0x97BA
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_179(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x97D6
{
	func_180(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_180(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x97FF
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_181(vector3 vParam0)//Position - 0x9BF3
{
...
int func_182(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x9C1D
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_183(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x9F13
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_184(vector3 vParam0)//Position - 0x9FC7
{
	float fVar0;
	float fVar1;
...
void func_185(int iParam0)//Position - 0xA006
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
bool func_186(vector3 vParam0, int iParam3)//Position - 0xA06B
{
	return func_187(Global_97130.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_187(int iParam0, vector3 vParam1, int iParam4)//Position - 0xA088
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_188()//Position - 0xA0F2
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_189()//Position - 0xA109
{
	return 3.01f, 11.01f, 6.01f;
}

int func_190(var uParam0, var uParam1, var uParam2)//Position - 0xA120
{
...
void func_191(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0xA157
{
	int iVar0;
...
Vector3 func_192(int iParam0)//Position - 0xA315
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_193(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA328
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_194(int iParam0, int iParam1, int iParam2)//Position - 0xAB3E
{
	int iVar0;
...
int func_195(int iParam0)//Position - 0xABCA
{
	switch (iParam0)
	{
...
void func_196(int iParam0, int iParam1, int iParam2)//Position - 0xAC05
{
	int iVar0;
	int iVar1;
...
int func_197(int iParam0, int iParam1, int iParam2)//Position - 0xAC8F
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_198(int iParam0, int iParam1, int iParam2)//Position - 0xAD6D
{
	Global_71402[1 /*14*/] = { func_243(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_199(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xAD98
{
	var uVar0;
	int iVar10;
...
int func_200(int iParam0, int iParam1, int iParam2)//Position - 0xB39C
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_201(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB435
{
	int iVar0;
...
int func_202(int iParam0, int iParam1, int iParam2)//Position - 0xB4CB
{
	int iVar0;
	int iVar1;
...
int func_203(int iParam0)//Position - 0xB56C
{
	switch (iParam0)
	{
		case 0:
...
int func_204(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB61C
{
	int iVar0;
...
int func_205(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB923
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_206(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xC4D7
{
	int iVar0;
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC7BB
{
	int iVar0;
...
int func_208(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCA82
{
	int iVar0;
	int iVar1;
...
int func_209(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCAB9
{
	int iVar0;
...
int func_210(int iParam0, int iParam1, int iParam2)//Position - 0xCAE2
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_211(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCDAC
{
	int iVar0;
...
int func_212(int iParam0, int iParam1, int iParam2)//Position - 0xD036
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_213(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD18D
{
	int iVar0;
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD225
{
	switch (iParam0)
	{
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD2F3
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_203(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_216(int iParam0, int iParam1)//Position - 0xD44F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_217(int iParam0)//Position - 0xD7F6
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_218(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD857
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_219(int iParam0, int iParam1)//Position - 0xD953
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDA91
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_203(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_221(int iParam0)//Position - 0xDB71
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_222(int iParam0, int iParam1)//Position - 0xDBF7
{
	int iVar0;
	struct<10> Var1;
...
void func_223(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE526
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_224(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xE650
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_225(int iParam0, int iParam1)//Position - 0xE698
{
	int iVar0;
	struct<17> Var1;
...
void func_226(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x104E2
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_227(int iParam0)//Position - 0x106CC
{
	switch (iParam0)
	{
		case 0:
...
void func_228(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1077C
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_229(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x107ED
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_230(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10A6A
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_231(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10E8F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_232(int iParam0, int iParam1)//Position - 0x11182
{
	int iVar0;
	int iVar1;
...
int func_233(int iParam0, int iParam1)//Position - 0x111C8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_234(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11228
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_235(int iParam0)//Position - 0x112AC
{
...
void func_236(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x11364
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_237(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x113AE
{
	int iVar0;
...
int func_238(var uParam0)//Position - 0x113DE
{
	int iVar0;
	int iVar1;
...
int func_239(int iParam0, int iParam1, int iParam2)//Position - 0x11412
{
	int iVar0;
	var uVar1;
...
bool func_240(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x11444
{
	int iVar0;
...
int func_241(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x13215
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_242(int iParam0)//Position - 0x14135
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_243(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14186
{
	func_306();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_244(int iParam0, int iParam1)//Position - 0x141D8
{
	switch (iParam0)
	{
		case 0:
...
void func_245(int iParam0)//Position - 0x142C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_246(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1553F
{
	int iVar0;
	int iVar1;
...
bool func_247(int iParam0, int iParam1, var uParam2)//Position - 0x158D0
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_248(int iParam0, int iParam1)//Position - 0x15CD5
{
	switch (iParam1)
	{
		case 0:
...
int func_249(int iParam0, int iParam1)//Position - 0x160D0
{
	switch (iParam1)
	{
		case 0:
...
int func_250(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x164CB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_251(int iParam0)//Position - 0x1650D
{
	switch (iParam0)
	{
		case -1:
...
void func_252(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x165E1
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_246(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_246(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_203(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_253(int iParam0)//Position - 0x168BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_254(int iParam0)//Position - 0x16A11
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(int iParam0)//Position - 0x16F1F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_256(int iParam0)//Position - 0x16F94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_257(int iParam0)//Position - 0x17008
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_258(int iParam0)//Position - 0x170EF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_259(int iParam0)//Position - 0x17452
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0)//Position - 0x17663
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_261(int iParam0)//Position - 0x17893
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x179A3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x18342
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x18EB5
{
	if (iParam0 < 136)
	{
		func_266(iParam0);
...
void func_265(int iParam0)//Position - 0x18EEA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x19AEE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x1A9FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x1AB29
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0, int iParam1)//Position - 0x1AC27
{
	switch (iParam0)
	{
		case 0:
...
void func_270(int iParam0)//Position - 0x1AD17
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x1C209
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1C35A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1C865
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1CED3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1CF47
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1D017
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1D547
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1D6DE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1DEDC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1DFEC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1EF17
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x1FBD4
{
	if (iParam0 < 107)
	{
		func_285(iParam0);
...
void func_283(int iParam0)//Position - 0x1FC1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x206C1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x214B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x220F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x22372
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0, int iParam1)//Position - 0x224B8
{
	switch (iParam0)
	{
		case 0:
...
void func_289(int iParam0)//Position - 0x225A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x23332
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x234AC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x23A23
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x23F4D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x23FC1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x240A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x24581
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x247EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x24AC0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x24C89
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x257DD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x26427
{
	if (iParam0 < 60)
	{
		func_303(iParam0);
...
void func_302(int iParam0)//Position - 0x2645C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x271FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x27888
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x2796F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306()//Position - 0x27A6D
{
...
int func_307(int iParam0, int iParam1, int iParam2)//Position - 0x27AE6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_308(bool bParam0)//Position - 0x27D41
{
	int iVar0;
...
void func_309()//Position - 0x27D7F
{
	bool bVar0;
	vector3 vVar1;
				...
				if (!iLocal_397)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_113(iLocal_410, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_112.f_9, vLocal_628, 30f))
									{
...
int func_310(var uParam0)//Position - 0x28258
{
	vector3 vVar0;
...
int func_311(var uParam0)//Position - 0x2829D
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
bool func_312(char* sParam0, int iParam1, int iParam2)//Position - 0x282D5
{
...
void func_313(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x282F3
{
...
void func_314(char* sParam0, int iParam1, int iParam2)//Position - 0x2839F
{
	iParam2 = iParam2;
...
int func_315(char* sParam0, bool bParam1)//Position - 0x283B8
{
	struct<6> Var0;
...
struct<6> func_316()//Position - 0x283F3
{
	struct<6> Var0;
...
void func_317(int iParam0, vector3 vParam1, int iParam4, float fParam5)//Position - 0x28417
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_318(var uParam0, int iParam1, int iParam2)//Position - 0x284FC
{
	char* sVar0;
...
int func_319(char* sParam0)//Position - 0x285D9
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_320()//Position - 0x285EC
{
	if (func_23(Local_112.f_9))
	{
...
int func_321(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x286F1
{
	int iVar0;
...
int func_322(int iParam0, vector3 vParam1, float fParam4, float fParam5)//Position - 0x28867
{
...
int func_323(int iParam0, vector3 vParam1)//Position - 0x2889F
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
void func_324(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x288FD
{
	func_325(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_325(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x28917
{
	func_326(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_326(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x28934
{
	...
	uParam0->f_6 = 2;
	func_327(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_327(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2896C
{
	int iVar0;
	int iVar1;
	...
	if (func_351(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_343(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_328(var uParam0)//Position - 0x28CD9
{
...
int func_329(var uParam0)//Position - 0x28D42
{
	int iVar0;
...
int func_330(bool bParam0)//Position - 0x28D6D
{
	switch (Global_36425)
	{
		case 0:
...
void func_331(char* sParam0, int iParam1)//Position - 0x28E17
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_332(char* sParam0)//Position - 0x28E2E
{
	if (!func_333(1, 1, 0))
	{
...
int func_333(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28EC7
{
	int iVar0;
	int iVar1;
...
int func_334(int iParam0)//Position - 0x29120
{
	if (iParam0 != func_336())
	{
...
int func_335(int iParam0, bool bParam1, bool bParam2)//Position - 0x29186
{
	int iVar0;
...
int func_336()//Position - 0x291D0
{
	return -1;
}

int func_337(int iParam0, int iParam1)//Position - 0x291D9
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_338(int iParam0, int iParam1)//Position - 0x2923B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_339()//Position - 0x292C0
{
	return Global_2448756.f_16;
}

bool func_340(int iParam0)//Position - 0x292CE
{
	return iParam0 == 51;
}

var func_341()//Position - 0x292DB
{
	return Global_2448756.f_15;
}

bool func_342()//Position - 0x292E9
{
	return MISC::GET_GAME_TIMER() <= Global_17411.f_5878 + 100;
}

void func_343(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x292FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_344()//Position - 0x2940E
{
	return func_345(PLAYER::PLAYER_ID());
}

int func_345(int iParam0)//Position - 0x2941E
{
...
int func_346(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2943D
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_347(bool bParam0, bool bParam1, bool bParam2)//Position - 0x297A9
{
...
int func_348(bool bParam0, bool bParam1, bool bParam2)//Position - 0x297FB
{
	if (!func_333(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_349(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29844
{
	if (!func_333(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_350(bool bParam0, bool bParam1, bool bParam2)//Position - 0x298A3
{
	if (!func_333(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_351(int iParam0)//Position - 0x298F9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_352()//Position - 0x29954
{
	MISC::SET_BIT(&Global_2424, 4);
}

void func_353(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29964
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_354(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x29A5F
{
	int iVar0;
	bool bVar1;
...
void func_355(int iParam0)//Position - 0x29AB1
{
...
void func_356(var uParam0, vector3 vParam1)//Position - 0x29B00
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_357()//Position - 0x29BDD
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
				...
				case 1:
					...
					{
						func_38(&Local_285, 1);
						if (!BRAIN::IS_PED_ACTIVE_IN_SCENARIO(Local_112.f_9))
						{
							BRAIN::TASK_START_SCENARIO_IN_PLACE(Local_112.f_9, "WORLD_HUMAN_SMOKING", 0, 1);
				...
				case 30:
					if (!func_64(Local_112.f_9, 242628503))
					{
						...
						BRAIN::CLOSE_SEQUENCE_TASK(uLocal_432);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_432);
				...
				case 31:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 750)))
					{
				...
				case 13:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::_0xFE07FF6495D52E2A(Local_112.f_9, vLocal_628);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, 1);
						if (iVar0 != joaat("weapon_unarmed"))
						{
				...
				case 15:
					...
					{
						if (((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_248[0 /*6*/], 0) && func_105(Local_248[0 /*6*/], Local_248[0 /*6*/].f_1, 3f)) && func_364(ENTITY::GET_ENTITY_HEADING(Local_248[0 /*6*/]), Local_248[0 /*6*/].f_4, 20f)) && !func_363(Local_248[0 /*6*/], 2))
						{
							...
							else if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								...
								BRAIN::TASK_ENTER_VEHICLE(Local_112.f_9, Local_248[0 /*6*/], 25000, -1, 3f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
								Local_112.f_10 = 16;
							}
						}
				...
				case 16:
					...
					else if ((((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_248[0 /*6*/], 1) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_105(Local_248[0 /*6*/], Local_248[0 /*6*/].f_1, 3f)) || !func_364(ENTITY::GET_ENTITY_HEADING(Local_248[0 /*6*/]), Local_248[0 /*6*/].f_4, 20f)) || func_363(Local_248[0 /*6*/], 2))
					{
						Local_112.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_112.f_10 = 13;
					}
				...
				case 17:
					...
					{
						BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(Local_112.f_9, Local_248[0 /*6*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, 1);
				...
				case 21:
					...
					else if (PED::DOES_GROUP_EXIST(func_360()))
					{
						...
						if (!PED::IS_PED_GROUP_MEMBER(Local_112.f_9, func_360()))
						{
							PED::SET_PED_AS_GROUP_MEMBER(Local_112.f_9, func_360());
						}
					...
					if (func_362(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_361())
					{
						...
						if (((!PED::IS_PED_RAGDOLL(Local_112.f_9) && !PED::IS_PED_BEING_STUNNED(Local_112.f_9, 0)) && !PED::IS_PED_BEING_JACKED(Local_112.f_9)) && !func_64(Local_112.f_9, -828834893))
						{
							...
							if ((!func_358(Local_112.f_19, 10) && func_105(Local_112.f_9, vLocal_628, 50f)) || !func_113(iLocal_429, 2000))
							{
								...
								else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_112.f_9)) && !func_361()) || ENTITY::IS_ENTITY_IN_WATER(Local_112.f_9))
								{
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1);
								}
				...
				case 24:
					if (func_362(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_361())
					{
						if (!func_64(Local_112.f_9, -1519143300))
						{
							...
							{
								if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_112.f_9)) || func_361())
								{
									Local_112.f_10 = 23;
								}
							}
...
bool func_358(int iParam0, int iParam1)//Position - 0x2AE56
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_359()//Position - 0x2AE68
{
	int iVar0;
	int iVar1;
...
var func_360()//Position - 0x2AEEE
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_361()//Position - 0x2AEFE
{
	if (!iLocal_369)
	{
		return 1;
...
int func_362(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2AF6B
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (func_23(iParam0))
	{
		...
		if (func_105(iParam0, vLocal_628, fParam2))
		{
...
int func_363(int iParam0, int iParam1)//Position - 0x2B121
{
	int iVar0;
...
int func_364(float fParam0, float fParam1, float fParam2)//Position - 0x2B185
{
...
char* func_365()//Position - 0x2B1A1
{
	return "move_m@bail_bond_not_tazered";
}

char* func_366()//Position - 0x2B1AD
{
	return "move_m@bail_bond_tazered";
}

int func_367()//Position - 0x2B1B9
{
...
void func_368(var uParam0, bool bParam1)//Position - 0x2B1EE
{
...
void func_369(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2B205
{
	if (func_421(iParam0))
	{
...
bool func_370(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2B231
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_371(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2B2F2
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_372(int iParam0, int iParam1)//Position - 0x2B41E
{
	int iVar0;
...
int func_374(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2B52D
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = { func_184(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_375(vector3 vParam0, vector3 vParam3)//Position - 0x2B5BE
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

int func_376(int iParam0, int iParam1)//Position - 0x2B5DF
{
	int iVar0;
...
void func_377(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2B61E
{
	if (func_421(iParam0))
	{
...
void func_378()//Position - 0x2B64A
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_625, 100f))
	{
		if (!func_379())
		{
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_625, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
bool func_379()//Position - 0x2B6D4
{
	return Global_91021;
}

void func_380()//Position - 0x2B6E0
{
	func_37();
	func_378();
	if (func_23(Local_112.f_9))
...
void func_381()//Position - 0x2B9F0
{
	int iVar0;
	int iVar1;
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_64(Local_112.f_9, -1519143300))
				{
					if (func_105(Local_112.f_9, vLocal_628, 25f))
					{
						...
						{
							if (func_113(iLocal_411, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_62())
								{
									func_3();
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_113(iLocal_410, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_112.f_9, vLocal_628, 20f))
							{
...
int func_382(int iParam0)//Position - 0x2BE6C
{
	int iVar0;
...
void func_383(char* sParam0, int iParam1)//Position - 0x2BEA5
{
	if (func_319(sParam0))
	{
...
void func_384(int iParam0)//Position - 0x2BEBC
{
...
void func_385()//Position - 0x2BEFB
{
	func_37();
	func_378();
	if (func_23(Local_112.f_9))
				...
				if (!iLocal_398)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_404))
						{
							if (iLocal_386)
							{
								iLocal_404 = func_390(vLocal_625, 5, 1);
							}
						}
						if (!iLocal_370)
						{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_105(PLAYER::PLAYER_PED_ID(), vLocal_625, 6.5f))
							{
								iLocal_100 = 2;
							}
						}
						else if (func_105(PLAYER::PLAYER_PED_ID(), vLocal_625, 2.5f))
						{
							iLocal_100 = 2;
						}
					}
...
int func_386(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2C2F7
{
	int iVar0;
...
bool func_387(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2C3C8
{
	vector3 vVar0;
...
int func_388(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6)//Position - 0x2C3F2
{
	vector3 vVar0;
	var uVar3;
	char[] cVar168[8];
...
void func_389(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2C47E
{
...
int func_390(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2C4B9
{
	int iVar0;
...
void func_391()//Position - 0x2C4E7
{
	bool bVar0;
...
void func_392(bool bParam0, var uParam1)//Position - 0x2C9E6
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_393(int iParam0, int iParam1, vector3 vParam2)//Position - 0x2CAD3
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_394(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x2CB76
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_395(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2CCCF
{
...
int func_396(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2CDBE
{
	if (func_23(iParam0))
	{
		if (func_7(iParam1))
...
void func_397()//Position - 0x2CEC5
{
	if (func_23(Local_112.f_9))
	{
...
int func_398(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2D3A1
{
	if (func_421(iParam0))
	{
		if (!func_358(iParam1, 10))
...
int func_399(var uParam0)//Position - 0x2D407
{
...
int func_400(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2D421
{
	vector3 vVar0;
	float fVar3;
...
void func_401()//Position - 0x2D450
{
	switch (iLocal_100)
	{
		case 0:
...
void func_402(var uParam0, var uParam1)//Position - 0x2D674
{
	if (!uParam0->f_7)
	{
...
char* func_403(int iParam0)//Position - 0x2D705
{
	switch (iParam0)
	{
		case 0:
...
char* func_404(int iParam0)//Position - 0x2D74A
{
	switch (iParam0)
	{
		case 0:
...
int func_405(int iParam0, int iParam1, int iParam2)//Position - 0x2D78D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_406(int iParam0)//Position - 0x2D877
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_407(int iParam0)//Position - 0x2D8DB
{
	switch (iParam0)
	{
		case 0:
...
void func_408()//Position - 0x2D918
{
	if (bLocal_392)
	{
...
void func_409()//Position - 0x2D975
{
	if (bLocal_392)
	{
...
void func_410()//Position - 0x2D9BF
{
...
int func_411(bool bParam0)//Position - 0x2DAFE
{
	if (func_23(Local_336))
	{
		...
		if (PED::HAS_PED_RECEIVED_EVENT(Local_336, 60))
		{
			return 1;
		}
		...
		if (PED::HAS_PED_RECEIVED_EVENT(Local_336, 50))
		{
			return 1;
		}
		...
		if (PED::HAS_PED_RECEIVED_EVENT(Local_336, 72))
		{
			return 1;
		}
		if (bParam0)
...
int func_412(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2DC56
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_413(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2DD51
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_414(int iParam0, float fParam1)//Position - 0x2DE5D
{
	var uVar0;
	vector3 vVar1;
...
int func_415(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x2DEF2
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_416(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2DF80
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_417(int iParam0, float fParam1)//Position - 0x2DFC8
{
	float fVar0;
...
bool func_418(int iParam0, float fParam1)//Position - 0x2E03E
{
	return func_370(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_419(int iParam0)//Position - 0x2E056
{
...
void func_420(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2E07E
{
...
int func_421(int iParam0)//Position - 0x2E0AC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
bool func_422(bool bParam0)//Position - 0x2E0CD
{
...
void func_423(int iParam0, bool bParam1)//Position - 0x2E0F8
{
	func_433(bParam1, 1);
	if (bParam1)
	{
...
void func_424()//Position - 0x2E187
{
	func_425(1, 0);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_425(bool bParam0, bool bParam1)//Position - 0x2E1F9
{
	HUD::CLEAR_PRINTS();
	if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
...
void func_426(bool bParam0)//Position - 0x2E315
{
	if (bParam0)
	{
...
void func_427()//Position - 0x2E344
{
	STREAMING::REMOVE_ANIM_SET(func_365());
	STREAMING::REMOVE_ANIM_SET(func_366());
}

void func_428(bool bParam0, int iParam1, int iParam2)//Position - 0x2E35C
{
	bool bVar0;
...
void func_429(int iParam0)//Position - 0x2E3BB
{
	Global_91018 = iParam0;
}

void func_430(bool bParam0)//Position - 0x2E3C9
{
	if (bParam0)
	{
...
void func_431(bool bParam0)//Position - 0x2E4A5
{
	if (bParam0)
	{
		func_432();
...
void func_432()//Position - 0x2E508
{
...
void func_433(bool bParam0, bool bParam1)//Position - 0x2E531
{
	if (bParam0)
	{
		func_428(0, 1, 1);
...
void func_434(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2E564
{
	if (func_508())
	{
...
void func_435(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2E5F9
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_481(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_168(vParam1, 0f, 0f, 0f, 0))
		...
		{
			func_476(iParam12, 0);
			while (!func_436(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_436(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x2E78D
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_437(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2F5D1
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_438(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x301E9
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_439(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x3025C
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_440(int iParam0)//Position - 0x3174E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_441(int iParam0, bool bParam1, var uParam2)//Position - 0x317FE
{
	int iVar0;
	bool bVar1;
...
int func_442(int iParam0)//Position - 0x3196C
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
...
int func_443(int iParam0)//Position - 0x319B3
{
	switch (iParam0)
	{
		case 0:
...
int func_444(int iParam0)//Position - 0x31D43
{
...
int func_445(int iParam0)//Position - 0x31D85
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_446(int iParam0)//Position - 0x31E18
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
...
int func_447(int iParam0)//Position - 0x31E5F
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
...
int func_448(int iParam0)//Position - 0x31EA5
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_449(int iParam0)//Position - 0x31EDA
{
...
int func_450(int iParam0)//Position - 0x31F09
{
...
int func_451(int iParam0)//Position - 0x31FC6
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_452(int iParam0)//Position - 0x31FFC
{
	switch (iParam0)
	{
		case 562680400:
...
int func_453(int iParam0, bool bParam1)//Position - 0x32055
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_454(int iParam0)//Position - 0x320B0
{
	int iVar0;
...
int func_455(int iParam0, int iParam1)//Position - 0x320EA
{
	if (iParam1 == 0)
	{
...
bool func_456()//Position - 0x3245E
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_457()//Position - 0x3246F
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_458()//Position - 0x32480
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_459()//Position - 0x32491
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_460()//Position - 0x324A2
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_461()//Position - 0x324B3
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_462(int iParam0, int iParam1)//Position - 0x324C4
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_463(int iParam0)//Position - 0x3283A
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
...
int func_464(int iParam0)//Position - 0x32899
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
...
int func_465(int iParam0)//Position - 0x328F9
{
	if (iParam0 != func_336())
	{
		if (func_335(iParam0, 1, 1))
...
int func_466(int iParam0, bool bParam1, var uParam2)//Position - 0x32940
{
	bool bVar0;
...
int func_467(int iParam0)//Position - 0x32D65
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_468(int iParam0, int iParam1)//Position - 0x32D8E
{
	int iVar0;
...
void func_469(int iParam0)//Position - 0x32E10
{
	if (!func_470(*iParam0))
	{
...
bool func_470(int iParam0)//Position - 0x32E3B
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_471(int iParam0, var uParam1, var uParam2)//Position - 0x32E4A
{
	int iVar0;
	int iVar1;
...
int func_472(int iParam0)//Position - 0x3300D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_473(var uParam0)//Position - 0x330E9
{
...
int func_474(int iParam0, int iParam1)//Position - 0x33129
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_475(var uParam0, int iParam1)//Position - 0x3320E
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_476(int iParam0, int iParam1)//Position - 0x3324F
{
	int iVar0;
...
void func_477(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x332ED
{
	int iVar0;
...
void func_478(int iParam0)//Position - 0x3333D
{
	bool bVar0;
...
int func_479(int iParam0, int iParam1)//Position - 0x334AF
{
	int iVar0;
...
int func_480(var uParam0)//Position - 0x33521
{
	return *uParam0;
}

int func_481(vector3 vParam0, float fParam3)//Position - 0x3352C
{
	return func_482(&(Global_100114.f_2890), vParam0, fParam3, 0);
}

int func_482(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x33546
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_483(int iParam0)//Position - 0x337F8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_484(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x338BB
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_168(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_485(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x33AC3
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_486(int iParam0, int iParam1, bool bParam2)//Position - 0x33B3E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_487(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x33B9F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_488(int iParam0, int iParam1)//Position - 0x340F0
{
	int iVar0;
	int iVar1;
...
bool func_489()//Position - 0x34168
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_490(int iParam0)//Position - 0x34179
{
	int iVar0;
...
int func_492(int iParam0)//Position - 0x3424B
{
...
int func_493(int iParam0)//Position - 0x3427A
{
...
int func_494(int iParam0)//Position - 0x34297
{
...
int func_495(int iParam0, int iParam1)//Position - 0x342BA
{
...
int func_496(int iParam0)//Position - 0x342F5
{
	if (func_495(iParam0, 0))
	{
...
int func_497(int iParam0, int iParam1)//Position - 0x34318
{
	int iVar0;
...
int func_498(var uParam0)//Position - 0x34365
{
	if (func_499(uParam0))
	{
...
int func_499(var uParam0)//Position - 0x3439A
{
...
bool func_500()//Position - 0x343F9
{
	return func_498(&(Global_100114.f_2890));
}

void func_501()//Position - 0x3440C
{
	func_502(&(Global_100114.f_2890));
}

void func_502(var uParam0)//Position - 0x3441F
{
	if (func_499(uParam0))
	{
...
int func_503(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3443D
{
...
int func_505(int iParam0)//Position - 0x34540
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_506()//Position - 0x34599
{
	return func_499(&(Global_100114.f_2890));
}

int func_507()//Position - 0x345AC
{
...
void func_509()//Position - 0x345FA
{
	vector3 vVar0;
	vector3 vVar3;
	...
	if (func_23(PLAYER::PLAYER_PED_ID()))
	{
		func_91(&uLocal_447, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_510()//Position - 0x3474B
{
	int iVar0;
	...
	if (func_23(Local_112.f_9))
	{
		...
		BRAIN::TASK_PLAY_ANIM(Local_112.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 8f, -2f, -1, 1, 0, 0, 0, 0);
...
void func_511(int iParam0, char* sParam1, int iParam2)//Position - 0x3492D
{
	char cVar0[16];
...
int func_513(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7)//Position - 0x34B34
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_514(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x34BA5
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_515(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x34C44
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_516(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x34CB8
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_517()//Position - 0x34D2C
{
	int iVar0;
...
float func_518()//Position - 0x35104
{
	return 75.15f;
}

Vector3 func_519()//Position - 0x35111
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_520()//Position - 0x35128
{
	return 71f;
}

Vector3 func_521()//Position - 0x35135
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_522()//Position - 0x3514C
{
	return 1385417869;
}

float func_523()//Position - 0x35159
{
	return -91.28f;
}

Vector3 func_524()//Position - 0x35166
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_525()//Position - 0x3517D
{
	return -741944541;
}

float func_526()//Position - 0x3518A
{
	return 89.19f;
}

Vector3 func_527()//Position - 0x35197
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_528(int iParam0)//Position - 0x351AE
{
	if (!func_84(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
...
int func_529(bool bParam0)//Position - 0x351D9
{
...
int func_533(int iParam0)//Position - 0x35311
{
	int iVar0;
...
var func_534()//Position - 0x35A2E
{
	return Global_93721.f_1;
}

int func_535()//Position - 0x35A3C
{
	if (Global_90634 != -1)
	{
...
bool func_536()//Position - 0x35A62
{
	return Global_93734.f_340 > 0;
}

bool func_537()//Position - 0x35A73
{
	return Global_93734.f_339 > 0;
}

var func_538()//Position - 0x35A84
{
	return Global_1312867;
}

bool func_539(int iParam0)//Position - 0x35A90
{
	return func_540(iParam0, Global_36425);
}

int func_540(int iParam0, int iParam1)//Position - 0x35AA1
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_541(int iParam0)//Position - 0x35C82
{
	func_566();
	if (!func_565())
	{
...
void func_542(char* sParam0)//Position - 0x35CCD
{
	if (Global_93682 != 12)
	{
...
int func_543(char* sParam0, int iParam1, int iParam2)//Position - 0x35CEA
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_554())
	{
		...
		{
			iVar33 = func_544(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_544(char* sParam0)//Position - 0x35E7C
{
...
void func_545(int iParam0, var uParam1)//Position - 0x35ED2
{
	switch (iParam0)
	{
		case 0:
...
int func_547(int iParam0)//Position - 0x37118
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_548(int iParam0)//Position - 0x3745E
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_549(int iParam0)//Position - 0x37495
{
	struct<2> Var0;
...
int func_551(char* sParam0, bool bParam1)//Position - 0x37905
{
	int iVar0;
	int iVar1;
...
int func_552(int iParam0, bool bParam1)//Position - 0x3792F
{
	int iVar0;
...
void func_555(int iParam0)//Position - 0x37A21
{
	if (iParam0 == 1)
	{
		Global_36974 = 1;
...
void func_556(bool bParam0)//Position - 0x37A3A
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_557(int iParam0)//Position - 0x37A4E
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_558(int iParam0)//Position - 0x37A8B
{
	if (iParam0 == 1)
	{
...
void func_559()//Position - 0x37AC8
{
	Global_17272.f_5 = 1;
}

void func_560()//Position - 0x37AD6
{
	Global_17272.f_5 = 0;
}

void func_561()//Position - 0x37AE4
{
	Global_87888 = 0;
	Global_87889 = 0;
}

void func_562()//Position - 0x37AF6
{
	Global_93682 = 13;
	Global_93682.f_1 = -1;
	Global_93682.f_2 = 0;
...
void func_566()//Position - 0x37BE1
{
	Global_93717 = 1;
...
void func_567()//Position - 0x37CCE
{
	if (iLocal_399)
	{
		func_425(0, 1);
