...
int func_89()//Position - 0x2E3F
{
	return 1;
}

float func_90(int iParam0, int iParam1)//Position - 0x2E48
{
	return func_78(iParam0, iParam1, 1);
}

void func_91(int iParam0)//Position - 0x2E59
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x2E8A
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0, bool bParam1)//Position - 0x2EBB
{
	if (!func_71(iParam0))
	{
		if (!bParam1)
...
void func_94(var uParam0, var uParam1)//Position - 0x2F6E
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_95(int iParam0, bool bParam1)//Position - 0x2F7F
{
	if (iParam0 == 1)
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_96(int iParam0)//Position - 0x2FF1
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_97()//Position - 0x3012
{
	func_98();
}

void func_98()//Position - 0x301E
{
	PED::SET_PED_PROP_INDEX(iLocal_240, 1, 0, 0, false);
}

void func_99()//Position - 0x3030
{
...
int func_103()//Position - 0x312D
{
	return 1;
}

bool func_104(var uParam0)//Position - 0x3136
{
	return func_105(Global_106565.f_20111, uParam0);
}

bool func_105(var uParam0, var uParam1)//Position - 0x314B
{
	return (uParam0 && uParam1) != 0;
}

int func_106(int iParam0)//Position - 0x315A
{
...
void func_107(int iParam0)//Position - 0x3281
{
	var uVar0;
...
void func_108(int iParam0)//Position - 0x3350
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_109()//Position - 0x3370
{
	struct<6> Var0;
...
void func_110()//Position - 0x3394
{
	func_111();
}

void func_111()//Position - 0x33A0
{
}

void func_112()//Position - 0x33A8
{
	if (iLocal_245 == -1)
	{
