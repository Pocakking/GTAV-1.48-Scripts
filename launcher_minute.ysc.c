...
int func_59(int iParam0)//Position - 0x469F
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x473A
{
...
int func_61(int iParam0, int iParam1)//Position - 0x48C0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5431
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x546C
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x56E0
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x571C
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5C77
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5CBB
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x63C2
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x6409
{
...
bool func_70(int iParam0)//Position - 0x6464
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6474
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x64DE
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x67FF
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x680A
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x681A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x68BC
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x705F
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
var func_98(int iParam0)//Position - 0x84F1
{
...
int func_100(var uParam0)//Position - 0x852D
{
	return uParam0 & 15;
}
...
void func_105(int iParam0)//Position - 0x8604
{
	var uVar0;
	vector3 vVar1[24];
...
void func_106(char* sParam0, int iParam1, int iParam2)//Position - 0x865D
{
...
bool func_107(bool bParam0)//Position - 0x869F
{
...
struct<2> func_108(int iParam0)//Position - 0x86CA
{
	struct<2> Var0;
...
void func_109(int iParam0, var uParam1)//Position - 0x8B17
{
	switch (iParam0)
	{
		case 0:
...
int func_111(int iParam0)//Position - 0x9DEF
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0xA135
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0xA1D9
{
	struct<2> Var0;
...
void func_114(int iParam0)//Position - 0xA274
{
	if (iParam0 < 63)
	{
		func_115();
...
void func_116(int iParam0)//Position - 0xA2D2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0)//Position - 0xA32B
{
...
int func_118(int iParam0)//Position - 0xA3AE
{
	int iVar0;
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA3DF
{
	func_120(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA3F4
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA4A7
{
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA4C2
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA50E
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA557
{
	if (func_126(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_126(int iParam0)//Position - 0xA577
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_127(int iParam0)//Position - 0xA598
{
	switch (iParam0)
	{
		case 5:
...
int func_129(int iParam0)//Position - 0xA668
{
	switch (iParam0)
	{
		case 5:
...
void func_130(var uParam0, bool bParam1, bool bParam2)//Position - 0xA6BB
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xA7B0
{
	switch (iParam0)
	{
		case 5:
...
void func_132(bool bParam0)//Position - 0xA81B
{
	int iVar0;
...
void func_133(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xA859
{
	if (bParam0)
	{
...
bool func_134()//Position - 0xA992
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_135(int iParam0, int iParam1)//Position - 0xA9AF
{
	bool bVar0;
...
int func_136(int iParam0, bool bParam1)//Position - 0xA9FA
{
	int iVar0;
	int iVar1;
...
int func_137(int iParam0)//Position - 0xAA3B
{
...
bool func_138()//Position - 0xAA7D
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_139(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAA8E
{
	int iVar0;
...
void func_141(int iParam0)//Position - 0xAAE8
{
	if (iParam0 == 1)
	{
...
int func_142(int iParam0)//Position - 0xAB0B
{
...
void func_143()//Position - 0xAB48
{
	Global_14732 = 0;
	func_144();
}

void func_144()//Position - 0xAB58
{
...
int func_148(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xAC3E
{
...
void func_149(int iParam0)//Position - 0xADCD
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_151(int iParam0)//Position - 0xAE4A
{
	if (func_155())
	{
		return;
...
void func_152(int iParam0)//Position - 0xAE7D
{
	if (func_155())
	{
		return;
...
void func_153(bool bParam0, bool bParam1)//Position - 0xAEF7
{
	if (bParam0)
	{
		if (func_154(0))
...
int func_154(int iParam0)//Position - 0xAF6B
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_155()//Position - 0xAFC5
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

int func_156(int iParam0)//Position - 0xAFD7
{
...
int func_157(int iParam0)//Position - 0xB018
{
	int iVar0;
...
void func_158(int iParam0)//Position - 0xB05D
{
...
int func_159(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB08F
{
	int iVar0;
...
void func_160(var uParam0, int iParam1)//Position - 0xB1C6
{
	int iVar0;
...
bool func_161(int iParam0)//Position - 0xB215
{
	return func_162(iParam0, Global_36425);
}

int func_162(int iParam0, int iParam1)//Position - 0xB226
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_163(int iParam0)//Position - 0xB407
{
	if (Global_36425 == 15)
	{
		return 0;
...
int func_164()//Position - 0xB429
{
	return func_165(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_165(char* sParam0, int iParam1)//Position - 0xB43A
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_167(int iParam0, int iParam1)//Position - 0xB4A7
{
	switch (iParam0)
	{
		case 0:
...
int func_168(vector3 vParam0, bool bParam3)//Position - 0xB92E
{
	int iVar0;
...
float func_169(bool bParam0, float fParam1, float fParam2)//Position - 0xB95A
{
	if (bParam0)
	{
		return fParam1;
...
int func_170(int iParam0)//Position - 0xB971
{
	switch (iParam0)
	{
		case 0:
...
int func_171(int iParam0, int iParam1)//Position - 0xBA00
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_172()//Position - 0xC1E5
{
	func_27(&(Global_97130.f_2890), &Global_97130, 0, 1, 1, 0);
}

int func_173(var uParam0)//Position - 0xC200
{
	float fVar0;
...
void func_174(int iParam0, int iParam1)//Position - 0xC28E
{
	if (iParam0 == 1)
	{
		if (!func_129(iParam1))
...
int func_175(bool bParam0)//Position - 0xC2F2
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0xC389
{
	int iVar0;
...
var func_177()//Position - 0xCAA6
{
	return Global_93721.f_1;
}

int func_178()//Position - 0xCAB4
{
	if (Global_90634 != -1)
	{
...
bool func_181()//Position - 0xCB1E
{
	return Global_93734.f_340 > 0;
}

bool func_182(int iParam0, int iParam1)//Position - 0xCB2F
{
	switch (iParam0)
	{
		case 5:
...
var func_183()//Position - 0xCB6A
{
	return Global_1312867;
}

int func_184()//Position - 0xCB76
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCB92
{
	var uVar0;
	
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_186(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC1A
{
...
void func_187(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC55
{
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCCAB
{
...
float func_189(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCD46
{
	vector3 vVar0;
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xCD80
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_176(2))
		{
			...
			else if (((func_192(sParam5) && !*uParam10 == 1) && func_126(PLAYER::PLAYER_PED_ID())) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_288("pause conversation");
				func_191(1);
				*uParam10 = 1;
			}
			if (func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam10 == 1)
			{
...
void func_191(int iParam0)//Position - 0xCECB
{
	Global_16877 = iParam0;
}

int func_192(char* sParam0)//Position - 0xCED8
{
	struct<6> Var0;
...
struct<6> func_193()//Position - 0xCEF8
{
	struct<6> Var0;
...
void func_194(int iParam0, int iParam1, vector3 vParam2)//Position - 0xCF1C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_195(int iParam0, bool bParam1)//Position - 0xD00D
{
	if (iParam0 == -1)
	{
		return;
...
int func_196(int iParam0)//Position - 0xD049
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_197(int iParam0, int iParam1)//Position - 0xD082
{
	bool bVar0;
	int iVar1;
...
bool func_198()//Position - 0xD120
{
	return Global_91021;
}

void func_199(int iParam0)//Position - 0xD12C
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_200(iParam0);
...
void func_200(int iParam0)//Position - 0xD143
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_201(int iParam0)//Position - 0xD22B
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
void func_202(var uParam0)//Position - 0xD253
{
	int iVar0;
	int iVar1;
...
void func_203(int iParam0)//Position - 0xD557
{
	int iVar0;
...
void func_204(int iParam0)//Position - 0xD5F4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_205(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, float fParam6)//Position - 0xD61F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_206(int iParam0)//Position - 0xD658
{
	if (func_126(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_208(var uParam0, bool bParam1)//Position - 0xD6B5
{
	struct<27> Var0;
...
void func_209(int iParam0, var uParam1, int iParam2)//Position - 0xD928
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0)//Position - 0xDC80
{
...
int func_211(var uParam0)//Position - 0xDCA0
{
...
int func_212(var uParam0)//Position - 0xDCB8
{
...
void func_213(var uParam0)//Position - 0xDCDD
{
	int iVar0;
...
int func_214(var uParam0, bool bParam1, bool bParam2)//Position - 0xDD5D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_215(int iParam0, int iParam1)//Position - 0xDF1B
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, int iParam2)//Position - 0xDF4B
{
	int iVar0;
	int iVar1;
...
int func_217(int iParam0)//Position - 0xE207
{
...
int func_218(int iParam0, float fParam1)//Position - 0xE23B
{
	float fVar0;
...
bool func_219(int iParam0, float fParam1)//Position - 0xE2B1
{
	return func_220(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_220(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE2C9
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_221(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE38A
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_222(int iParam0, int iParam1)//Position - 0xE4B6
{
	int iVar0;
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE5C5
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = { func_226(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_225(vector3 vParam0, vector3 vParam3)//Position - 0xE656
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_226(vector3 vParam0)//Position - 0xE677
{
	float fVar0;
	float fVar1;
...
void func_227(var uParam0)//Position - 0xE6B6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_228(int iParam0, int iParam1)//Position - 0xE6D1
{
	int iVar0;
...
int func_229(int iParam0)//Position - 0xE710
{
...
int func_230(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE738
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_231(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE833
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_232(int iParam0, float fParam1)//Position - 0xE93F
{
	var uVar0;
	vector3 vVar1;
...
int func_233(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE9D4
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_234(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEA62
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_235(int iParam0)//Position - 0xEAAA
{
...
int func_236(int iParam0)//Position - 0xEAF4
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_237(int iParam0)//Position - 0xEB8C
{
...
int func_240(int iParam0)//Position - 0xEC0E
{
...
int func_242(int iParam0)//Position - 0xEC80
{
	if (func_107(0))
	{
...
int func_245(var uParam0)//Position - 0xED34
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
...
void func_246(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF055
{
	func_247(iParam0);
...
void func_247(int iParam0)//Position - 0xF097
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xF133
{
...
int func_249(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xF18F
{
	int iVar0;
...
int func_250(var uParam0, int iParam1)//Position - 0xF21D
{
	int iVar0;
...
void func_251(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF263
{
	func_204(iParam0);
...
int func_252(var uParam0)//Position - 0xF28A
{
	if (func_212(uParam0))
	{
...
int func_253(int iParam0)//Position - 0xF2B4
{
	int iVar0;
...
void func_254(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF2E5
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_255(var uParam0)//Position - 0xF321
{
	int iVar0[1];
	int iVar2;
...
int func_256(var uParam0)//Position - 0xF434
{
	int iVar0[4];
	int iVar5;
	bool bVar6;
...
void func_257(int iParam0, int iParam1)//Position - 0xF755
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_258(int iParam0)//Position - 0xF78B
{
	struct<27> Var0;
	int iVar32;
...
int func_259(int iParam0)//Position - 0xF7DF
{
	char* sVar0;
...
int func_260(int iParam0)//Position - 0xF898
{
	var uVar0;
...
int func_261(int iParam0)//Position - 0xF959
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_262(int iParam0, char* sParam1)//Position - 0xF9DE
{
...
bool func_263(int iParam0)//Position - 0xFAC0
{
...
bool func_264(int iParam0)//Position - 0xFAEE
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_265(int iParam0)//Position - 0xFB1C
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_266(int iParam0)//Position - 0xFB4A
{
	if (func_237(iParam0))
	{
		return 0;
...
void func_267()//Position - 0xFB7F
{
	func_288("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_268(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xFB99
{
	int iVar0;
...
int func_269(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xFBFE
{
	int iVar0;
	struct<7> Var1;
...
int func_270(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xFC7C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_271(int iParam0, bool bParam1)//Position - 0xFCF7
{
	char* sVar0;
...
void func_272(char* sParam0)//Position - 0xFDE4
{
...
void func_273()//Position - 0xFE03
{
	Global_14732 = 0;
	func_274();
}

void func_274()//Position - 0xFE13
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_275(var uParam0)//Position - 0xFE34
{
	if (func_212(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_276(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFE6A
{
...
void func_277(var uParam0, bool bParam1)//Position - 0xFE8A
{
	func_278(&(uParam0->f_41), bParam1);
}

void func_278(var uParam0, bool bParam1)//Position - 0xFE9C
{
	int iVar0;
...
void func_279(int iParam0, bool bParam1)//Position - 0xFEDA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_280(var uParam0, bool bParam1)//Position - 0xFF15
{
	func_281(&(uParam0->f_35), bParam1);
}

void func_281(var uParam0, bool bParam1)//Position - 0xFF27
{
	int iVar0;
...
void func_282(int iParam0)//Position - 0xFF64
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_283(var uParam0, int iParam1)//Position - 0xFF9C
{
	func_284(&(uParam0->f_28), iParam1);
}

void func_284(var uParam0, int iParam1)//Position - 0xFFAE
{
	int iVar0;
...
void func_285(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFFEF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_286(int iParam0)//Position - 0x10041
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_287(var uParam0)//Position - 0x10082
{
	if (*uParam0 == -1)
	{
		return;
...
void func_288(int iParam0)//Position - 0x100BF
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_289(var uParam0)//Position - 0x100D1
{
	*uParam0 = -1;
...
void func_290()//Position - 0x10104
{
	func_288("Running start routines.");
	Global_106283++;
}

int func_291(int iParam0)//Position - 0x1011E
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
