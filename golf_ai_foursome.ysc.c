...
void func_1(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0) == func_292(uParam2, 0))
		{
			...
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(func_282(uParam2, 0), -1794415470) != 1)
				{
					BRAIN::CLEAR_PED_TASKS(func_282(uParam2, 0));
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(func_282(uParam2, 0), PLAYER::PLAYER_PED_ID(), -1);
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(func_282(uParam2, 1)) && !ENTITY::IS_ENTITY_DEAD(func_282(uParam2, 1), 0))
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(func_282(uParam2, 1), -1794415470) != 1)
				{
					BRAIN::CLEAR_PED_TASKS(func_282(uParam2, 1));
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(func_282(uParam2, 1), PLAYER::PLAYER_PED_ID(), -1);
				}
			}
		}
	...
	switch (func_274(uParam2))
	{
		case 5:
			if (!func_273(uParam2, 1048576))
			{
				...
				{
					if (BRAIN::GET_SCRIPT_TASK_STATUS(func_282(uParam2, uParam2->f_165), -1794415470) != 1 && !func_296(uParam2, uParam2->f_165, 67108864))
					{
						BRAIN::CLEAR_PED_TASKS(func_282(uParam2, uParam2->f_165));
						if (!PED::IS_PED_IN_VEHICLE(func_282(uParam2, uParam2->f_165), func_272(uParam2, uParam2->f_165), 0))
						{
							if (uParam2->f_165 == func_269(uParam2, func_270(uParam2, uParam2->f_165)))
							{
								...
								{
									BRAIN::TASK_ENTER_VEHICLE(func_282(uParam2, uParam2->f_165), func_272(uParam2, uParam2->f_165), -1, -1, 1f, 1, 0);
								}
							}
							else
							{
								BRAIN::TASK_ENTER_VEHICLE(func_282(uParam2, uParam2->f_165), func_272(uParam2, uParam2->f_165), -1, 0, 1f, 1, 0);
							}
						}
					}
				}
...
void func_20(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 < func_318(uParam0))
	{
		if (((iParam2 == 0 && (iVar0 == 0 || iVar0 == 1)) || (iParam2 == 1 && (iVar0 == 2 || iVar0 == 3))) && func_23(uParam0, iVar0) == 4)
		{
			...
			Stack.Push(iVar0);
			Call_Loc(iParam4);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(StackVal, StackVal, StackVal, StackVal, 1f, -1, 1048576000, 0, 1193033728);
			Stack.Push(0);
			Stack.Push(uParam1);
			Stack.Push(func_311(uParam0));
			Call_Loc(iParam5);
			...
			BRAIN::TASK_PERFORM_SEQUENCE(func_282(uParam0, iVar0), uParam0->f_15[iVar0 /*34*/].f_21);
	...
	switch (func_34(uParam2))
	{
		...
		case 4:
			if (func_169(PLAYER::PLAYER_PED_ID(), uParam2->f_15[func_268(uParam2) /*34*/].f_2, 0) < 1f)
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(uParam2->f_15[func_268(uParam2) /*34*/].f_2);
					func_202(uParam1, uParam2, uParam0, 0, 0, 0, 1, 0);
					func_275(uParam2, 0);
					func_261(uParam2, 1);
		...
		case 8:
			...
			{
				BRAIN::CLEAR_PED_TASKS(func_64(uParam2));
				BRAIN::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_268(uParam2) /*34*/].f_21));
				BRAIN::TASK_GO_TO_COORD_ANY_MEANS(0, func_266(uParam1, func_311(uParam2), func_268(uParam2)), 1f, 0, 0, 786603, -1082130432);
				BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, func_41(uParam1, func_311(uParam2)), 0);
				BRAIN::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_268(uParam2) /*34*/].f_21);
				BRAIN::TASK_PERFORM_SEQUENCE(func_64(uParam2), uParam2->f_15[func_268(uParam2) /*34*/].f_21);
				BRAIN::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_268(uParam2) /*34*/].f_21));
			}
			break;
			...
			if (!func_118(uParam0, uParam2, 0))
			{
				if (func_70(uParam1, uParam2) && !func_265(uParam2, func_268(uParam2)))
				{
					if (!func_273(uParam2, 1048576))
					{
						...
						BRAIN::CLEAR_PED_TASKS(func_64(uParam2));
						BRAIN::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_268(uParam2) /*34*/].f_21));
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_264(uParam1, func_311(uParam2), func_268(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
						BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, func_325(uParam1, func_311(uParam2)), 0);
						BRAIN::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_268(uParam2) /*34*/].f_21);
						BRAIN::TASK_PERFORM_SEQUENCE(func_64(uParam2), uParam2->f_15[func_268(uParam2) /*34*/].f_21);
						BRAIN::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_268(uParam2) /*34*/].f_21));
					}
				...
				else if (func_193(uParam2) || func_273(uParam2, 67108864))
				{
					if (!func_273(uParam2, 1048576))
					{
						if (!func_63(uParam2, func_268(uParam2), 0))
						{
							...
							BRAIN::CLEAR_PED_TASKS(func_64(uParam2));
							BRAIN::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_268(uParam2) /*34*/].f_21));
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_266(uParam1, func_311(uParam2), func_268(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
							BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, func_41(uParam1, func_311(uParam2)), 0);
							BRAIN::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_268(uParam2) /*34*/].f_21);
							BRAIN::TASK_PERFORM_SEQUENCE(func_64(uParam2), uParam2->f_15[func_268(uParam2) /*34*/].f_21);
							BRAIN::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_268(uParam2) /*34*/].f_21));
...
void func_203(var uParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, var uParam6, bool bParam7)
{
	...
	{
		BRAIN::TASK_STAND_STILL(func_297(uParam0), -1);
	}
	else
	{
		iParam5 = 1;
	...
	else
	{
		...
		BRAIN::TASK_PERFORM_SEQUENCE(func_297(uParam0), uParam0->f_21);
...
void func_252(var uParam0, int iParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (!PED::IS_PED_IN_VEHICLE(iVar2, func_272(uParam0, iParam1), 0) && !bVar6)
	{
		...
		{
			BRAIN::TASK_ENTER_VEHICLE(iVar2, func_272(uParam0, iParam1), -1, -1, 1f, 1, 0);
		}
		return;
	}
	iVar7 = 786603;
	...
	if (bVar6)
	{
		...
		{
			BRAIN::TASK_VEHICLE_PARK(func_282(uParam0, func_254(uParam0, iParam1)), func_272(uParam0, iParam1), ENTITY::GET_ENTITY_COORDS(func_272(uParam0, iParam1), true), 0f, 3, 360f, 0);
			if (bParam3)
			{
				BRAIN::TASK_LEAVE_ANY_VEHICLE(func_282(uParam0, iParam1), 0, 0);
				func_275(uParam0, 2);
...
void func_298(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
	...
	if (BRAIN::GET_SCRIPT_TASK_STATUS(func_297(uParam0), -1794415470) == 1)
	{
		return;
	}
...
void func_299(var uParam0, int iParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(func_282(uParam0, iParam1)) && !ENTITY::IS_ENTITY_DEAD(func_282(uParam0, iParam1), 0))
	{
		...
		{
			BRAIN::TASK_SMART_FLEE_PED(func_282(uParam0, iParam1), PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
		}
		if (PED::IS_PED_IN_MELEE_COMBAT(func_282(uParam0, iParam1)))
		{
			BRAIN::CLEAR_PED_TASKS(func_282(uParam0, iParam1));
			BRAIN::TASK_SMART_FLEE_PED(func_282(uParam0, iParam1), PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
		}
	}
