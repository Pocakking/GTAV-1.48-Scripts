...
void func_5(var uParam0)//Position - 0x228
{
	...
	iVar3 = BRAIN::GET_SCRIPT_TASK_STATUS(*uParam0, 242628503);
	if (iVar3 != 0 && iVar3 != 1)
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(sVar0))
		{
			...
			if (!func_7(uParam0))
			{
				if (func_6(uParam0))
				{
					BRAIN::TASK_PLAY_ANIM_ADVANCED(0, sVar0, sVar1, uParam0->f_6, 0f, 0f, uParam0->f_9, 8f, -8f, -1, 790529, fVar2, 2, 3);
				}
				else
				{
					BRAIN::TASK_PLAY_ANIM(0, sVar0, sVar1, 8f, -8f, -1, 1, fVar2, 0, 0, 0);
				}
			}
			else
			{
				...
				while (iVar12 < 4)
				{
					...
					{
						case 0:
							BRAIN::TASK_PLAY_ANIM(0, sVar0, "IDLE_A", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 1:
							BRAIN::TASK_PLAY_ANIM(0, sVar0, "IDLE_B", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 2:
							BRAIN::TASK_PLAY_ANIM(0, sVar0, "IDLE_C", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 3:
							BRAIN::TASK_PLAY_ANIM(0, sVar0, "IDLE_D", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
					}
					iVar12++;
				}
			}
			BRAIN::SET_SEQUENCE_TO_REPEAT(uVar4, 1);
			BRAIN::CLOSE_SEQUENCE_TASK(uVar4);
			BRAIN::TASK_PERFORM_SEQUENCE(*uParam0, uVar4);
...
void func_10(int iParam0)//Position - 0x687
{
...
int func_35()//Position - 0xF6F
{
	...
	if (func_36() != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_36()) == 0)
		{
			return 1;
		}
	}
...
{
	while (!NETWORK::_NETWORK_SET_THIS_SCRIPT_MARKED(32, 0, Global_1316818))
	{
		SYSTEM::WAIT(0);
	}
	Global_1316818++;
