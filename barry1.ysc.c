	...
	switch (iLocal_161)
	{
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, iLocal_338, sLocal_352, 8f, -8f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, iLocal_338, sLocal_353, 8f, -8f, -1, 1, 0, 0, 0, 0);
			...
			func_35(&uLocal_390, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			iLocal_161 = 2;
			break;
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_34(&uLocal_390, "BARY1AU", "BARY1_PREOUT", 8, 0, 0, 0) || MISC::GET_GAME_TIMER() > iLocal_158)
				{
...
void func_38(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x1687
{
	if (bParam0)
	{
...
bool func_39()//Position - 0x17C0
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_40(int iParam0, int iParam1)//Position - 0x17DD
{
	bool bVar0;
...
int func_41(int iParam0, bool bParam1)//Position - 0x1828
{
	int iVar0;
	int iVar1;
...
int func_43(int iParam0)//Position - 0x1875
{
...
bool func_44()//Position - 0x18B7
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_45(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x18C8
{
	int iVar0;
...
void func_46(int iParam0)//Position - 0x18FB
{
	if (iParam0 == 1)
	{
...
void func_47(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x191E
{
	int iVar0;
...
int func_48(int iParam0)//Position - 0x19C7
{
	if (func_567(iParam0))
	{
...
void func_49(vector3 vParam0, float fParam3)//Position - 0x19E7
{
	func_50(&(Global_100114.f_2890), vParam0, fParam3);
}

void func_50(var uParam0, vector3 vParam1, var uParam4)//Position - 0x1A00
{
	*uParam0 = { vParam1 };
	uParam0->f_6 = uParam4;
}

void func_51(vector3 vParam0, float fParam3)//Position - 0x1A16
{
...
bool func_52(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x1A42
{
	if (bParam6)
	{
...
void func_54(int iParam0)//Position - 0x1AB6
{
	int iVar0;
...
void func_55(var uParam0, int iParam1)//Position - 0x1AE2
{
	if (*uParam0 == 0)
	{
		return;
...
void func_56(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1B0A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_57(var uParam0)//Position - 0x1B5A
{
	if (func_61(uParam0))
	{
		iLocal_558 = 0;
...
void func_58(var uParam0)//Position - 0x1BAB
{
...
void func_59(var uParam0)//Position - 0x1BDB
{
	if (*uParam0 != 0)
	{
...
void func_60(var uParam0)//Position - 0x1C0B
{
	if (*uParam0 != -1)
	{
...
bool func_61(var uParam0)//Position - 0x1C2C
{
	return (uParam0->f_1 == 10 || uParam0->f_1 == 11);
}

void func_62()//Position - 0x1C48
{
	int iVar0;
	...
	while (iVar0 < Local_586)
	{
		if (func_4(&(Local_586[iVar0 /*33*/])))
		{
			...
			BRAIN::TASK_SMART_FLEE_COORD(Local_586[iVar0 /*33*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
		}
		iVar0++;
	}
}

void func_63()//Position - 0x1CB3
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x1CDD
{
	var uVar0;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			BRAIN::TASK_PLAY_ANIM(0, iLocal_338, sLocal_348, 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, iLocal_338, sLocal_351, 8f, -2f, -1, 0, 0, 0, 0, 0);
		...
		case 4:
			...
			func_74(PLAYER::PLAYER_PED_ID(), SYSTEM::FLOOR(fLocal_208), &iLocal_186);
			break;
...
void func_67(var uParam0)//Position - 0x2046
{
	if (*uParam0 == 0)
	{
		return;
...
void func_68(int iParam0)//Position - 0x206A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_69(var uParam0, float fParam1)//Position - 0x20AB
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (!uParam0->f_15)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			if (bVar9)
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar10, CAM::_GET_GAMEPLAY_CAM_COORDS()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar10, vVar6, 1);
			}
			else
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar11, CAM::_GET_GAMEPLAY_CAM_COORDS()) };
...
void func_70(int iParam0)//Position - 0x26E3
{
	Global_17270 = iParam0;
}

float func_71(int iParam0)//Position - 0x26F0
{
	vector3 vVar0;
...
float func_72(float fParam0, float fParam1, float fParam2)//Position - 0x2713
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
int func_73()//Position - 0x273A
{
	return Global_2359302.f_2;
}

void func_74(int iParam0, int iParam1, int iParam2)//Position - 0x2748
{
	if (*iParam2 >= 8)
	{
		return;
...
void func_75(int iParam0)//Position - 0x276C
{
	if (CUTSCENE::_0xB56BBBCC2955D9CB())
	{
		if (func_567(PLAYER::PLAYER_PED_ID()))
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (func_327(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_277();
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_328, 2, func_570(49), 0);
		...
		case 3:
			...
			func_47(1, 1, 1, 1);
			func_269(PLAYER::PLAYER_PED_ID(), vLocal_174);
...
void func_77(int iParam0, bool bParam1)//Position - 0x2B9D
{
	int iVar0;
	char* sVar1;
...
void func_79(int iParam0, int iParam1, int iParam2)//Position - 0x2D1F
{
	bool bVar0;
...
int func_81()//Position - 0x32C8
{
	return Global_25765;
}

int func_82(int iParam0, int iParam1)//Position - 0x32D3
{
	int iVar0;
...
int func_83(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3324
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_85(int iParam0)//Position - 0x3933
{
	if (iParam0 == 1)
	{
...
void func_87()//Position - 0x397A
{
	StringCopy(&Global_71822, "", 16);
	StringCopy(&Global_71826, "", 16);
}

void func_88()//Position - 0x3992
{
	int iVar0;
...
void func_92(int iParam0)//Position - 0x3A64
{
	if (iParam0 == 1)
	{
		Global_36974 = 1;
...
void func_93()//Position - 0x3A7D
{
	func_94(&Global_100114);
}

void func_94(var uParam0)//Position - 0x3A8D
{
	int iVar0;
	int iVar1;
...
void func_95(var uParam0)//Position - 0x401E
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_96(var uParam0)//Position - 0x4039
{
...
void func_97(var uParam0)//Position - 0x4068
{
	int iVar0;
...
void func_98(var uParam0)//Position - 0x4117
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_99(var uParam0)//Position - 0x4135
{
	int iVar0;
...
void func_100(var uParam0)//Position - 0x4214
{
	*uParam0 = -15;
}

void func_101()//Position - 0x4222
{
	StringCopy(&Global_97122, "", 32);
	func_94(&Global_97130);
}

void func_102()//Position - 0x423A
{
...
int func_104(int iParam0, int iParam1, int iParam2)//Position - 0x4378
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_105(int iParam0, int iParam1, int iParam2)//Position - 0x4537
{
	int iVar0;
...
int func_106(int iParam0)//Position - 0x45C3
{
	switch (iParam0)
	{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x45FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_108(int iParam0, int iParam1, int iParam2)//Position - 0x4E14
{
	int iVar0;
	int iVar1;
...
int func_109(int iParam0, int iParam1, int iParam2)//Position - 0x4E9E
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_110(int iParam0, int iParam1, int iParam2)//Position - 0x4F7C
{
	Global_71402[1 /*14*/] = { func_155(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_111(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x4FA7
{
	var uVar0;
	int iVar10;
...
int func_112(int iParam0, int iParam1, int iParam2)//Position - 0x55AB
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_113(int iParam0, int iParam1, int iParam2)//Position - 0x5644
{
	int iVar0;
	int iVar1;
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x56E5
{
	int iVar0;
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x59EC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x659F
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6883
{
	int iVar0;
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6B4A
{
	int iVar0;
	int iVar1;
...
int func_119(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6B81
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0x6BAA
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6E74
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0x70FE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7255
{
	int iVar0;
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x72ED
{
	switch (iParam0)
	{
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x73BB
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_126(int iParam0, int iParam1)//Position - 0x7517
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_127(int iParam0)//Position - 0x78BE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x791F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0, int iParam1)//Position - 0x7A1B
{
	int iVar0;
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7B59
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_131(int iParam0)//Position - 0x7C39
{
	switch (iParam0)
	{
		case 0:
...
int func_132(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7CBF
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_133(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7F3C
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_134(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8362
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_135(int iParam0, int iParam1)//Position - 0x8655
{
	int iVar0;
	int iVar1;
...
int func_136(int iParam0, int iParam1)//Position - 0x869B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_137(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x86FB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_138(int iParam0)//Position - 0x877F
{
...
void func_139(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x8837
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_140(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x8881
{
	int iVar0;
...
int func_141(var uParam0)//Position - 0x88B1
{
	int iVar0;
	int iVar1;
...
int func_142(int iParam0, int iParam1, int iParam2)//Position - 0x88E5
{
	int iVar0;
	var uVar1;
...
bool func_143(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x8917
{
	int iVar0;
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA6E8
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_145(int iParam0)//Position - 0xB606
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_146(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB657
{
	int iVar0;
...
int func_147(int iParam0)//Position - 0xB6ED
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_148(int iParam0, int iParam1)//Position - 0xB79D
{
	int iVar0;
	struct<10> Var1;
...
void func_149(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC0CE
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_150(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xC1F8
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_151(int iParam0, int iParam1)//Position - 0xC240
{
	int iVar0;
	struct<17> Var1;
...
void func_152(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE088
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_153(int iParam0)//Position - 0xE272
{
	switch (iParam0)
	{
		case 0:
...
void func_154(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xE322
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_155(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE393
{
	func_218();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_156(int iParam0, int iParam1)//Position - 0xE3E5
{
	switch (iParam0)
	{
		case 0:
...
void func_157(int iParam0)//Position - 0xE4D5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xF74C
{
	int iVar0;
	int iVar1;
...
bool func_159(int iParam0, int iParam1, var uParam2)//Position - 0xFADD
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_160(int iParam0, int iParam1)//Position - 0xFEE2
{
	switch (iParam1)
	{
		case 0:
...
int func_161(int iParam0, int iParam1)//Position - 0x102ED
{
	switch (iParam1)
	{
		case 0:
...
int func_162(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x106E8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_163(int iParam0)//Position - 0x1072A
{
	switch (iParam0)
	{
		case -1:
...
void func_164(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x107FE
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_165(int iParam0)//Position - 0x10AD7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x10C2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1113C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x111B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x11225
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1130C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1166F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x11880
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x11AB0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x11BC0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1255F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x130D2
{
	if (iParam0 < 136)
	{
		func_178(iParam0);
...
void func_177(int iParam0)//Position - 0x13107
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x13D0B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x14EE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x15014
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0, int iParam1)//Position - 0x15112
{
	switch (iParam0)
	{
		case 0:
...
void func_182(int iParam0)//Position - 0x15202
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x166F3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x16844
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x16D4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x173BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x17431
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x17501
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x17A31
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x17BC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x183C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x184D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x19403
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x1A0C0
{
	if (iParam0 < 107)
	{
		func_197(iParam0);
...
void func_195(int iParam0)//Position - 0x1A106
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x1ABAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x1B99A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0)//Position - 0x1C5E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x1C85E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0, int iParam1)//Position - 0x1C9A4
{
	switch (iParam0)
	{
		case 0:
...
void func_201(int iParam0)//Position - 0x1CA94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_202(int iParam0)//Position - 0x1D81E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x1D998
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204(int iParam0)//Position - 0x1DF0F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x1E439
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206(int iParam0)//Position - 0x1E4AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_207(int iParam0)//Position - 0x1E57D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_208(int iParam0)//Position - 0x1EA55
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_209(int iParam0)//Position - 0x1ECBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_210(int iParam0)//Position - 0x1EF94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_211(int iParam0)//Position - 0x1F15D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_212(int iParam0)//Position - 0x1FCB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_213(int iParam0)//Position - 0x208FD
{
	if (iParam0 < 60)
	{
		func_215(iParam0);
...
void func_214(int iParam0)//Position - 0x20932
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_215(int iParam0)//Position - 0x216D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_216(int iParam0)//Position - 0x21D5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_217(int iParam0)//Position - 0x21E45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_218()//Position - 0x21F43
{
...
int func_219(int iParam0, int iParam1, int iParam2)//Position - 0x21FBC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_220(char* sParam0, int iParam1)//Position - 0x22217
{
...
struct<2> func_222(int iParam0)//Position - 0x222B7
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_223(int iParam0)//Position - 0x222ED
{
	struct<2> Var0;
...
void func_224(int iParam0, int iParam1)//Position - 0x22738
{
...
void func_225(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x22782
{
...
void func_226(int iParam0, int iParam1, int iParam2)//Position - 0x2281F
{
	struct<4> Var0;
	char* sVar32;
...
void func_227(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x2285E
{
...
void func_228(int iParam0, var uParam1)//Position - 0x228A1
{
	switch (iParam0)
	{
		case 0:
...
int func_230(int iParam0)//Position - 0x23AA7
{
	switch (iParam0)
	{
		case 0:
...
void func_231(int iParam0)//Position - 0x23DED
{
	Global_36976 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_232()//Position - 0x23DFF
{
	if (Global_91024)
	{
		func_25();
...
char* func_233(var uParam0)//Position - 0x23E30
{
	uParam0 = uParam0;
	return "";
}

void func_234()//Position - 0x23E3E
{
	vector3 vVar0[24];
...
void func_235(int iParam0, int iParam1)//Position - 0x23E81
{
	Global_91019 = iParam0;
	Global_91020 = iParam1;
}

void func_236()//Position - 0x23E95
{
	if (Global_71844 != 6)
	{
	}
...
void func_237(var uParam0)//Position - 0x23ECD
{
	if (*uParam0 == -1)
	{
		return;
...
void func_238(int iParam0, bool bParam1)//Position - 0x23F0A
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_239(int iParam0)//Position - 0x24090
{
	switch (iParam0)
	{
		case 0:
...
void func_240(int iParam0)//Position - 0x24417
{
	func_242(iParam0, 1);
...
int func_241()//Position - 0x2444D
{
	return (Global_106565.f_10010.f_21 + Global_106565.f_18568.f_380);
}

void func_242(var uParam0, bool bParam1)//Position - 0x24469
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_243(int iParam0)//Position - 0x2478D
{
...
void func_244(int iParam0)//Position - 0x247C0
{
	switch (iParam0)
	{
		case 30:
...
void func_245(int iParam0, bool bParam1)//Position - 0x247F5
{
	if (iParam0 == -1)
	{
		return;
...
void func_246(int iParam0, int iParam1, bool bParam2)//Position - 0x24852
{
	if (iParam0 == -1)
	{
		return;
...
bool func_247(int iParam0, int iParam1)//Position - 0x2488D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_248(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x248B0
{
	if (iParam0 != 198)
	{
		if (Global_71590)
...
void func_249(int iParam0, int iParam1)//Position - 0x2490B
{
	switch (iParam0)
	{
		case 12:
...
void func_250(int iParam0, bool bParam1)//Position - 0x249F4
{
	if (bParam1)
	{
...
bool func_251(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x24A1D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_253()//Position - 0x25389
{
	return Global_25766;
}

int func_254(var uParam0, int iParam1)//Position - 0x25394
{
	int iVar0;
...
int func_255(int iParam0)//Position - 0x28A8E
{
	switch (iParam0)
	{
		case 46:
...
void func_256(int iParam0, bool bParam1)//Position - 0x28B80
{
	switch (iParam0)
	{
		case 46:
...
void func_257(int iParam0, bool bParam1)//Position - 0x28BD1
{
	int iVar0;
...
void func_258(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x28C37
{
	func_259(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_259(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x28C57
{
	int iVar0;
...
void func_260()//Position - 0x28E29
{
	int iVar0;
...
int func_261(int iParam0)//Position - 0x28F49
{
	int iVar0;
	int iVar1;
...
int func_264(int iParam0)//Position - 0x29182
{
...
void func_265(int iParam0, int iParam1)//Position - 0x291AF
{
...
int func_266(char* sParam0)//Position - 0x291EC
{
	int iVar0;
...
int func_267()//Position - 0x2924C
{
	return func_268(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_268(char* sParam0, int iParam1)//Position - 0x2925D
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
Vector3 func_269(int iParam0, vector3 vParam1)//Position - 0x292A6
{
	var uVar0;
...
void func_270(bool bParam0, int iParam1, int iParam2)//Position - 0x292EC
{
	bool bVar0;
...
void func_271(int iParam0, bool bParam1)//Position - 0x2934B
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_272(int iParam0, int iParam1)//Position - 0x2937D
{
	vector3 vVar0;
	float fVar3;
	...
	fVar3 = 23.45f;
	func_273(iParam0, iParam1, vVar0, fVar3);
}

void func_273(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x293AD
{
	func_14(iParam0);
...
void func_274(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x293D4
{
	int iVar0;
...
Vector3 func_275(int iParam0)//Position - 0x29592
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

void func_276(int iParam0, bool bParam1)//Position - 0x295A5
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
		if (!CAM::IS_SCREEN_FADING_IN())
...
void func_277()//Position - 0x295E1
{
	if (iLocal_929)
	{
		return;
	}
	if (ENTITY::DOES_ENTITY_EXIST(func_325()) && !func_52(vLocal_925, vLocal_166, 0))
	{
		MISC::CLEAR_AREA(vLocal_925, 3f, 1, 0, 0, false);
		if (func_567(func_325()))
		{
			ENTITY::SET_ENTITY_COORDS(func_325(), vLocal_925, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(func_325(), fLocal_928);
...
void func_278(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x29677
{
	struct<60> Var0;
...
void func_279(int iParam0, int iParam1, int iParam2)//Position - 0x297A0
{
	int iVar0;
...
void func_280(int iParam0, int iParam1)//Position - 0x298BD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_281(int iParam0)//Position - 0x29ABF
{
...
int func_282(int iParam0)//Position - 0x29B9C
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_283(int iParam0, bool bParam1)//Position - 0x29D4D
{
	int iVar0;
	struct<2> Var1;
...
int func_284(int iParam0)//Position - 0x29ECD
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_286(int iParam0)//Position - 0x29FB0
{
	int iVar0;
	int iVar1;
...
int func_287()//Position - 0x2C01E
{
	return 0;
}

int func_288()//Position - 0x2C027
{
	return 1;
}

int func_289()//Position - 0x2C030
{
	return 1;
}

int func_290()//Position - 0x2C039
{
...
int func_292(int iParam0)//Position - 0x2C10D
{
	int iVar0;
	char* sVar1;
...
int func_293(int iParam0)//Position - 0x2C153
{
	int iVar0;
...
int func_294(int iParam0)//Position - 0x2C18E
{
	int iVar0;
...
int func_295(int iParam0)//Position - 0x2C20A
{
	int iVar0;
...
int func_296(int iParam0, int iParam1, bool bParam2)//Position - 0x2C2F2
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_297(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2C363
{
...
int func_298(int iParam0)//Position - 0x2C43A
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_300(var uParam0, int iParam1)//Position - 0x2C49C
{
	if (iParam1 <= 0)
	{
		return;
...
void func_301(var uParam0, int iParam1)//Position - 0x2C522
{
...
void func_302(var uParam0, int iParam1)//Position - 0x2C555
{
	int iVar0;
	int iVar1;
...
int func_303(int iParam0, int iParam1)//Position - 0x2C5A6
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_304(int iParam0)//Position - 0x2C648
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_305(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_305(bool bParam0, int iParam1, int iParam2)//Position - 0x2C66D
{
	if (bParam0)
	{
		return iParam1;
...
int func_306(var uParam0)//Position - 0x2C684
{
	return uParam0 & 15;
}

void func_307(var uParam0, int iParam1)//Position - 0x2C691
{
...
void func_308(var uParam0, int iParam1)//Position - 0x2C6CB
{
...
void func_309(var uParam0, int iParam1)//Position - 0x2C706
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_310(var uParam0, int iParam1)//Position - 0x2C742
{
	int iVar0;
	int iVar1;
...
int func_311(int iParam0, int iParam1)//Position - 0x2DE38
{
	struct<82> Var0;
...
void func_312(int iParam0, var uParam1, int iParam2)//Position - 0x2DE7A
{
	int iVar0;
...
void func_313(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x2E0D6
{
	if (func_310(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_314(var uParam0, var uParam1)//Position - 0x2E1D5
{
...
void func_315(int iParam0)//Position - 0x2E2A1
{
	if (iParam0 == -1)
	{
		return;
...
int func_316(int iParam0)//Position - 0x2E31B
{
	int iVar0;
...
void func_317(int iParam0, var uParam1)//Position - 0x2E37E
{
	int iVar0;
...
int func_318(int iParam0)//Position - 0x2E629
{
	switch (iParam0)
	{
		case 1:
...
int func_319(int iParam0, var uParam1, var uParam2)//Position - 0x2E6D9
{
	int iVar0;
	int iVar1;
...
int func_320(int iParam0)//Position - 0x2E8CC
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_321(int iParam0)//Position - 0x2E8EC
{
...
bool func_322(vector3 vParam0, int iParam3)//Position - 0x2E913
{
	return func_323(Global_97130.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_323(int iParam0, vector3 vParam1, int iParam4)//Position - 0x2E930
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_324()//Position - 0x2E99A
{
	return 2.55f, 5.665f, 2.55f;
}

int func_325()//Position - 0x2E9B1
{
	return Global_97130.f_4;
}

void func_326()//Position - 0x2E9BF
{
...
int func_327(int iParam0, float fParam1, int iParam2)//Position - 0x2EA31
{
	int iVar0;
...
bool func_328()//Position - 0x2EB05
{
	bool bVar0;
...
void func_329()//Position - 0x2EB28
{
	Global_14732 = 0;
	func_32();
}

int func_330()//Position - 0x2EB38
{
...
void func_331()//Position - 0x2EB5A
{
...
int func_332(int iParam0, int iParam1)//Position - 0x2EBAB
{
	if (func_48(iParam0))
	{
...
int func_333(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2EBDE
{
...
void func_334(int iParam0)//Position - 0x2ED6D
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_335(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2ED99
{
	var uVar0;
	int iVar1;
...
void func_336()//Position - 0x2EE09
{
	Global_17272.f_6 = 1;
}

void func_337(int iParam0)//Position - 0x2EE17
{
	switch (*iParam0)
	{
		case 0:
...
void func_338(int iParam0)//Position - 0x2EE70
{
	switch (*iParam0)
	{
		case 0:
...
void func_339()//Position - 0x2EF60
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
int func_341(var uParam0, int iParam1)//Position - 0x2F028
{
...
int func_343(var uParam0)//Position - 0x2F097
{
	int iVar0;
	int iVar1;
...
bool func_344(char* sParam0, int iParam1, int iParam2)//Position - 0x2F0BA
{
...
void func_345()//Position - 0x2F0D8
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_346(var uParam0)//Position - 0x2F1FE
{
	if (iLocal_181 == 0)
	{
		return 0;
...
int func_347(var uParam0, bool bParam1)//Position - 0x2F258
{
	vector3 vVar0;
	float fVar3;
	...
	if (func_349(PLAYER::PLAYER_PED_ID(), vVar0, fVar3))
	{
		return 0;
	}
...
bool func_348(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2F31D
{
	return MISC::IS_POSITION_OCCUPIED(vParam0, fParam3, 0, 0, 1, 0, 0, iParam4, iParam5);
}

bool func_349(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2F338
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1) <= (fParam4 * fParam4);
}

Vector3 func_350(vector3 vParam0, float fParam3, float fParam4)//Position - 0x2F355
{
	vector3 vVar0;
	float fVar3;
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_351(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
	vVar0.z = MISC::GET_RANDOM_FLOAT_IN_RANGE(-fVar3, fVar3);
	return vParam0 + vVar0;
}

Vector3 func_351(vector3 vParam0, float fParam3)//Position - 0x2F39D
{
	float fVar0;
...
void func_352(var uParam0)//Position - 0x2F3D4
{
...
int func_353(var uParam0, vector3 vParam1, int iParam4, bool bParam5)//Position - 0x2F408
{
	if (bParam5)
	{
	...
	*uParam0 = 1;
	...
	BRAIN::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_350, 1000f, -8f, -1, 1, 0, 0, 0, 0);
	iLocal_876++;
	return 1;
}

float func_354(int iParam0, int iParam1, bool bParam2)//Position - 0x2F676
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_355(int iParam0)//Position - 0x2F6D4
{
	float fVar0;
...
float func_356(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, int iParam6)//Position - 0x2F6FB
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_357(var uParam0, float fParam1)//Position - 0x2F760
{
	float fVar0;
	vector3 vVar1;
...
int func_358(var uParam0)//Position - 0x2F7A0
{
	int iVar0;
	int iVar1;
	vector3 vVar2[9];
...
void func_359(int iParam0, int iParam1, vector3 vParam2)//Position - 0x2F83E
{
	*(iParam0[iParam1 /*3*/]) = { vParam2 };
}

void func_360(var uParam0)//Position - 0x2F852
{
	int iVar0;
...
int func_361(int iParam0)//Position - 0x2F879
{
	int iVar0;
...
void func_362(int iParam0)//Position - 0x2F8B1
{
	int iVar0;
...
int func_363(int iParam0)//Position - 0x2F942
{
	int iVar0;
...
int func_364(int iParam0)//Position - 0x2F986
{
	int iVar0;
...
int func_365(int iParam0)//Position - 0x2F9BE
{
	if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		return 0;
...
void func_366(int iParam0)//Position - 0x2F9FB
{
	switch (*iParam0)
	{
		case 0:
...
int func_367(int iParam0, float fParam1)//Position - 0x2FAE6
{
...
void func_368(var uParam0)//Position - 0x2FB04
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
int func_369(var uParam0, float fParam1)//Position - 0x2FB1A
{
	if (func_373(uParam0))
	{
...
float func_370(var uParam0)//Position - 0x2FB3C
{
	if (func_373(uParam0))
	{
		if (func_372(uParam0))
...
float func_371(bool bParam0)//Position - 0x2FB7B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_372(var uParam0)//Position - 0x2FBD3
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_373(var uParam0)//Position - 0x2FBE3
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

void func_374(int iParam0)//Position - 0x2FBF3
{
	if (!func_373(iParam0))
	{
		func_375(iParam0);
...
void func_375(int iParam0)//Position - 0x2FC0B
{
	func_376(iParam0, 0f);
}

void func_376(int iParam0, float fParam1)//Position - 0x2FC1A
{
...
void func_377(int iParam0)//Position - 0x2FC48
{
	int iVar0;
...
void func_378(vector3 vParam0, float fParam3, int iParam4, bool bParam5)//Position - 0x2FE8D
{
	int iVar0;
	vector3 vVar1;
	...
	{
		if (func_367(&iLocal_890, fLocal_893))
		{
			if (func_361(&iVar0))
			{
...
int func_379(vector3 vParam0, float fParam3, var uParam4)//Position - 0x2FF0F
{
	if (iLocal_181 == 0)
	{
		return 0;
...
void func_380()//Position - 0x2FF37
{
	struct<2> Var0;
...
void func_381(int iParam0, int iParam1)//Position - 0x2FFA0
{
	int iVar0;
...
void func_382(int iParam0)//Position - 0x3000C
{
	int iVar0;
...
void func_383()//Position - 0x300A8
{
	iLocal_36 = MISC::GET_GAME_TIMER();
}

void func_384(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x300B6
{
...
void func_385(var uParam0, bool bParam1)//Position - 0x300D6
{
	func_386(&(uParam0->f_41), bParam1);
}

void func_386(var uParam0, bool bParam1)//Position - 0x300E8
{
	int iVar0;
...
void func_387(int iParam0, bool bParam1)//Position - 0x30126
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_388(var uParam0, bool bParam1)//Position - 0x30161
{
	func_389(&(uParam0->f_35), bParam1);
}

void func_389(var uParam0, bool bParam1)//Position - 0x30173
{
	int iVar0;
...
void func_390(int iParam0)//Position - 0x301B0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_391(int iParam0)//Position - 0x301E8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_392(int iParam0)//Position - 0x30284
{
	if (func_567(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_393(var uParam0, int iParam1)//Position - 0x302AE
{
	func_394(&(uParam0->f_28), iParam1);
}

void func_394(var uParam0, int iParam1)//Position - 0x302C0
{
	int iVar0;
...
void func_395(var uParam0, bool bParam1, bool bParam2)//Position - 0x30301
{
	int iVar0;
...
void func_396()//Position - 0x303F6
{
	func_35(&uLocal_390, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
void func_397()//Position - 0x30448
{
	...
	func_402(&uLocal_210, 8, 2, iLocal_338, 0);
	func_401(&uLocal_210, 9, iLocal_359);
}

int func_398(var uParam0, int iParam1)//Position - 0x304C9
{
...
void func_399(var uParam0)//Position - 0x30510
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_400(var uParam0, int iParam1, char* sParam2, int iParam3)//Position - 0x30535
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_401(var uParam0, int iParam1, int iParam2)//Position - 0x30585
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_402(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4)//Position - 0x305D4
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_403(var uParam0, int iParam1, int iParam2)//Position - 0x306AC
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
bool func_404(var uParam0)//Position - 0x306F2
{
	int iVar0;
	int iVar1;
...
int func_405(var uParam0, int iParam1)//Position - 0x30766
{
...
int func_406(var uParam0, int iParam1)//Position - 0x3096C
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_407(int iParam0)//Position - 0x30B09
{
	int iVar0;
	char* sVar1;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_327(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_28[0], sLocal_328, 2, func_570(49), 0);
				}
				if (func_567(Local_96.f_41[0]))
				{
				...
				iLocal_884 = func_422(PLAYER::PLAYER_PED_ID(), iLocal_209, 1, 0, 0, 0, 0, 0, 0);
...
int func_408(int iParam0)//Position - 0x30FF7
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_410(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x31073
{
...
void func_411(int iParam0, int iParam1)//Position - 0x31091
{
...
void func_412()//Position - 0x31160
{
	if (func_322(func_324(), 1))
	{
		if (func_567(func_325()))
		{
			vLocal_925 = { ENTITY::GET_ENTITY_COORDS(func_325(), 1) };
			fLocal_928 = ENTITY::GET_ENTITY_HEADING(func_325());
		}
	}
...
void func_413(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x31210
{
	func_414(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_414(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x3123A
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_415(vector3 vParam0)//Position - 0x3162E
{
...
int func_416(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x31658
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_417(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x3194E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_418(vector3 vParam0)//Position - 0x31A02
{
	float fVar0;
	float fVar1;
...
void func_419(int iParam0)//Position - 0x31A41
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_420(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x31AA6
{
	if (iParam0 == 1)
	{
...
void func_421()//Position - 0x31B40
{
	int iVar0;
...
int func_422(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x31B60
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (func_426(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_426(iVar2, iVar8)))
			{
				if (func_425(func_426(iVar2, iVar8)))
				{
					iVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_426(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_426(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_426(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iVar1, func_426(iVar2, iVar8));
				func_423(iVar1, func_426(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_423(int iParam0, int iParam1)//Position - 0x31CD4
{
	int iVar0;
...
int func_424(int iParam0)//Position - 0x31CF2
{
	switch (iParam0)
	{
		case 1550611612:
...
int func_425(int iParam0)//Position - 0x31E78
{
...
int func_426(int iParam0, int iParam1)//Position - 0x32050
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_427(int iParam0)//Position - 0x32BC1
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_428(int iParam0, var uParam1)//Position - 0x32C5C
{
	int iVar0;
	int iVar1;
...
void func_429(int iParam0)//Position - 0x32C97
{
	int iVar0;
	int iVar1;
...
void func_430(int iParam0, var uParam1)//Position - 0x32CF4
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_431(Var11.f_1)) && iVar72 < 51)
			{
...
int func_431(int iParam0)//Position - 0x32F7C
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_432(int iParam0)//Position - 0x33102
{
	int iVar0;
...
void func_433(int iParam0)//Position - 0x33376
{
	var uVar0;
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_339) && !func_330())
			{
				uVar0 = 16;
				...
				{
					BRAIN::TASK_PLAY_ANIM(Local_96.f_28[0], sLocal_339, "leadin", 8f, -4f, -1, 2, 0, 0, 0, 0);
		...
		case 2:
			if (func_567(Local_96.f_28[0]))
			{
				if (!func_330() || MISC::GET_GAME_TIMER() > iLocal_157)
				{
					*iParam0 = 4;
				}
			}
...
int func_434(char* sParam0, int iParam1)//Position - 0x33531
{
	int iVar0;
...
void func_435()//Position - 0x3358C
{
	if (func_567(PLAYER::PLAYER_PED_ID()))
	{
...
void func_436()//Position - 0x33605
{
	func_476(0);
	func_331();
	func_437();
...
void func_437()//Position - 0x3361A
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_438()//Position - 0x33672
{
	int iVar0;
...
void func_439()//Position - 0x336CE
{
	int iVar0;
	float fVar1;
...
void func_440(var uParam0)//Position - 0x33756
{
	vector3 vVar0;
	var uVar3;
	int iVar4;
	...
	if (func_469(uParam0) && bLocal_559 == 1)
	{
		...
		BRAIN::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_349, 8f, -8f, -1, 1, 0, 0, 0, 0);
		func_58(uParam0);
		func_60(&(uParam0->f_17));
		uParam0->f_1 = 13;
		uParam0->f_26 = 0;
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_2, false);
			func_355(uParam0->f_2);
			BRAIN::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_350, 8f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 3:
			...
			if (uParam0->f_15 < 255f)
			{
				func_74(uParam0->f_2, SYSTEM::FLOOR(uParam0->f_15), &iLocal_186);
			}
			else
			{
		...
		case 13:
			...
			if (bLocal_559 == 1)
			{
				...
				{
					BRAIN::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_349, 4f, -4f, -1, 1, 0, 0, 0, 0);
				}
				return;
			}
			uParam0->f_1 = 14;
		...
		case 18:
			if (!PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
			{
				...
				BRAIN::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0, 0, 0, 0);
				uParam0->f_1 = 19;
			}
			break;
		...
		case 20:
			...
			if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) != 1)
			{
				BRAIN::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) == 1)
			{
...
int func_441(var uParam0)//Position - 0x341BB
{
	if (uParam0->f_1 != 7)
	{
		return 0;
...
int func_442(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x34221
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_443(var uParam0)//Position - 0x3429C
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_444(vector3 vParam0, vector3 vParam3, int iParam6)//Position - 0x346F6
{
...
void func_445()//Position - 0x34752
{
...
void func_446(char* sParam0, int iParam1)//Position - 0x347AC
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_447(var uParam0)//Position - 0x347C3
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	vVar3 = { func_451(CAM::_GET_GAMEPLAY_CAM_ROT(2)) };
	vVar6 = { vVar0 + vVar3 * FtoV(CAM::_0xD0082607100D7193()) };
	fVar13 = (fLocal_571 * 1.25f);
	if (func_450(&vVar9, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1), vVar3, vVar6))
	{
		if (CAM::IS_SPHERE_VISIBLE(vVar9, 0.5f))
		{
			iVar14 = func_448(vVar3, vVar0, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1));
			iVar15 = func_448(vVar3, vVar0, ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1));
...
int func_448(vector3 vParam0, vector3 vParam3, vector3 vParam6)//Position - 0x34920
{
	float fVar0;
...
float func_449(vector3 vParam0, vector3 vParam3)//Position - 0x34955
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

int func_450(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10)//Position - 0x34976
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_453(vector3 vParam0, vector3 vParam3, var uParam6, var uParam7, int iParam8)//Position - 0x34A4C
{
	vector3 vVar0;
...
void func_454(vector3 vParam0, var uParam3, var uParam4, int iParam5)//Position - 0x34A6F
{
	float fVar0;
...
void func_455(var uParam0)//Position - 0x34B14
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, iLocal_338, "MIND_CONTROL_B_Enter", 8f, -8f, -1, 2, 0, 0, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(uVar2);
				BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_2, uVar2);
...
void func_456(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x34D28
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_457(iParam3), 0);
}

int func_457(int iParam0)//Position - 0x34D41
{
	int iVar0;
...
void func_458(var uParam0)//Position - 0x34F54
{
	int iVar0;
	float fVar1;
	...
	if (uParam0->f_18 > iLocal_565 || BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_2, 242628503) > 1)
	{
		...
		{
			BRAIN::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_345, 8f, -8f, -1, 0, 0, 0, 0, 0);
		}
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_344, 3))
		{
			BRAIN::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
			BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_346, 8f, -4f, -1, 0, 0, 0, 0, 0);
	...
	if (MISC::GET_GAME_TIMER() > uParam0->f_7)
	{
		BRAIN::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_347, 8f, -8f, -1, 0, 0, 0, 0, 0);
		func_60(&(uParam0->f_17));
		func_459();
	}
}

void func_459()//Position - 0x351B8
{
...
int func_460(char* sParam0)//Position - 0x351D6
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_461(float fParam0)//Position - 0x351E9
{
	if (fParam0 < 0f)
	{
		return -1;
...
void func_462(var uParam0)//Position - 0x35200
{
	var uVar0;
	...
	func_355(uParam0->f_2);
	BRAIN::OPEN_SEQUENCE_TASK(&uVar0);
	BRAIN::TASK_PLAY_ANIM(0, iLocal_338, sLocal_341, 8f, -8f, -1, 0, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, iLocal_338, sLocal_343, 8f, -8f, -1, 1, 0, 0, 0, 0);
	BRAIN::CLOSE_SEQUENCE_TASK(uVar0);
	BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_2, uVar0);
	BRAIN::CLEAR_SEQUENCE_TASK(&uVar0);
	PED::_0x2208438012482A1A(uParam0->f_2, 0, 0);
	func_464(PLAYER::PLAYER_PED_ID(), uParam0->f_2);
	BRAIN::OPEN_SEQUENCE_TASK(&uVar0);
	BRAIN::TASK_PLAY_ANIM(0, iLocal_338, sLocal_342, 8f, -8f, -1, 0, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, iLocal_338, sLocal_344, 8f, -8f, -1, 1, 0, 0, 0, 0);
	BRAIN::CLOSE_SEQUENCE_TASK(uVar0);
	BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar0);
	BRAIN::CLEAR_SEQUENCE_TASK(&uVar0);
	PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
...
void func_463()//Position - 0x354A2
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
void func_464(int iParam0, int iParam1)//Position - 0x354F1
{
	float fVar0;
...
int func_465(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x35516
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = { func_418(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_466(var uParam0)//Position - 0x355A7
{
	if (uParam0->f_32)
	{
		return 0;
...
int func_467(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x355E7
{
	int iVar0;
	bool bVar1;
...
bool func_468(var uParam0)//Position - 0x35639
{
	int iVar0;
...
bool func_469(var uParam0)//Position - 0x3564C
{
	return ((((uParam0->f_1 == 20 || uParam0->f_1 == 19) || uParam0->f_1 == 18) || uParam0->f_1 == 17) || uParam0->f_1 == 15);
}

void func_470(var uParam0)//Position - 0x3568F
{
...
int func_471(var uParam0)//Position - 0x35702
{
	if (!func_475(uParam0))
	{
...
void func_472(int iParam0)//Position - 0x35892
{
	bool bVar0;
	int iVar1;
...
void func_473()//Position - 0x35903
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
void func_474(char* sParam0, char* sParam1, vector3 vParam2, int iParam5)//Position - 0x35991
{
	AUDIO::_PLAY_AMBIENT_SPEECH_AT_COORDS(sParam0, sParam1, vParam2, func_457(iParam5));
}

bool func_475(var uParam0)//Position - 0x359AB
{
	return (uParam0->f_1 == 7 || uParam0->f_1 == 8);
}

void func_476(int iParam0)//Position - 0x359C6
{
	if (func_480())
	{
		return;
...
void func_477(int iParam0)//Position - 0x359F9
{
	if (func_480())
	{
		return;
...
void func_478(bool bParam0, bool bParam1)//Position - 0x35A73
{
	if (bParam0)
	{
		if (func_479(0))
...
int func_479(int iParam0)//Position - 0x35AE7
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_480()//Position - 0x35B41
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

void func_481()//Position - 0x35B53
{
	PED::SET_PED_DENSITY_MULTIPLIER_THIS_FRAME(0f);
...
void func_482(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x35B75
{
	float fVar0;
	int iVar1;
	int iVar2;
...
float func_483(char* sParam0)//Position - 0x35E5A
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_484(int iParam0, int iParam1, int iParam2)//Position - 0x35E6D
{
	struct<2> Var0;
	int iVar2;
...
char* func_485(int iParam0)//Position - 0x35F42
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_486(int iParam0)//Position - 0x360AA
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_487(int iParam0)//Position - 0x360DD
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_488(int iParam0)//Position - 0x36110
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_489(int iParam0)//Position - 0x36143
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_490(int iParam0)//Position - 0x36176
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_491(int iParam0)//Position - 0x361B3
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_492(int iParam0)//Position - 0x361E6
{
	struct<2> Var0;
...
int func_493(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x36253
{
...
bool func_494(bool bParam0)//Position - 0x3636C
{
	if (bParam0)
	{
...
int func_495(int iParam0)//Position - 0x36395
{
	if (Global_36425 == 15)
	{
		return 0;
...
bool func_496(int iParam0)//Position - 0x363B7
{
	return func_497(iParam0, Global_36425);
}

int func_497(int iParam0, int iParam1)//Position - 0x363C8
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_498(bool bParam0)//Position - 0x365A9
{
...
void func_499(int iParam0)//Position - 0x365D4
{
	if (iParam0 > 0)
	{
	}
...
void func_500(vector3 vParam0, float fParam3, var uParam4, var uParam5)//Position - 0x365E2
{
	vector3 vVar0;
...
int func_501(int iParam0, int iParam1)//Position - 0x3660E
{
	int iVar0;
...
void func_502()//Position - 0x3666C
{
	...
	if (func_515() == 1)
	{
		...
		if (func_567(PLAYER::PLAYER_PED_ID()))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_344, 3))
			{
				BRAIN::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_344, -8f);
			}
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_342, 3))
			{
				BRAIN::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_342, -8f);
			}
			ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), true, 0);
			func_429(PLAYER::PLAYER_PED_ID());
			WEAPON::REMOVE_ALL_PED_WEAPONS(PLAYER::PLAYER_PED_ID(), 1);
...
void func_503(int iParam0, int iParam1, int iParam2)//Position - 0x36867
{
...
bool func_504()//Position - 0x3692B
{
	return MISC::IS_BIT_SET(Global_93682.f_20, 13);
}

void func_505(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x3693F
{
	if (func_515())
	{
...
int func_506(var uParam0)//Position - 0x369D4
{
	int iVar0[7];
	vector3 vVar8;
	float fVar11;
	...
	switch (iLocal_82)
	{
		...
		case 2:
			...
			{
				if (func_507(&(uParam0->f_28[0]), 49, vVar8, fVar11, "RC LAUNCHER: BARRY 1", 1))
				{
...
int func_507(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0x36E37
{
	if (func_508(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_508(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x36E93
{
	int iVar0;
...
int func_509(var uParam0, int iParam1)//Position - 0x36F21
{
	int iVar0;
...
int func_510(var uParam0)//Position - 0x36F67
{
	if (func_511(uParam0))
	{
...
int func_511(var uParam0)//Position - 0x36F91
{
...
int func_512(int iParam0)//Position - 0x36FB6
{
	int iVar0;
...
void func_513(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x36FE7
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
float func_514(float fParam0)//Position - 0x37023
{
	return (fParam0 * 57.29578f);
}

int func_515()//Position - 0x37033
{
...
void func_516(bool bParam0)//Position - 0x37057
{
	if (bParam0)
	{
...
void func_517(int iParam0, bool bParam1)//Position - 0x37083
{
	if (bParam1)
	{
...
void func_518()//Position - 0x370A5
{
...
void func_519()//Position - 0x3717D
{
	iLocal_209 = joaat("weapon_minigun");
	fLocal_570 = 7.5f;
	iLocal_565 = 10;
...
void func_520()//Position - 0x37232
{
	int iVar0;
...
void func_521(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x3725C
{
	*(uParam0[0 /*3*/]) = { vParam1 };
	*(uParam0[1 /*3*/]) = { vParam4 };
	uParam0->f_7 = fParam7;
...
void func_522(bool bParam0)//Position - 0x37280
{
	if (bParam0)
	{
		func_523();
...
void func_523()//Position - 0x372E3
{
...
void func_524(int iParam0)//Position - 0x3730C
{
...
void func_525(bool bParam0)//Position - 0x37366
{
	int iVar0;
...
void func_526(int iParam0, bool bParam1)//Position - 0x37389
{
	if (bParam1)
	{
...
void func_527(int iParam0, int iParam1, bool bParam2)//Position - 0x373C0
{
	int iVar0;
...
int func_528(int iParam0)//Position - 0x37432
{
	switch (iParam0)
	{
		case 0:
...
void func_529(int iParam0, int iParam1, bool bParam2)//Position - 0x37753
{
	int iVar0;
...
int func_530(int iParam0, int iParam1, bool bParam2)//Position - 0x377C5
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_531()//Position - 0x3782F
{
	func_421();
	if (func_535())
	{
...
void func_532(int iParam0)//Position - 0x37989
{
...
void func_533(var uParam0)//Position - 0x379EC
{
	int iVar0;
...
int func_534(var uParam0, int iParam1)//Position - 0x37A11
{
...
void func_536(bool bParam0)//Position - 0x37CA5
{
	int iVar0;
...
void func_537(char* sParam0, int iParam1)//Position - 0x37D75
{
	if (Global_93682 != 12)
	{
...
int func_538(char* sParam0, int iParam1, int iParam2)//Position - 0x37D9D
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_544())
	{
		...
		{
			iVar33 = func_539(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_539(char* sParam0)//Position - 0x37F2F
{
...
int func_541(char* sParam0, bool bParam1)//Position - 0x37FAD
{
	int iVar0;
	int iVar1;
...
int func_542(int iParam0, bool bParam1)//Position - 0x37FD7
{
	int iVar0;
...
void func_545(bool bParam0)//Position - 0x380CB
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_546(int iParam0)//Position - 0x380DF
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_547(int iParam0)//Position - 0x3811C
{
	if (iParam0 == 1)
	{
...
void func_548()//Position - 0x38159
{
	Global_17272.f_5 = 1;
}

void func_549()//Position - 0x38167
{
	Global_17272.f_5 = 0;
}

void func_550()//Position - 0x38175
{
	Global_87888 = 0;
	Global_87889 = 0;
}

int func_551()//Position - 0x38187
{
...
void func_552()//Position - 0x381C5
{
	Global_93717 = 1;
...
void func_553(char* sParam0, bool bParam1)//Position - 0x382B6
{
	func_554(sParam0);
	func_536(bParam1);
}

void func_554(char* sParam0)//Position - 0x382CA
{
...
void func_555(int iParam0)//Position - 0x38308
{
...
void func_556(int iParam0)//Position - 0x3831A
{
	if (func_26(iParam0))
	{
...
void func_557(int iParam0, bool bParam1)//Position - 0x38352
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_558(int iParam0, bool bParam1)//Position - 0x38445
{
	int iVar0;
	int iVar1;
...
void func_559(int iParam0, var uParam1, bool bParam2)//Position - 0x384A2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_560(int iParam0, int iParam1, int iParam2)//Position - 0x38B0E
{
	int iVar0;
...
void func_561(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x38B3B
{
	int iVar0;
...
int func_562(int iParam0)//Position - 0x38B5D
{
	switch (iParam0)
	{
		case -1860492113:
...
void func_563(int iParam0, int iParam1, int iParam2)//Position - 0x38E8C
{
	int iVar0;
...
bool func_564(int iParam0)//Position - 0x38EAC
{
	int iVar0;
	struct<2> Var1;
...
int func_565(bool bParam0, bool bParam1)//Position - 0x38FD8
{
	if (bParam0)
	{
...
bool func_566()//Position - 0x39044
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_567(int iParam0)//Position - 0x39055
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_568(var uParam0)//Position - 0x39076
{
...
void func_569(var uParam0)//Position - 0x39096
{
	int iVar0;
...
int func_570(int iParam0)//Position - 0x390D0
{
	if (!func_26(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
