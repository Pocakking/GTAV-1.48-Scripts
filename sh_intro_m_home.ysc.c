...
int func_20()//Position - 0x3AA1
{
	return 0;
}

int func_21()//Position - 0x3AAA
{
	return 1;
}

int func_22()//Position - 0x3AB3
{
	return 1;
}

int func_23()//Position - 0x3ABC
{
...
int func_25(int iParam0)//Position - 0x3B90
{
	int iVar0;
	char* sVar1;
...
int func_26(int iParam0)//Position - 0x3BD6
{
	int iVar0;
...
int func_27(int iParam0)//Position - 0x3C11
{
	int iVar0;
...
int func_28(int iParam0)//Position - 0x3C8D
{
	int iVar0;
...
int func_29(int iParam0, int iParam1, bool bParam2)//Position - 0x3D75
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_30(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3DE6
{
...
int func_31(int iParam0)//Position - 0x3EBF
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_33(var uParam0, int iParam1)//Position - 0x3F21
{
	if (iParam1 <= 0)
	{
		return;
...
void func_34(var uParam0, int iParam1)//Position - 0x3FA7
{
...
void func_35(var uParam0, int iParam1)//Position - 0x3FDA
{
	int iVar0;
	int iVar1;
...
int func_36(int iParam0, int iParam1)//Position - 0x402D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_37(int iParam0)//Position - 0x40CF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_38(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_38(bool bParam0, int iParam1, int iParam2)//Position - 0x40F4
{
	if (bParam0)
	{
		return iParam1;
...
int func_39(var uParam0)//Position - 0x410B
{
	return uParam0 & 15;
}

void func_40(var uParam0, int iParam1)//Position - 0x4118
{
...
void func_41(var uParam0, int iParam1)//Position - 0x4152
{
...
void func_42(var uParam0, int iParam1)//Position - 0x418D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_43(var uParam0, int iParam1)//Position - 0x41C9
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1)//Position - 0x58C1
{
	struct<82> Var0;
...
void func_45(int iParam0, var uParam1, int iParam2)//Position - 0x5903
{
	int iVar0;
...
bool func_46(int iParam0)//Position - 0x5B5F
{
	return iParam0 < 3;
}

void func_47(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x5B6B
{
	if (func_43(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_48(int iParam0, bool bParam1)//Position - 0x5C6A
{
	if (iParam0 == -1)
	{
		return;
...
void func_49(int iParam0, int iParam1, bool bParam2)//Position - 0x5CC7
{
	if (iParam0 == -1)
	{
		return;
...
bool func_50(int iParam0, int iParam1)//Position - 0x5D02
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_51(var uParam0, var uParam1)//Position - 0x5D25
{
...
void func_52(int iParam0)//Position - 0x5DF1
{
	if (iParam0 == -1)
	{
		return;
...
int func_53(int iParam0)//Position - 0x5E6B
{
	int iVar0;
...
bool func_54(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x5ECE
{
	if (bParam6)
	{
...
void func_55(int iParam0, var uParam1)//Position - 0x5F15
{
	int iVar0;
...
int func_56(int iParam0)//Position - 0x61C0
{
	switch (iParam0)
	{
		case 1:
...
int func_57(int iParam0, var uParam1, var uParam2)//Position - 0x6270
{
	int iVar0;
	int iVar1;
...
int func_58(int iParam0)//Position - 0x6463
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_59(var uParam0)//Position - 0x6483
{
	int iVar0;
...
void func_60(int iParam0)//Position - 0x6534
{
...
Vector3 func_61(vector3 vParam0)//Position - 0x655B
{
	return (-SYSTEM::SIN(vParam0.z) * SYSTEM::COS(vParam0.x)), (SYSTEM::COS(vParam0.z) * SYSTEM::COS(vParam0.x)), SYSTEM::SIN(vParam0.x);
}

void func_62(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x6588
{
	int iVar0;
...
void func_63(int iParam0, bool bParam1)//Position - 0x6746
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
...
Vector3 func_64(int iParam0)//Position - 0x6782
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_65(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x6795
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x6FAB
{
	int iVar0;
...
int func_67(int iParam0)//Position - 0x7037
{
	switch (iParam0)
	{
...
void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x7072
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x70FC
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_70(int iParam0, int iParam1, int iParam2)//Position - 0x71DA
{
	Global_71402[1 /*14*/] = { func_116(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_71(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x7205
{
	var uVar0;
	int iVar10;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x7809
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x78A2
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x7938
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x79D9
{
	switch (iParam0)
	{
		case 0:
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7A89
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x7D90
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x89C8
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8CAC
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8F73
{
	int iVar0;
	int iVar1;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8FAA
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x8FD3
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x929D
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2)//Position - 0x9527
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x967E
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9716
{
	switch (iParam0)
	{
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x97E4
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_88(int iParam0, int iParam1)//Position - 0x9940
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_89(int iParam0)//Position - 0x9CE7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9D48
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0, int iParam1)//Position - 0x9E44
{
	int iVar0;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9F82
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_93(int iParam0)//Position - 0xA062
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_94(int iParam0, int iParam1)//Position - 0xA0E8
{
	int iVar0;
	struct<10> Var1;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAA17
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_96(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xAB41
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_97(int iParam0, int iParam1)//Position - 0xAB89
{
	int iVar0;
	struct<17> Var1;
...
void func_98(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC9D3
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_99(int iParam0)//Position - 0xCBBD
{
	switch (iParam0)
	{
		case 0:
...
void func_100(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xCC6D
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCCDE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCF5B
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD380
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_104(int iParam0, int iParam1)//Position - 0xD673
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0xD6B9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD719
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_107(int iParam0)//Position - 0xD79D
{
...
void func_108(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xD855
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xD89F
{
	int iVar0;
...
int func_110(var uParam0)//Position - 0xD8CF
{
	int iVar0;
	int iVar1;
...
int func_111()//Position - 0xD903
{
	return Global_1312745;
}

int func_112(int iParam0, int iParam1, int iParam2)//Position - 0xD90F
{
	int iVar0;
	var uVar1;
...
bool func_113(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xD941
{
	int iVar0;
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xF712
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_115(int iParam0)//Position - 0x10631
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_116(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10682
{
	func_180();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_117(int iParam0, int iParam1)//Position - 0x106D4
{
	switch (iParam0)
	{
		case 0:
...
void func_118(int iParam0)//Position - 0x107C4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x11A3B
{
	int iVar0;
	int iVar1;
...
bool func_120(int iParam0, int iParam1, var uParam2)//Position - 0x11DCC
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_121(int iParam0, int iParam1)//Position - 0x121D1
{
	switch (iParam1)
	{
		case 0:
...
int func_122(int iParam0, int iParam1)//Position - 0x125CC
{
	switch (iParam1)
	{
		case 0:
...
int func_123(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x129C7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_124(int iParam0)//Position - 0x12A09
{
	return Global_36425 == iParam0;
}

int func_125(int iParam0)//Position - 0x12A17
{
	switch (iParam0)
	{
		case -1:
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12AEB
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_119(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_119(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_127(int iParam0)//Position - 0x12DC4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x13429
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x1349E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x13512
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x135F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x1395C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x13B6D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x13D9D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x13EAD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x14978
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x154EB
{
	if (iParam0 < 136)
	{
		func_140(iParam0);
...
void func_139(int iParam0)//Position - 0x15520
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x16124
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x17032
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1715F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0, int iParam1)//Position - 0x1725D
{
	switch (iParam0)
	{
		case 0:
...
void func_144(int iParam0)//Position - 0x1734D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1883F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x18990
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x18E9B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x19509
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1957D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1964D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x19B7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x19D14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1A512
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1A622
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1B54D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1C20C
{
	if (iParam0 < 107)
	{
		func_159(iParam0);
...
void func_157(int iParam0)//Position - 0x1C252
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1CCF7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1DAE6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1E72F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1E9A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0, int iParam1)//Position - 0x1EAEE
{
	switch (iParam0)
	{
		case 0:
...
void func_163(int iParam0)//Position - 0x1EBDE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1F968
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1FAE2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x2005A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x20584
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x205F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x206C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x20BA0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x20E09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x210DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x212A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x21DFC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x22A46
{
	if (iParam0 < 60)
	{
		func_177(iParam0);
...
void func_176(int iParam0)//Position - 0x22A7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x2381B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x23EA7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x23F8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180()//Position - 0x2408E
{
...
int func_181(int iParam0, int iParam1, int iParam2)//Position - 0x24107
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_182()//Position - 0x24362
{
	func_183();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_183()//Position - 0x2437B
{
	int iVar0;
...
int func_184(int iParam0)//Position - 0x24478
{
	int iVar0;
	int iVar1;
...
int func_185(int iParam0)//Position - 0x244B5
{
	if (func_46(iParam0))
	{
...
void func_186(bool bParam0)//Position - 0x244DF
{
	int iVar0;
...
void func_187(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2451D
{
	if (bParam0)
	{
...
bool func_188()//Position - 0x24656
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_189(int iParam0, int iParam1)//Position - 0x24673
{
	bool bVar0;
...
int func_190(int iParam0, bool bParam1)//Position - 0x246BE
{
	int iVar0;
	int iVar1;
...
int func_191(int iParam0)//Position - 0x246FF
{
...
bool func_192()//Position - 0x24741
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_193(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x24752
{
	int iVar0;
...
void func_195(int iParam0)//Position - 0x247AC
{
	if (iParam0 == 1)
	{
...
void func_196()//Position - 0x247CF
{
	Global_14732 = 0;
	func_197();
}

void func_197()//Position - 0x247DF
{
...
int func_198(int iParam0, float fParam1, int iParam2)//Position - 0x24800
{
	int iVar0;
...
bool func_199()//Position - 0x248D4
{
	bool bVar0;
...
void func_200()//Position - 0x248F7
{
	Global_14732 = 0;
	func_201();
}

void func_201()//Position - 0x24907
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
...
void func_203()//Position - 0x24980
{
...
int func_204(int iParam0, int iParam1)//Position - 0x249D1
{
	if (func_7(iParam0))
	{
...
int func_205(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x24A04
{
...
void func_206(int iParam0)//Position - 0x24B93
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_207()//Position - 0x24BBF
{
	if (iLocal_41)
	{
		if (INTERIOR::IS_VALID_INTERIOR(iLocal_51))
...
void func_208(bool bParam0)//Position - 0x24BF5
{
	if (bParam0)
	{
		if (!iLocal_40)
...
int func_210(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x24C6F
{
	int iVar0;
...
void func_211(var uParam0, int iParam1)//Position - 0x24DA6
{
	int iVar0;
...
bool func_212(int iParam0)//Position - 0x24DF5
{
	return func_213(iParam0, Global_36425);
}

int func_213(int iParam0, int iParam1)//Position - 0x24E06
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_214(int iParam0)//Position - 0x24FE7
{
	if (Global_36425 == 15)
	{
		return 0;
...
bool func_218(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x250C5
{
	vector3 vVar0;
...
bool func_219(var uParam0, struct<2> Param1, var uParam3)//Position - 0x250EF
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_220(var uParam0)//Position - 0x251AB
{
	int iVar0;
	float fVar1;
...
void func_221(var uParam0, vector3 vParam1)//Position - 0x2524B
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_222(var uParam0)//Position - 0x2527C
{
	if (uParam0->f_51)
	{
	}
...
void func_223()//Position - 0x252A3
{
	if (iLocal_47 != -1)
	{
		if (iLocal_39)
...
void func_224(int iParam0)//Position - 0x2531E
{
	if (*iParam0 == -1)
	{
		return;
...
int func_225(int iParam0)//Position - 0x2535B
{
	int iVar0;
	int iVar1;
