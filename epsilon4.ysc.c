...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_103(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_103(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		...
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			if (iLocal_283 >= 2)
			{
				if (func_229(Local_81.f_28[1]) && func_286(iLocal_292))
				{
					...
					BRAIN::CLOSE_SEQUENCE_TASK(uLocal_435);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_81.f_28[1], uLocal_435);
		...
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			if (iLocal_283 >= 2)
			{
				if (func_229(Local_81.f_28[0]) && func_286(iLocal_292))
				{
					...
					BRAIN::CLOSE_SEQUENCE_TASK(uLocal_435);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_81.f_28[0], uLocal_435);
					BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_435);
			...
			{
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_81.f_28[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				BRAIN::CLOSE_SEQUENCE_TASK(uLocal_97);
					...
					if (!iLocal_263)
					{
						if (func_229(Local_81.f_28[0]))
						{
							...
							if (func_229(PLAYER::PLAYER_PED_ID()))
							{
								...
								BRAIN::CLOSE_SEQUENCE_TASK(uLocal_97);
								BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_97);
								BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_97);
