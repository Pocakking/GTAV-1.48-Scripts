...
void func_24(char* sParam0)//Position - 0x1806
{
	int iVar0;
...
void func_25(int iParam0, char* sParam1)//Position - 0x184A
{
	switch (iParam0)
	{
		case 0:
...
void func_26(char* sParam0)//Position - 0x1A13
{
	char cVar0[64];
...
void func_27(char* sParam0)//Position - 0x1A47
{
	struct<4> Var0;
...
void func_28(char* sParam0)//Position - 0x1A72
{
...
bool func_32(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B10
{
...
int func_33(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B5E
{
	Global_15867 = 0;
...
bool func_40(int iParam0, int iParam1)//Position - 0x20A7
{
	switch (iParam0)
	{
		case 5:
...
void func_41(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x20E2
{
...
void func_42(char[4] cParam0)//Position - 0x2138
{
	int iVar0;
...
void func_43(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2173
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_44(char* sParam0)//Position - 0x220E
{
	int iVar0;
...
void func_45(var uParam0)//Position - 0x2246
{
}

void func_46(var uParam0, int iParam1, float fParam2)//Position - 0x224E
{
}

void func_47()//Position - 0x2256
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_48()//Position - 0x2265
{
	char* sVar0;
	struct<16> Var8;
...
void func_49(var uParam0)//Position - 0x22DB
{
}

void func_50(char* sParam0)//Position - 0x22E3
{
...
void func_51(int iParam0, char* sParam1, char* sParam2)//Position - 0x22F6
{
...
bool func_53()//Position - 0x23C7
{
	return Global_93734.f_339 > 0;
}

bool func_54()//Position - 0x23D8
{
	bool bVar0;
...
void func_58(char* sParam0)//Position - 0x245B
{
	struct<8> Var0;
...
void func_59(char* sParam0)//Position - 0x249B
{
	func_25(iLocal_297, sParam0);
}

void func_60(char* sParam0)//Position - 0x24AC
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_106510[iLocal_251] + 1, 16);
}

void func_61(int iParam0, bool bParam1)//Position - 0x24CA
{
	int iVar0;
...
void func_62(int iParam0, bool bParam1)//Position - 0x24EB
{
	int iVar0;
...
void func_63(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x255C
{
	func_64(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_64(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x257C
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x286E
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0)//Position - 0x29B7
{
	if (func_71(iParam0))
	{
...
int func_70(int iParam0)//Position - 0x29DE
{
	int iVar0;
...
int func_71(int iParam0)//Position - 0x2A11
{
...
int func_72(int iParam0)//Position - 0x2A3B
{
	switch (iParam0)
	{
...
void func_73(int iParam0)//Position - 0x2AF9
{
	if (iLocal_447 == 1)
	{
...
void func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x2B18
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_75(int iParam0, bool bParam1, int iParam2)//Position - 0x2B6B
{
	int iVar0;
...
int func_76(int iParam0, bool bParam1, bool bParam2)//Position - 0x2BBD
{
	int iVar0;
...
float func_77(bool bParam0, float fParam1, float fParam2)//Position - 0x2C61
{
	if (bParam0)
	{
		return fParam1;
...
float func_78(int iParam0, int iParam1, bool bParam2)//Position - 0x2C78
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_79(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2CD6
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_80(vector3 vParam0, vector3 vParam3)//Position - 0x2D67
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_81(vector3 vParam0)//Position - 0x2D88
{
	float fVar0;
	float fVar1;
...
int func_82(int iParam0)//Position - 0x2DC7
{
	var uVar0;
...
void func_85()//Position - 0x2E1B
{
	Global_14732 = 0;
	func_86();
}

void func_86()//Position - 0x2E2B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_87()//Position - 0x2E4C
{
	return 0;
}

void func_88()//Position - 0x2E55
{
}

int func_89()//Position - 0x2E5D
{
	return 1;
}

float func_90(int iParam0, int iParam1)//Position - 0x2E66
{
	return func_78(iParam0, iParam1, 1);
}

void func_91(int iParam0)//Position - 0x2E77
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x2EA8
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0, bool bParam1)//Position - 0x2ED9
{
	if (!func_71(iParam0))
	{
		if (!bParam1)
...
void func_94(var uParam0, var uParam1)//Position - 0x2F8C
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_95(int iParam0, bool bParam1)//Position - 0x2F9D
{
	if (iParam0 == 1)
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_96(int iParam0)//Position - 0x300F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_97()//Position - 0x3030
{
	func_98();
}

void func_98()//Position - 0x303C
{
}

void func_99()//Position - 0x3044
{
...
bool func_106(var uParam0)//Position - 0x3257
{
	return func_107(Global_106565.f_20111, uParam0);
}

bool func_107(var uParam0, var uParam1)//Position - 0x326C
{
	return (uParam0 && uParam1) != 0;
}

int func_108(int iParam0)//Position - 0x327B
{
...
void func_109(int iParam0)//Position - 0x33A2
{
	var uVar0;
...
void func_110(int iParam0)//Position - 0x3471
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_111()//Position - 0x3491
{
	struct<6> Var0;
...
void func_112()//Position - 0x34B5
{
	func_113();
}

void func_113()//Position - 0x34C1
{
}

void func_114()//Position - 0x34C9
{
	if (iLocal_245 == -1)
	{
