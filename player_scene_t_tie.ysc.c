...
void func_19()//Position - 0x545
{
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			...
			BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_72[iVar0], &cLocal_117, &(Local_125[iVar0 /*8*/]), vLocal_82 + vLocal_86[iVar0 /*3*/], Vector(uLocal_85, 0f, 0f) + vLocal_99[iVar0 /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
...
int func_22(struct<109> Param0, var uParam109)//Position - 0xD04
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
...
void func_23(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)//Position - 0x4080
{
...
bool func_27(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x4376
{
	if (bParam6)
	{
