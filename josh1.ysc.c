...
void func_1()//Position - 0x17C
{
	switch (iLocal_145)
	{
		...
		case 1:
			...
			if (!iLocal_160)
			{
				if (func_282(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
				{
					iLocal_149 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_150, vLocal_153, 2);
					BRAIN::TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_149))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_149) > 0.29f)
				{
					if (!iLocal_161)
					{
						func_220(&uLocal_163, 2, PLAYER::PLAYER_PED_ID(), "Trevor", 0, 1);
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, true, 0))
				{
					...
					if (func_281(Local_83.f_28[0]))
					{
						BRAIN::CLEAR_PED_TASKS(Local_83.f_28[0]);
				...
				if (func_209(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), 1) > 17.5f)
				{
					if (func_281(Local_83.f_28[0]))
					{
		...
		case 2:
			...
			if (func_281(Local_83.f_28[0]))
			{
				if (iLocal_162 == 1)
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_146);
					...
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_146);
				}
				else
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_146);
				...
				BRAIN::TASK_PERFORM_SEQUENCE(Local_83.f_28[0], iLocal_146);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_146);
...
int func_11()//Position - 0x13E6
{
	return Global_1312745;
}

void func_12()//Position - 0x13F2
{
	func_29();
	func_21();
	func_17();
...
void func_13(int iParam0)//Position - 0x144B
{
	if (iParam0 == 1)
	{
...
void func_15()//Position - 0x1492
{
	StringCopy(&Global_71822, "", 16);
	StringCopy(&Global_71826, "", 16);
}

void func_16()//Position - 0x14AE
{
	int iVar0;
...
void func_20(int iParam0)//Position - 0x1580
{
	if (iParam0 == 1)
	{
		Global_36974 = 1;
...
void func_21()//Position - 0x1599
{
	func_22(&Global_100114);
}

void func_22(var uParam0)//Position - 0x15A9
{
	int iVar0;
	int iVar1;
...
void func_23(var uParam0)//Position - 0x1B39
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_24(var uParam0)//Position - 0x1B54
{
...
void func_25(var uParam0)//Position - 0x1B83
{
	int iVar0;
...
void func_26(var uParam0)//Position - 0x1C34
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_27(var uParam0)//Position - 0x1C52
{
	int iVar0;
...
void func_28(var uParam0)//Position - 0x1D33
{
	*uParam0 = -15;
}

void func_29()//Position - 0x1D41
{
	StringCopy(&Global_97122, "", 32);
	func_22(&Global_97130);
}

void func_30()//Position - 0x1D5B
{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x1E99
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2058
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x20E4
{
	switch (iParam0)
	{
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x211F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_36(int iParam0, int iParam1, int iParam2)//Position - 0x2935
{
	int iVar0;
	int iVar1;
...
int func_37(int iParam0, int iParam1, int iParam2)//Position - 0x29BF
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_38(int iParam0, int iParam1, int iParam2)//Position - 0x2A9D
{
	Global_71402[1 /*14*/] = { func_83(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_39(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2AC8
{
	var uVar0;
	int iVar10;
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x30CC
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x3165
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3206
{
	int iVar0;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x350D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4140
{
	int iVar0;
...
int func_45(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4424
{
	int iVar0;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x46EB
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4722
{
	int iVar0;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x474B
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4A15
{
	int iVar0;
...
int func_50(int iParam0, int iParam1, int iParam2)//Position - 0x4C9F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DF6
{
	int iVar0;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4E8E
{
	switch (iParam0)
	{
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4F5C
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_54(int iParam0, int iParam1)//Position - 0x50B8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_55(int iParam0)//Position - 0x545F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x54C0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_57(int iParam0, int iParam1)//Position - 0x55BC
{
	int iVar0;
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x56FA
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_59(int iParam0)//Position - 0x57DA
{
	switch (iParam0)
	{
		case 0:
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5860
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5ADD
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5F02
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_63(int iParam0, int iParam1)//Position - 0x61F5
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0, int iParam1)//Position - 0x623B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x629B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_66(int iParam0)//Position - 0x631F
{
...
void func_67(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x63D7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_68(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x6421
{
	int iVar0;
...
int func_69(var uParam0)//Position - 0x6451
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0, int iParam1, int iParam2)//Position - 0x6485
{
	int iVar0;
	var uVar1;
...
bool func_71(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x64B7
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8289
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_73(int iParam0)//Position - 0x91A7
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x91F8
{
	int iVar0;
...
int func_75(int iParam0)//Position - 0x928E
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_76(int iParam0, int iParam1)//Position - 0x933E
{
	int iVar0;
	struct<10> Var1;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9C6D
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9D97
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_79(int iParam0, int iParam1)//Position - 0x9DDF
{
	int iVar0;
	struct<17> Var1;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBC27
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_81(int iParam0)//Position - 0xBE11
{
	switch (iParam0)
	{
		case 0:
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xBEC1
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBF32
{
	func_147();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_84(int iParam0, int iParam1)//Position - 0xBF84
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0)//Position - 0xC076
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_86(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD2ED
{
	int iVar0;
	int iVar1;
...
bool func_87(int iParam0, int iParam1, var uParam2)//Position - 0xD67E
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_88(int iParam0, int iParam1)//Position - 0xDA83
{
	switch (iParam1)
	{
		case 0:
...
int func_89(int iParam0, int iParam1)//Position - 0xDE7E
{
	switch (iParam1)
	{
		case 0:
...
int func_90(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE279
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_91(int iParam0)//Position - 0xE2BB
{
	return Global_36425 == iParam0;
}

int func_92(int iParam0)//Position - 0xE2C9
{
	switch (iParam0)
	{
		case -1:
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE39D
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_94(int iParam0)//Position - 0xE676
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0xE7CD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0xECDB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0xED50
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xEDC4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0xEEAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xF20E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xF41F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xF64F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xF75F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0x10100
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0x10C73
{
	if (iParam0 < 136)
	{
		func_107(iParam0);
...
void func_106(int iParam0)//Position - 0x10CA8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x118AC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x127BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0x128E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0, int iParam1)//Position - 0x129E5
{
	switch (iParam0)
	{
		case 0:
...
void func_111(int iParam0)//Position - 0x12AD5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x13FC6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x14129
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x14634
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x14CA2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x14D16
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x14DE6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x15316
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x154AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x15CAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x15DBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x16CE6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x179A3
{
	if (iParam0 < 107)
	{
		func_126(iParam0);
...
void func_124(int iParam0)//Position - 0x179E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x18490
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x1927F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x19EC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x1A141
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0, int iParam1)//Position - 0x1A287
{
	switch (iParam0)
	{
		case 0:
...
void func_130(int iParam0)//Position - 0x1A377
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x1B101
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x1B27B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x1B7F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1BD1C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1BD90
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1BE60
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x1C5A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1C878
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1CA41
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1D595
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1E1DF
{
	if (iParam0 < 60)
	{
		func_144(iParam0);
...
void func_143(int iParam0)//Position - 0x1E214
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1EFB4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1F640
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1F727
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147()//Position - 0x1F825
{
...
int func_148(int iParam0, int iParam1, int iParam2)//Position - 0x1F89E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_149(int iParam0)//Position - 0x1FAF9
{
	int iVar0;
	int iVar1;
...
int func_150(int iParam0)//Position - 0x1FB36
{
	if (func_151(iParam0))
	{
...
bool func_151(int iParam0)//Position - 0x1FB60
{
	return iParam0 < 3;
}

void func_152(char* sParam0, int iParam1)//Position - 0x1FB6C
{
...
void func_154()//Position - 0x1FC0C
{
	int iVar0;
...
struct<2> func_155(int iParam0)//Position - 0x1FD09
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_156(int iParam0)//Position - 0x1FD41
{
	struct<2> Var0;
...
void func_157(int iParam0, int iParam1)//Position - 0x20190
{
...
void func_158(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x201DA
{
...
void func_159(int iParam0, int iParam1, int iParam2)//Position - 0x20277
{
	struct<4> Var0;
	char* sVar32;
...
void func_160(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x202B6
{
...
void func_161(int iParam0, var uParam1)//Position - 0x202FB
{
	switch (iParam0)
	{
		case 0:
...
int func_163(int iParam0)//Position - 0x215D3
{
	switch (iParam0)
	{
		case 0:
...
void func_164(int iParam0)//Position - 0x21919
{
	Global_36976 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_165()//Position - 0x2192B
{
	if (Global_91024)
	{
		func_154();
...
char* func_166(var uParam0)//Position - 0x2195E
{
	uParam0 = uParam0;
	return "";
}

void func_167()//Position - 0x2196E
{
	vector3 vVar0[24];
...
void func_168(int iParam0, int iParam1)//Position - 0x219B1
{
	Global_91019 = iParam0;
	Global_91020 = iParam1;
}

void func_169()//Position - 0x219C5
{
	if (Global_71844 != 6)
	{
	}
...
void func_170(var uParam0)//Position - 0x219FD
{
	if (*uParam0 == -1)
	{
		return;
...
void func_171(int iParam0, bool bParam1)//Position - 0x21A3A
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_172(int iParam0)//Position - 0x21BC1
{
	switch (iParam0)
	{
		case 0:
...
void func_173(int iParam0)//Position - 0x21F48
{
	func_175(iParam0, 1);
...
int func_174()//Position - 0x21F7E
{
	return (Global_106565.f_10010.f_21 + Global_106565.f_18568.f_380);
}

void func_175(var uParam0, bool bParam1)//Position - 0x21F9A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_176(int iParam0)//Position - 0x222BE
{
...
void func_177(int iParam0)//Position - 0x222F1
{
	switch (iParam0)
	{
		case 30:
...
void func_178(int iParam0, bool bParam1)//Position - 0x22326
{
	if (iParam0 == -1)
	{
		return;
...
void func_179(int iParam0, int iParam1, bool bParam2)//Position - 0x22383
{
	if (iParam0 == -1)
	{
		return;
...
bool func_180(int iParam0, int iParam1)//Position - 0x223BE
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_181(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x223E1
{
	if (iParam0 != 198)
	{
		if (Global_71590)
...
void func_182(int iParam0, int iParam1)//Position - 0x2243C
{
	switch (iParam0)
	{
		case 12:
...
void func_183(int iParam0, bool bParam1)//Position - 0x22525
{
	if (bParam1)
	{
...
bool func_184(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x2254E
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_186()//Position - 0x22EE6
{
	return Global_25766;
}

int func_187(var uParam0, int iParam1)//Position - 0x22EF1
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0x26730
{
	switch (iParam0)
	{
		case 46:
...
void func_189(int iParam0, bool bParam1)//Position - 0x26822
{
	switch (iParam0)
	{
		case 46:
...
void func_190(int iParam0, bool bParam1)//Position - 0x26873
{
	int iVar0;
...
void func_191(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x268D9
{
	func_192(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_192(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x268FB
{
	int iVar0;
...
void func_193()//Position - 0x26ACF
{
	int iVar0;
...
int func_194(int iParam0)//Position - 0x26BEF
{
	int iVar0;
	int iVar1;
...
int func_197(int iParam0)//Position - 0x26E2A
{
...
void func_198(int iParam0, int iParam1)//Position - 0x26E57
{
...
int func_199(char* sParam0)//Position - 0x26E94
{
	int iVar0;
...
int func_200()//Position - 0x26EF4
{
	return func_201(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_201(char* sParam0, int iParam1)//Position - 0x26F05
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_202(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x26F4E
{
	struct<14> Var0;
...
void func_203(int iParam0)//Position - 0x27069
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_204(int iParam0)//Position - 0x2712D
{
	switch (iParam0)
	{
		case 0:
...
void func_205(int iParam0, int iParam1, bool bParam2)//Position - 0x27197
{
	Global_3109 = iParam0;
...
void func_206()//Position - 0x27341
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
void func_207()//Position - 0x273C2
{
	if (func_91(14))
	{
...
int func_208()//Position - 0x27464
{
	func_154();
	return Global_106565.f_2357.f_539.f_4321;
}

float func_209(int iParam0, int iParam1, bool bParam2)//Position - 0x2747D
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_210(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x274DB
{
...
int func_211(char* sParam0, int iParam1, bool bParam2)//Position - 0x27529
{
	Global_15867 = 0;
...
void func_212()//Position - 0x277F5
{
	int iVar0;
...
void func_213()//Position - 0x27827
{
...
void func_216()//Position - 0x2797C
{
	int iVar0;
...
bool func_217(int iParam0, int iParam1)//Position - 0x279D4
{
	switch (iParam0)
	{
		case 5:
...
void func_218()//Position - 0x27A0F
{
...
void func_219(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x27A66
{
...
void func_220(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x27ABC
{
...
void func_221(int iParam0, int iParam1, int iParam2)//Position - 0x27B57
{
...
void func_222(int iParam0, bool bParam1)//Position - 0x27B8B
{
...
void func_223(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x27BC7
{
	int iVar0;
...
void func_224(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x27C70
{
	if (bParam0)
	{
...
bool func_225()//Position - 0x27DA9
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_226(int iParam0, int iParam1)//Position - 0x27DC6
{
	bool bVar0;
...
int func_227(int iParam0, bool bParam1)//Position - 0x27E11
{
	int iVar0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0x27E52
{
...
bool func_229()//Position - 0x27E94
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_230(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x27EA5
{
	int iVar0;
...
void func_231(int iParam0)//Position - 0x27ED8
{
	if (iParam0 == 1)
	{
...
void func_232(char* sParam0)//Position - 0x27EFB
{
	sParam0 = sParam0;
}

void func_233()//Position - 0x27F07
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_160)
				{
					...
					{
						iLocal_149 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_150, vLocal_153, 2);
						BRAIN::TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
			...
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!iLocal_160)
				{
					...
					{
						iLocal_149 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_150, vLocal_153, 2);
						BRAIN::TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
...
int func_234(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0x2858C
{
	bool bVar0;
	float fVar1;
...
void func_235(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x285E8
{
	int iVar0;
...
Vector3 func_236(int iParam0)//Position - 0x287A6
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_237(bool bParam0)//Position - 0x287B9
{
	int iVar0;
...
void func_238(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x287F7
{
	func_239(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_239(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28821
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_243(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_240(vector3 vParam0)//Position - 0x28C15
{
...
int func_241(int iParam0, int iParam1, bool bParam2)//Position - 0x28C3F
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_242(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x28CB0
{
...
int func_243(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x28D89
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_244(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2907F
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_245(vector3 vParam0)//Position - 0x29133
{
	float fVar0;
	float fVar1;
...
void func_246(int iParam0)//Position - 0x29172
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_247()//Position - 0x291D7
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0x291F7
{
	if (func_281(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_249(int iParam0, float fParam1, int iParam2)//Position - 0x29221
{
	int iVar0;
...
bool func_250()//Position - 0x292F5
{
	bool bVar0;
...
void func_251()//Position - 0x29318
{
	Global_14732 = 0;
	func_218();
}

int func_252()//Position - 0x29328
{
...
void func_253()//Position - 0x2934A
{
...
int func_254(int iParam0, int iParam1)//Position - 0x2939B
{
	if (func_282(iParam0))
	{
...
int func_255(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x293CE
{
...
void func_256(int iParam0)//Position - 0x2955D
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_257()//Position - 0x29589
{
	func_258();
	if (CUTSCENE::_0xB56BBBCC2955D9CB())
	{
		...
		case 1:
			if (!func_5(0))
			{
				if (!bLocal_156)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
					{
						if (func_282(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
						{
							...
							BRAIN::TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], iLocal_148, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_147, iLocal_148, "leadin_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
							BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], -1, 0, 2);
							BRAIN::TASK_LOOK_AT_ENTITY(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), 4000, 2060, 2);
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_148))
				{
					...
					if (func_209(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 2.5f)
					{
...
void func_258()//Position - 0x29919
{
	func_260(0);
	func_253();
	func_259();
...
void func_259()//Position - 0x2992E
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_260(int iParam0)//Position - 0x29986
{
	if (func_264())
	{
		return;
...
void func_261(int iParam0)//Position - 0x299B9
{
	if (func_264())
	{
		return;
...
void func_262(bool bParam0, bool bParam1)//Position - 0x29A33
{
	if (bParam0)
	{
		if (func_263(0))
...
int func_263(int iParam0)//Position - 0x29AA7
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
bool func_264()//Position - 0x29B01
{
	return MISC::IS_BIT_SET(Global_1681628, 19);
}

void func_265(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x29B13
{
	float fVar0;
	int iVar1;
	int iVar2;
...
float func_266(char* sParam0)//Position - 0x29DF8
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_267(int iParam0, int iParam1, int iParam2)//Position - 0x29E0B
{
	struct<2> Var0;
	int iVar2;
...
char* func_268(int iParam0)//Position - 0x29EE2
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_269(int iParam0)//Position - 0x2A035
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_270(int iParam0)//Position - 0x2A069
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_271(int iParam0)//Position - 0x2A09D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_272(int iParam0)//Position - 0x2A0D1
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_273(int iParam0)//Position - 0x2A105
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_274(int iParam0)//Position - 0x2A143
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_275(int iParam0)//Position - 0x2A177
{
	struct<2> Var0;
...
int func_276(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2A1E0
{
...
bool func_277(bool bParam0)//Position - 0x2A2F8
{
	if (bParam0)
	{
...
int func_278(int iParam0)//Position - 0x2A321
{
	if (Global_36425 == 15)
	{
		return 0;
...
bool func_279(int iParam0)//Position - 0x2A343
{
	return func_280(iParam0, Global_36425);
}

int func_280(int iParam0, int iParam1)//Position - 0x2A354
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_281(int iParam0)//Position - 0x2A535
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_282(int iParam0)//Position - 0x2A556
{
	if (func_281(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_283(var uParam0, bool bParam1, bool bParam2)//Position - 0x2A576
{
	int iVar0;
...
int func_284(var uParam0)//Position - 0x2A66B
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
int func_285(bool bParam0, bool bParam1)//Position - 0x2A7D8
{
	int iVar0;
...
void func_286(int iParam0, bool bParam1)//Position - 0x2A846
{
	vector3 vVar0;
	float fVar3;
	...
	func_287(iParam0, iLocal_81, vVar0, fVar3);
...
void func_287(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x2A8BA
{
	func_288(iParam0);
...
void func_288(int iParam0)//Position - 0x2A8FC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_289(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0x2A998
{
...
int func_290(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x2A9F4
{
	int iVar0;
...
int func_291(var uParam0, int iParam1)//Position - 0x2AA82
{
	int iVar0;
...
int func_292(var uParam0)//Position - 0x2AAC8
{
	if (func_293(uParam0))
	{
...
int func_293(var uParam0)//Position - 0x2AAF2
{
...
int func_294(int iParam0)//Position - 0x2AB17
{
	int iVar0;
...
void func_295(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2AB48
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_297()//Position - 0x2ABA8
{
	func_247();
	if (func_310())
	{
...
void func_298(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2AC32
{
...
void func_299(var uParam0, bool bParam1)//Position - 0x2AC52
{
	func_300(&(uParam0->f_41), bParam1);
}

void func_300(var uParam0, bool bParam1)//Position - 0x2AC64
{
	int iVar0;
...
void func_301(int iParam0, bool bParam1)//Position - 0x2ACA2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_302(int iParam0)//Position - 0x2ACDD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_303(var uParam0, bool bParam1)//Position - 0x2AD08
{
	func_304(&(uParam0->f_35), bParam1);
}

void func_304(var uParam0, bool bParam1)//Position - 0x2AD1A
{
	int iVar0;
...
void func_305(int iParam0)//Position - 0x2AD57
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_306(var uParam0, int iParam1)//Position - 0x2AD8F
{
	func_307(&(uParam0->f_28), iParam1);
}

void func_307(var uParam0, int iParam1)//Position - 0x2ADA1
{
	int iVar0;
...
void func_308(int iParam0)//Position - 0x2ADE2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_309(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2AE23
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_311(bool bParam0)//Position - 0x2AF14
{
	int iVar0;
...
void func_312(char* sParam0, int iParam1)//Position - 0x2AFE4
{
	if (Global_93682 != 12)
	{
...
int func_313(char* sParam0, int iParam1, int iParam2)//Position - 0x2B00C
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_314(char* sParam0)//Position - 0x2B19E
{
...
int func_316(char* sParam0, bool bParam1)//Position - 0x2B218
{
	int iVar0;
	int iVar1;
...
int func_317(int iParam0, bool bParam1)//Position - 0x2B242
{
	int iVar0;
...
void func_320(bool bParam0)//Position - 0x2B334
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_321(int iParam0)//Position - 0x2B348
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_322(int iParam0)//Position - 0x2B385
{
	if (iParam0 == 1)
	{
...
void func_323()//Position - 0x2B3C2
{
	Global_17272.f_5 = 1;
}

void func_324()//Position - 0x2B3D0
{
	Global_17272.f_5 = 0;
}

void func_325(bool bParam0)//Position - 0x2B3DE
{
	if (bParam0)
	{
		func_326();
...
void func_326()//Position - 0x2B441
{
...
void func_327()//Position - 0x2B46A
{
	Global_87888 = 0;
	Global_87889 = 0;
}

int func_328()//Position - 0x2B47C
{
...
void func_329()//Position - 0x2B4BA
{
	Global_93717 = 1;
...
void func_330(int iParam0)//Position - 0x2B5A9
{
...
void func_331(var uParam0)//Position - 0x2B5BB
{
...
void func_332(var uParam0)//Position - 0x2B5DB
{
	int iVar0;
...
int func_333(int iParam0)//Position - 0x2B615
{
	if (!func_151(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
