		...
		if (!func_104(0) && !func_103(14))
		{
			if (iLocal_47 == 0)
			{
				if (func_113())
				{
					...
					bLocal_461 = MISC::IS_BIT_SET(Global_2424, 28);
					if (iLocal_48 != -1)
					{
						if (fVar0 < fLocal_46)
						{
...
int func_22(int iParam0)//Position - 0x57F0
{
	switch (iParam0)
	{
		case -1:
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x58C4
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_13(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_13(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
int func_24(int iParam0)//Position - 0x5B9B
{
	switch (iParam0)
	{
		case 0:
...
void func_25(int iParam0)//Position - 0x5C4B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_26(int iParam0)//Position - 0x5D8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_27(int iParam0)//Position - 0x629A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_28(int iParam0)//Position - 0x630D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_29(int iParam0)//Position - 0x637F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_30(int iParam0)//Position - 0x6466
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_31(int iParam0)//Position - 0x6787
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_32(int iParam0)//Position - 0x6986
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_33(int iParam0)//Position - 0x6B96
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_34(int iParam0)//Position - 0x6C98
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_35(int iParam0)//Position - 0x761D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_36(int iParam0)//Position - 0x815B
{
	if (iParam0 < 136)
	{
		func_38(iParam0);
...
void func_37(int iParam0)//Position - 0x8190
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_38(int iParam0)//Position - 0x8D94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_39(int iParam0)//Position - 0x9C86
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_40(int iParam0)//Position - 0x9DB3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_41(int iParam0, int iParam1)//Position - 0x9EA3
{
	switch (iParam0)
	{
		case 0:
...
void func_42(int iParam0)//Position - 0x9F93
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_43(int iParam0)//Position - 0xB43C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_44(int iParam0)//Position - 0xB579
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_45(int iParam0)//Position - 0xBA82
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_46(int iParam0)//Position - 0xC0E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_47(int iParam0)//Position - 0xC159
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_48(int iParam0)//Position - 0xC229
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_49(int iParam0)//Position - 0xC6EF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_50(int iParam0)//Position - 0xC87A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_51(int iParam0)//Position - 0xD05A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_52(int iParam0)//Position - 0xD15C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_53(int iParam0)//Position - 0xE077
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_54(int iParam0)//Position - 0xED14
{
	if (iParam0 < 107)
	{
		func_57(iParam0);
...
void func_55(int iParam0)//Position - 0xED5A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_56(int iParam0)//Position - 0xF7FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_57(int iParam0)//Position - 0x105EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_58(int iParam0)//Position - 0x11221
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_59(int iParam0)//Position - 0x11498
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_60(int iParam0, int iParam1)//Position - 0x115CA
{
	switch (iParam0)
	{
		case 0:
...
void func_61(int iParam0)//Position - 0x116BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_62(int iParam0)//Position - 0x123EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_63(int iParam0)//Position - 0x12550
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_64(int iParam0)//Position - 0x12ABB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_65(int iParam0)//Position - 0x12FE1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_66(int iParam0)//Position - 0x13053
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_67(int iParam0)//Position - 0x13123
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_68(int iParam0)//Position - 0x135AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_69(int iParam0)//Position - 0x137F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_70(int iParam0)//Position - 0x13AA2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_71(int iParam0)//Position - 0x13C4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_72(int iParam0)//Position - 0x14788
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_73(int iParam0)//Position - 0x153A2
{
	if (iParam0 < 60)
	{
		func_75(iParam0);
...
void func_74(int iParam0)//Position - 0x153D7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_75(int iParam0)//Position - 0x1615D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_76(int iParam0)//Position - 0x167D5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_77(int iParam0)//Position - 0x168BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_79(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x16A21
{
	if (iParam2 == -99)
	{
		return;
...
int func_80(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x16B0A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<10> func_81(int iParam0, int iParam1)//Position - 0x16EF2
{
	int iVar0;
	struct<10> Var1;
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x17821
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1794B
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_84(int iParam0, int iParam1)//Position - 0x17A2B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_85(int iParam0)//Position - 0x17DD2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x17E33
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_87(int iParam0, int iParam1)//Position - 0x17E7B
{
	int iVar0;
	struct<17> Var1;
...
void func_107(char* sParam0, int iParam1)//Position - 0x1A8A5
{
