...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_179(uLocal_95, 4194304))
	{
		if (iLocal_106 != 263)
		{
			...
			switch (iLocal_96)
			{
				...
				case 3:
					...
					if (!func_177(iLocal_101))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_93682.f_3), &cLocal_70))
							{
								cLocal_70 = { Local_54 };
								bVar1 = false;
							}
					...
					else
					{
						...
						if (!func_164(3) && !Global_93716)
						{
							...
							{
								if ((!func_179(uLocal_95, 1) || !ENTITY::DOES_ENTITY_EXIST(func_163())) && !Global_93716)
								{
									func_172(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_118, vLocal_121, fLocal_124, 1, false, iLocal_104) || (fLocal_126 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_138(vLocal_118, vLocal_121, 0.5f), false) > fLocal_126))
							{
								bVar2 = false;
							}
							...
							if (bVar2)
							{
								...
								if (func_137(uLocal_87))
								{
									...
									else if (!func_179(uLocal_95, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_135(&iLocal_97);
				...
				case 6:
					...
					if (func_179(uLocal_95, 2097152))
					{
						if (!func_164(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_53))
						{
							func_172(10);
						}
					}
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_53))
					{
						...
						if (iLocal_100 != -1)
						{
							if (func_179(Global_105216, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_100), 0, Global_93719, 0);
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7831
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_57(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::_0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_57(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::_0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_68(int iParam0)//Position - 0x7B09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_69(int iParam0)//Position - 0x7C56
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_70(int iParam0)//Position - 0x8164
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_71(int iParam0)//Position - 0x81D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_72(int iParam0)//Position - 0x824B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_73(int iParam0)//Position - 0x8332
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_74(int iParam0)//Position - 0x8674
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_75(int iParam0)//Position - 0x887C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_76(int iParam0)//Position - 0x8A9C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_77(int iParam0)//Position - 0x8BA5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_78(int iParam0)//Position - 0x9537
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_79(int iParam0)//Position - 0xA08F
{
	if (iParam0 < 136)
	{
		func_81(iParam0);
...
void func_80(int iParam0)//Position - 0xA0C4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_81(int iParam0)//Position - 0xACC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_82(int iParam0)//Position - 0xBBC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_83(int iParam0)//Position - 0xBCF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_84(int iParam0, int iParam1)//Position - 0xBDEC
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0)//Position - 0xBEDC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
Vector3 func_138(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x1B0C8
{
...
void func_168()//Position - 0x1BF04
{
	...
	if (bLocal_129 && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_128 == 1)
		{
			...
			{
				iVar5[iVar9] = func_169(&iVar5, 3, 2, 7);
				iVar9++;
			}
			iVar9 = 0;
			while (iVar9 < iVar4 && iVar9 < 3)
