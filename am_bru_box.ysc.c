...
int func_4(vector3 vParam0)//Position - 0x319
{
		...
		if (func_210())
		{
			if (NETWORK::CAN_REGISTER_MISSION_OBJECTS(1))
			{
				...
				if (MISC::IS_BIT_SET(Local_60.f_1, 8))
				{
					...
					fVar3 = Global_2528542.f_850.f_4;
				}
				...
				if (iVar4 == 0)
				{
					if (MISC::IS_BIT_SET(Local_60.f_1, 8) || func_180(vVar6, fVar5, &vVar0, &fVar3, &Var13))
					{
						if (Local_60.f_7 >= 32 || func_224(PLAYER::PLAYER_ID()) == 1)
						{
...
int func_9(var uParam0, var uParam1, var uParam2)//Position - 0x73C
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
void func_10(var uParam0, var uParam1)//Position - 0x16F5
{
	int iVar0;
...
int func_11(int iParam0)//Position - 0x173F
{
...
void func_12(var uParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, var uParam5, var uParam6)//Position - 0x175E
{
	vector3 vVar0;
	var uVar3;
	struct<56> Var4;
...
int func_13(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x1BC9
{
	int iVar0;
	vector3 vVar1;
...
void func_14(var uParam0, var uParam1, float fParam2, bool bParam3, bool bParam4)//Position - 0x1CA4
{
	if (bParam4)
	{
		switch (uParam1->f_10)
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, float fParam8, bool bParam9)//Position - 0x1DAE
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
float func_16(vector3 vParam0, vector3 vParam3)//Position - 0x207D
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_17(vector3 vParam0, vector3 vParam3)//Position - 0x209E
{
	return ((vParam0.y * vParam3.z) - (vParam0.z * vParam3.y)), ((vParam0.z * vParam3.x) - (vParam0.x * vParam3.z)), ((vParam0.x * vParam3.y) - (vParam0.y * vParam3.x));
}

void func_18(var uParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6, float fParam7, bool bParam8)//Position - 0x20D7
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void func_19(var uParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, float fParam7)//Position - 0x21D6
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_20(var uParam0, vector3 vParam1)//Position - 0x227E
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
...
Vector3 func_21(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9, int iParam10, float fParam11, bool bParam12)//Position - 0x2355
{
	int iVar0;
	vector3 vVar1;
...
int func_22(vector3 vParam0, var uParam3, float fParam4, bool bParam5, bool bParam6)//Position - 0x2458
{
	switch (uParam3->f_10)
	{
		case 0:
...
int func_23(vector3 vParam0, int iParam3, vector3 vParam4, vector3 vParam7, float fParam10)//Position - 0x25B9
{
	switch (iParam3)
	{
		case 0:
...
int func_24(int iParam0, bool bParam1)//Position - 0x2626
{
	int iVar0;
...
int func_25(int iParam0)//Position - 0x26B4
{
	switch (iParam0)
	{
		case 0:
...
int func_26(int iParam0, bool bParam1, bool bParam2)//Position - 0x2A44
{
	int iVar0;
...
int func_27()//Position - 0x2A8E
{
	return -1;
}

int func_28(vector3 vParam0, var uParam3, int iParam4, int iParam5, bool bParam6)//Position - 0x2A97
{
...
int func_29(vector3 vParam0, var uParam3, int iParam4, bool bParam5)//Position - 0x2AF3
{
	float fVar0;
	var uVar1;
	var uVar8;
...
int func_30(var uParam0, bool bParam1)//Position - 0x2B78
{
	int iVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_31(vector3 vParam0, var uParam3)//Position - 0x2C85
{
	return OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, *uParam3, uParam3->f_3, uParam3->f_6, 0, 1);
}

int func_32(struct<2> Param0, var uParam2)//Position - 0x2CA5
{
...
int func_33(vector3 vParam0, float fParam3)//Position - 0x2D40
{
	int iVar0;
...
int func_34(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7, float fParam8)//Position - 0x2FD5
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_35(vector3 vParam0, float fParam3, int iParam4, var uParam5, var uParam6, var uParam7, float fParam8)//Position - 0x3028
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_36(int iParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5)//Position - 0x30F4
{
	int iVar0;
...
void func_37(int iParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5)//Position - 0x31B3
{
	int iVar0;
...
void func_38(int iParam0, var uParam1)//Position - 0x33BF
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0)//Position - 0x3440
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x346F
{
	int iVar0;
...
float func_41(int iParam0, float fParam1)//Position - 0x3481
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_42(int iParam0, bool bParam1)//Position - 0x3501
{
	if (bParam1)
	{
		if (func_43(iParam0))
...
bool func_43(int iParam0)//Position - 0x352D
{
	return func_44(iParam0);
}

bool func_44(int iParam0)//Position - 0x353B
{
	return MISC::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_13.f_1, 0);
}

int func_45(vector3 vParam0, var uParam3, var uParam4, var uParam5, bool bParam6, bool bParam7)//Position - 0x3555
{
	int iVar0;
	bool bVar1;
...
int func_46(vector3 vParam0, float fParam3)//Position - 0x3611
{
	int iVar0;
...
int func_47(var uParam0, bool bParam1, bool bParam2)//Position - 0x364C
{
	int iVar0;
	var uVar1;
	vector3 vVar2;
...
int func_48(vector3 vParam0)//Position - 0x36D0
{
	float fVar0;
...
int func_49(vector3 vParam0, var uParam3)//Position - 0x3709
{
	int iVar0;
	int iVar1;
...
bool func_51()//Position - 0x37A0
{
	return Global_1671295.f_163;
}

int func_52(vector3 vParam0)//Position - 0x37AE
{
	int iVar0;
	vector3 vVar1;
...
Vector3 func_53(var uParam0)//Position - 0x386E
{
	switch (uParam0->f_10)
	{
		case 0:
...
int func_54(vector3 vParam0, float fParam3)//Position - 0x38B7
{
	int iVar0;
...
int func_55(vector3 vParam0, float fParam3)//Position - 0x38FF
{
	int iVar0;
...
bool func_56(int iParam0, bool bParam1)//Position - 0x3946
{
	if (Global_1312448 != 0)
	{
...
int func_57(int iParam0)//Position - 0x396C
{
...
int func_58(vector3 vParam0, var uParam3)//Position - 0x398E
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_59(vector3 vParam0, vector3 vParam3, vector3 vParam6, bool bParam9, bool bParam10)//Position - 0x3A08
{
...
void func_60(var uParam0, var uParam1)//Position - 0x3AB3
{
	var uVar0;
...
int func_61(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x3B15
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_62(float fParam0)//Position - 0x3BC0
{
	if (fParam0 > 50f)
	{
		return 1;
...
int func_63(var uParam0, var uParam1, var uParam2, bool bParam3)//Position - 0x3BD8
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
...
void func_64(vector3 vParam0)//Position - 0x41A1
{
	int iVar0;
...
void func_65(var uParam0, var uParam1, var uParam2)//Position - 0x41F1
{
...
void func_66(var uParam0, vector3 vParam1, vector3 vParam4)//Position - 0x4256
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_67(var uParam0, vector3 vParam1)//Position - 0x42F5
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_68(var uParam0)//Position - 0x4377
{
	int iVar0;
	float fVar1;
	struct<10> Var2;
...
void func_69(var uParam0, float fParam1)//Position - 0x43E4
{
	int iVar0;
	float fVar1;
	struct<10> Var2;
...
void func_71(vector3 vParam0, float fParam3, var uParam4, var uParam5, bool bParam6, int iParam7)//Position - 0x449E
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	else
	{
		...
		if (iVar16 > -1)
		{
			func_104(vParam0, &vVar17, &vVar20, &fVar23);
			if (!func_99(&(Global_2405071.f_45[iVar16 /*12*/]), vVar17, vVar20, fVar23))
			{
				iVar8 = -1;
			}
		}
...
float func_72(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)//Position - 0x4E5B
{
	float fVar0;
...
float func_73(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x4EF9
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_74(int iParam0)//Position - 0x5090
{
...
void func_75(struct<10> Param0, int iParam10)//Position - 0x50BB
{
	struct<10> Var0;
...
void func_76(struct<10> Param0)//Position - 0x510D
{
	int iVar0;
	struct<10> Var1;
	int iVar11;
...
float func_77(vector3 vParam0, bool bParam3, bool bParam4, int iParam5, bool bParam6, int iParam7)//Position - 0x5201
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_78(int iParam0)//Position - 0x5364
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_79(int iParam0)//Position - 0x5377
{
	if (func_26(iParam0, 0, 1))
	{
		if (!func_86(iParam0))
...
int func_80(int iParam0)//Position - 0x5422
{
...
int func_81(int iParam0, int iParam1)//Position - 0x5469
{
	int iVar0;
...
int func_82(int iParam0)//Position - 0x5494
{
	if (iParam0 != func_27())
	{
...
struct<13> func_83(int iParam0)//Position - 0x54B7
{
	struct<13> Var0;
...
int func_84(int iParam0, int iParam1)//Position - 0x54CE
{
...
int func_85(int iParam0, int iParam1, int iParam2)//Position - 0x553B
{
	if (iParam2 == 1)
	{
		if (iParam0 == iParam1)
...
int func_86(int iParam0)//Position - 0x5706
{
...
bool func_87()//Position - 0x5748
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

float func_88(vector3 vParam0)//Position - 0x5759
{
	var uVar0;
...
float func_89(vector3 vParam0, var uParam3, var uParam4)//Position - 0x5771
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_90(vector3 vParam0, vector3 vParam3, bool bParam6, bool bParam7, bool bParam8, int iParam9, var uParam10)//Position - 0x58ED
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_91(vector3 vParam0, var uParam3, var uParam4)//Position - 0x5AD4
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
float func_92(vector3 vParam0, int iParam3, int iParam4)//Position - 0x5B2D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
float func_93(vector3 vParam0)//Position - 0x5BD9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_94(int iParam0)//Position - 0x5CF7
{
	int iVar0;
	int iVar1;
...
int func_98(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, float fParam7, float fParam8, float fParam9)//Position - 0x5EB0
{
	float fVar0;
...
int func_99(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x5F3F
{
	switch (uParam0->f_10)
	{
		case 0:
			if (func_103(*uParam0, uParam0->f_6, vParam1, vParam4, fParam7))
			{
				return 1;
			}
			break;
		...
		case 1:
			if (func_102(*uParam0, uParam0->f_3, vParam1, vParam4, fParam7))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (func_100(*uParam0, uParam0->f_3, uParam0->f_6, vParam1, vParam4, fParam7))
			{
				return 1;
			}
			break;
...
int func_100(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, vector3 vParam10, float fParam13)//Position - 0x5FCB
{
	vector3 vVar0[8];
	int iVar25;
...
void func_101(vector3 vParam0, vector3 vParam3, float fParam6, var uParam7)//Position - 0x601D
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_102(vector3 vParam0, vector3 vParam3, vector3 vParam6, vector3 vParam9, float fParam12)//Position - 0x614A
{
	vector3 vVar0[8];
	int iVar25;
...
int func_103(vector3 vParam0, float fParam3, vector3 vParam4, vector3 vParam7, float fParam10)//Position - 0x6214
{
	vector3 vVar0[4];
	int iVar13;
...
void func_104(vector3 vParam0, var uParam3, var uParam4, var uParam5)//Position - 0x6298
{
	int iVar0;
	vector3 vVar1;
	int iVar4;
...
int func_105(vector3 vParam0)//Position - 0x6386
{
	int iVar0;
	int iVar1;
...
int func_106(vector3 vParam0)//Position - 0x63F1
{
...
int func_107(vector3 vParam0, var uParam3, var uParam4, float fParam5)//Position - 0x6483
{
	float fVar0;
	int iVar1;
	vector3 vVar2;
...
int func_108(var uParam0, var uParam1, bool bParam2, float fParam3)//Position - 0x6531
{
	int iVar0;
	vector3 vVar1;
...
int func_109(int iParam0)//Position - 0x65A4
{
...
bool func_110(int iParam0)//Position - 0x65DA
{
	return Global_1589819[iParam0 /*818*/].f_196 != 0;
}

int func_111(int iParam0)//Position - 0x65EF
{
...
int func_112(vector3 vParam0, float fParam3, int iParam4)//Position - 0x6613
{
	int iVar0;
...
int func_113(var uParam0, bool bParam1)//Position - 0x6651
{
	var uVar0;
	vector3 vVar1;
	float fVar4;
...
int func_114(vector3 vParam0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)//Position - 0x66E9
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iParam4 && !bParam7)
	{
		if (func_26(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_115(PLAYER::PLAYER_ID()), vParam0, 1) <= (fVar2 + fParam3))
				{
					if (CAM::IS_SPHERE_VISIBLE(vParam0, fParam3))
					{
						return 1;
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_74(iVar1) || !bParam10) && !Global_2424047[iVar1 /*416*/].f_259)
					{
						...
						if (!bParam7)
						{
							if ((iParam5 || (iParam5 == 0 && PLAYER::GET_PLAYER_TEAM(iVar1) != PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()))) || PLAYER::GET_PLAYER_TEAM(iVar1) == -1)
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_115(iVar1), vParam0, 1) <= (fVar2 + fParam3))
								{
									if (NETWORK::IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, vParam0, fParam3))
									{
										return 1;
...
Vector3 func_115(int iParam0)//Position - 0x68A1
{
	int iVar0;
...
var func_116()//Position - 0x68F4
{
	return Global_2448756.f_16;
}

int func_117(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6902
{
...
int func_118(vector3 vParam0, int iParam3, int iParam4)//Position - 0x6933
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_119(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6)//Position - 0x69F5
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_120(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, float fParam8, float fParam9, float fParam10, float fParam11, float fParam12, float fParam13, bool bParam14, bool bParam15)//Position - 0x6B12
{
	...
	if (!func_117(vParam0, 0.5f, PLAYER::PLAYER_ID(), 0, 0))
	{
		...
		else if (!bParam4)
		{
			if (func_171(vParam0, 3.65f, 0.5f, 1.5f, 1f, 0, bParam6, iParam7, fParam8, bParam15, -1, 1, 0, 0, fParam13, bParam14, 0))
			{
				...
				{
					Global_2405071.f_3++;
					if (!func_121(vParam0, fParam3, fParam9, fParam10, 1084227584))
					{
						Global_2405071.f_3++;
						if (!func_33(vParam0, 1056964608))
						{
		...
		else if (func_171(vParam0, 6f, 5f, 5f, 5f, 0, bParam6, iParam7, fParam8, bParam15, -1, 1, 0, 0, fParam13, bParam14, 0))
		{
			...
			{
				Global_2405071.f_3++;
				if (!func_121(vParam0, fParam3, fParam9, fParam10, fParam11))
				{
					Global_2405071.f_3++;
					if (!func_33(vParam0, 1056964608))
					{
...
int func_121(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x6D52
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if (!PLAYER::PLAYER_ID() == iVar1)
		{
			if ((func_26(iVar1, 1, 1) && func_74(iVar1)) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
			{
				...
				{
					if (func_122(func_78(iVar1), vParam0, fParam3, fParam4, fParam5, fParam6))
					{
						return 1;
					}
				}
...
bool func_122(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8, float fParam9)//Position - 0x6DD1
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6E5D
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
int func_124(vector3 vParam0, float fParam3)//Position - 0x6ED5
{
	int iVar0;
	int iVar1;
...
int func_125(int iParam0)//Position - 0x6F91
{
...
int func_126(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, int iParam9)//Position - 0x6FD4
{
	int iVar0;
	int iVar1;
				...
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam7 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_74(iVar1)))
					{
						if ((!bParam6 || (bParam6 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_78(iVar1), vParam0, 1) < fParam3)
								{
									return 1;
								}
							}
...
int func_127(vector3 vParam0, float fParam3, int iParam4, float fParam5)//Position - 0x70D0
{
	int iVar0;
	int iVar1;
	float fVar2;
		...
		while (iVar0 < 32)
		{
			...
			if (func_26(iVar1, 1, 1))
			{
				if ((!func_140(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1)) && iVar1 != PLAYER::PLAYER_ID())
				{
					...
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_78(iVar1), vParam0, 1) <= (fVar2 + fParam3))
						{
							if (NETWORK::IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, vParam0, fParam3))
							{
								return 1;
...
int func_128(int iParam0)//Position - 0x7195
{
...
int func_129(int iParam0)//Position - 0x71D1
{
	if (!func_26(iParam0, 0, 1))
	{
		return 0;
...
int func_130(int iParam0, int iParam1)//Position - 0x71F4
{
...
int func_131(int iParam0)//Position - 0x722F
{
	int iVar0;
...
void func_132(vector3 vParam0, var uParam3, var uParam4)//Position - 0x7250
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_133(var uParam0, var uParam1, int iParam2)//Position - 0x7573
{
...
void func_134(var uParam0, var uParam1, int iParam2)//Position - 0x75B1
{
...
void func_135(var uParam0, var uParam1)//Position - 0x75EB
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
int func_136(vector3 vParam0, var uParam3)//Position - 0x76D8
{
	switch (uParam3->f_7)
	{
		case 0:
...
void func_137(vector3 vParam0, vector3 vParam3, var uParam6, var uParam7, var uParam8)//Position - 0x7735
{
	float fVar0;
...
var func_138()//Position - 0x778B
{
	return Global_1310987.f_4;
}

void func_139(var uParam0, var uParam1)//Position - 0x7799
{
	func_178();
	func_170(uParam0, uParam1);
}

bool func_140(int iParam0, int iParam1)//Position - 0x77AD
{
	bool bVar0;
...
int func_141(int iParam0, bool bParam1)//Position - 0x77F8
{
	int iVar0;
	int iVar1;
...
int func_142()//Position - 0x7839
{
	return Global_1312745;
}

bool func_143(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7, bool bParam8)//Position - 0x7845
{
	if (bParam7 && bParam8)
	{
		vParam0.z = 0f;
...
void func_144(var uParam0, var uParam1, var uParam2)//Position - 0x78F8
{
	int iVar0;
...
int func_145(var uParam0, var uParam1, var uParam2)//Position - 0x7967
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
void func_146(var uParam0, var uParam1, var uParam2, vector3 vParam3)//Position - 0x8393
{
	float fVar0;
	float fVar1;
	int iVar2;
...
void func_147(int iParam0, vector3 vParam1, int iParam4, var uParam5, float fParam6, var uParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, bool bParam13)//Position - 0x8417
{
	int iVar0;
...
void func_148(int iParam0, var uParam1)//Position - 0x849B
{
...
void func_149(int iParam0)//Position - 0x84F6
{
	while (iParam0 < 39)
	{
		if (iParam0 < 39)
...
void func_150(vector3 vParam0, float fParam3, int iParam4)//Position - 0x8541
{
	vector3 vVar0;
	var uVar3;
...
int func_151(vector3 vParam0, float fParam3, float fParam4)//Position - 0x85AE
{
	int iVar0;
	vector3 vVar1;
	int iVar4;
...
int func_152(vector3 vParam0, float fParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10)//Position - 0x8616
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_153(vector3 vParam0, float fParam3, int iParam4, vector3 vParam5, float fParam8, int iParam9, bool bParam10)//Position - 0x8789
{
	int iVar0;
	vector3 vVar1[4];
	vector3 vVar14;
...
int func_154(vector3 vParam0, float fParam3, int iParam4)//Position - 0x8943
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_155(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x8A4F
{
...
int func_156(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8A85
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_157(vector3 vParam0, int iParam3, vector3 vParam4, int iParam7)//Position - 0x8B5F
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_158(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8B9F
{
	int iVar0;
	int iVar1;
...
int func_159(vector3 vParam0, var uParam3)//Position - 0x8CAE
{
	if (uParam3->f_18)
	{
		switch (uParam3->f_26)
...
Vector3 func_160(vector3 vParam0, float fParam3, int iParam4, bool bParam5, vector3 vParam6, int iParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15)//Position - 0x8D3F
{
	vector3 vVar0;
	var uVar3;
	var uVar4;
	...
	if (bParam15)
	{
		...
		{
			if (!func_163(vParam0, *fParam3, vParam6))
			{
...
float func_161(int iParam0, float fParam1)//Position - 0x9186
{
	float fVar0;
	float fVar3;
	float fVar6;
...
int func_162(vector3 vParam0)//Position - 0x91BD
{
	float fVar0;
...
int func_163(vector3 vParam0, float fParam3, vector3 vParam4)//Position - 0x91F5
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_164(vector3 vParam0)//Position - 0x9231
{
	int iVar0;
	int iVar1;
...
bool func_165(var uParam0, bool bParam1)//Position - 0x92AC
{
	bool bVar0;
...
int func_166(var uParam0, var uParam1, var uParam2)//Position - 0x939E
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_167(vector3 vParam0)//Position - 0x99D6
{
	float fVar0;
	var uVar1;
	int iVar2;
...
int func_168(vector3 vParam0, float fParam3, float fParam4)//Position - 0x9A11
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_169(int iParam0)//Position - 0x9A73
{
	return iParam0 == 50;
}

void func_170(var uParam0, var uParam1)//Position - 0x9A80
{
...
int func_171(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, int iParam18)//Position - 0x9AB3
{
...
int func_179(bool bParam0)//Position - 0x9D02
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		return 10000;
...
int func_180(vector3 vParam0, float fParam3, var uParam4, var uParam5, var uParam6)//Position - 0x9D25
{
	struct<17> Var0;
	struct<18> Var34;
	vector3 vVar62;
...
int func_181(var uParam0)//Position - 0x9E25
{
	if (uParam0->f_1)
	{
...
void func_182(var uParam0)//Position - 0x9E4E
{
	if (!uParam0->f_1)
	{
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
...
void func_183(var uParam0, bool bParam1, bool bParam2)//Position - 0x9E6D
{
	if (uParam0->f_1 == 0)
	{
...
void func_185(int iParam0)//Position - 0x9F39
{
	int iVar0;
...
void func_188()//Position - 0x9FD0
{
	func_189(1188, -1);
}

void func_189(int iParam0, int iParam1)//Position - 0x9FE0
{
	int iVar0;
...
void func_190(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA021
{
	int iVar0;
...
void func_191(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA972
{
	int iVar0;
...
int func_192(int iParam0)//Position - 0xA9A2
{
	if (Global_1382575)
	{
		switch (iParam0)
...
int func_193(int iParam0, int iParam1, int iParam2)//Position - 0xAC00
{
	int iVar0;
	var uVar1;
...
int func_194(var uParam0)//Position - 0xAC32
{
	int iVar0;
	int iVar1;
...
void func_196(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14)//Position - 0xAD05
{
	Param0 = 111286607;
...
int func_197(int iParam0)//Position - 0xAD32
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_198(char* sParam0, int iParam1)//Position - 0xAD8F
{
	int iVar0;
...
void func_199(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)//Position - 0xADBB
{
	int iVar0;
...
int func_200(int iParam0)//Position - 0xAEC3
{
	int iVar0;
...
void func_201(int iParam0)//Position - 0xAF25
{
	int iVar0;
...
bool func_202()//Position - 0xAF5E
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

int func_203(int iParam0)//Position - 0xAF6F
{
	switch (iParam0)
	{
		case 1:
...
void func_204(var uParam0)//Position - 0xAFD2
{
	var uVar0;
...
int func_205(var uParam0)//Position - 0xB00B
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(uParam0))
	{
...
int func_209()//Position - 0xB119
{
	return Local_60;
}

int func_210()//Position - 0xB123
{
...
int func_211(int iParam0)//Position - 0xB145
{
	return vLocal_71[iParam0 /*3*/];
}

int func_212()//Position - 0xB153
{
	var uVar0;
...
int func_215()//Position - 0xB234
{
	return Global_25765;
}

bool func_216()//Position - 0xB23F
{
	return Global_2448756.f_586;
}

int func_217(int iParam0)//Position - 0xB24E
{
...
bool func_218()//Position - 0xB265
{
	return Global_2458613;
}

bool func_219()//Position - 0xB271
{
	return Global_2448756.f_581;
}

void func_220(var uParam0)//Position - 0xB280
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_221(int iParam0)//Position - 0xB2F3
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
int func_222(int iParam0, var uParam1)//Position - 0xB374
{
...
void func_223()//Position - 0xB3D3
{
	SYSTEM::WAIT(0);
}

int func_224(int iParam0)//Position - 0xB3E0
{
	return Global_1589819[iParam0 /*818*/];
}

void func_225()//Position - 0xB3F1
{
	Global_1382798 = -1;
	if (HUD::DOES_BLIP_EXIST(iLocal_170))
	{
...
void func_226()//Position - 0xB457
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_227()//Position - 0xB463
{
...
void func_229(int iParam0)//Position - 0xB4F8
{
	char* sVar0;
...
char* func_230(int iParam0, bool bParam1)//Position - 0xB50F
{
	switch (iParam0)
	{
		case 1:
...
int func_231(struct<21> Param0)//Position - 0xB5B2
{
...
int func_233(int iParam0, int iParam1, bool bParam2)//Position - 0xB6A3
{
	int iVar0;
...
bool func_234()//Position - 0xB7B8
{
	return Global_1312844;
}

void func_235(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0xB7C4
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_226();
...
int func_236(int iParam0)//Position - 0xB7E3
{
	switch (iParam0)
	{
		case 3:
