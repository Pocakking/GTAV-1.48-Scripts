...
void func_10(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7A7
{
	var uVar0;
	int iVar1;
...
void func_18(int iParam0, struct<2> Param1, float fParam3)//Position - 0x9D9
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_19(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0xA38
{
	bool bVar0;
	float fVar1;
...
void func_26(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xC34
{
	if (bParam0)
	{
...
bool func_27()//Position - 0xD6D
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_28(int iParam0, int iParam1)//Position - 0xD8A
{
	bool bVar0;
...
int func_29(int iParam0, bool bParam1)//Position - 0xDD5
{
	int iVar0;
	int iVar1;
...
int func_30()//Position - 0xE16
{
	return Global_1312745;
}

int func_31(int iParam0)//Position - 0xE22
{
...
bool func_32()//Position - 0xE64
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_33(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xE75
{
	int iVar0;
...
void func_34(int iParam0)//Position - 0xEA8
{
	if (iParam0 == 1)
	{
...
void func_35(int iParam0)//Position - 0xECB
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iParam0)
...
void func_37(int iParam0, bool bParam1)//Position - 0x10DC
{
	if (bParam1)
	{
		func_39(iParam0);
...
void func_38(int iParam0, bool bParam1)//Position - 0x10F9
{
...
void func_39(int iParam0)//Position - 0x1134
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
char* func_40()//Position - 0x115F
{
	return "special_ped@maude@base";
}

void func_41(int iParam0, bool bParam1)//Position - 0x116A
{
	if (bParam1)
	{
		func_43(iParam0);
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1189
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_43(int iParam0)//Position - 0x11D9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
float func_45()//Position - 0x1227
{
	return -92.17f;
}

Vector3 func_46()//Position - 0x1234
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_47()//Position - 0x124B
{
	return -380698483;
}

void func_48()//Position - 0x1258
{
	int iVar0;
	int iVar1;
	...
	if (func_22(Local_322))
	{
		if (func_428(Local_330))
		{
			if (func_57(2))
			{
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_322, iVar0, func_40(), func_50(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_330, iVar0, func_49(), func_40(), 1000f, -8f, iVar1, 1148846080);
				...
				BRAIN::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_322, 0);
				BRAIN::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_322, 0);
...
char* func_49()//Position - 0x1344
{
	return "base_chair";
}

char* func_50()//Position - 0x134F
{
	return "base";
}

Vector3 func_51()//Position - 0x135A
{
	return 0f, 0f, -92.17f;
}

Vector3 func_52()//Position - 0x1369
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_53(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x1380
{
...
void func_54(int iParam0, bool bParam1)//Position - 0x1402
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_55(int iParam0)//Position - 0x142D
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_56(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x1453
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_55(iParam1))
...
int func_57(int iParam0)//Position - 0x14BE
{
	switch (iParam0)
	{
		case 0:
...
bool func_58(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x1562
{
	return SYSTEM::VDIST2(vParam0, vParam3) <= (fParam6 * fParam6);
}

int func_59(int iParam0, float fParam1, int iParam2)//Position - 0x157C
{
	int iVar0;
...
int func_63(int iParam0, int iParam1)//Position - 0x16E6
{
	if (func_22(iParam0))
	{
...
int func_64(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x1719
{
...
void func_65(int iParam0)//Position - 0x18A8
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_67(char* sParam0)//Position - 0x1916
{
	func_26(1, 1, 0, 0, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x1930
{
	if (func_515() && func_70())
	{
...
void func_69(int iParam0)//Position - 0x19F4
{
	if (iParam0 == 1)
	{
...
bool func_70()//Position - 0x1A1D
{
	return MISC::IS_BIT_SET(Global_93682.f_20, 13);
}

void func_71()//Position - 0x1A31
{
	char* sVar0;
	int iVar1;
					...
					else if (func_22(Local_322))
					{
						if (!func_63(Local_322, 1805844857))
						{
							if (!PED::IS_PED_FLEEING(Local_322))
							{
								...
								{
									func_72(&Local_322);
									BRAIN::TASK_SMART_FLEE_PED(Local_322, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(Local_322, 1);
								}
							}
						}
...
void func_72(int iParam0)//Position - 0x1CDC
{
	if (func_22(*iParam0))
	{
...
char* func_73()//Position - 0x1D45
{
	return "female_Flee_Table_Left_Maude";
}

int func_74(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D51
{
	if (iParam4 == 0)
	{
...
bool func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D8E
{
...
int func_76(char* sParam0, int iParam1, bool bParam2)//Position - 0x1DDC
{
	Global_15867 = 0;
...
int func_81()//Position - 0x22A9
{
	func_82();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_82()//Position - 0x22C2
{
	int iVar0;
...
bool func_83(int iParam0)//Position - 0x23BF
{
	return iParam0 < 3;
}

int func_84(int iParam0)//Position - 0x23CB
{
	int iVar0;
	int iVar1;
...
int func_85(int iParam0)//Position - 0x2408
{
	if (func_83(iParam0))
	{
...
bool func_86(int iParam0)//Position - 0x2432
{
	return Global_36425 == iParam0;
}

void func_87()//Position - 0x2440
{
	int iVar0;
...
bool func_88(int iParam0, int iParam1)//Position - 0x2497
{
	switch (iParam0)
	{
		case 5:
...
void func_89(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x24D2
{
...
void func_90(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2528
{
...
void func_91(bool bParam0)//Position - 0x25C3
{
	int iVar0;
...
void func_92(int iParam0, bool bParam1)//Position - 0x2796
{
	if (bParam1)
	{
		func_94(iParam0);
...
void func_93(int iParam0)//Position - 0x27B2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_94(int iParam0)//Position - 0x27EA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_95(int iParam0)//Position - 0x2886
{
	if (func_428(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_96(var uParam0)//Position - 0x28B0
{
...
void func_98(char* sParam0)//Position - 0x28F6
{
...
void func_99(int iParam0, bool bParam1)//Position - 0x2935
{
	if (func_22(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, 0);
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x29B0
{
	int iVar0;
...
char* func_101()//Position - 0x2AFC
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_102()//Position - 0x2B08
{
	return "special_ped@maude@exit_flee";
}

void func_103(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2B14
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_104(iParam3), 0);
}

int func_104(int iParam0)//Position - 0x2B2D
{
	int iVar0;
...
bool func_105(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2D22
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1) <= (fParam4 * fParam4);
}

void func_106(int iParam0, bool bParam1)//Position - 0x2D3F
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_107(var uParam0, int iParam1)//Position - 0x2DB0
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_109(int iParam0)//Position - 0x2DF1
{
	bool bVar0;
	struct<8> Var1;
...
void func_110(int iParam0)//Position - 0x2E63
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_111(int iParam0)//Position - 0x2E83
{
	int iVar0;
...
bool func_113(int iParam0, int iParam1)//Position - 0x2F6F
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_114(int iParam0)//Position - 0x2F81
{
	if (func_22(Local_132[iParam0 /*19*/]))
	{
		if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iParam0 /*19*/]) == iLocal_597)
		{
			...
			BRAIN::TASK_LOOK_AT_ENTITY(Local_132[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			if (!PED::IS_PED_FLEEING(Local_132[iParam0 /*19*/]))
			{
				...
				BRAIN::TASK_CLEAR_LOOK_AT(Local_132[iParam0 /*19*/]);
				BRAIN::CLEAR_PED_SECONDARY_TASK(Local_132[iParam0 /*19*/]);
				BRAIN::CLEAR_PED_TASKS(Local_132[iParam0 /*19*/]);
				BRAIN::TASK_HANDS_UP(Local_132[iParam0 /*19*/], -1, PLAYER::PLAYER_PED_ID(), -1, 0);
			}
...
void func_115(int iParam0)//Position - 0x30C4
{
	func_23(500, 1);
...
void func_116(int iParam0, int iParam1, int iParam2)//Position - 0x30F9
{
	bool bVar0;
...
int func_119()//Position - 0x36ED
{
	return Global_25765;
}

int func_120(int iParam0, int iParam1)//Position - 0x36F8
{
	int iVar0;
...
int func_121(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3749
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(int iParam0)//Position - 0x3CFF
{
	int iVar0;
	...
	switch (iLocal_100)
	{
		...
		case 2:
			...
			else
			{
				...
				if (func_22(Local_322))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(Local_322, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					PED::SET_PED_KEEP_TASK(Local_322, 1);
				}
...
void func_124(int iParam0)//Position - 0x403A
{
	iLocal_98 = iParam0;
	iLocal_100 = 0;
}

void func_125(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x4049
{
	vector3 vVar0;
	var uVar3;
...
void func_126(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x40C4
{
	struct<60> Var0;
...
void func_127(int iParam0, int iParam1, int iParam2)//Position - 0x41ED
{
	int iVar0;
...
void func_128(int iParam0, int iParam1)//Position - 0x430A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0x450C
{
...
int func_130(int iParam0)//Position - 0x45E9
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_131(int iParam0, bool bParam1)//Position - 0x479A
{
	int iVar0;
	struct<2> Var1;
...
int func_132(int iParam0)//Position - 0x491A
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_134(int iParam0)//Position - 0x49FD
{
	int iVar0;
	int iVar1;
...
int func_135()//Position - 0x6A6A
{
	return 0;
}

int func_136()//Position - 0x6A73
{
	return 1;
}

int func_137()//Position - 0x6A7C
{
	return 1;
}

int func_138()//Position - 0x6A85
{
...
int func_140(int iParam0)//Position - 0x6B59
{
	int iVar0;
	char* sVar1;
...
int func_141(int iParam0)//Position - 0x6B9F
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0x6BDA
{
	int iVar0;
...
int func_143(int iParam0)//Position - 0x6C56
{
	int iVar0;
...
int func_144(int iParam0, int iParam1, bool bParam2)//Position - 0x6D3E
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_145(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x6DAF
{
...
void func_147(var uParam0, int iParam1)//Position - 0x6ECD
{
	if (iParam1 <= 0)
	{
		return;
...
void func_148(var uParam0, int iParam1)//Position - 0x6F53
{
...
void func_149(var uParam0, int iParam1)//Position - 0x6F86
{
	int iVar0;
	int iVar1;
...
int func_150(int iParam0, int iParam1)//Position - 0x6FD7
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_151(int iParam0)//Position - 0x7079
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_152(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_152(bool bParam0, int iParam1, int iParam2)//Position - 0x709E
{
	if (bParam0)
	{
		return iParam1;
...
int func_153(var uParam0)//Position - 0x70B5
{
	return uParam0 & 15;
}

void func_154(var uParam0, int iParam1)//Position - 0x70C2
{
...
void func_155(var uParam0, int iParam1)//Position - 0x70FC
{
...
void func_156(var uParam0, int iParam1)//Position - 0x7137
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_157(var uParam0, int iParam1)//Position - 0x7173
{
	int iVar0;
	int iVar1;
...
int func_158(int iParam0, int iParam1)//Position - 0x886F
{
	struct<82> Var0;
...
void func_159(int iParam0, var uParam1, int iParam2)//Position - 0x88B1
{
	int iVar0;
...
void func_160(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x8B0D
{
	if (func_157(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_161(int iParam0, bool bParam1)//Position - 0x8C0C
{
	if (iParam0 == -1)
	{
		return;
...
void func_162(int iParam0, int iParam1, bool bParam2)//Position - 0x8C69
{
	if (iParam0 == -1)
	{
		return;
...
bool func_163(int iParam0, int iParam1)//Position - 0x8CA4
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_164(var uParam0, var uParam1)//Position - 0x8CC7
{
...
void func_165(int iParam0)//Position - 0x8D93
{
	if (iParam0 == -1)
	{
		return;
...
int func_166(int iParam0)//Position - 0x8E0D
{
	int iVar0;
...
bool func_167(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x8E70
{
	if (bParam6)
	{
...
void func_168(int iParam0, var uParam1)//Position - 0x8EB7
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0x9162
{
	switch (iParam0)
	{
		case 1:
...
int func_170(int iParam0, var uParam1, var uParam2)//Position - 0x9212
{
	int iVar0;
	int iVar1;
...
int func_171(int iParam0)//Position - 0x9405
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_172(var uParam0)//Position - 0x9425
{
	int iVar0;
...
void func_173(int iParam0)//Position - 0x94D5
{
...
int func_174(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x94FC
{
	int iVar0;
...
int func_175(vector3 vParam0, int iParam3, int iParam4)//Position - 0x9612
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_176(int iParam0)//Position - 0x96A1
{
	return MISC::IS_BIT_SET(Global_106565.f_7223[iParam0], 0);
}

int func_177(int iParam0)//Position - 0x96B9
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_178(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x96D5
{
	func_179(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_179(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x96FE
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_180(vector3 vParam0)//Position - 0x9AF2
{
...
int func_181(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x9B1C
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_182(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x9E12
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_183(vector3 vParam0)//Position - 0x9EC6
{
	float fVar0;
	float fVar1;
...
void func_184(int iParam0)//Position - 0x9F05
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
bool func_185(vector3 vParam0, int iParam3)//Position - 0x9F6A
{
	return func_186(Global_97130.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_186(int iParam0, vector3 vParam1, int iParam4)//Position - 0x9F87
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_187()//Position - 0x9FF1
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_188()//Position - 0xA008
{
	return 3.01f, 11.01f, 6.01f;
}

int func_189(var uParam0, var uParam1, var uParam2)//Position - 0xA01F
{
...
void func_190(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0xA056
{
	int iVar0;
...
Vector3 func_191(int iParam0)//Position - 0xA214
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_192(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA227
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_193(int iParam0, int iParam1, int iParam2)//Position - 0xAA3D
{
	int iVar0;
...
int func_194(int iParam0)//Position - 0xAAC9
{
	switch (iParam0)
	{
...
void func_195(int iParam0, int iParam1, int iParam2)//Position - 0xAB04
{
	int iVar0;
	int iVar1;
...
int func_196(int iParam0, int iParam1, int iParam2)//Position - 0xAB8E
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_197(int iParam0, int iParam1, int iParam2)//Position - 0xAC6C
{
	Global_71402[1 /*14*/] = { func_242(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}

int func_198(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xAC97
{
	var uVar0;
	int iVar10;
...
int func_199(int iParam0, int iParam1, int iParam2)//Position - 0xB29B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB334
{
	int iVar0;
...
int func_201(int iParam0, int iParam1, int iParam2)//Position - 0xB3CA
{
	int iVar0;
	int iVar1;
...
int func_202(int iParam0)//Position - 0xB46B
{
	switch (iParam0)
	{
		case 0:
...
int func_203(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB51B
{
	int iVar0;
...
int func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB822
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_205(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xC3D7
{
	int iVar0;
...
int func_206(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC6BB
{
	int iVar0;
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC982
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC9B9
{
	int iVar0;
...
int func_209(int iParam0, int iParam1, int iParam2)//Position - 0xC9E2
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCCAC
{
	int iVar0;
...
int func_211(int iParam0, int iParam1, int iParam2)//Position - 0xCF36
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_212(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD08D
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD125
{
	switch (iParam0)
	{
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD1F3
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_215(int iParam0, int iParam1)//Position - 0xD34F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_216(int iParam0)//Position - 0xD6F6
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD757
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_218(int iParam0, int iParam1)//Position - 0xD853
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD991
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_220(int iParam0)//Position - 0xDA71
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_221(int iParam0, int iParam1)//Position - 0xDAF7
{
	int iVar0;
	struct<10> Var1;
...
void func_222(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE426
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_223(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xE550
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_224(int iParam0, int iParam1)//Position - 0xE598
{
	int iVar0;
	struct<17> Var1;
...
void func_225(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1042C
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_226(int iParam0)//Position - 0x10616
{
	switch (iParam0)
	{
		case 0:
...
void func_227(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x106C6
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10737
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_229(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x109B4
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_230(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10DD9
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_231(int iParam0, int iParam1)//Position - 0x110CC
{
	int iVar0;
	int iVar1;
...
int func_232(int iParam0, int iParam1)//Position - 0x11112
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_233(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11172
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_234(int iParam0)//Position - 0x111F6
{
...
void func_235(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x112AE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_236(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x112F8
{
	int iVar0;
...
int func_237(var uParam0)//Position - 0x11328
{
	int iVar0;
	int iVar1;
...
int func_238(int iParam0, int iParam1, int iParam2)//Position - 0x1135C
{
	int iVar0;
	var uVar1;
...
bool func_239(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x1138E
{
	int iVar0;
...
int func_240(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1315F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_241(int iParam0)//Position - 0x1407F
{
	if (!MISC::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_242(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x140D0
{
	func_305();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_243(int iParam0, int iParam1)//Position - 0x14122
{
	switch (iParam0)
	{
		case 0:
...
void func_244(int iParam0)//Position - 0x14212
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_245(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x15489
{
	int iVar0;
	int iVar1;
...
bool func_246(int iParam0, int iParam1, var uParam2)//Position - 0x1581A
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_247(int iParam0, int iParam1)//Position - 0x15C1F
{
	switch (iParam1)
	{
		case 0:
...
int func_248(int iParam0, int iParam1)//Position - 0x1601A
{
	switch (iParam1)
	{
		case 0:
...
int func_249(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x16415
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_250(int iParam0)//Position - 0x16457
{
	switch (iParam0)
	{
		case -1:
...
void func_251(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1652B
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_252(int iParam0)//Position - 0x16804
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_253(int iParam0)//Position - 0x1695B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_254(int iParam0)//Position - 0x16E69
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(int iParam0)//Position - 0x16EDE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_256(int iParam0)//Position - 0x16F52
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_257(int iParam0)//Position - 0x17039
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_258(int iParam0)//Position - 0x1739C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_259(int iParam0)//Position - 0x175AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0)//Position - 0x177DD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_261(int iParam0)//Position - 0x178ED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x1828D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x18E00
{
	if (iParam0 < 136)
	{
		func_265(iParam0);
...
void func_264(int iParam0)//Position - 0x18E35
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x19A39
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x1A947
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x1AA74
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0, int iParam1)//Position - 0x1AB72
{
	switch (iParam0)
	{
		case 0:
...
void func_269(int iParam0)//Position - 0x1AC62
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x1C154
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x1C2A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1C7B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1CE1E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1CE92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1CF62
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1D492
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1D629
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1DE27
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1DF37
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1EE62
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1FB1F
{
	if (iParam0 < 107)
	{
		func_284(iParam0);
...
void func_282(int iParam0)//Position - 0x1FB65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x2060C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x213FB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x22044
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x222BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0, int iParam1)//Position - 0x22403
{
	switch (iParam0)
	{
		case 0:
...
void func_288(int iParam0)//Position - 0x224F3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x2327D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x233F7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x2396E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x23E98
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x23F0C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x23FDC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x244B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x2471F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x249F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x24BBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x25712
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x2635C
{
	if (iParam0 < 60)
	{
		func_302(iParam0);
...
void func_301(int iParam0)//Position - 0x26391
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x27131
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x277BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x278A4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305()//Position - 0x279A2
{
...
int func_306(int iParam0, int iParam1, int iParam2)//Position - 0x27A1B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_307(bool bParam0)//Position - 0x27C76
{
	int iVar0;
...
void func_308()//Position - 0x27CB4
{
	bool bVar0;
	vector3 vVar1;
				...
				if (!iLocal_382)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_113(iLocal_397, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_112.f_9, vLocal_619, 30f))
									{
...
int func_309(var uParam0)//Position - 0x28191
{
	vector3 vVar0;
...
int func_310(var uParam0)//Position - 0x281D6
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
bool func_311(char* sParam0, int iParam1, int iParam2)//Position - 0x2820E
{
...
void func_312(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x2822C
{
...
void func_313(char* sParam0, int iParam1, int iParam2)//Position - 0x282D8
{
	iParam2 = iParam2;
...
int func_314(char* sParam0, bool bParam1)//Position - 0x282F1
{
	struct<6> Var0;
...
struct<6> func_315()//Position - 0x2832C
{
	struct<6> Var0;
...
void func_316(int iParam0, vector3 vParam1, int iParam4, float fParam5)//Position - 0x28350
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_317(var uParam0, int iParam1, int iParam2)//Position - 0x28435
{
	char* sVar0;
...
int func_318(char* sParam0)//Position - 0x28512
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_319()//Position - 0x28525
{
	if (func_22(Local_112.f_9))
	{
...
int func_320(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x28620
{
	int iVar0;
...
int func_321(int iParam0, vector3 vParam1, float fParam4, float fParam5)//Position - 0x28796
{
...
int func_322(int iParam0, vector3 vParam1)//Position - 0x287CE
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
void func_323(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2882C
{
	func_324(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_324(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x28846
{
	func_325(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_325(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x28863
{
...
void func_326(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2889B
{
	int iVar0;
	int iVar1;
...
void func_327(var uParam0)//Position - 0x28C08
{
...
int func_328(var uParam0)//Position - 0x28C71
{
	int iVar0;
...
int func_329(bool bParam0)//Position - 0x28C9C
{
	switch (Global_36425)
	{
		case 0:
...
void func_330(char* sParam0, int iParam1)//Position - 0x28D46
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_331(char* sParam0)//Position - 0x28D5D
{
	if (!func_332(1, 1, 0))
	{
...
int func_332(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28DF6
{
	int iVar0;
	int iVar1;
...
int func_333(int iParam0)//Position - 0x2904F
{
	if (iParam0 != func_335())
	{
...
int func_334(int iParam0, bool bParam1, bool bParam2)//Position - 0x290B5
{
	int iVar0;
...
int func_335()//Position - 0x290FF
{
	return -1;
}

int func_336(int iParam0, int iParam1)//Position - 0x29108
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_337(int iParam0, int iParam1)//Position - 0x2916A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_338()//Position - 0x291EF
{
	return Global_2448756.f_16;
}

bool func_339(int iParam0)//Position - 0x291FD
{
	return iParam0 == 51;
}

var func_340()//Position - 0x2920A
{
	return Global_2448756.f_15;
}

bool func_341()//Position - 0x29218
{
	return MISC::GET_GAME_TIMER() <= Global_17411.f_5878 + 100;
}

void func_342(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x2922D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_343()//Position - 0x2933D
{
	return func_344(PLAYER::PLAYER_ID());
}

int func_344(int iParam0)//Position - 0x2934D
{
...
int func_345(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2936C
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_346(bool bParam0, bool bParam1, bool bParam2)//Position - 0x296D8
{
...
int func_347(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2972A
{
	if (!func_332(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_348(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29773
{
	if (!func_332(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_349(bool bParam0, bool bParam1, bool bParam2)//Position - 0x297D2
{
	if (!func_332(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_350(int iParam0)//Position - 0x29828
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_351()//Position - 0x29883
{
	MISC::SET_BIT(&Global_2424, 4);
}

void func_352(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29893
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_353(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2998E
{
	int iVar0;
	bool bVar1;
...
void func_354(int iParam0)//Position - 0x299E0
{
...
void func_355(var uParam0, vector3 vParam1)//Position - 0x29A26
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_356()//Position - 0x29B03
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (Local_112.f_10)
			{
				...
				case 30:
					if (!func_63(Local_112.f_9, 242628503))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&uLocal_418);
						BRAIN::TASK_GOTO_ENTITY_AIMING(0, PLAYER::PLAYER_PED_ID(), fVar3, 30f);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(uLocal_418);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_418);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
					}
					break;
				...
				case 31:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER::PLAYER_PED_ID(), 1f, 1, 0.5f, 4f, 1, 0, 0, -957453492, 20000);
						...
						BRAIN::TASK_SET_SPHERE_DEFENSIVE_AREA(0, vLocal_622, 50f);
						BRAIN::CLOSE_SEQUENCE_TASK(uLocal_418);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_418);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
				...
				case 33:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, -687903391, 20000);
				...
				case 35:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&uLocal_418);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 750, 0);
						BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.75f, 4f, 1, 0, 0, -687903391, 20000);
						BRAIN::CLOSE_SEQUENCE_TASK(uLocal_418);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_418);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
				...
				case 13:
					if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 5, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 17, 1);
						BRAIN::TASK_SMART_FLEE_PED(Local_112.f_9, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
						PED::SET_PED_KEEP_TASK(Local_112.f_9, 1);
						Local_112.f_10 = 14;
					}
					...
					if (func_95(Local_191[0 /*6*/]))
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[0 /*6*/], 0) && func_105(Local_191[0 /*6*/], Local_191[0 /*6*/].f_1, 3f)) && func_363(ENTITY::GET_ENTITY_HEADING(Local_191[0 /*6*/]), Local_191[0 /*6*/].f_4, 20f))
						{
							...
							else if (func_113(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								...
								BRAIN::TASK_ENTER_VEHICLE(Local_112.f_9, Local_191[0 /*6*/], 25000, -1, 2f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
								Local_112.f_10 = 16;
							}
						}
				...
				case 17:
					...
					{
						BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(Local_112.f_9, Local_191[0 /*6*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, 1);
...
bool func_357(int iParam0, int iParam1)//Position - 0x2AFAD
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_358()//Position - 0x2AFBF
{
	int iVar0;
	int iVar1;
...
var func_359()//Position - 0x2B045
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_360()//Position - 0x2B055
{
	if (!iLocal_355)
	{
		return 1;
...
int func_361(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2B0C2
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (func_22(iParam0))
	{
		...
		if (func_105(iParam0, vLocal_619, fParam2))
		{
...
int func_362(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2B278
{
	int iVar0;
...
int func_363(float fParam0, float fParam1, float fParam2)//Position - 0x2B36F
{
...
char* func_364()//Position - 0x2B38B
{
	return "move_m@bail_bond_not_tazered";
}

char* func_365()//Position - 0x2B397
{
	return "move_m@bail_bond_tazered";
}

int func_366()//Position - 0x2B3A3
{
...
void func_367(var uParam0, bool bParam1)//Position - 0x2B3D8
{
...
void func_368(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2B3EF
{
	if (func_428(iParam0))
	{
...
bool func_369(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2B41B
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_370(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2B4DC
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_371(int iParam0, int iParam1)//Position - 0x2B608
{
	int iVar0;
...
int func_373(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2B717
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_374(vector3 vParam0, vector3 vParam3)//Position - 0x2B7A8
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

int func_375(int iParam0, int iParam1)//Position - 0x2B7C9
{
	int iVar0;
...
void func_376(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2B808
{
	if (func_428(iParam0))
	{
...
void func_377()//Position - 0x2B834
{
...
bool func_378()//Position - 0x2B8BE
{
	return Global_91021;
}

void func_379()//Position - 0x2B8CA
{
	func_36();
	func_377();
	if (func_22(Local_112.f_9))
...
int func_380(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6)//Position - 0x2BBDE
{
	vector3 vVar0;
	var uVar3;
	char[] cVar168[8];
...
void func_381(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2BC6B
{
...
void func_382()//Position - 0x2BCA6
{
	int iVar0;
	int iVar1;
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_63(Local_112.f_9, -1519143300))
				{
					if (func_105(Local_112.f_9, vLocal_619, 25f))
					{
						...
						{
							if (func_113(iLocal_398, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_5();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_113(iLocal_397, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_112.f_9, vLocal_619, 20f))
							{
...
int func_383(int iParam0)//Position - 0x2C102
{
	int iVar0;
...
void func_384(char* sParam0, int iParam1)//Position - 0x2C13B
{
	if (func_318(sParam0))
	{
...
void func_385(int iParam0)//Position - 0x2C152
{
...
void func_386()//Position - 0x2C18D
{
	func_36();
	func_377();
	if (func_22(Local_112.f_9))
				...
				if (!iLocal_383)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_390))
						{
							if (iLocal_369)
							{
								iLocal_390 = func_389(vLocal_616, 5, 1);
							}
						}
						if (!iLocal_356)
						{
...
int func_387(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2C562
{
	int iVar0;
...
bool func_388(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2C653
{
	vector3 vVar0;
...
int func_389(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2C67D
{
	int iVar0;
...
void func_390()//Position - 0x2C6AB
{
	bool bVar0;
...
void func_391(bool bParam0, var uParam1)//Position - 0x2CACA
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_392(int iParam0)//Position - 0x2CBB7
{
	int iVar0;
...
void func_393(int iParam0)//Position - 0x2CC00
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (func_22(Local_132[iVar0 /*19*/]))
		{
			...
			switch (Local_132[iVar0 /*19*/].f_14)
			{
				...
				case 2:
					...
					{
						if (!func_22(Local_112.f_9) || (PED::IS_PED_FLEEING(Local_112.f_9) && BRAIN::GET_PED_DESIRED_MOVE_BLEND_RATIO(Local_112.f_9) > 1f))
						{
							if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_132[iVar0 /*19*/], -1519143300) == 1)
							{
								if (iVar0 == 0)
								{
									iVar2 = 750;
								...
								BRAIN::UPDATE_TASK_HANDS_UP_DURATION(Local_132[iVar0 /*19*/], iVar2);
							}
							else
							{
								BRAIN::CLEAR_PED_TASKS(Local_132[iVar0 /*19*/]);
								BRAIN::CLEAR_PED_SECONDARY_TASK(Local_132[iVar0 /*19*/]);
							}
							Local_132[iVar0 /*19*/].f_14 = 4;
							func_109(&(Local_132[iVar0 /*19*/].f_6));
						}
					...
					else if (!func_63(Local_132[iVar0 /*19*/], 780511057))
					{
						...
						if (func_105(Local_132[iVar0 /*19*/], vLocal_619, 5f))
						{
							if (!func_357(Local_132[iVar0 /*19*/].f_16, 10))
							{
								...
								BRAIN::TASK_COMBAT_PED(Local_132[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					...
					else
					{
						...
						{
							BRAIN::CLEAR_PED_TASKS(Local_132[iVar0 /*19*/]);
							BRAIN::TASK_LOOK_AT_ENTITY(Local_132[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_132[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), -1);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iVar0 /*19*/], 0);
						}
...
int func_394(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x2CF54
{
	if (iParam3 == 0)
	{
...
int func_395(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)//Position - 0x2D12B
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_396(int iParam0)//Position - 0x2D2C4
{
	int iVar0;
...
void func_397()//Position - 0x2D303
{
	if (func_22(Local_112.f_9))
	{
...
void func_398(bool bParam0)//Position - 0x2D7C7
{
...
void func_399()//Position - 0x2D7EB
{
	Global_14732 = 0;
	func_400();
}

void func_400()//Position - 0x2D7FB
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_401()//Position - 0x2D81F
{
	if (!iLocal_367)
	{
		if (!func_61())
...
struct<6> func_402()//Position - 0x2D944
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
int func_403(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2D9F0
{
	if (iParam5 == 0)
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
...
bool func_404(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2DA2D
{
...
int func_405(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2DA81
{
	if (func_428(iParam0))
	{
		if (!func_357(iParam1, 10))
...
int func_406(var uParam0)//Position - 0x2DAE7
{
...
int func_407(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2DB01
{
	vector3 vVar0;
	float fVar3;
...
void func_408()//Position - 0x2DB30
{
	switch (iLocal_100)
	{
		case 0:
...
void func_409(var uParam0, var uParam1)//Position - 0x2DD5D
{
	if (!uParam0->f_7)
	{
...
char* func_410(int iParam0)//Position - 0x2DDEE
{
	switch (iParam0)
	{
		case 0:
...
char* func_411(int iParam0)//Position - 0x2DE33
{
	switch (iParam0)
	{
		case 0:
...
int func_412(int iParam0, int iParam1, int iParam2)//Position - 0x2DE76
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_413(int iParam0)//Position - 0x2DF60
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_414(int iParam0)//Position - 0x2DFC4
{
	switch (iParam0)
	{
		case 0:
...
void func_415()//Position - 0x2E001
{
	if (bLocal_378)
	{
...
void func_416()//Position - 0x2E05E
{
	if (bLocal_378)
	{
...
void func_417()//Position - 0x2E0A8
{
...
int func_418(bool bParam0)//Position - 0x2E1E7
{
	if (func_22(Local_322))
	{
...
int func_419(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2E33F
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_420(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2E43A
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_421(int iParam0, float fParam1)//Position - 0x2E546
{
	var uVar0;
	vector3 vVar1;
...
int func_422(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x2E5DB
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_423(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2E669
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_424(int iParam0, float fParam1)//Position - 0x2E6B1
{
	float fVar0;
...
bool func_425(int iParam0, float fParam1)//Position - 0x2E727
{
	return func_369(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_426(int iParam0)//Position - 0x2E73F
{
...
void func_427(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2E767
{
...
int func_428(int iParam0)//Position - 0x2E795
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
bool func_429(bool bParam0)//Position - 0x2E7B6
{
...
void func_430(int iParam0, bool bParam1)//Position - 0x2E7E1
{
	func_440(bParam1, 1);
	if (bParam1)
	{
...
void func_431()//Position - 0x2E870
{
	func_432(1, 0);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_432(bool bParam0, bool bParam1)//Position - 0x2E8E2
{
	HUD::CLEAR_PRINTS();
	if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
...
void func_433(bool bParam0)//Position - 0x2E9F9
{
	if (bParam0)
	{
...
void func_434()//Position - 0x2EA34
{
	STREAMING::REMOVE_ANIM_SET(func_364());
	STREAMING::REMOVE_ANIM_SET(func_365());
}

void func_435(bool bParam0, int iParam1, int iParam2)//Position - 0x2EA4C
{
	bool bVar0;
...
void func_436(int iParam0)//Position - 0x2EAAB
{
	Global_91018 = iParam0;
}

void func_437(bool bParam0)//Position - 0x2EAB9
{
	if (bParam0)
	{
...
void func_438(bool bParam0)//Position - 0x2EB95
{
	if (bParam0)
	{
		func_439();
...
void func_439()//Position - 0x2EBF8
{
...
void func_440(bool bParam0, bool bParam1)//Position - 0x2EC21
{
	if (bParam0)
	{
		func_435(0, 1, 1);
...
void func_441(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2EC54
{
	if (func_515())
	{
...
void func_442(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2ECE9
{
	int iVar0;
	...
	else if (iParam9 == 1)
	{
		...
		{
			func_483(iParam12, 0);
			while (!func_443(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_443(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x2EE7D
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_444(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2FCC1
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_445(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x308D6
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_446(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x30949
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_447(int iParam0)//Position - 0x31E3B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_448(int iParam0, bool bParam1, var uParam2)//Position - 0x31EEB
{
	int iVar0;
	bool bVar1;
...
int func_449(int iParam0)//Position - 0x32059
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_450(int iParam0)//Position - 0x320A0
{
	switch (iParam0)
	{
		case 0:
...
int func_451(int iParam0)//Position - 0x32430
{
...
int func_452(int iParam0)//Position - 0x32472
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_453(int iParam0)//Position - 0x32505
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_454(int iParam0)//Position - 0x3254C
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_455(int iParam0)//Position - 0x32592
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_456(int iParam0)//Position - 0x325C7
{
...
int func_457(int iParam0)//Position - 0x325F6
{
...
int func_458(int iParam0)//Position - 0x326B3
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_459(int iParam0)//Position - 0x326E9
{
	switch (iParam0)
	{
		case 562680400:
...
int func_460(int iParam0, bool bParam1)//Position - 0x32742
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_461(int iParam0)//Position - 0x3279D
{
	int iVar0;
...
int func_462(int iParam0, int iParam1)//Position - 0x327D7
{
	if (iParam1 == 0)
	{
...
bool func_463()//Position - 0x32B4B
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_464()//Position - 0x32B5C
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_465()//Position - 0x32B6D
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_466()//Position - 0x32B7E
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_467()//Position - 0x32B8F
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_468()//Position - 0x32BA0
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_469(int iParam0, int iParam1)//Position - 0x32BB1
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_470(int iParam0)//Position - 0x32F27
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_471(int iParam0)//Position - 0x32F86
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_472(int iParam0)//Position - 0x32FE6
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
...
int func_473(int iParam0, bool bParam1, var uParam2)//Position - 0x3302D
{
	bool bVar0;
...
int func_474(int iParam0)//Position - 0x33452
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_475(int iParam0, int iParam1)//Position - 0x3347B
{
	int iVar0;
...
void func_476(int iParam0)//Position - 0x334FD
{
	if (!func_477(*iParam0))
	{
...
bool func_477(int iParam0)//Position - 0x33528
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_478(int iParam0, var uParam1, var uParam2)//Position - 0x33537
{
	int iVar0;
	int iVar1;
...
int func_479(int iParam0)//Position - 0x336FA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_480(var uParam0)//Position - 0x337D6
{
...
int func_481(int iParam0, int iParam1)//Position - 0x33816
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_482(var uParam0, int iParam1)//Position - 0x338FB
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_483(int iParam0, int iParam1)//Position - 0x3393C
{
	int iVar0;
...
void func_484(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x339DA
{
	int iVar0;
...
void func_485(int iParam0)//Position - 0x33A2A
{
	bool bVar0;
...
int func_486(int iParam0, int iParam1)//Position - 0x33B9C
{
	int iVar0;
...
int func_487(var uParam0)//Position - 0x33C0E
{
	return *uParam0;
}

int func_488(vector3 vParam0, float fParam3)//Position - 0x33C19
{
	return func_489(&(Global_100114.f_2890), vParam0, fParam3, 0);
}

int func_489(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x33C33
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_490(int iParam0)//Position - 0x33EE5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_491(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x33FA8
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_492(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x341B0
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_493(int iParam0, int iParam1, bool bParam2)//Position - 0x3422B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_494(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x3428C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_495(int iParam0, int iParam1)//Position - 0x347DC
{
	int iVar0;
	int iVar1;
...
bool func_496()//Position - 0x34854
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_497(int iParam0)//Position - 0x34865
{
	int iVar0;
...
int func_498(int iParam0)//Position - 0x348B0
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_499(int iParam0)//Position - 0x34937
{
...
int func_500(int iParam0)//Position - 0x34966
{
...
int func_501(int iParam0)//Position - 0x34983
{
...
int func_502(int iParam0, int iParam1)//Position - 0x349A6
{
...
int func_503(int iParam0)//Position - 0x349E1
{
	if (func_502(iParam0, 0))
	{
...
int func_504(int iParam0, int iParam1)//Position - 0x34A04
{
	int iVar0;
...
int func_505(var uParam0)//Position - 0x34A51
{
	if (func_506(uParam0))
	{
...
int func_506(var uParam0)//Position - 0x34A86
{
...
bool func_507()//Position - 0x34AE5
{
	return func_505(&(Global_100114.f_2890));
}

void func_508()//Position - 0x34AF8
{
	func_509(&(Global_100114.f_2890));
}

void func_509(var uParam0)//Position - 0x34B0B
{
	if (func_506(uParam0))
	{
...
int func_510(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x34B29
{
...
int func_512(int iParam0)//Position - 0x34C2C
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_513()//Position - 0x34C85
{
	return func_506(&(Global_100114.f_2890));
}

int func_514()//Position - 0x34C98
{
...
void func_516()//Position - 0x34CE6
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_517()//Position - 0x34E2B
{
	int iVar0;
	...
	if (func_22(Local_112.f_9))
	{
		...
		BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_418, 1);
		BRAIN::CLOSE_SEQUENCE_TASK(uLocal_418);
		BRAIN::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
		BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_418);
	}
		...
		if (func_22(Local_132[iVar0 /*19*/]))
		{
			...
			switch (iVar0)
			{
				case 0:
					...
					BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_418, 1);
					BRAIN::CLOSE_SEQUENCE_TASK(uLocal_418);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_132[iVar0 /*19*/], uLocal_418);
					BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_418);
					break;
...
void func_518(int iParam0, char* sParam1, int iParam2)//Position - 0x35322
{
	char cVar0[16];
...
int func_520(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7)//Position - 0x35574
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_55(iParam6))
...
int func_521(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x355E5
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_55(iParam1))
...
Vector3 func_522(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x35684
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_523(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x356F8
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_524()//Position - 0x3576C
{
	int iVar0;
...
float func_525()//Position - 0x35C2D
{
	return 75.15f;
}

Vector3 func_526()//Position - 0x35C3A
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_527()//Position - 0x35C51
{
	return 71f;
}

Vector3 func_528()//Position - 0x35C5E
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_529()//Position - 0x35C75
{
	return 1385417869;
}

float func_530()//Position - 0x35C82
{
	return -91.28f;
}

Vector3 func_531()//Position - 0x35C8F
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_532()//Position - 0x35CA6
{
	return -741944541;
}

float func_533()//Position - 0x35CB3
{
	return 89.19f;
}

Vector3 func_534()//Position - 0x35CC0
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_535(int iParam0)//Position - 0x35CD7
{
	if (!func_83(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
...
int func_536(bool bParam0)//Position - 0x35D02
{
...
int func_540(int iParam0)//Position - 0x35E3A
{
	int iVar0;
...
var func_541()//Position - 0x36557
{
	return Global_93721.f_1;
}

int func_542()//Position - 0x36565
{
	if (Global_90634 != -1)
	{
...
bool func_543()//Position - 0x3658B
{
	return Global_93734.f_340 > 0;
}

bool func_544()//Position - 0x3659C
{
	return Global_93734.f_339 > 0;
}

var func_545()//Position - 0x365AD
{
	return Global_1312867;
}

bool func_546(int iParam0)//Position - 0x365B9
{
	return func_547(iParam0, Global_36425);
}

int func_547(int iParam0, int iParam1)//Position - 0x365CA
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_548(int iParam0)//Position - 0x367AB
{
	func_573();
	if (!func_572())
	{
...
void func_549(char* sParam0)//Position - 0x367F6
{
	if (Global_93682 != 12)
	{
...
int func_550(char* sParam0, int iParam1, int iParam2)//Position - 0x36813
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_551(char* sParam0)//Position - 0x369A5
{
...
void func_552(int iParam0, var uParam1)//Position - 0x369FB
{
	switch (iParam0)
	{
		case 0:
...
int func_554(int iParam0)//Position - 0x37C41
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_555(int iParam0)//Position - 0x37F87
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_556(int iParam0)//Position - 0x37FBE
{
	struct<2> Var0;
...
int func_558(char* sParam0, bool bParam1)//Position - 0x38462
{
	int iVar0;
	int iVar1;
...
int func_559(int iParam0, bool bParam1)//Position - 0x3848C
{
	int iVar0;
...
void func_562(int iParam0)//Position - 0x3857E
{
	if (iParam0 == 1)
	{
		Global_36974 = 1;
...
void func_563(bool bParam0)//Position - 0x38597
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_564(int iParam0)//Position - 0x385AB
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_565(int iParam0)//Position - 0x385E8
{
	if (iParam0 == 1)
	{
...
void func_566()//Position - 0x38625
{
	Global_17272.f_5 = 1;
}

void func_567()//Position - 0x38633
{
	Global_17272.f_5 = 0;
}

void func_568()//Position - 0x38641
{
	Global_87888 = 0;
	Global_87889 = 0;
}

void func_569()//Position - 0x38653
{
	Global_93682 = 13;
	Global_93682.f_1 = -1;
	Global_93682.f_2 = 0;
...
void func_573()//Position - 0x3873E
{
	Global_93717 = 1;
...
void func_574()//Position - 0x3882B
{
	if (iLocal_384)
	{
		func_432(0, 1);
