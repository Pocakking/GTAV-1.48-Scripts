...
int func_59(int iParam0)//Position - 0x4554
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_60(int iParam0)//Position - 0x45EF
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4775
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x52E6
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x5321
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5595
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x55D1
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5B2C
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5B70
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6277
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x62BE
{
...
bool func_70(int iParam0)//Position - 0x6319
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6329
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x6393
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x66B4
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x66BF
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x66CF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6771
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6D73
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6DD1
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6E7F
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x6F14
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x6F58
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x70DC
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x70EA
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7BB1
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7C33
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C91
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7C9A
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7EA5
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x7EB5
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7ED2
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7EE2
{
	switch (iParam0)
	{
		case -1:
...
int func_182(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xC62E
{
	var uVar0;
	...
	if (func_173(2))
	{
		if (!func_145())
		{
			if (((func_126(PLAYER::PLAYER_PED_ID()) && func_126(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_188(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
...
int func_183(char* sParam0)//Position - 0xC6F0
{
	struct<6> Var0;
...
struct<6> func_184()//Position - 0xC710
{
	struct<6> Var0;
...
void func_185(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC734
{
...
void func_186(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC76F
{
...
void func_187(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC7C5
{
...
void func_189(int iParam0, var uParam1, int iParam2, vector3 vParam3, vector3 vParam6, vector3 vParam9)//Position - 0xC89A
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam2))
		{
			...
			else
			{
				...
				{
					fVar0 = func_188(PLAYER::PLAYER_PED_ID(), vParam6, 1);
					fVar1 = func_188(PLAYER::PLAYER_PED_ID(), vParam9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								CUTSCENE::REMOVE_CUTSCENE();
								CUTSCENE::_REQUEST_CUTSCENE_EX(iParam2, 5, 8);
								func_190(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							CUTSCENE::REMOVE_CUTSCENE();
							CUTSCENE::_REQUEST_CUTSCENE_EX(iParam2, 6, 8);
							func_190(*iParam0, 1);
							*uParam1 = 2;
						}
					}
...
void func_190(int iParam0, bool bParam1)//Position - 0xC9B8
{
	if (iParam0 == -1)
	{
		return;
...
int func_191(int iParam0)//Position - 0xC9F4
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_192(int iParam0, int iParam1)//Position - 0xCA2D
{
	bool bVar0;
	int iVar1;
...
void func_193(int iParam0)//Position - 0xCACB
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_194(iParam0);
...
void func_194(int iParam0)//Position - 0xCAE2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_195()//Position - 0xCBCA
{
	return Global_91021;
}

void func_196(int iParam0)//Position - 0xCBD6
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_197(var uParam0, bool bParam1)//Position - 0xCBFE
{
	struct<27> Var0;
...
void func_198(int iParam0, var uParam1, int iParam2)//Position - 0xCE71
{
	int iVar0;
	int iVar1;
...
int func_199(int iParam0)//Position - 0xD1C9
{
...
int func_200(var uParam0)//Position - 0xD1E9
{
...
int func_201(var uParam0)//Position - 0xD201
{
...
void func_202(var uParam0)//Position - 0xD226
{
	int iVar0;
	int iVar1;
...
void func_203(int iParam0)//Position - 0xD52A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_204(var uParam0)//Position - 0xD555
{
	int iVar0;
...
int func_205(var uParam0, bool bParam1, bool bParam2)//Position - 0xD5D5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_206(int iParam0, int iParam1)//Position - 0xD793
{
	int iVar0;
...
int func_207(var uParam0, bool bParam1, int iParam2)//Position - 0xD7C3
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0)//Position - 0xDA7F
{
...
int func_209(int iParam0, float fParam1)//Position - 0xDAB3
{
	float fVar0;
...
bool func_210(int iParam0, float fParam1)//Position - 0xDB29
{
	return func_211(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_211(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDB41
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_212(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDC02
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_213(int iParam0, int iParam1)//Position - 0xDD2E
{
	int iVar0;
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDE3D
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_216(vector3 vParam0, vector3 vParam3)//Position - 0xDECE
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_217(vector3 vParam0)//Position - 0xDEEF
{
	float fVar0;
	float fVar1;
...
void func_218(var uParam0)//Position - 0xDF2E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_219(int iParam0, int iParam1)//Position - 0xDF49
{
	int iVar0;
...
int func_221(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDFB0
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_222(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE0AB
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_223(int iParam0, float fParam1)//Position - 0xE1B7
{
	var uVar0;
	vector3 vVar1;
...
int func_224(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE24C
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_225(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE2DA
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_226(int iParam0)//Position - 0xE322
{
...
void func_227(int iParam0)//Position - 0xE36C
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE409
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_229(int iParam0)//Position - 0xE4A1
{
...
int func_232(int iParam0)//Position - 0xE523
{
...
int func_234(int iParam0)//Position - 0xE595
{
	if (func_107(0))
	{
...
int func_235(int iParam0)//Position - 0xE5BD
{
	if (!func_236(iParam0))
	{
		return 0;
...
int func_236(var uParam0)//Position - 0xE5DC
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
void func_237(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xE7C8
{
	func_238(iParam0);
...
void func_238(int iParam0)//Position - 0xE80A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_239(int iParam0)//Position - 0xE8A6
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xE8D7
{
	struct<27> Var0;
	int iVar32;
...
int func_241(int iParam0)//Position - 0xE92B
{
	char* sVar0;
...
int func_242(int iParam0)//Position - 0xE9E4
{
	var uVar0;
...
int func_243(int iParam0)//Position - 0xEAA5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_244(int iParam0, char* sParam1)//Position - 0xEB2A
{
...
bool func_245(int iParam0)//Position - 0xEC0C
{
...
bool func_246(int iParam0)//Position - 0xEC3A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_247(int iParam0)//Position - 0xEC68
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_248(int iParam0)//Position - 0xEC96
{
	if (func_229(iParam0))
	{
		return 0;
...
void func_249()//Position - 0xECCB
{
	func_267("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xECE5
{
	int iVar0;
...
int func_251(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xED4A
{
	int iVar0;
	struct<7> Var1;
...
int func_252(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xEDC8
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_253(int iParam0, bool bParam1)//Position - 0xEE43
{
	if (bParam1)
	{
...
int func_254(var uParam0)//Position - 0xEE99
{
	if (func_201(uParam0))
	{
...
void func_255(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEECF
{
...
void func_256(var uParam0, bool bParam1)//Position - 0xEEEF
{
	func_257(&(uParam0->f_41), bParam1);
}

void func_257(var uParam0, bool bParam1)//Position - 0xEF01
{
	int iVar0;
...
void func_258(int iParam0, bool bParam1)//Position - 0xEF3F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_259(var uParam0, bool bParam1)//Position - 0xEF7A
{
	func_260(&(uParam0->f_35), bParam1);
}

void func_260(var uParam0, bool bParam1)//Position - 0xEF8C
{
	int iVar0;
...
void func_261(int iParam0)//Position - 0xEFC9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_262(var uParam0, int iParam1)//Position - 0xF001
{
	func_263(&(uParam0->f_28), iParam1);
}

void func_263(var uParam0, int iParam1)//Position - 0xF013
{
	int iVar0;
...
void func_264(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF054
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_265(int iParam0)//Position - 0xF0A4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_266(var uParam0)//Position - 0xF0E5
{
	if (*uParam0 == -1)
	{
		return;
...
void func_267(int iParam0)//Position - 0xF122
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_268(var uParam0)//Position - 0xF134
{
	*uParam0 = -1;
