...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_199(Var0.f_28[0]))
		{
			...
			{
				func_186(&uLocal_105, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_185(Var0))
...
int func_59(int iParam0)//Position - 0x4652
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_61(int iParam0, int iParam1)//Position - 0x4873
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x53E4
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x541F
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5693
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x56CF
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_66(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5C2A
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5C6E
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6375
{
	if (bParam6)
	{
...
int func_69(var uParam0)//Position - 0x63BC
{
...
bool func_70(int iParam0)//Position - 0x6417
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6427
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x6491
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x67B2
{
	return Global_25765;
}

int func_74(int iParam0)//Position - 0x67BD
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x67CD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x686F
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6E71
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6ECF
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6F7D
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_80(vector3 vParam0, float fParam3)//Position - 0x7012
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_81(int iParam0)//Position - 0x7056
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x71DA
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x71E8
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7CAF
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7D31
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7D8F
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7D98
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7FA3
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x7FB3
{
	return MISC::GET_BITS_IN_RANGE(Global_2424047[iParam0 /*416*/].f_309.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7FD0
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7FE0
{
	switch (iParam0)
	{
		case -1:
...
bool func_92()//Position - 0x82BA
{
	return Global_93734.f_339 > 0;
}

var func_93()//Position - 0x82CB
{
	var uVar0;
...
void func_94(var uParam0, int iParam1)//Position - 0x8311
{
	if (iParam1 <= 0)
	{
		return;
...
void func_95(var uParam0, int iParam1)//Position - 0x8397
{
...
void func_96(var uParam0, int iParam1)//Position - 0x83CA
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1)//Position - 0x841B
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_98(int iParam0)//Position - 0x84BD
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_99(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_99(bool bParam0, int iParam1, int iParam2)//Position - 0x84E2
{
	if (bParam0)
	{
		return iParam1;
...
int func_100(var uParam0)//Position - 0x84F9
{
	return uParam0 & 15;
}

void func_101(var uParam0, int iParam1)//Position - 0x8506
{
...
void func_102(var uParam0, int iParam1)//Position - 0x8540
{
...
void func_103(var uParam0, int iParam1)//Position - 0x857B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_104()//Position - 0x85B7
{
	func_55();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_105(int iParam0)//Position - 0x85D0
{
	var uVar0;
	vector3 vVar1[24];
...
void func_106(char* sParam0, var uParam1, int iParam2)//Position - 0x8629
{
...
bool func_107(bool bParam0)//Position - 0x866B
{
...
struct<2> func_108(int iParam0)//Position - 0x8696
{
	struct<2> Var0;
...
void func_109(int iParam0, var uParam1)//Position - 0x8AE3
{
	switch (iParam0)
	{
		case 0:
...
int func_111(int iParam0)//Position - 0x9DBB
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0xA101
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0xA1A5
{
	struct<2> Var0;
...
void func_114(int iParam0)//Position - 0xA240
{
	if (iParam0 < 63)
	{
		func_115();
...
void func_116(int iParam0)//Position - 0xA29E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0)//Position - 0xA2F7
{
...
int func_118(int iParam0)//Position - 0xA37A
{
	int iVar0;
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA3AB
{
	func_120(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA3C0
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA473
{
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA48E
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA4DA
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA523
{
	if (func_199(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_126(int iParam0)//Position - 0xA543
{
	switch (iParam0)
	{
		case 5:
...
int func_128(int iParam0)//Position - 0xA613
{
	switch (iParam0)
	{
		case 5:
...
void func_129(var uParam0, bool bParam1, bool bParam2)//Position - 0xA666
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0xA75B
{
	switch (iParam0)
	{
		case 5:
...
void func_131(bool bParam0)//Position - 0xA7C6
{
	int iVar0;
...
void func_132(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xA804
{
	if (bParam0)
	{
...
bool func_133()//Position - 0xA93D
{
	return MISC::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18, 14);
}

bool func_134(int iParam0, int iParam1)//Position - 0xA95A
{
	bool bVar0;
...
int func_135(int iParam0, bool bParam1)//Position - 0xA9A5
{
	int iVar0;
	int iVar1;
...
int func_136(int iParam0)//Position - 0xA9E6
{
...
bool func_137()//Position - 0xAA28
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_138(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAA39
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0xAA93
{
	if (iParam0 == 1)
	{
...
int func_141(int iParam0)//Position - 0xAAB6
{
...
void func_142()//Position - 0xAAF3
{
	Global_14732 = 0;
	func_143();
}

void func_143()//Position - 0xAB03
{
...
int func_147(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xABE9
{
...
void func_148(int iParam0)//Position - 0xAD78
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_150(int iParam0)//Position - 0xADF5
{
	if (func_154())
	{
		return;
...
void func_151(int iParam0)//Position - 0xAE28
{
	if (func_154())
	{
		return;
...
void func_152(bool bParam0, bool bParam1)//Position - 0xAEA2
{
	if (bParam0)
	{
		if (func_153(0))
...
int func_153(int iParam0)//Position - 0xAF16
{
	if (iParam0 == 1)
	{
		if (Global_14553.f_1 > 3)
...
int func_156(int iParam0)//Position - 0xAFC3
{
	int iVar0;
...
void func_157(int iParam0)//Position - 0xB008
{
...
int func_158(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB03A
{
	int iVar0;
...
void func_159(var uParam0, int iParam1)//Position - 0xB171
{
	int iVar0;
...
bool func_160(int iParam0)//Position - 0xB1C0
{
	return func_161(iParam0, Global_36425);
}

int func_161(int iParam0, int iParam1)//Position - 0xB1D1
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_162(int iParam0)//Position - 0xB3B2
{
	if (Global_36425 == 15)
	{
		return 0;
...
int func_163()//Position - 0xB3D4
{
	return func_164(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_164(char* sParam0, int iParam1)//Position - 0xB3E5
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_166(int iParam0, int iParam1)//Position - 0xB452
{
	switch (iParam0)
	{
		case 0:
...
int func_167(vector3 vParam0, bool bParam3)//Position - 0xB8D9
{
	int iVar0;
...
float func_168(bool bParam0, float fParam1, float fParam2)//Position - 0xB905
{
	if (bParam0)
	{
		return fParam1;
...
int func_169(int iParam0)//Position - 0xB91C
{
	switch (iParam0)
	{
		case 0:
...
int func_170(int iParam0, int iParam1)//Position - 0xB9AB
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_171()//Position - 0xC191
{
	func_27(&(Global_97130.f_2890), &Global_97130, 0, 1, 1, 0);
}

int func_172(var uParam0)//Position - 0xC1AC
{
	float fVar0;
...
void func_173(int iParam0, int iParam1)//Position - 0xC23A
{
	if (iParam0 == 1)
	{
		if (!func_128(iParam1))
...
int func_174(bool bParam0)//Position - 0xC29E
{
	int iVar0;
...
int func_175(int iParam0)//Position - 0xC335
{
	if (func_199(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_176(int iParam0)//Position - 0xC35F
{
	int iVar0;
...
var func_177()//Position - 0xCA7C
{
	return Global_93721.f_1;
}

int func_178()//Position - 0xCA8A
{
	if (Global_90634 != -1)
	{
...
bool func_181()//Position - 0xCAF4
{
	return Global_93734.f_340 > 0;
}

bool func_182(int iParam0, int iParam1)//Position - 0xCB05
{
	switch (iParam0)
	{
		case 5:
...
var func_183()//Position - 0xCB40
{
	return Global_1312867;
}

int func_184()//Position - 0xCB4C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_185(int iParam0)//Position - 0xCB68
{
	switch (iParam0)
	{
		case 5:
...
void func_186(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5)//Position - 0xCB8B
{
	switch (*uParam0)
	{
		case 0:
...
bool func_187(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCC28
{
...
int func_188(char* sParam0, int iParam1, bool bParam2)//Position - 0xCC76
{
	Global_15867 = 0;
...
void func_194(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD19C
{
...
float func_195(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xD1F2
{
	vector3 vVar0;
...
void func_196(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)//Position - 0xD22C
{
	int iVar0;
	int iVar1;
...
int func_197(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD2C9
{
	var uVar0;
	
	if ((((func_199(PLAYER::PLAYER_PED_ID()) && func_199(iParam0->f_28[0])) && !func_144()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_195(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_198(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD351
{
...
int func_199(int iParam0)//Position - 0xD38C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_200(int iParam0, int iParam1, vector3 vParam2)//Position - 0xD3AD
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_201(int iParam0, bool bParam1)//Position - 0xD49E
{
	if (iParam0 == -1)
	{
		return;
...
int func_202(int iParam0)//Position - 0xD4DA
{
	if (Global_71586 == iParam0)
	{
		if (Global_71587 == -1)
...
void func_203(int iParam0, int iParam1)//Position - 0xD513
{
	bool bVar0;
	int iVar1;
...
bool func_204()//Position - 0xD5B1
{
	return Global_91021;
}

void func_205(int iParam0)//Position - 0xD5BD
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(iParam0);
...
void func_206(int iParam0)//Position - 0xD5D4
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_207(int iParam0)//Position - 0xD6BC
{
	if (iParam0 == -1)
	{
		iParam0 = func_163();
...
int func_208(int iParam0, bool bParam1)//Position - 0xD6E4
{
	struct<27> Var0;
...
void func_209(int iParam0, var uParam1, int iParam2)//Position - 0xD957
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0)//Position - 0xDCAF
{
...
int func_211(var uParam0)//Position - 0xDCCF
{
...
int func_212(var uParam0)//Position - 0xDCE7
{
...
void func_213(var uParam0)//Position - 0xDD0C
{
	int iVar0;
	int iVar1;
...
void func_214(int iParam0)//Position - 0xE010
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_215(var uParam0)//Position - 0xE03B
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, bool bParam2)//Position - 0xE0BB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_217(int iParam0, int iParam1)//Position - 0xE279
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, int iParam2)//Position - 0xE2A9
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE565
{
...
int func_220(int iParam0, float fParam1)//Position - 0xE599
{
	float fVar0;
...
bool func_221(int iParam0, float fParam1)//Position - 0xE60F
{
	return func_222(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE627
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_223(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE6E8
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_224(int iParam0, int iParam1)//Position - 0xE814
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE923
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_227(vector3 vParam0, vector3 vParam3)//Position - 0xE9B4
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_228(vector3 vParam0)//Position - 0xE9D5
{
	float fVar0;
	float fVar1;
...
void func_229(var uParam0)//Position - 0xEA14
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_230(int iParam0, int iParam1)//Position - 0xEA2F
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xEA6E
{
...
int func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEA96
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_233(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEB91
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_234(int iParam0, float fParam1)//Position - 0xEC9D
{
	var uVar0;
	vector3 vVar1;
...
int func_235(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xED32
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_236(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEDC0
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_237(int iParam0)//Position - 0xEE08
{
...
void func_238(int iParam0)//Position - 0xEE52
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xEEEF
{
	if (iParam0 == -1)
	{
		iParam0 = func_163();
...
int func_240(int iParam0)//Position - 0xEF87
{
...
int func_243(int iParam0)//Position - 0xF009
{
...
int func_245(int iParam0)//Position - 0xF07B
{
	if (func_107(0))
	{
...
void func_246()//Position - 0xF0A3
{
	...
	if (func_199(PLAYER::PLAYER_PED_ID()))
	{
		if (func_247(PLAYER::PLAYER_PED_ID(), vVar0, fVar3))
		{
			func_149();
		}
	}
...
bool func_247(int iParam0, vector3 vParam1, float fParam4)//Position - 0xF0E5
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_248(int iParam0)//Position - 0xF102
{
	if (func_199(iParam0->f_28[0]))
	{
...
void func_249(var uParam0)//Position - 0xF171
{
	int iVar0;
...
void func_250(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xF20B
{
...
void func_253(var uParam0, char* sParam1)//Position - 0xF3B6
{
...
void func_254(var uParam0)//Position - 0xF3DF
{
	int iVar0;
...
int func_255(var uParam0)//Position - 0xF40C
{
	uParam0->f_16 = 3;
...
int func_256(var uParam0)//Position - 0xF437
{
	int iVar0[3];
	vector3 vVar4;
	vector3 vVar7;
...
void func_257(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF6BC
{
	func_214(iParam0);
...
void func_258(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF6E3
{
	func_259(iParam0);
...
void func_259(int iParam0)//Position - 0xF725
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_260(int iParam0)//Position - 0xF7C1
{
	int iVar0;
...
int func_261(var uParam0)//Position - 0xF7F2
{
	int iVar0[4];
	vector3 vVar5;
	vector3 vVar8;
...
void func_262(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0xFB41
{
	func_263(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

void func_263(int iParam0)//Position - 0xFB62
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_264(var uParam0)//Position - 0xFBA3
{
	int iVar0[2];
	vector3 vVar3;
	float fVar6;
...
int func_265(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xFD99
{
...
int func_266(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xFDF5
{
	int iVar0;
...
int func_267(var uParam0, int iParam1)//Position - 0xFE83
{
	int iVar0;
...
int func_268(var uParam0)//Position - 0xFEC9
{
	if (func_212(uParam0))
	{
...
void func_269(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xFEF3
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_270(var uParam0)//Position - 0xFF2F
{
	int iVar0[5];
	vector3 vVar6;
	float fVar9;
...
void func_271(int iParam0, int iParam1)//Position - 0x102CE
{
	vector3 vVar0;
	float fVar3;
	...
	fVar3 = 23.45f;
	func_257(iParam0, iParam1, vVar0, fVar3);
}

float func_272(float fParam0)//Position - 0x102FE
{
	return (fParam0 * 57.29578f);
}

int func_273(var uParam0)//Position - 0x1030E
{
	int iVar0[7];
	vector3 vVar8;
	float fVar11;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_265(&(uParam0->f_28[0]), 49, vVar8, fVar11, "RC LAUNCHER: BARRY 1", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false);
				}
				else
...
int func_274(int iParam0)//Position - 0x1076C
{
	struct<27> Var0;
	int iVar32;
...
int func_275(int iParam0)//Position - 0x107C0
{
	char* sVar0;
...
int func_276(int iParam0)//Position - 0x10879
{
	var uVar0;
...
int func_277(int iParam0)//Position - 0x1093A
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_278(int iParam0, char* sParam1)//Position - 0x109BF
{
...
bool func_279(int iParam0)//Position - 0x10AA1
{
...
bool func_280(int iParam0)//Position - 0x10ACF
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_281(int iParam0)//Position - 0x10AFD
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_282(int iParam0)//Position - 0x10B2B
{
	if (func_240(iParam0))
	{
		return 0;
...
void func_283()//Position - 0x10B60
{
	func_305("Running end routines.");
	Global_106283 = (Global_106283 - 1);
}

int func_284(int iParam0, vector3 vParam1, float fParam4)//Position - 0x10B7A
{
	int iVar0[4];
	int iVar5;
...
int func_285(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0x10C0B
{
	int iVar0;
	struct<7> Var1;
...
int func_286(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x10C89
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_287(int iParam0, bool bParam1)//Position - 0x10D04
{
	char* sVar0;
...
void func_288(char* sParam0)//Position - 0x10D99
{
...
void func_289()//Position - 0x10DB8
{
	Global_14732 = 0;
	func_290();
}

void func_290()//Position - 0x10DC8
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_291(char* sParam0)//Position - 0x10DE9
{
	struct<6> Var0;
...
struct<6> func_292()//Position - 0x10E09
{
	struct<6> Var0;
...
int func_293(var uParam0)//Position - 0x10E2D
{
	if (func_212(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_294(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10E63
{
...
void func_295(var uParam0, bool bParam1)//Position - 0x10E83
{
	func_296(&(uParam0->f_41), bParam1);
}

void func_296(var uParam0, bool bParam1)//Position - 0x10E95
{
	int iVar0;
...
void func_297(int iParam0, bool bParam1)//Position - 0x10ED3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_298(var uParam0, bool bParam1)//Position - 0x10F0E
{
	func_299(&(uParam0->f_35), bParam1);
}

void func_299(var uParam0, bool bParam1)//Position - 0x10F20
{
	int iVar0;
...
void func_300(int iParam0)//Position - 0x10F5D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_301(var uParam0, int iParam1)//Position - 0x10F95
{
	func_302(&(uParam0->f_28), iParam1);
}

void func_302(var uParam0, int iParam1)//Position - 0x10FA7
{
	int iVar0;
...
void func_303(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10FE8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_304(var uParam0)//Position - 0x11038
{
	if (*uParam0 == -1)
	{
		return;
...
void func_305(int iParam0)//Position - 0x11075
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_306(var uParam0)//Position - 0x11087
{
	*uParam0 = -1;
...
void func_307()//Position - 0x110BA
{
	func_305("Running start routines.");
	Global_106283++;
}

int func_308(int iParam0)//Position - 0x110D4
{
	if (!func_36(iParam0))
	{
		return Global_106565.f_28044[iParam0 /*29*/];
