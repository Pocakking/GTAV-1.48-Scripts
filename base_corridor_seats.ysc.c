...
void func_11(var uParam0)//Position - 0x21C
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar42 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_57.f_1);
		...
		case 8:
			iVar43 = NETWORK::_NETWORK_UNLINK_NETWORKED_SYNCHRONISED_SCENE(uParam0->f_57.f_1);
...
void func_55(var uParam0)//Position - 0x15B2
{
	...
	func_56(&(uParam0->f_57), 2, BRAIN::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
void func_74(int iParam0, var uParam1, int iParam2)//Position - 0x19AD
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
...
Vector3 func_75(int iParam0)//Position - 0x1A68
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_77(vector3 vParam0, float fParam3)//Position - 0x1AF8
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
Vector3 func_78(int iParam0)//Position - 0x1B3C
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_79()//Position - 0x1B88
{
	return func_80() + Vector(0f, -8.946f, 47.215f);
}

Vector3 func_80()//Position - 0x1BA0
{
	return 345.0041f, 4842.001f, -59.9997f;
}

void func_81(int iParam0, var uParam1, var uParam2)//Position - 0x1BB7
{
	switch (iParam0)
	{
		case 0:
...
int func_82(int iParam0, int iParam1, bool bParam2)//Position - 0x1D55
{
	int iVar0;
