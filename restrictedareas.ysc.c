					...
					else
					{
						if (iLocal_58)
						{
							...
							while (iLocal_68 < 8)
							{
								...
								{
									if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), iLocal_68 + 1, 0, 0))
									{
						...
						if (SYSTEM::TIMERA() > 125)
						{
							...
							if (func_29(iLocal_37, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)))
							{
								...
								if (func_28(iLocal_37))
								{
									...
									if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&Local_72)) == 0)
									{
...
int func_32(vector3 vParam0, int iParam3, int iParam4, bool bParam5)//Position - 0x1172
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
