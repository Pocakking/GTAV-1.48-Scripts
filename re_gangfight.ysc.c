					...
					case 1:
						...
						if (!func_77() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
						{
							if ((!PED::IS_PED_INJURED(iLocal_68) && !PED::IS_PED_INJURED(iLocal_69[0])) && !PED::IS_PED_INJURED(iLocal_69[1]))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 969.2191f, 3608.665f, 41.8758f, 100f, 80f, 20f, false, true, 0))
								{
									...
									iLocal_61[0] = func_74(iLocal_69[0], 1, 145);
									iLocal_61[1] = func_74(iLocal_69[1], 1, 145);
									HUD::_0x75A16C3DA34F1245(iLocal_60, false);
									HUD::_0x75A16C3DA34F1245(iLocal_61[0], false);
									HUD::_0x75A16C3DA34F1245(iLocal_61[1], false);
									func_64(1);
								}
							}
						}
						else
						{
							...
							while (iVar0 < iLocal_69)
							{
								...
								{
									BRAIN::TASK_SMART_FLEE_PED(iLocal_69[iVar0], PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
								}
								iVar0++;
							}
							if (!PED::IS_PED_INJURED(iLocal_68))
							{
								BRAIN::TASK_SMART_FLEE_PED(iLocal_68, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
							}
							func_63();
						}
						break;
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < iLocal_69)
					{
						...
						{
							BRAIN::TASK_COMBAT_PED(iLocal_69[iVar2], PLAYER::PLAYER_PED_ID(), 0, 16);
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_69[iVar0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (iVar0 < 2)
				{
					...
					{
						BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_69[iVar0], iLocal_77[iVar0], PLAYER::PLAYER_PED_ID(), 8, 20f, 786469, 150f, 10f, 1);
						PED::SET_PED_KEEP_TASK(iLocal_69[iVar0], true);
					}
					else
					{
						BRAIN::TASK_SMART_FLEE_PED(iLocal_69[iVar0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					}
				}
				else
				{
	...
	switch (iLocal_48)
	{
			...
			if (SYSTEM::TIMERB() > 2000)
			{
				...
				while (iVar0 < iLocal_69)
				{
					if (!PED::IS_PED_INJURED(iLocal_69[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_77[iVar0], 0))
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_61[iVar0]))
						{
							iLocal_61[iVar0] = func_74(iLocal_69[iVar0], 1, 145);
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_69[iVar0], 0))
							{
								if (!bLocal_55)
								{
									BRAIN::TASK_DRIVE_BY(iLocal_69[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 150f, 100, 1, -753768974);
								}
								else
								{
									...
									BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69[iVar0], iLocal_84);
				...
				if (!PED::IS_PED_INJURED(iLocal_69[iVar1]))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_69[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, false, true, 0))
					{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_69[iVar1], 0))
						{
							...
							BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_84);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69[iVar1], iLocal_84);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_84);
					...
					if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_69[iVar1], 0))
					{
						BRAIN::TASK_COMBAT_PED(iLocal_69[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
						PED::SET_PED_KEEP_TASK(iLocal_69[iVar1], true);
					}
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_77[iVar1], 0))
					{
		...
		case 2:
			...
			if (!PED::IS_PED_INJURED(iLocal_68))
			{
				...
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_84);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_68, iLocal_84);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_84);
			}
		...
		case 5:
			if (!PED::IS_PED_INJURED(iLocal_68) && !ENTITY::IS_ENTITY_DEAD(iLocal_76, 0))
			{
				...
				BRAIN::TASK_ENTER_VEHICLE(0, iLocal_76, -1, -1, 2f, 8, 0);
				BRAIN::TASK_PAUSE(0, 2000);
				BRAIN::TASK_PLAY_ANIM(0, "veh@drivebystd_ds_grenades", "drop_grenade", 2f, -2f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_76, 10f, 786603);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_84);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_68, iLocal_84);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_84);
				PED::SET_PED_KEEP_TASK(iLocal_68, true);
				VEHICLE::_0x25367DE49D64CF16(iLocal_76, 1);
				iLocal_48++;
			}
			break;
...
int func_21()//Position - 0x1907
{
	return Global_1312745;
}

int func_22(int iParam0, int iParam1)//Position - 0x1913
{
	switch (iParam0)
	{
		case 0:
...
int func_23(int iParam0)//Position - 0x1C87
{
	switch (iParam0)
	{
		case 29:
...
void func_25(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1CF8
{
	func_26(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_26(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1D1A
{
	int iVar0;
...
bool func_30(int iParam0)//Position - 0x2151
{
	return Global_36425 == iParam0;
}

bool func_31(int iParam0)//Position - 0x215F
{
	return iParam0 < 3;
}

int func_32(int iParam0)//Position - 0x216B
{
	int iVar0;
	int iVar1;
...
int func_33(int iParam0)//Position - 0x21A8
{
	if (func_31(iParam0))
	{
...
int func_34(int iParam0)//Position - 0x21D2
{
	int iVar0;
	int iVar1;
...
void func_35(int iParam0, int iParam1)//Position - 0x2215
{
	MISC::SET_BIT(&(Global_106565.f_24989.f_8[iParam0]), iParam1);
}

int func_36(int iParam0)//Position - 0x2230
{
	int iVar0;
...
int func_38(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x22FE
{
...
int func_39()//Position - 0x24D8
{
	return 1;
}

void func_40(int iParam0)//Position - 0x24E1
{
	int iVar0;
...
bool func_41(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2510
{
...
int func_42(char* sParam0, int iParam1, bool bParam2)//Position - 0x255E
{
	Global_15867 = 0;
...
int func_48()//Position - 0x2A53
{
	func_29();
	return Global_106565.f_2357.f_539.f_4321;
}

void func_49()//Position - 0x2A6C
{
	int iVar0;
...
bool func_50(int iParam0, int iParam1)//Position - 0x2AC4
{
	switch (iParam0)
	{
		case 5:
...
void func_52(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2B56
{
	...
	switch (iLocal_48)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_68))
			{
				...
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_68, PLAYER::PLAYER_PED_ID(), -1, 2060, 2);
				...
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_68, 916.5764f, 3602.146f, 31.9262f, 3.3f, 3.3f, 3.3f, false, true, 0))
				{
					if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_68, 8f, 8f, 8f, 0, 1, 0))
					{
						if (!func_8())
						{
							...
							{
								BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_68, PLAYER::PLAYER_PED_ID(), -1);
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_76, 0))
								{
									ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_76);
								}
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_68, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))
					{
						if (func_56())
						{
							...
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_84);
								BRAIN::TASK_OPEN_VEHICLE_DOOR(0, iLocal_76, -1, -1, 1f);
								BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_69[2], 2000, 0, 2);
								BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_69[2], 0);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_84);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_68, iLocal_84);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_84);
								func_40(2000);
				...
				while (iVar0 < iLocal_69)
				{
					if (!PED::IS_PED_INJURED(iLocal_69[iVar0]))
					{
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_77[iVar0], 0))
						{
							...
							{
								BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_69[iVar0], iLocal_77[iVar0], PLAYER::PLAYER_PED_ID(), (iVar0 - 2) + 10, 60f, 786475, 5f, 10f, 1);
							}
						}
					}
					iVar0++;
...
void func_54()//Position - 0x31E1
{
	Global_14732 = 0;
	func_55();
}

void func_55()//Position - 0x31F1
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
		...
		if ((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_01")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_02"))) && AUDIO::IS_AUDIO_SCENE_ACTIVE("RE_COUNTRYSIDE_GANG_FIGHT_SCENE"))
		{
			...
			while (iVar0 < iLocal_69)
			{
				if (!PED::IS_PED_INJURED(iLocal_69[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_77[iVar0], 0))
				{
					...
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_84);
					BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_77[2], 966.7098f, 3633.926f, 31.3974f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					BRAIN::TASK_LOOK_AT_COORD(0, vLocal_50, 5000, 0, 2);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_84);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69[2], iLocal_84);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_84);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_84);
					BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_77[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					BRAIN::TASK_LOOK_AT_COORD(0, vLocal_50, 5000, 0, 2);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_84);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69[3], iLocal_84);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_84);
					PED::SET_PED_KEEP_TASK(iLocal_69[3], true);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_84);
					BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_77[4], 971.023f, 3631.225f, 31.3807f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					BRAIN::TASK_LOOK_AT_COORD(0, vLocal_50, 5000, 0, 2);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_84);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69[4], iLocal_84);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_84);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_84);
					BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_77[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					BRAIN::TASK_LOOK_AT_COORD(0, vLocal_50, 5000, 0, 2);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_84);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69[5], iLocal_84);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_84);
				}
				iVar0++;
			}
...
void func_57(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x36EC
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_58()//Position - 0x3787
{
	if (!PED::IS_PED_INJURED(iLocal_68))
	{
		BRAIN::TASK_SMART_FLEE_PED(iLocal_68, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_68, true);
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_69[0], 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_69[1], 0))
		{
			ENTITY::SET_ENTITY_HEALTH(iLocal_68, 101, 0);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_68, false);
			BRAIN::TASK_SHOOT_AT_ENTITY(iLocal_69[0], iLocal_68, 1000, 0);
			BRAIN::TASK_SHOOT_AT_ENTITY(iLocal_69[1], iLocal_68, 1000, 0);
		}
		else
		{
			func_4();
...
void func_59(int iParam0, char* sParam1, int iParam2)//Position - 0x382B
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_60(iParam2), 1);
}

int func_60(int iParam0)//Position - 0x3842
{
	int iVar0;
		...
		case 3:
			if ((!PED::IS_PED_INJURED(iLocal_68) && !PED::IS_PED_INJURED(iLocal_69[0])) && !PED::IS_PED_INJURED(iLocal_69[1]))
			{
				...
				if (SYSTEM::TIMERA() < 28000)
				{
					...
					{
						if (((PED::_CAN_PED_SEE_PED(iLocal_69[0], PLAYER::PLAYER_PED_ID()) || PED::_CAN_PED_SEE_PED(iLocal_69[1], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_69[0], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_69[1], PLAYER::PLAYER_PED_ID()))
						{
							BRAIN::TASK_LOOK_AT_ENTITY(iLocal_69[0], PLAYER::PLAYER_PED_ID(), 4000, 2056, 4);
							BRAIN::TASK_LOOK_AT_ENTITY(iLocal_69[1], PLAYER::PLAYER_PED_ID(), 4000, 2056, 4);
							if (!iLocal_57)
							{
								func_4();
								func_40(0);
					...
					else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_69[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 3))
					{
						...
						{
							BRAIN::TASK_AIM_GUN_AT_ENTITY(iLocal_69[0], iLocal_68, -1, 0);
						}
					}
				}
		...
		case 4:
			...
			while (iVar0 < iLocal_69)
			{
				if (!PED::IS_PED_INJURED(iLocal_69[iVar0]))
				{
					...
					BRAIN::TASK_COMBAT_PED(iLocal_69[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					PED::SET_PED_KEEP_TASK(iLocal_69[iVar0], true);
				}
				iVar0++;
			}
...
void func_63()//Position - 0x3E4C
{
	iLocal_47 = 3;
}

int func_64(int iParam0)//Position - 0x3E57
{
	if (func_68())
	{
		Global_106555 = 1;
...
void func_65(int iParam0)//Position - 0x3EAA
{
	switch (iParam0)
	{
		case 0:
...
void func_66(char* sParam0, int iParam1)//Position - 0x3F8B
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_67(int iParam0)//Position - 0x3FA2
{
	char* sVar0;
...
int func_69(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x4023
{
	int iVar0;
...
void func_70(var uParam0, int iParam1)//Position - 0x415A
{
	int iVar0;
...
bool func_71(int iParam0)//Position - 0x41A9
{
	return func_72(iParam0, Global_36425);
}

int func_72(int iParam0, int iParam1)//Position - 0x41BA
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_73(int iParam0)//Position - 0x439B
{
	if (Global_36425 == 15)
	{
		return 0;
...
int func_74(int iParam0, bool bParam1, int iParam2)//Position - 0x43BD
{
	int iVar0;
...
int func_75(int iParam0, bool bParam1, bool bParam2)//Position - 0x440F
{
	int iVar0;
...
float func_76(bool bParam0, float fParam1, float fParam2)//Position - 0x44B3
{
	if (bParam0)
	{
		return fParam1;
		...
		if ((!PED::IS_PED_INJURED(iLocal_68) && !PED::IS_PED_INJURED(iLocal_69[0])) && !PED::IS_PED_INJURED(iLocal_69[1]))
		{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_68, 12f, 12f, 2.5f, 0, 1, 0))
			{
				if (((PED::_CAN_PED_SEE_PED(iLocal_69[0], PLAYER::PLAYER_PED_ID()) || PED::_CAN_PED_SEE_PED(iLocal_69[1], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_69[0], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_69[1], PLAYER::PLAYER_PED_ID()))
				{
					if (!iLocal_54)
					{
						BRAIN::TASK_AIM_GUN_AT_ENTITY(iLocal_69[0], PLAYER::PLAYER_PED_ID(), -1, 0);
						iLocal_54 = 1;
					}
					if (HUD::DOES_BLIP_EXIST(iLocal_60))
					{
						HUD::_0x75A16C3DA34F1245(iLocal_60, true);
					}
					if (HUD::DOES_BLIP_EXIST(iLocal_61[0]))
					{
						HUD::_0x75A16C3DA34F1245(iLocal_61[0], true);
					}
					if (HUD::DOES_BLIP_EXIST(iLocal_61[1]))
					{
						HUD::_0x75A16C3DA34F1245(iLocal_61[1], true);
					}
...
int func_79()//Position - 0x4A3D
{
	...
	if (((((!ENTITY::DOES_ENTITY_EXIST(iLocal_68) && !ENTITY::DOES_ENTITY_EXIST(iLocal_69[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_69[1])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_76)) && !ENTITY::DOES_ENTITY_EXIST(iLocal_77[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_77[1]))
	{
		...
		if (((((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_m_skidrow_01")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_02"))) && STREAMING::HAS_MODEL_LOADED(joaat("picador"))) && STREAMING::HAS_MODEL_LOADED(joaat("hexer"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@countryside_gang_fight")) && STREAMING::HAS_ANIM_DICT_LOADED("veh@drivebystd_ds_grenades")) && STREAMING::HAS_ANIM_SET_LOADED("move_m@gangster@var_i"))
		{
			...
			BRAIN::TASK_PLAY_ANIM(iLocal_68, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			...
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("hexer"));
			BRAIN::TASK_PLAY_ANIM(iLocal_69[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(iLocal_69[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			iVar0 = 0;
			while (iVar0 < iLocal_69)
			{
				if (iVar0 < 2)
			...
			if (func_48() == 0)
			{
				func_57(&uLocal_85, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			}
			else if (func_48() == 1)
			{
				func_57(&uLocal_85, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
			else if (func_48() == 2)
			{
				func_57(&uLocal_85, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			}
			return 1;
		}
	}
...
int func_81(float fParam0, bool bParam1)//Position - 0x4F7E
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_82(int iParam0, var uParam1)//Position - 0x5035
{
	switch (iParam0)
	{
		case 0:
...
int func_84(int iParam0)//Position - 0x630D
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_85(int iParam0)//Position - 0x6653
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_86(int iParam0)//Position - 0x668B
{
	struct<2> Var0;
...
bool func_88()//Position - 0x6B0A
{
	return Global_106283 > 0;
}

int func_89()//Position - 0x6B18
{
	if (Global_90634 != -1)
	{
		return 1;
...
void func_94()//Position - 0x6BFD
{
}

void func_95(int iParam0)//Position - 0x6C05
{
	if (iParam0 == -1)
	{
		iParam0 = func_37();
...
void func_97(int iParam0)//Position - 0x6C78
{
	Global_106554 = iParam0;
}

int func_98(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x6C86
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_99(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x7020
{
	if (bParam6)
	{
...
bool func_100(int iParam0)//Position - 0x7067
{
	int iVar0;
...
int func_101(int iParam0)//Position - 0x7088
{
	return func_102(iParam0, 1);
}

int func_102(int iParam0, int iParam1)//Position - 0x7097
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_103(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x70EA
{
	func_104(func_115(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_104(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x7108
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_105(float fParam0, float fParam1, float fParam2)//Position - 0x7309
{
	float fVar0;
...
int func_106(int iParam0, int iParam1)//Position - 0x734B
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_107(int iParam0)//Position - 0x73ED
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_108(int iParam0)//Position - 0x7400
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_109(int iParam0)//Position - 0x7413
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_110(int iParam0)//Position - 0x7426
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_111(int iParam0)//Position - 0x7438
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_112(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_112(bool bParam0, int iParam1, int iParam2)//Position - 0x745D
{
	if (bParam0)
	{
		return iParam1;
...
int func_113(int iParam0)//Position - 0x7474
{
	return iParam0 & 15;
}

int func_114(int iParam0, int iParam1)//Position - 0x7481
{
	int iVar0;
	int iVar1;
...
void func_116(var uParam0, int iParam1)//Position - 0x75D3
{
	if (iParam1 <= 0)
	{
		return;
...
void func_117(var uParam0, int iParam1)//Position - 0x7659
{
...
void func_118(var uParam0, int iParam1)//Position - 0x768C
{
	int iVar0;
	int iVar1;
...
void func_119(var uParam0, int iParam1)//Position - 0x76DD
{
...
void func_120(var uParam0, int iParam1)//Position - 0x7717
{
...
void func_121(var uParam0, int iParam1)//Position - 0x7752
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_122(int iParam0)//Position - 0x778E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_123(int iParam0, int iParam1)//Position - 0x786A
{
...
int func_124(int iParam0)//Position - 0x788D
{
	int iVar0;
...
var func_125()//Position - 0x7FAA
{
	return Global_93721.f_1;
}

int func_126()//Position - 0x7FB8
{
	if (Global_90634 != -1)
	{
...
bool func_129()//Position - 0x8025
{
	return Global_93734.f_340 > 0;
}

bool func_130()//Position - 0x8036
{
	return Global_93734.f_339 > 0;
}

var func_131()//Position - 0x8047
{
	return Global_1312867;
}

int func_132()//Position - 0x8053
{
...
bool func_134(int iParam0)//Position - 0x8097
{
	return func_114(func_115(), iParam0);
}

int func_135(int iParam0, int iParam1, int iParam2)//Position - 0x80A9
{
	int iVar0;
	int iVar1;
...
int func_136(int iParam0)//Position - 0x818D
{
	if (!func_31(iParam0))
	{
		return 7;
...
bool func_137(int iParam0)//Position - 0x81B1
{
	int iVar0;
	bool bVar1;
...
void func_141(int iParam0)//Position - 0x84CF
{
	char cVar0[64];
...
void func_142(var uParam0)//Position - 0x8584
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_143(int iParam0, bool bParam1)//Position - 0x85C1
{
	switch (iParam0)
	{
		case 0:
...
void func_144(int iParam0)//Position - 0x880A
{
	Global_36976 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_145(int iParam0)//Position - 0x881C
{
	func_146(iParam0, 0, func_151(iParam0));
}

void func_146(int iParam0, int iParam1, int iParam2)//Position - 0x8831
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_147(var uParam0)//Position - 0x8860
{
	struct<16> Var0;
	int iVar16;
...
void func_148(int iParam0, var uParam1)//Position - 0x8931
{
	Global_106565.f_24989.f_43[iParam0] = *uParam1;
}

void func_149(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8949
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_150(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8ACB
{
...
int func_151(int iParam0)//Position - 0x8B03
{
	int iVar0;
