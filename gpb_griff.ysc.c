...
void func_22(char* sParam0)//Position - 0x17CA
{
	struct<16> Var0;
...
void func_23(char* sParam0)//Position - 0x17F0
{
	int iVar0;
...
void func_24(char* sParam0)//Position - 0x182E
{
	int iVar0;
...
void func_25(int iParam0, char* sParam1)//Position - 0x1872
{
	switch (iParam0)
	{
		case 0:
...
void func_26(char* sParam0)//Position - 0x1A3B
{
	char cVar0[64];
...
void func_27(char* sParam0)//Position - 0x1A6F
{
	struct<4> Var0;
...
void func_28(char* sParam0)//Position - 0x1A9A
{
...
void func_29()//Position - 0x1ABB
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_30(char* sParam0)//Position - 0x1ACC
{
	int iVar0;
...
bool func_32(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B38
{
...
int func_33(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B86
{
	Global_15867 = 0;
...
bool func_40(int iParam0, int iParam1)//Position - 0x20CF
{
	switch (iParam0)
	{
		case 5:
...
void func_41(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x210A
{
...
void func_42(char[4] cParam0)//Position - 0x2160
{
	int iVar0;
...
void func_43(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x219B
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_44(char* sParam0)//Position - 0x2236
{
	int iVar0;
...
void func_45(var uParam0)//Position - 0x226E
{
}

void func_46(var uParam0, int iParam1, float fParam2)//Position - 0x2276
{
}

void func_47()//Position - 0x227E
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_48()//Position - 0x228D
{
	char* sVar0;
	struct<16> Var8;
...
void func_49(var uParam0)//Position - 0x2303
{
}

void func_50(char* sParam0)//Position - 0x230B
{
...
void func_51(int iParam0, char* sParam1, char* sParam2)//Position - 0x231E
{
...
bool func_53()//Position - 0x2411
{
	return Global_93734.f_339 > 0;
}

bool func_54()//Position - 0x2422
{
	bool bVar0;
...
void func_58(char* sParam0)//Position - 0x24A5
{
	struct<8> Var0;
...
void func_59(char* sParam0)//Position - 0x24E5
{
	func_25(iLocal_297, sParam0);
}

void func_60(char* sParam0)//Position - 0x24F6
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_106510[iLocal_251] + 1, 16);
}

void func_61(int iParam0, bool bParam1)//Position - 0x2514
{
	int iVar0;
...
void func_62(int iParam0, bool bParam1)//Position - 0x2535
{
	int iVar0;
...
void func_63(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x25A6
{
	func_64(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_64(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x25C6
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x28B8
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0)//Position - 0x2A01
{
	if (func_71(iParam0))
	{
...
int func_70(int iParam0)//Position - 0x2A28
{
	int iVar0;
...
int func_71(int iParam0)//Position - 0x2A5B
{
...
int func_72(int iParam0)//Position - 0x2A85
{
	switch (iParam0)
	{
...
void func_73(int iParam0)//Position - 0x2B43
{
	if (iLocal_447 == 1)
	{
...
void func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x2B62
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_75(int iParam0, bool bParam1, int iParam2)//Position - 0x2BB5
{
	int iVar0;
...
int func_76(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C07
{
	int iVar0;
...
float func_77(bool bParam0, float fParam1, float fParam2)//Position - 0x2CAB
{
	if (bParam0)
	{
		return fParam1;
...
float func_78(int iParam0, int iParam1, bool bParam2)//Position - 0x2CC2
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_79(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2D20
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_80(vector3 vParam0, vector3 vParam3)//Position - 0x2DB1
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_81(vector3 vParam0)//Position - 0x2DD2
{
	float fVar0;
	float fVar1;
...
int func_82(int iParam0)//Position - 0x2E11
{
	var uVar0;
...
void func_85()//Position - 0x2E65
{
	Global_14732 = 0;
	func_86();
}

void func_86()//Position - 0x2E75
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16877 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_87()//Position - 0x2E96
{
	return 1;
}

void func_88()//Position - 0x2E9F
{
}

int func_89()//Position - 0x2EA7
{
	return 1;
}

float func_90(int iParam0, int iParam1)//Position - 0x2EB0
{
	return func_78(iParam0, iParam1, 1);
}

void func_91(int iParam0)//Position - 0x2EC1
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x2EF2
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0, bool bParam1)//Position - 0x2F23
{
	if (!func_71(iParam0))
	{
		if (!bParam1)
...
void func_94(var uParam0, var uParam1)//Position - 0x2FD6
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_95(int iParam0, bool bParam1)//Position - 0x2FE7
{
	if (iParam0 == 1)
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_96(int iParam0)//Position - 0x3059
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_97()//Position - 0x307A
{
	func_98();
}

void func_98()//Position - 0x3086
{
...
int func_103()//Position - 0x31EB
{
	return 1;
}

bool func_104(var uParam0)//Position - 0x31F4
{
	return func_105(Global_106565.f_20111, uParam0);
}

bool func_105(var uParam0, var uParam1)//Position - 0x3209
{
	return (uParam0 && uParam1) != 0;
}

int func_106(int iParam0)//Position - 0x3218
{
...
void func_107(int iParam0)//Position - 0x333F
{
	var uVar0;
...
void func_108(int iParam0)//Position - 0x340E
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_109()//Position - 0x342E
{
	struct<6> Var0;
...
void func_110()//Position - 0x3452
{
	func_111();
}

void func_111()//Position - 0x345E
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_448))
	{
